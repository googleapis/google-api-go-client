...
func (c *RegionViewsGetCall) DoHeader() (*ResourceView, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *RegionViewsInsertCall) DoHeader() (*RegionViewsInsertResponse, http.Header, error) {
	var body io.Reader = nil
...
func (c *RegionViewsListCall) DoHeader() (*RegionViewsListResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *RegionViewsListresourcesCall) DoHeader() (*RegionViewsListResourcesResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["maxResults"]; ok {
...
func (c *ZoneViewsGetCall) DoHeader() (*ResourceView, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *ZoneViewsInsertCall) DoHeader() (*ZoneViewsInsertResponse, http.Header, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.resourceview)
	if err != nil {
		return nil, nil, err
...
func (c *ZoneViewsListCall) DoHeader() (*ZoneViewsListResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["maxResults"]; ok {
...
func (c *ZoneViewsListresourcesCall) DoHeader() (*ZoneViewsListResourcesResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["maxResults"]; ok {
