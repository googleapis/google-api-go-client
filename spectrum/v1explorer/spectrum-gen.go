...
type PawsGetSpectrumCallDoer interface {
	...
	Fields(s ...googleapi.Field) PawsGetSpectrumCallDoer
}
...
type PawsGetSpectrumBatchCallDoer interface {
	...
	Fields(s ...googleapi.Field) PawsGetSpectrumBatchCallDoer
}
...
type PawsInitCallDoer interface {
	...
	Fields(s ...googleapi.Field) PawsInitCallDoer
}
...
type PawsNotifySpectrumUseCallDoer interface {
	...
	Fields(s ...googleapi.Field) PawsNotifySpectrumUseCallDoer
}
...
type PawsRegisterCallDoer interface {
	...
	Fields(s ...googleapi.Field) PawsRegisterCallDoer
}
...
type PawsVerifyDeviceCallDoer interface {
	...
	Fields(s ...googleapi.Field) PawsVerifyDeviceCallDoer
}
...
// PawsServicer makes it easy to provide your own testable versions of PawsService.
type PawsServicer interface {
	GetSpectrum(pawsgetspectrumrequest *PawsGetSpectrumRequest) PawsGetSpectrumCallDoer
	GetSpectrumBatch(pawsgetspectrumbatchrequest *PawsGetSpectrumBatchRequest) PawsGetSpectrumBatchCallDoer
	Init(pawsinitrequest *PawsInitRequest) PawsInitCallDoer
	NotifySpectrumUse(pawsnotifyspectrumuserequest *PawsNotifySpectrumUseRequest) PawsNotifySpectrumUseCallDoer
	Register(pawsregisterrequest *PawsRegisterRequest) PawsRegisterCallDoer
	VerifyDevice(pawsverifydevicerequest *PawsVerifyDeviceRequest) PawsVerifyDeviceCallDoer
}
