...
// At most one of Media and ResumableMedia may be set.
func (c *TimelineInsertCall) ResumableMedia(ctx context.Context, r googleapi.Reader) *TimelineInsertCall {
	c.ctx_ = ctx
	c.media_ = r
...
// ResumableMedia specifies the media to upload in chunks and can be cancelled with ctx.
// At most one of Media and ResumableMedia may be set.
func (c *TimelineUpdateCall) ResumableMedia(ctx context.Context, r googleapi.Reader) *TimelineUpdateCall {
	c.ctx_ = ctx
	c.media_ = r
	c.protocol_ = "resumable"
	return c
...
// ResumableMedia specifies the media to upload in chunks and can be cancelled with ctx.
// At most one of Media and ResumableMedia may be set.
func (c *TimelineAttachmentsInsertCall) ResumableMedia(ctx context.Context, r googleapi.Reader) *TimelineAttachmentsInsertCall {
	c.ctx_ = ctx
	c.media_ = r
	c.protocol_ = "resumable"
	return c
