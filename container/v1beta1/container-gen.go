...
func (c *ProjectsClustersListCall) DoHeader() (http.Header, *ListAggregatedClustersResponse, error) {
...
func (c *ProjectsOperationsListCall) DoHeader() (http.Header, *ListAggregatedOperationsResponse, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *ProjectsZonesClustersCreateCall) DoHeader() (http.Header, *Operation, error) {
	var body io.Reader = nil
...
func (c *ProjectsZonesClustersDeleteCall) DoHeader() (http.Header, *Operation, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *ProjectsZonesClustersGetCall) DoHeader() (http.Header, *Cluster, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *ProjectsZonesClustersListCall) DoHeader() (http.Header, *ListClustersResponse, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *ProjectsZonesOperationsGetCall) DoHeader() (http.Header, *Operation, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *ProjectsZonesOperationsListCall) DoHeader() (http.Header, *ListOperationsResponse, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
