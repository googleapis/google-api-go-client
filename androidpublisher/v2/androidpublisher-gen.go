...
// VoidedPurchase: A VoidedPurchase resource indicates the purchase was
// either cancelled/refunded/charged-back.
type VoidedPurchase struct {
	// Kind: This kind represents a voided purchase object in the
	// androidpublisher service.
	Kind string `json:"kind,omitempty"`

	// PurchaseTimeMillis: The time the purchase was made, in milliseconds
	// since the epoch (Jan 1, 1970).
	PurchaseTimeMillis int64 `json:"purchaseTimeMillis,omitempty,string"`

	// PurchaseToken: The token that was generated when a purchase was made
	// and uniquely identifies a purchase.
	PurchaseToken string `json:"purchaseToken,omitempty"`

	// VoidedTimeMillis: The time when the purchase was
	// cancelled/refunded/chargeback, in milliseconds since the epoch (Jan
	// 1, 1970).
...
// EndTime sets the optional parameter "endTime": The end time of list
// window, in milliseconds since the epoch (Jan 1, 1970). If not
// specified, default to current time, which is also the latest accepted
...
// StartTime sets the optional parameter "startTime": The start time of
// list window, in milliseconds since the epoch (Jan 1, 1970). If not
// specified, default to current time - 30 days, which is also the
// earlies accepted start time. This parameter will be ignored if
