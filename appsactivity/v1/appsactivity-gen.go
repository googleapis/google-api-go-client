...
func (c *ActivitiesListCall) Do() (ret *ListActivitiesResponse, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
func (c *ActivitiesListCall) DoHeader() (ret *ListActivitiesResponse, resHeader http.Header, err error) {
