...
// GoogleCloudSecuritycenterV1Resource:  Information related to the Google
// Cloud resource.
...
// representation of a Google Cloud resource. The Asset is a Security Command
// Center resource that captures information about a single Google Cloud
// resource. All modifications to an Asset are only within the context of
// Security Command Center and don't affect the referenced Google Cloud
// resource.
...
// GoogleCloudSecuritycenterV1p1beta1IamPolicy: Cloud IAM Policy information
// associated with the Google Cloud resource described by the Security Command
// Center asset. This information is managed and defined by the Google Cloud
...
type GoogleCloudSecuritycenterV1p1beta1IamPolicy struct {
	...
	// See https://cloud.google.com/iam/docs/reference/rest/v1/Policy for format
	// details.
...
// GoogleCloudSecuritycenterV1p1beta1SecurityCenterProperties: Security Command
// Center managed properties. These properties are managed by Security Command
...
type GoogleCloudSecuritycenterV1p1beta1SecurityCenterProperties struct {
	...
	// ForceSendFields is a list of field names (e.g. "ResourceDisplayName") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ResourceDisplayName") to include
...
// GoogleCloudSecuritycenterV1p1beta1TemporalAsset: Wrapper over asset object
// that also captures the state change for the asset e.g. if it was a newly
// created asset vs updated or deleted asset.
