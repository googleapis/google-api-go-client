...
// is cancelled.
func (c *BatchReportDefinitionsListCall) Ctx(ctx context.Context) *BatchReportDefinitionsListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *BatchReportsListCall) Ctx(ctx context.Context) *BatchReportsListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *GroupItemsDeleteCall) Ctx(ctx context.Context) *GroupItemsDeleteCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *GroupItemsInsertCall) Ctx(ctx context.Context) *GroupItemsInsertCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *GroupItemsListCall) Ctx(ctx context.Context) *GroupItemsListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *GroupsUpdateCall) Ctx(ctx context.Context) *GroupsUpdateCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ReportsQueryCall) Ctx(ctx context.Context) *ReportsQueryCall {
	c.ctx_ = ctx
	return c
}
