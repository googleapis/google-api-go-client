...
const basePathTemplate = "https://www.UNIVERSE_DOMAIN/pagespeedonline/v2/"
...
// PagespeedApiImageV2PageRect: The region of the page that is captured by this
// image, with dimensions measured in CSS pixels.
...
type ResultFormattedResultsRuleResults struct {
	...
	// list is one of "SPEED" or "USABILITY".
...
type ResultRuleGroups struct {
	...
	// more usable). A high score indicates little room for improvement, while a
