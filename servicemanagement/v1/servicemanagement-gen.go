...
// field that refers to
// an API resource.
type ResourceReference struct {
	// ChildType: The resource type of a child collection that the annotated
	// field
	// references. This is useful for annotating the `parent` field
	// that
	...
	// Type: The resource type that the annotated field
	// references.
	//
	// Example:
	//
...
//
// A managed service is immutable, and is subject to mandatory
// 30-day
// data retention. You cannot move a service or recreate it within 30
// days
// after deletion.
//
// One producer project can own no more than 500 services. For security
// and
// reliability purposes, a production service should be hosted in
// a
