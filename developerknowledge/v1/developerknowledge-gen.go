...
// in RFC-3339 format, e.g., "2025-01-01T00:00:00Z". Note: Field names must
// be in `snake_case` (e.g., `data_source`). Values on the right-hand side of
// filtering expressions must be string literals enclosed in double quotes
...
// `AND`. Use parentheses for explicit precedence grouping. Examples: * Filter
// by `Document.content_length_bytes`: `content_length_bytes < 50000` *
