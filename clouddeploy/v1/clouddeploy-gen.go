...
type DeliveryPipeline struct {
	...
	// constraints: Each resource is limited to 64 labels. Keys must conform
	// to the regexp: `a-zA-Z{0,62}`. Values must conform to the regexp:
	// `[a-zA-Z0-9_-]{0,63}`. Both keys and values are additionally
...
type ExecutionConfig struct {
	...
	// ForceSendFields is a list of field names (e.g. "DefaultPool") to
	// unconditionally include in API requests. By default, fields with
	// empty or default values are omitted from API requests. However, any
	// non-pointer, non-interface field appearing in ForceSendFields will be
	// sent to the server regardless of whether the field is empty or not.
	...
	// NullFields is a list of field names (e.g. "DefaultPool") to include
	// in API requests with the JSON null value. By default, fields with
	// empty values are omitted from API requests. However, any field with
	// an empty value appearing in NullFields will be sent to the server as
	// null. It is an error if a field in this list has a non-empty value.
...
type Release struct {
	...
	// TargetSnapshots: Output only. Snapshot of the parent pipeline's
...
type Stage struct {
	...
	// parent `DeliveryPipeline` of the `Target` is inferred to be the
	// parent `DeliveryPipeline` of the `Release` in which this `Stage`
	// lives.
	TargetId string `json:"targetId,omitempty"`
...
type Target struct {
	...
	// following constraints: Each resource is limited to 64 labels. Keys
	// must conform to the regexp: `a-zA-Z{0,62}`. Values must conform to
	// the regexp: `[a-zA-Z0-9_-]{0,63}`. Both keys and values are
...
type TargetRender struct {
	...
	// ForceSendFields is a list of field names (e.g. "RenderingBuild") to
	// unconditionally include in API requests. By default, fields with
	// empty or default values are omitted from API requests. However, any
	// non-pointer, non-interface field appearing in ForceSendFields will be
	// sent to the server regardless of whether the field is empty or not.
	...
	// NullFields is a list of field names (e.g. "RenderingBuild") to
	// include in API requests with the JSON null value. By default, fields
	// with empty values are omitted from API requests. However, any field
	// with an empty value appearing in NullFields will be sent to the
	// server as null. It is an error if a field in this list has a
