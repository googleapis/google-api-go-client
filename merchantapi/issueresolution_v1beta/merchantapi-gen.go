...
// restricted to an allowlist. You can submit an allowlist request in the
// Shopping API Support Form
// (https://support.google.com/merchants/contact/shopping_api_support_form)
