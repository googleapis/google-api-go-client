...
func (c *SitemapsGetCall) DoHeader() (http.Header, *WmxSitemap, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *SitemapsListCall) DoHeader() (http.Header, *SitemapsListResponse, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *SitesGetCall) DoHeader() (http.Header, *WmxSite, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *UrlcrawlerrorscountsQueryCall) DoHeader() (http.Header, *UrlCrawlErrorsCountsQueryResponse, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *UrlcrawlerrorssamplesGetCall) DoHeader() (http.Header, *UrlCrawlErrorsSample, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *UrlcrawlerrorssamplesListCall) DoHeader() (http.Header, *UrlCrawlErrorsSamplesListResponse, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	params.Set("category", fmt.Sprintf("%v", c.category))
