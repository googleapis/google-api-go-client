...
func (c *TrainedmodelsGetCall) DoHeader() (*Training, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *TrainedmodelsInsertCall) DoHeader() (*Training, http.Header, error) {
	var body io.Reader = nil
...
func (c *TrainedmodelsPredictCall) DoHeader() (*Output, http.Header, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.input)
	if err != nil {
		return nil, nil, err
...
func (c *TrainedmodelsUpdateCall) DoHeader() (*Training, http.Header, error) {
	var body io.Reader = nil
