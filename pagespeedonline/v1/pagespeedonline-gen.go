...
type PagespeedapiRunpagespeedCallDoer interface {
	Do() (*Result, error)
	FilterThirdPartyResources(filterThirdPartyResources bool) PagespeedapiRunpagespeedCallDoer
	Locale(locale string) PagespeedapiRunpagespeedCallDoer
	Rule(rule string) PagespeedapiRunpagespeedCallDoer
	Screenshot(screenshot bool) PagespeedapiRunpagespeedCallDoer
	Strategy(strategy string) PagespeedapiRunpagespeedCallDoer
	Fields(s ...googleapi.Field) PagespeedapiRunpagespeedCallDoer
}
