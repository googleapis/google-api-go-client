...
//
//	saasservicemgmtService, err := saasservicemgmt.NewService(ctx, option.WithScopes(saasservicemgmt.SaasservicemgmtReadonlyScope))
//
...
const (
	...
	// See, edit, configure, and delete your Google Cloud App Lifecycle Management
	// data and see the email address for your Google Account
	SaasservicemgmtReadWriteScope = "https://www.googleapis.com/auth/saasservicemgmt.read-write"

	// See your Google Cloud App Lifecycle Management data and the email address of
	// your Google Account
	SaasservicemgmtReadonlyScope = "https://www.googleapis.com/auth/saasservicemgmt.readonly"
)
...
func (c *ProjectsLocationsSaasReleasesCreateCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1beta1/{+parent}/saasReleases")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
type ProjectsLocationsSaasReleasesPatchCall struct {
	s           *Service
	name        string
	saasrelease *SaasRelease
	urlParams_  gensupport.URLParams
...
// Patch: Update a single saas release.
//
//   - name: Identifier. The resource name (full URI of the resource) following
//     the standard naming scheme:
//     "projects/{project}/locations/{location}/saasReleases/{saasRelease}".
func (r *ProjectsLocationsSaasReleasesService) Patch(name string, saasrelease *SaasRelease) *ProjectsLocationsSaasReleasesPatchCall {
	c := &ProjectsLocationsSaasReleasesPatchCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.name = name
	c.saasrelease = saasrelease
	return c
}
...
// RequestId sets the optional parameter "requestId": An optional request ID to
// identify requests.
func (c *ProjectsLocationsSaasReleasesPatchCall) RequestId(requestId string) *ProjectsLocationsSaasReleasesPatchCall {
	c.urlParams_.Set("requestId", requestId)
	return c
}
...
func (c *ProjectsLocationsSaasReleasesPatchCall) UpdateMask(updateMask string) *ProjectsLocationsSaasReleasesPatchCall {
	c.urlParams_.Set("updateMask", updateMask)
	return c
}
...
// is set to true, the service will try to validate that this request would
// succeed, but will not actually make changes.
func (c *ProjectsLocationsSaasReleasesPatchCall) ValidateOnly(validateOnly bool) *ProjectsLocationsSaasReleasesPatchCall {
	c.urlParams_.Set("validateOnly", fmt.Sprint(validateOnly))
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse for more
// details.
func (c *ProjectsLocationsSaasReleasesPatchCall) Fields(s ...googleapi.Field) *ProjectsLocationsSaasReleasesPatchCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}

// Context sets the context to be used in this call's Do method.
func (c *ProjectsLocationsSaasReleasesPatchCall) Context(ctx context.Context) *ProjectsLocationsSaasReleasesPatchCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns a http.Header that can be modified by the caller to add
// headers to the request.
func (c *ProjectsLocationsSaasReleasesPatchCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *ProjectsLocationsSaasReleasesPatchCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.saasrelease)
	if err != nil {
		return nil, err
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "saasservicemgmt.projects.locations.saasReleases.patch", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "saasservicemgmt.projects.locations.saasReleases.patch" call.
// Any non-2xx status code is an error. Response headers are in either
// *SaasRelease.ServerResponse.Header or (if a response was returned at all) in
// error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
func (c *ProjectsLocationsSaasReleasesPatchCall) Do(opts ...googleapi.CallOption) (*SaasRelease, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "saasservicemgmt.projects.locations.saasReleases.patch", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *ProjectsLocationsUnitGroupOperationsCreateCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1beta1/{+parent}/unitGroupOperations")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
type ProjectsLocationsUnitGroupOperationsPatchCall struct {
	s                  *Service
	name               string
	unitgroupoperation *UnitGroupOperation
	urlParams_         gensupport.URLParams
...
// Patch: Update a single unit group operation.
//
//   - name: Identifier. The resource name (full URI of the resource) following
//     the standard naming scheme:
//     "projects/{project}/locations/{location}/unitGroupOperations/{unitGroupOper
//     ation}".
func (r *ProjectsLocationsUnitGroupOperationsService) Patch(name string, unitgroupoperation *UnitGroupOperation) *ProjectsLocationsUnitGroupOperationsPatchCall {
	c := &ProjectsLocationsUnitGroupOperationsPatchCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.name = name
	c.unitgroupoperation = unitgroupoperation
	return c
}
...
// request ID must be a valid UUID with the exception that zero UUID is not
// supported (00000000-0000-0000-0000-000000000000).
func (c *ProjectsLocationsUnitGroupOperationsPatchCall) RequestId(requestId string) *ProjectsLocationsUnitGroupOperationsPatchCall {
	c.urlParams_.Set("requestId", requestId)
	return c
}

// UpdateMask sets the optional parameter "updateMask": Field mask is used to
// specify the fields to be overwritten in the UnitGroupOperation resource by
// the update. The fields specified in the update_mask are relative to the
// resource, not the full request. A field will be overwritten if it is in the
// mask. If the user does not provide a mask then all fields in the
// UnitGroupOperation will be overwritten.
func (c *ProjectsLocationsUnitGroupOperationsPatchCall) UpdateMask(updateMask string) *ProjectsLocationsUnitGroupOperationsPatchCall {
	c.urlParams_.Set("updateMask", updateMask)
	return c
}
...
// is set to true, the service will try to validate that this request would
// succeed, but will not actually make changes.
func (c *ProjectsLocationsUnitGroupOperationsPatchCall) ValidateOnly(validateOnly bool) *ProjectsLocationsUnitGroupOperationsPatchCall {
	c.urlParams_.Set("validateOnly", fmt.Sprint(validateOnly))
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse for more
// details.
func (c *ProjectsLocationsUnitGroupOperationsPatchCall) Fields(s ...googleapi.Field) *ProjectsLocationsUnitGroupOperationsPatchCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}

// Context sets the context to be used in this call's Do method.
func (c *ProjectsLocationsUnitGroupOperationsPatchCall) Context(ctx context.Context) *ProjectsLocationsUnitGroupOperationsPatchCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns a http.Header that can be modified by the caller to add
// headers to the request.
func (c *ProjectsLocationsUnitGroupOperationsPatchCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *ProjectsLocationsUnitGroupOperationsPatchCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.unitgroupoperation)
	if err != nil {
		return nil, err
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "saasservicemgmt.projects.locations.unitGroupOperations.patch", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "saasservicemgmt.projects.locations.unitGroupOperations.patch" call.
// Any non-2xx status code is an error. Response headers are in either
// *UnitGroupOperation.ServerResponse.Header or (if a response was returned at
// all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified was
// returned.
func (c *ProjectsLocationsUnitGroupOperationsPatchCall) Do(opts ...googleapi.CallOption) (*UnitGroupOperation, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "saasservicemgmt.projects.locations.unitGroupOperations.patch", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *ProjectsLocationsUnitGroupsCreateCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1beta1/{+parent}/unitGroups")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
type ProjectsLocationsUnitGroupsPatchCall struct {
	s          *Service
	name       string
	unitgroup  *UnitGroup
	urlParams_ gensupport.URLParams
...
// Patch: Update a single unit group.
//
//   - name: Identifier. The resource name (full URI of the resource) following
//     the standard naming scheme:
//     "projects/{project}/locations/{location}/unitGroups/{unitGroup}".
func (r *ProjectsLocationsUnitGroupsService) Patch(name string, unitgroup *UnitGroup) *ProjectsLocationsUnitGroupsPatchCall {
	c := &ProjectsLocationsUnitGroupsPatchCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.name = name
	c.unitgroup = unitgroup
	return c
}
...
// RequestId sets the optional parameter "requestId": An optional request ID to
// identify requests.
func (c *ProjectsLocationsUnitGroupsPatchCall) RequestId(requestId string) *ProjectsLocationsUnitGroupsPatchCall {
	c.urlParams_.Set("requestId", requestId)
	return c
}
...
// UpdateMask sets the optional parameter "updateMask": Field mask is used to
// specify the fields to be overwritten.
func (c *ProjectsLocationsUnitGroupsPatchCall) UpdateMask(updateMask string) *ProjectsLocationsUnitGroupsPatchCall {
	c.urlParams_.Set("updateMask", updateMask)
	return c
}
...
// is set to true, the service will try to validate that this request would
// succeed, but will not actually make changes.
func (c *ProjectsLocationsUnitGroupsPatchCall) ValidateOnly(validateOnly bool) *ProjectsLocationsUnitGroupsPatchCall {
	c.urlParams_.Set("validateOnly", fmt.Sprint(validateOnly))
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse for more
// details.
func (c *ProjectsLocationsUnitGroupsPatchCall) Fields(s ...googleapi.Field) *ProjectsLocationsUnitGroupsPatchCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}

// Context sets the context to be used in this call's Do method.
func (c *ProjectsLocationsUnitGroupsPatchCall) Context(ctx context.Context) *ProjectsLocationsUnitGroupsPatchCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns a http.Header that can be modified by the caller to add
// headers to the request.
func (c *ProjectsLocationsUnitGroupsPatchCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *ProjectsLocationsUnitGroupsPatchCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.unitgroup)
	if err != nil {
		return nil, err
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "saasservicemgmt.projects.locations.unitGroups.patch", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "saasservicemgmt.projects.locations.unitGroups.patch" call.
// Any non-2xx status code is an error. Response headers are in either
// *UnitGroup.ServerResponse.Header or (if a response was returned at all) in
// error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
func (c *ProjectsLocationsUnitGroupsPatchCall) Do(opts ...googleapi.CallOption) (*UnitGroup, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "saasservicemgmt.projects.locations.unitGroups.patch", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
