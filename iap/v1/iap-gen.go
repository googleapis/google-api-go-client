...
type ApplicationSettings struct {
	...
	// propagation to customer application. These attributes may come from
...
// attributes to customer applications protected by IAP. These
// attributes may be SAML attributes from a 3rd party IdP, or
...
type AttributePropagationSettings struct {
	...
	// Expression: Raw string CEL expression. Expression should be of the
