...
type GlobalAccountsOperationsServicer interface {
	Delete(project string, operation string) *GlobalAccountsOperationsDeleteCall
	Get(project string, operation string) *GlobalAccountsOperationsGetCall
	List(project string) *GlobalAccountsOperationsListCall
}
...
type GroupsServicer interface {
	AddMember(project string, groupName string, groupsaddmemberrequest *GroupsAddMemberRequest) *GroupsAddMemberCall
	Delete(project string, groupName string) *GroupsDeleteCall
	Get(project string, groupName string) *GroupsGetCall
	Insert(project string, group *Group) *GroupsInsertCall
	List(project string) *GroupsListCall
	RemoveMember(project string, groupName string, groupsremovememberrequest *GroupsRemoveMemberRequest) *GroupsRemoveMemberCall
}
...
type LinuxServicer interface {
	GetAuthorizedKeysView(project string, zone string, user string, instance string) *LinuxGetAuthorizedKeysViewCall
	GetLinuxAccountViews(project string, zone string, instance string) *LinuxGetLinuxAccountViewsCall
}
...
type UsersServicer interface {
	AddPublicKey(project string, user string, publickey *PublicKey) *UsersAddPublicKeyCall
	Delete(project string, user string) *UsersDeleteCall
	Get(project string, user string) *UsersGetCall
	Insert(project string, user *User) *UsersInsertCall
	List(project string) *UsersListCall
	RemovePublicKey(project string, user string, fingerprint string) *UsersRemovePublicKeyCall
}
