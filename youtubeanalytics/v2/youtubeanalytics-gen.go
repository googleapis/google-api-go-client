...
// or `ageGroup,gender`. See the Available Reports document for a list
// of the reports that you can retrieve and the dimensions used for
// those reports. Also see the Dimensions document for definitions of
...
// See the Available Reports document for a list of the reports that you
// can retrieve and the metrics available in each report, and see the
// Metrics document for definitions of those metrics. required: true,
// pattern: [0-9a-zA-Z,]+
