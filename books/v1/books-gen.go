...
// Exactly one of *Bookshelf or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Bookshelf.ServerResponse.Header
...
// Exactly one of *Bookshelves or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Bookshelves.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Volumes or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Volumes.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Any non-2xx status code is an error.
// Response headers are in either *BooksCloudloadingResource.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Layersummary or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Layersummary.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Layersummaries or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Layersummaries.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Annotationdata or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Annotationdata.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Annotationsdata or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Annotationsdata.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Volumeannotation or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Volumeannotation.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Volumeannotations or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Volumeannotations.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Usersettings or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Usersettings.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *DownloadAccesses or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *DownloadAccesses.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *RequestAccess or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *RequestAccess.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Annotation or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Annotation.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Annotations or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Annotations.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *AnnotationsSummary or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *AnnotationsSummary.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *ReadingPosition or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *ReadingPosition.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Category or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Category.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Volume2 or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Volume2.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Offers or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Offers.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Volume or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Volume.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *BooksVolumesRecommendedRateResponse or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *BooksVolumesRecommendedRateResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
