...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ZoneViewsGetServiceCall) Ctx(ctx context.Context) *ZoneViewsGetServiceCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ZoneViewsSetServiceCall) Ctx(ctx context.Context) *ZoneViewsSetServiceCall {
	c.ctx_ = ctx
	return c
}
