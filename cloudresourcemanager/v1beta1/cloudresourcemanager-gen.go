...
type ProjectsCreateCallDoer interface {
	Do() (*Project, error)
	Fields(s ...googleapi.Field) ProjectsCreateCallDoer
}
...
type ProjectsDeleteCallDoer interface {
	Do() (*Empty, error)
	Fields(s ...googleapi.Field) ProjectsDeleteCallDoer
}
...
type ProjectsListCallDoer interface {
	...
	Filter(filter string) ProjectsListCallDoer
	PageSize(pageSize int64) ProjectsListCallDoer
...
type ProjectsUndeleteCallDoer interface {
	Do() (*Empty, error)
	Fields(s ...googleapi.Field) ProjectsUndeleteCallDoer
}
...
type ProjectsUpdateCallDoer interface {
	Do() (*Project, error)
	Fields(s ...googleapi.Field) ProjectsUpdateCallDoer
}
