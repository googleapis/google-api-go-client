...
package gkehub // import "google.golang.org/api/gkehub/v2"
...
type FeatureState struct {
	...
	Workloadidentity *WorkloadIdentityState `json:"workloadidentity,omitempty"`
...
// WorkloadIdentityState: **WorkloadIdentity**: The membership-specific state
// for WorkloadIdentity feature.
...
func (s WorkloadIdentityState) MarshalJSON() ([]byte, error) {
	type NoMethod WorkloadIdentityState
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}
