...
// is cancelled.
func (c *UrlGetCall) Ctx(ctx context.Context) *UrlGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *UrlInsertCall) Ctx(ctx context.Context) *UrlInsertCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *UrlListCall) Ctx(ctx context.Context) *UrlListCall {
	c.ctx_ = ctx
	return c
}
