...
type DatabaseInstance struct {
	...
	// ReplicationCluster: Optional. The pair of a primary instance and
	// disaster recovery (DR) replica. A DR replica is a cross-region
	// replica that you designate for failover in the event that the primary
	// instance has regional failure.
...
type DemoteContext struct {
	...
	// which acts as the on-premises primary instance in the replication
	// setup.
...
// InstancesAcquireSsrsLeaseRequest: Request to acquire a lease for
// SSRS.
...
// SqlInstancesAcquireSsrsLeaseResponse: Response for the acquire SSRS
// lease request.
...
// SqlInstancesReleaseSsrsLeaseResponse: Response for the release SSRS
// lease request.
...
// SqlInstancesStartExternalSyncRequest: Instance start external sync
// request.
type SqlInstancesStartExternalSyncRequest struct {
	...
	//
	// Possible values:
	//   "MIGRATION_TYPE_UNSPECIFIED" - Default value is logical migration
...
// SqlInstancesVerifyExternalSyncSettingsRequest: Instance verify
// external sync settings request.
...
//     project ID. The instance ID contains lowercase letters, numbers,
//     and hyphens, and it must start with a letter. This ID can have a
...
// Switchover: Switches over from the primary instance to the replica
// instance.
//
// - instance: Cloud SQL read replica instance name.
