...
func (c *ProjectsCreateCall) Do() (ret *Project, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *ProjectsDeleteCall) Do() (ret *Empty, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *ProjectsListCall) Do() (ret *ListProjectsResponse, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *ProjectsUndeleteCall) Do() (ret *Empty, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *ProjectsUpdateCall) Do() (ret *Project, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
