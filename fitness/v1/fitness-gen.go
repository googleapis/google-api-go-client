...
//
// In addition to the data source fields reflected into the data source
// ID, the developer project number that is authenticated when creating
// the data source is included. This developer project number is
// obfuscated when read by any other developer reading public data
// types.
