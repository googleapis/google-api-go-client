...
func (c *RollingUpdatesCancelCall) Do() (ret *Operation, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *RollingUpdatesGetCall) Do() (ret *RollingUpdate, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *RollingUpdatesInsertCall) Do() (ret *Operation, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *RollingUpdatesListCall) Do() (ret *RollingUpdateList, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *RollingUpdatesListInstanceUpdatesCall) Do() (ret *InstanceUpdateList, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *RollingUpdatesPauseCall) Do() (ret *Operation, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *RollingUpdatesResumeCall) Do() (ret *Operation, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *RollingUpdatesRollbackCall) Do() (ret *Operation, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
