...
type LicenseAssignmentsServicer interface {
	...
	Get(productId string, skuId string, userId string) *LicenseAssignmentsGetCall
	Insert(productId string, skuId string, licenseassignmentinsert *LicenseAssignmentInsert) *LicenseAssignmentsInsertCall
	...
	Patch(productId string, skuId string, userId string, licenseassignment *LicenseAssignment) *LicenseAssignmentsPatchCall
	Update(productId string, skuId string, userId string, licenseassignment *LicenseAssignment) *LicenseAssignmentsUpdateCall
}
