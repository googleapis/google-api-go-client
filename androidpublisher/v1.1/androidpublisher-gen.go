...
// is cancelled.
func (c *InapppurchasesGetCall) Ctx(ctx context.Context) *InapppurchasesGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *PurchasesCancelCall) Ctx(ctx context.Context) *PurchasesCancelCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *PurchasesGetCall) Ctx(ctx context.Context) *PurchasesGetCall {
	c.ctx_ = ctx
	return c
}
