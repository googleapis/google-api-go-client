...
func (c *GetCertForOpenIdConnectCall) DoHeader() (*Jwk, http.Header, error) {
...
func (c *TokeninfoCall) DoHeader() (*Tokeninfo, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *UserinfoGetCall) DoHeader() (*Userinfoplus, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *UserinfoV2MeGetCall) DoHeader() (*Userinfoplus, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
