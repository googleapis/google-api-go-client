...
func (c *LicenseAssignmentsDeleteCall) Do() (err error) {
	_, err = c.DoHeader()
	return err
}
...
func (c *LicenseAssignmentsDeleteCall) DoHeader() (resHeader http.Header, err error) {
...
// Do performs a round-trip call to the server.
func (c *LicenseAssignmentsGetCall) Do() (ret *LicenseAssignment, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// regardless of the status code returned. This can be useful for checking for
// header values such as "Etag" even when http.StatusNotModified is returned.
func (c *LicenseAssignmentsGetCall) DoHeader() (ret *LicenseAssignment, resHeader http.Header, err error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
// Do performs a round-trip call to the server.
func (c *LicenseAssignmentsInsertCall) Do() (ret *LicenseAssignment, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// regardless of the status code returned. This can be useful for checking for
// header values such as "Etag" even when http.StatusNotModified is returned.
func (c *LicenseAssignmentsInsertCall) DoHeader() (ret *LicenseAssignment, resHeader http.Header, err error) {
	var body io.Reader = nil
...
// Do performs a round-trip call to the server.
func (c *LicenseAssignmentsListForProductCall) Do() (ret *LicenseAssignmentList, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// regardless of the status code returned. This can be useful for checking for
// header values such as "Etag" even when http.StatusNotModified is returned.
func (c *LicenseAssignmentsListForProductCall) DoHeader() (ret *LicenseAssignmentList, resHeader http.Header, err error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
// Do performs a round-trip call to the server.
func (c *LicenseAssignmentsListForProductAndSkuCall) Do() (ret *LicenseAssignmentList, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// regardless of the status code returned. This can be useful for checking for
// header values such as "Etag" even when http.StatusNotModified is returned.
func (c *LicenseAssignmentsListForProductAndSkuCall) DoHeader() (ret *LicenseAssignmentList, resHeader http.Header, err error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	params.Set("customerId", fmt.Sprintf("%v", c.customerId))
...
// Do performs a round-trip call to the server.
func (c *LicenseAssignmentsPatchCall) Do() (ret *LicenseAssignment, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// regardless of the status code returned. This can be useful for checking for
// header values such as "Etag" even when http.StatusNotModified is returned.
func (c *LicenseAssignmentsPatchCall) DoHeader() (ret *LicenseAssignment, resHeader http.Header, err error) {
	var body io.Reader = nil
...
// Do performs a round-trip call to the server.
func (c *LicenseAssignmentsUpdateCall) Do() (ret *LicenseAssignment, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// regardless of the status code returned. This can be useful for checking for
// header values such as "Etag" even when http.StatusNotModified is returned.
func (c *LicenseAssignmentsUpdateCall) DoHeader() (ret *LicenseAssignment, resHeader http.Header, err error) {
	var body io.Reader = nil
	body, err = googleapi.WithoutDataWrapper.JSONReader(c.licenseassignment)
	if err != nil {
		return nil, nil, err
