...
type File struct {
	...
	// FolderColorRgb: The color for a folder or shortcut to a folder as an
	// RGB hex string. The supported colors are published in the
	// folderColorPalette field of the About resource.
