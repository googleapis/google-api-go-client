...
func (c *LineitemsDownloadlineitemsCall) DoHeader() (http.Header, *DownloadLineItemsResponse, error) {
...
func (c *LineitemsUploadlineitemsCall) DoHeader() (http.Header, *UploadLineItemsResponse, error) {
	var body io.Reader = nil
...
func (c *QueriesCreatequeryCall) DoHeader() (http.Header, *Query, error) {
	var body io.Reader = nil
...
func (c *QueriesGetqueryCall) DoHeader() (http.Header, *Query, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *QueriesListqueriesCall) DoHeader() (http.Header, *ListQueriesResponse, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *ReportsListreportsCall) DoHeader() (http.Header, *ListReportsResponse, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
