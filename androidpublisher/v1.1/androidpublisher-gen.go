...
func (c *InapppurchasesGetCall) DoHeader() (*InappPurchase, http.Header, error) {
...
func (c *PurchasesCancelCall) DoHeader() (http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *PurchasesGetCall) DoHeader() (*SubscriptionPurchase, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
