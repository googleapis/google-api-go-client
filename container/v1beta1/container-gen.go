...
type Cluster struct {
	...
	NodePoolUpgradeConcurrencyConfig *NodePoolUpgradeConcurrencyConfig `json:"nodePoolUpgradeConcurrencyConfig,omitempty"`
...
type ClusterUpdate struct {
	...
	DesiredNodePoolUpgradeConcurrencyConfig *NodePoolUpgradeConcurrencyConfig `json:"desiredNodePoolUpgradeConcurrencyConfig,omitempty"`
...
type NodeConfig struct {
	...
	// DiskSizeGb: Size of the disk attached to each node, specified in GB. The
	// smallest allowed disk size is 15 GB for node pools running GKE versions
	// 1.36.2-gke.2933000 or later. Or, for earlier versions, the smallest allowed
	// disk size is 12 GB. If unspecified, the default disk size is 100GB.
	DiskSizeGb int64 `json:"diskSizeGb,omitempty"`
	// DiskType: Type of the disk attached to each node (e.g. 'pd-standard',
	// 'pd-ssd' or 'pd-balanced') If unspecified, the default disk type is
...
// NodePoolUpgradeConcurrencyConfig: NodePoolUpgradeConcurrencyConfig is the
// configuration for the node pool auto upgrade concurrency.
type NodePoolUpgradeConcurrencyConfig struct {
...
func (s NodePoolUpgradeConcurrencyConfig) MarshalJSON() ([]byte, error) {
	type NoMethod NodePoolUpgradeConcurrencyConfig
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}
...
// recurs. Alternative to RecurringTimeWindow, with renamed fields.
