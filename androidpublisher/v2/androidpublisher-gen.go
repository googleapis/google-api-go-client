...
// At most one of Media and ResumableMedia may be set.
func (c *EditsApksUploadCall) ResumableMedia(ctx context.Context, r googleapi.Reader) *EditsApksUploadCall {
	c.ctx_ = ctx
	c.media_ = r
...
// ResumableMedia specifies the media to upload in chunks and can be cancelled with ctx.
// At most one of Media and ResumableMedia may be set.
func (c *EditsExpansionfilesUploadCall) ResumableMedia(ctx context.Context, r googleapi.Reader) *EditsExpansionfilesUploadCall {
	c.ctx_ = ctx
	c.media_ = r
	c.protocol_ = "resumable"
	return c
...
// ResumableMedia specifies the media to upload in chunks and can be cancelled with ctx.
// At most one of Media and ResumableMedia may be set.
func (c *EditsImagesUploadCall) ResumableMedia(ctx context.Context, r googleapi.Reader) *EditsImagesUploadCall {
	c.ctx_ = ctx
	c.media_ = r
	c.protocol_ = "resumable"
	return c
