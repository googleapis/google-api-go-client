...
func (c *AdvertisersGetCall) Do() (ret *Advertiser, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
func (c *AdvertisersGetCall) DoHeader() (ret *Advertiser, resHeader http.Header, err error) {
...
// Do performs a round-trip call to the server.
func (c *AdvertisersListCall) Do() (ret *Advertisers, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// regardless of the status code returned. This can be useful for checking for
// header values such as "Etag" even when http.StatusNotModified is returned.
func (c *AdvertisersListCall) DoHeader() (ret *Advertisers, resHeader http.Header, err error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
// Do performs a round-trip call to the server.
func (c *CcOffersListCall) Do() (ret *CcOffers, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// regardless of the status code returned. This can be useful for checking for
// header values such as "Etag" even when http.StatusNotModified is returned.
func (c *CcOffersListCall) DoHeader() (ret *CcOffers, resHeader http.Header, err error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
// Do performs a round-trip call to the server.
func (c *EventsListCall) Do() (ret *Events, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *LinksGetCall) Do() (ret *Link, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// regardless of the status code returned. This can be useful for checking for
// header values such as "Etag" even when http.StatusNotModified is returned.
func (c *LinksGetCall) DoHeader() (ret *Link, resHeader http.Header, err error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
// the object's Etag matches the given value. This is useful for getting updates
// only after the object has changed since the last request.
func (c *LinksInsertCall) IfNoneMatch(entityTag string) *LinksInsertCall {
	c.opt_["ifNoneMatch"] = entityTag
	return c
}

// Do performs a round-trip call to the server.
func (c *LinksInsertCall) Do() (ret *Link, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// regardless of the status code returned. This can be useful for checking for
// header values such as "Etag" even when http.StatusNotModified is returned.
func (c *LinksInsertCall) DoHeader() (ret *Link, resHeader http.Header, err error) {
	var body io.Reader = nil
...
// Do performs a round-trip call to the server.
func (c *LinksListCall) Do() (ret *Links, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// regardless of the status code returned. This can be useful for checking for
// header values such as "Etag" even when http.StatusNotModified is returned.
func (c *LinksListCall) DoHeader() (ret *Links, resHeader http.Header, err error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["advertiserId"]; ok {
...
// Do performs a round-trip call to the server.
func (c *PublishersGetCall) Do() (ret *Publisher, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// regardless of the status code returned. This can be useful for checking for
// header values such as "Etag" even when http.StatusNotModified is returned.
func (c *PublishersGetCall) DoHeader() (ret *Publisher, resHeader http.Header, err error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["publisherId"]; ok {
...
// Do performs a round-trip call to the server.
func (c *PublishersListCall) Do() (ret *Publishers, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// regardless of the status code returned. This can be useful for checking for
// header values such as "Etag" even when http.StatusNotModified is returned.
func (c *PublishersListCall) DoHeader() (ret *Publishers, resHeader http.Header, err error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["maxResults"]; ok {
...
// Do performs a round-trip call to the server.
func (c *ReportsGetCall) Do() (ret *Report, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
