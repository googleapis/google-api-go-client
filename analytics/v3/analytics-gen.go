...
// Exactly one of *GaData or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *GaData.ServerResponse.Header
...
// Exactly one of *McfData or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *McfData.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *RealtimeData or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *RealtimeData.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *AccountSummaries or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *AccountSummaries.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *EntityUserLink or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *EntityUserLink.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *EntityUserLinks or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *EntityUserLinks.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *CustomDataSources or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *CustomDataSources.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *CustomDimension or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *CustomDimension.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *CustomDimensions or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *CustomDimensions.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *CustomMetric or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *CustomMetric.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *CustomMetrics or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *CustomMetrics.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Experiment or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Experiment.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Experiments or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Experiments.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Filter or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Filter.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Filters or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Filters.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Goal or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Goal.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Goals or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Goals.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *ProfileFilterLink or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *ProfileFilterLink.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *ProfileFilterLinks or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *ProfileFilterLinks.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Profiles or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Profiles.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Segments or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Segments.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *UnsampledReport or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *UnsampledReport.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *UnsampledReports or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *UnsampledReports.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Upload or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Upload.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Uploads or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Uploads.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *EntityAdWordsLink or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *EntityAdWordsLink.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *EntityAdWordsLinks or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *EntityAdWordsLinks.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Webproperty or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Webproperty.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Webproperties or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Webproperties.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Columns or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Columns.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *AccountTicket or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *AccountTicket.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
