...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *PreferreddealsGetCall) Ctx(ctx context.Context) *PreferreddealsGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *PreferreddealsListCall) Ctx(ctx context.Context) *PreferreddealsListCall {
	c.ctx_ = ctx
	return c
}
