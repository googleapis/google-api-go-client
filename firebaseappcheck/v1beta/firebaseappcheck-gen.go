...
type GoogleFirebaseAppcheckV1betaExchangeAppAttestAttestationRequest struct {
	// AttestationStatement: The App Attest statement as returned by Apple's
	// client-side App Attest API. This is the CBOR object returned by
	// Apple, which will be Base64 encoded in the JSON API.
	AttestationStatement string `json:"attestationStatement,omitempty"`

	// Challenge: The challenge previously generated by the FAC backend.
	Challenge string `json:"challenge,omitempty"`

	// KeyId: The key ID generated by App Attest for the client app.
	KeyId string `json:"keyId,omitempty"`
...
type GoogleFirebaseAppcheckV1betaExchangeCustomTokenRequest struct {
	// CustomToken: A custom token signed using your project's Admin SDK
...
type GoogleFirebaseAppcheckV1betaExchangeDebugTokenRequest struct {
	// DebugToken: A debug token secret. This string must match a debug
...
type GoogleFirebaseAppcheckV1betaExchangeDeviceCheckTokenRequest struct {
	// DeviceToken: The `device_token` as returned by Apple's client-side
	// DeviceCheck API
...
type GoogleFirebaseAppcheckV1betaExchangeRecaptchaTokenRequest struct {
	// RecaptchaToken: The reCAPTCHA token as returned by the reCAPTCHA v3
...
type GoogleFirebaseAppcheckV1betaExchangeSafetyNetTokenRequest struct {
	// SafetyNetToken: The SafetyNet attestation response
