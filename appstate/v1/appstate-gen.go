...
// is cancelled.
func (c *StatesClearCall) Ctx(ctx context.Context) *StatesClearCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *StatesDeleteCall) Ctx(ctx context.Context) *StatesDeleteCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *StatesGetCall) Ctx(ctx context.Context) *StatesGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *StatesListCall) Ctx(ctx context.Context) *StatesListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *StatesUpdateCall) Ctx(ctx context.Context) *StatesUpdateCall {
	c.ctx_ = ctx
	return c
}
