...
func (c *RelyingpartyCreateAuthUriCall) DoHeader() (*CreateAuthUriResponse, http.Header, error) {
...
func (c *RelyingpartyDeleteAccountCall) DoHeader() (*DeleteAccountResponse, http.Header, error) {
	var body io.Reader = nil
...
func (c *RelyingpartyDownloadAccountCall) DoHeader() (*DownloadAccountResponse, http.Header, error) {
	var body io.Reader = nil
...
func (c *RelyingpartyGetAccountInfoCall) DoHeader() (*GetAccountInfoResponse, http.Header, error) {
	var body io.Reader = nil
...
func (c *RelyingpartyGetOobConfirmationCodeCall) DoHeader() (*GetOobConfirmationCodeResponse, http.Header, error) {
	var body io.Reader = nil
...
func (c *RelyingpartyGetPublicKeysCall) DoHeader() (map[string]string, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *RelyingpartyGetRecaptchaParamCall) DoHeader() (*GetRecaptchaParamResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *RelyingpartyResetPasswordCall) DoHeader() (*ResetPasswordResponse, http.Header, error) {
	var body io.Reader = nil
...
func (c *RelyingpartySetAccountInfoCall) DoHeader() (*SetAccountInfoResponse, http.Header, error) {
	var body io.Reader = nil
...
func (c *RelyingpartyUploadAccountCall) DoHeader() (*UploadAccountResponse, http.Header, error) {
	var body io.Reader = nil
...
func (c *RelyingpartyVerifyAssertionCall) DoHeader() (*VerifyAssertionResponse, http.Header, error) {
	var body io.Reader = nil
...
func (c *RelyingpartyVerifyPasswordCall) DoHeader() (*VerifyPasswordResponse, http.Header, error) {
	var body io.Reader = nil
