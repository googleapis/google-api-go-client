...
// is cancelled.
func (c *BeaconinfoGetforobservedCall) Ctx(ctx context.Context) *BeaconinfoGetforobservedCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *BeaconsActivateCall) Ctx(ctx context.Context) *BeaconsActivateCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *BeaconsDeactivateCall) Ctx(ctx context.Context) *BeaconsDeactivateCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *BeaconsDecommissionCall) Ctx(ctx context.Context) *BeaconsDecommissionCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *BeaconsGetCall) Ctx(ctx context.Context) *BeaconsGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *BeaconsListCall) Ctx(ctx context.Context) *BeaconsListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *BeaconsRegisterCall) Ctx(ctx context.Context) *BeaconsRegisterCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *BeaconsUpdateCall) Ctx(ctx context.Context) *BeaconsUpdateCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *BeaconsAttachmentsBatchDeleteCall) Ctx(ctx context.Context) *BeaconsAttachmentsBatchDeleteCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *BeaconsAttachmentsCreateCall) Ctx(ctx context.Context) *BeaconsAttachmentsCreateCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *BeaconsAttachmentsDeleteCall) Ctx(ctx context.Context) *BeaconsAttachmentsDeleteCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *BeaconsAttachmentsListCall) Ctx(ctx context.Context) *BeaconsAttachmentsListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *BeaconsDiagnosticsListCall) Ctx(ctx context.Context) *BeaconsDiagnosticsListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *NamespacesListCall) Ctx(ctx context.Context) *NamespacesListCall {
	c.ctx_ = ctx
	return c
}
