...
type ChromeOsDevice struct {
	...
	// LastKnownNetwork: Contains last used network (Read-only)
...
// format provided by this Help Center article.
...
func (c *ChromeosdevicesListCall) Do(opts ...googleapi.CallOption) (*ChromeOsDevices, error) {
	...
	//     },
	//     "query": {
	//       "description": "Search string in the format provided by this Help Center article.",
	//       "location": "query",
	//       "type": "string"
	//     },
	//     "sortOrder": {
