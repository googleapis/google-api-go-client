...
type Customer struct {
	...
	// CustomerType: The type of the customer (DOMAIN or TEAM), default is
	// DOMAIN.
	//
	// Possible values:
...
type PrimaryAdmin struct {
	// PrimaryEmail: Primary admin's domained email This email's domain will
	// be used to create TEAM customer
