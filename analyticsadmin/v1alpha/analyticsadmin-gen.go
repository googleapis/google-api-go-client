...
type GoogleAnalyticsAdminV1alphaConnectedSiteTag struct {
	// DisplayName: Required. User-provided display name for the connected site
	// tag. Must be less than 256 characters.
	DisplayName string `json:"displayName,omitempty"`
	// TagId: Required. "Tag ID to forward events to. Also known as the Measurement
	// ID, or the "G-ID" (For example: G-12345).
...
// for CreateConnectedSiteTag RPC.
type GoogleAnalyticsAdminV1alphaCreateConnectedSiteTagRequest struct {
	...
	// Property: The Universal Analytics property to create connected site tags
	// for. This API does not support GA4 properties. Format:
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ConnectedSiteTag") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// for DeleteConnectedSiteTag RPC.
type GoogleAnalyticsAdminV1alphaDeleteConnectedSiteTagRequest struct {
	// Property: The Universal Analytics property to delete connected site tags
	// for. This API does not support GA4 properties. Format:
	// properties/{universalAnalyticsPropertyId} Example: properties/1234
	Property string `json:"property,omitempty"`
	// TagId: Tag ID to forward events to. Also known as the Measurement ID, or the
...
type GoogleAnalyticsAdminV1alphaFetchAutomatedGa4ConfigurationOptOutRequest struct {
	// Property: Required. The UA property to get the opt out status. Note this
	// request uses the internal property ID, not the tracking ID of the form
	// UA-XXXXXX-YY. Format: properties/{internalWebPropertyId} Example:
	// properties/1234
	Property string `json:"property,omitempty"`
	// ForceSendFields is a list of field names (e.g. "Property") to
	// unconditionally include in API requests. By default, fields with empty or
...
type GoogleAnalyticsAdminV1alphaFetchAutomatedGa4ConfigurationOptOutResponse struct {
	...
	// ServerResponse contains the HTTP response code and headers from the server.
	googleapi.ServerResponse `json:"-"`
	// ForceSendFields is a list of field names (e.g. "OptOut") to unconditionally
	// include in API requests. By default, fields with empty or default values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
...
// looking up GA4 property connected to a UA property.
type GoogleAnalyticsAdminV1alphaFetchConnectedGa4PropertyResponse struct {
	// Property: The GA4 property connected to the UA property. An empty string is
	// returned when there is no connected GA4 property. Format:
...
type GoogleAnalyticsAdminV1alphaListConnectedSiteTagsRequest struct {
	// Property: The Universal Analytics property to fetch connected site tags for.
...
// for ListConnectedSiteTags RPC.
type GoogleAnalyticsAdminV1alphaListConnectedSiteTagsResponse struct {
	// ConnectedSiteTags: The site tags for the Universal Analytics property. A
	// maximum of 20 connected site tags will be returned.
	ConnectedSiteTags []*GoogleAnalyticsAdminV1alphaConnectedSiteTag `json:"connectedSiteTags,omitempty"`

	// ServerResponse contains the HTTP response code and headers from the server.
	googleapi.ServerResponse `json:"-"`
	// ForceSendFields is a list of field names (e.g. "ConnectedSiteTags") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ConnectedSiteTags") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type GoogleAnalyticsAdminV1alphaSetAutomatedGa4ConfigurationOptOutRequest struct {
	...
	OptOut bool `json:"optOut,omitempty"`
	// Property: Required. The UA property to set the opt out status. Note this
	// request uses the internal property ID, not the tracking ID of the form
	// UA-XXXXXX-YY. Format: properties/{internalWebPropertyId} Example:
	// properties/1234
	Property string `json:"property,omitempty"`
...
// Analytics property. You can create a maximum of 20 connected site tags per
// property. Note: This API cannot be used on GA4 properties.
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleAnalyticsAdminV1alphaCreateConnectedSiteTagResponse.ServerResponse.Hea
// der or (if a response was returned at all) in
// error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
...
// FetchAutomatedGa4ConfigurationOptOut: Fetches the opt out status for the
// automated GA4 setup process for a UA property. Note: this has no effect on
// GA4 property.
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleAnalyticsAdminV1alphaFetchAutomatedGa4ConfigurationOptOutResponse.Serv
...
// FetchConnectedGa4Property: Given a specified UA property, looks up the GA4
// property connected to it. Note: this cannot be used with GA4 properties.
...
// Property sets the optional parameter "property": Required. The UA property
// for which to look up the connected GA4 property. Note this request uses the
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleAnalyticsAdminV1alphaFetchConnectedGa4PropertyResponse.ServerResponse.
// Header or (if a response was returned at all) in
// error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
...
// Analytics property. A maximum of 20 connected site tags will be returned.
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleAnalyticsAdminV1alphaListConnectedSiteTagsResponse.ServerResponse.Head
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleAnalyticsAdminV1alphaSetAutomatedGa4ConfigurationOptOutResponse.Server
...
func (c *PropertiesBigQueryLinksCreateCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.googleanalyticsadminv1alphabigquerylink)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
...
func (c *PropertiesDataStreamsEventEditRulesCreateCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.googleanalyticsadminv1alphaeventeditrule)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
