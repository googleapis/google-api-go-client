...
func (c *BatchReportDefinitionsListCall) Do() (ret *BatchReportDefinitionList, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *BatchReportsListCall) Do() (ret *BatchReportList, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *GroupItemsDeleteCall) Do() (err error) {
	_, err = c.DoHeader()
	return err
}
...
// Do performs a round-trip call to the server.
func (c *GroupItemsInsertCall) Do() (ret *GroupItem, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *GroupItemsListCall) Do() (ret *GroupItemListResponse, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *GroupsDeleteCall) Do() (err error) {
	_, err = c.DoHeader()
	return err
}
...
// Do performs a round-trip call to the server.
func (c *GroupsInsertCall) Do() (ret *Group, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *GroupsListCall) Do() (ret *GroupListResponse, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *GroupsUpdateCall) Do() (ret *Group, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *ReportsQueryCall) Do() (ret *ResultTable, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
