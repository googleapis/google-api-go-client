...
func (c *ActivitiesGetCall) DoHeader() (*Activity, http.Header, error) {
...
func (c *ActivitiesListCall) DoHeader() (*ActivityFeed, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *ActivitiesSearchCall) DoHeader() (*ActivityFeed, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *CommentsListCall) DoHeader() (*CommentFeed, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["maxResults"]; ok {
...
func (c *MomentsInsertCall) DoHeader() (*Moment, http.Header, error) {
	var body io.Reader = nil
...
func (c *MomentsListCall) DoHeader() (*MomentsFeed, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["maxResults"]; ok {
...
func (c *PeopleGetCall) DoHeader() (*Person, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *PeopleListCall) DoHeader() (*PeopleFeed, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["maxResults"]; ok {
...
func (c *PeopleListByActivityCall) DoHeader() (*PeopleFeed, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["maxResults"]; ok {
...
func (c *PeopleSearchCall) DoHeader() (*PeopleFeed, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	params.Set("query", fmt.Sprintf("%v", c.query))
