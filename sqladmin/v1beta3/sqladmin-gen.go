...
type BackupRunsServicer interface {
	Get(project string, instance string, backupConfiguration string, dueTime string) *BackupRunsGetCall
	List(project string, instance string, backupConfiguration string) *BackupRunsListCall
}
...
type InstancesServicer interface {
	Clone(project string, instancesclonerequest *InstancesCloneRequest) *InstancesCloneCall
	...
	RestoreBackup(project string, instance string, backupConfigurationid string, dueTime string) *InstancesRestoreBackupCall
	SetRootPassword(project string, instance string, instancesetrootpasswordrequest *InstanceSetRootPasswordRequest) *InstancesSetRootPasswordCall
...
type OperationsServicer interface {
	Get(project string, instance string, operation string) *OperationsGetCall
