...
type GoogleCloudRetailV2betaProduct struct {
	...
	// string with a length limit of 128 characters. * Max indexable entries
	// count: 200 by default; 40 for Type.VARIANT. * Max searchable entries
	// count: 30. * For indexable attribute, the key must match the pattern:
	...
	// "wooden". A maximum of 5 values are allowed. Each value must be a
	...
	// "striped", "polka dot", "paisley". A maximum of 5 values are allowed
...
type GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey struct {
	...
	// ColorInfo.colors. * | "colors"; *# The Product.sizes. * | "sizes"; *#
	// The Product.materials. * | "materials"; *# The Product.patterns. * |
