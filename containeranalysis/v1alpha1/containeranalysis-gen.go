...
// CVSS: Common Vulnerability Scoring System. This is the storage level
// proto that is intended to store similar data as the CVSS proto in
// google3/third_party/grafeas/proto/v1/cvss.proto
type CVSS struct {
	// Possible values:
