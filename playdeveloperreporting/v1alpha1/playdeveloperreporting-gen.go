...
// GooglePlayDeveloperReportingV1alpha1QueryRatingsMetricSetRequest: Request
// message for [QueryRatingsMetricSet].
type GooglePlayDeveloperReportingV1alpha1QueryRatingsMetricSetRequest struct {
...
func (s GooglePlayDeveloperReportingV1alpha1QueryRatingsMetricSetRequest) MarshalJSON() ([]byte, error) {
	type NoMethod GooglePlayDeveloperReportingV1alpha1QueryRatingsMetricSetRequest
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}

// GooglePlayDeveloperReportingV1alpha1QueryRatingsMetricSetResponse: Response
// message for [QueryRatingsMetricSet].
type GooglePlayDeveloperReportingV1alpha1QueryRatingsMetricSetResponse struct {
...
func (s GooglePlayDeveloperReportingV1alpha1QueryRatingsMetricSetResponse) MarshalJSON() ([]byte, error) {
	type NoMethod GooglePlayDeveloperReportingV1alpha1QueryRatingsMetricSetResponse
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}
...
// GooglePlayDeveloperReportingV1alpha1RatingsMetricSet: Singleton resource
...
type GooglePlayDeveloperReportingV1alpha1RatingsMetricSet struct {
...
func (s GooglePlayDeveloperReportingV1alpha1RatingsMetricSet) MarshalJSON() ([]byte, error) {
	type NoMethod GooglePlayDeveloperReportingV1alpha1RatingsMetricSet
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}
...
// Any non-2xx status code is an error. Response headers are in either
// *GooglePlayDeveloperReportingV1alpha1RatingsMetricSet.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// Use googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
func (c *RatingsGetCall) Do(opts ...googleapi.CallOption) (*GooglePlayDeveloperReportingV1alpha1RatingsMetricSet, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
	...
	ret := &GooglePlayDeveloperReportingV1alpha1RatingsMetricSet{
		ServerResponse: googleapi.ServerResponse{
			Header:         res.Header,
			HTTPStatusCode: res.StatusCode,
		},
...
type RatingsQueryCall struct {
	s                                                                *Service
	name                                                             string
	googleplaydeveloperreportingv1alpha1queryratingsmetricsetrequest *GooglePlayDeveloperReportingV1alpha1QueryRatingsMetricSetRequest
	urlParams_                                                       gensupport.URLParams
	ctx_                                                             context.Context
	header_                                                          http.Header
}
...
func (r *RatingsService) Query(name string, googleplaydeveloperreportingv1alpha1queryratingsmetricsetrequest *GooglePlayDeveloperReportingV1alpha1QueryRatingsMetricSetRequest) *RatingsQueryCall {
	c := &RatingsQueryCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.name = name
	c.googleplaydeveloperreportingv1alpha1queryratingsmetricsetrequest = googleplaydeveloperreportingv1alpha1queryratingsmetricsetrequest
	return c
}
...
func (c *RatingsQueryCall) doRequest(alt string) (*http.Response, error) {
	...
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.googleplaydeveloperreportingv1alpha1queryratingsmetricsetrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
...
// Any non-2xx status code is an error. Response headers are in either
// *GooglePlayDeveloperReportingV1alpha1QueryRatingsMetricSetResponse.ServerResp
// onse.Header or (if a response was returned at all) in
// error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
func (c *RatingsQueryCall) Do(opts ...googleapi.CallOption) (*GooglePlayDeveloperReportingV1alpha1QueryRatingsMetricSetResponse, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
	...
	ret := &GooglePlayDeveloperReportingV1alpha1QueryRatingsMetricSetResponse{
		ServerResponse: googleapi.ServerResponse{
			Header:         res.Header,
			HTTPStatusCode: res.StatusCode,
		},
...
// A non-nil error returned from f will halt the iteration.
// The provided context supersedes any context provided to the Context method.
func (c *RatingsQueryCall) Pages(ctx context.Context, f func(*GooglePlayDeveloperReportingV1alpha1QueryRatingsMetricSetResponse) error) error {
	c.ctx_ = ctx
	defer func(pt string) { c.googleplaydeveloperreportingv1alpha1queryratingsmetricsetrequest.PageToken = pt }(c.googleplaydeveloperreportingv1alpha1queryratingsmetricsetrequest.PageToken)
	for {
		x, err := c.Do()
		if err != nil {
			return err
		...
		c.googleplaydeveloperreportingv1alpha1queryratingsmetricsetrequest.PageToken = x.NextPageToken
	}
}
