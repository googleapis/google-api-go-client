...
func (c *ProjectsLocationsExternalAccountKeysCreateCall) doRequest(alt string) (*http.Response, error) {
	...
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.externalaccountkey)
	if err != nil {
		return nil, err
	}
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "publicca.projects.locations.externalAccountKeys.create", "request", internallog.HTTPRequest(req, body.Bytes()))
...
func (c *ProjectsLocationsExternalAccountKeysCreateCall) Do(opts ...googleapi.CallOption) (*ExternalAccountKey, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "publicca.projects.locations.externalAccountKeys.create", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
