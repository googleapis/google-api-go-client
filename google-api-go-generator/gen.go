...
// canonicalDocsURL maps the auto-generated documentation URL to a
// valid (possibly through 301 redirect[s]) URL via the whitelist.
// If the URL is invalid, the empty string is returned.
func canonicalDocsURL(url string) string {
