...
// provider's system.
type Account struct {
	// Approvals: Output only.
	// The approvals for this account. These approvals are used to track
	// actions
	...
	// InputProperties: Output only.
	// The custom properties that were collected from the user to create
	// this
	// account.
	...
	// The identifier of the service provider that this account was
	// created
	...
	// State: Output only.
	// The state of the account. This is used to decide whether the customer
	// is in
...
type Entitlement struct {
	...
	// Provider: Output only.
	// The identifier of the service provider that this entitlement was
	// created
	// against. Each service provider is assigned a unique provider value
	// when
	// they onboard with Cloud Commerce platform.
