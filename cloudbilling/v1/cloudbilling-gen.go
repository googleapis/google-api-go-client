...
// is cancelled.
func (c *BillingAccountsGetCall) Ctx(ctx context.Context) *BillingAccountsGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *BillingAccountsListCall) Ctx(ctx context.Context) *BillingAccountsListCall {
	c.ctx_ = ctx
	return c
}
...
func (c *BillingAccountsListCall) Do() (*ListBillingAccountsResponse, error) {
	...
	var ret *ListBillingAccountsResponse
	if err := json.NewDecoder(res.Body).Decode(&ret); err != nil {
		return nil, err
	}
	return ret, nil
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *BillingAccountsProjectsListCall) Ctx(ctx context.Context) *BillingAccountsProjectsListCall {
	c.ctx_ = ctx
	return c
}
...
func (c *BillingAccountsProjectsListCall) Do() (*ListProjectBillingInfoResponse, error) {
	...
	var ret *ListProjectBillingInfoResponse
	if err := json.NewDecoder(res.Body).Decode(&ret); err != nil {
		return nil, err
	}
	return ret, nil
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsGetBillingInfoCall) Ctx(ctx context.Context) *ProjectsGetBillingInfoCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsUpdateBillingInfoCall) Ctx(ctx context.Context) *ProjectsUpdateBillingInfoCall {
	c.ctx_ = ctx
	return c
}
