...
func (c *LicenseAssignmentsDeleteCall) DoHeader() (http.Header, error) {
...
func (c *LicenseAssignmentsGetCall) DoHeader() (*LicenseAssignment, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *LicenseAssignmentsInsertCall) DoHeader() (*LicenseAssignment, http.Header, error) {
	var body io.Reader = nil
...
func (c *LicenseAssignmentsListForProductCall) DoHeader() (*LicenseAssignmentList, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *LicenseAssignmentsListForProductAndSkuCall) DoHeader() (*LicenseAssignmentList, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	params.Set("customerId", fmt.Sprintf("%v", c.customerId))
...
func (c *LicenseAssignmentsPatchCall) DoHeader() (*LicenseAssignment, http.Header, error) {
	var body io.Reader = nil
...
func (c *LicenseAssignmentsUpdateCall) DoHeader() (*LicenseAssignment, http.Header, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.licenseassignment)
	if err != nil {
		return nil, nil, err
