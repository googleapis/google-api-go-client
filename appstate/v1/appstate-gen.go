...
func (c *StatesClearCall) DoHeader() (http.Header, *WriteResult, error) {
...
func (c *StatesGetCall) DoHeader() (http.Header, *GetResponse, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *StatesListCall) DoHeader() (http.Header, *ListResponse, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *StatesUpdateCall) DoHeader() (http.Header, *WriteResult, error) {
	var body io.Reader = nil
