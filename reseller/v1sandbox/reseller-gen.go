...
func (c *CustomersGetCall) DoHeader() (http.Header, *Customer, error) {
...
func (c *CustomersInsertCall) DoHeader() (http.Header, *Customer, error) {
	var body io.Reader = nil
...
func (c *CustomersPatchCall) DoHeader() (http.Header, *Customer, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.customer)
	if err != nil {
		return nil, nil, err
...
func (c *CustomersUpdateCall) DoHeader() (http.Header, *Customer, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.customer)
	if err != nil {
		return nil, nil, err
...
func (c *SubscriptionsActivateCall) DoHeader() (http.Header, *Subscription, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *SubscriptionsChangePlanCall) DoHeader() (http.Header, *Subscription, error) {
	var body io.Reader = nil
...
func (c *SubscriptionsChangeRenewalSettingsCall) DoHeader() (http.Header, *Subscription, error) {
	var body io.Reader = nil
...
func (c *SubscriptionsChangeSeatsCall) DoHeader() (http.Header, *Subscription, error) {
	var body io.Reader = nil
...
func (c *SubscriptionsListCall) DoHeader() (http.Header, *Subscriptions, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["customerAuthToken"]; ok {
...
func (c *SubscriptionsStartPaidServiceCall) DoHeader() (http.Header, *Subscription, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *SubscriptionsSuspendCall) DoHeader() (http.Header, *Subscription, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
