...
func (c *FilesInsertCall) Media(r io.Reader, opt ...googleapi.UploadOption) *FilesInsertCall {
	c.media_ = r
...
// At most one of Media and ResumableMedia may be set.
func (c *FilesInsertCall) ResumableMedia(ctx context.Context, r io.Reader, opt ...googleapi.UploadOption) *FilesInsertCall {
	c.ctx_ = ctx
	c.media_ = r
...
// Media specifies the media to upload in a single chunk.
// At most one of Media and ResumableMedia may be set.
func (c *FilesUpdateCall) Media(r io.Reader, opt ...googleapi.UploadOption) *FilesUpdateCall {
	c.media_ = r
	c.protocol_ = "multipart"
	c.uploadOpts_ = opt
	return c
...
// ResumableMedia specifies the media to upload in chunks and can be cancelled with ctx.
// At most one of Media and ResumableMedia may be set.
func (c *FilesUpdateCall) ResumableMedia(ctx context.Context, r io.Reader, opt ...googleapi.UploadOption) *FilesUpdateCall {
	c.ctx_ = ctx
	c.media_ = r
	c.protocol_ = "resumable"
	c.uploadOpts_ = opt
...
// Media specifies the media to upload in a single chunk.
// At most one of Media and ResumableMedia may be set.
func (c *RealtimeUpdateCall) Media(r io.Reader, opt ...googleapi.UploadOption) *RealtimeUpdateCall {
	c.media_ = r
	c.protocol_ = "multipart"
	c.uploadOpts_ = opt
	return c
...
// ResumableMedia specifies the media to upload in chunks and can be cancelled with ctx.
// At most one of Media and ResumableMedia may be set.
func (c *RealtimeUpdateCall) ResumableMedia(ctx context.Context, r io.Reader, opt ...googleapi.UploadOption) *RealtimeUpdateCall {
	c.ctx_ = ctx
	c.media_ = r
	c.protocol_ = "resumable"
	c.uploadOpts_ = opt
