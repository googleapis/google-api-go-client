...
func (c *InstancesCloneCall) DoHeader() (*InstancesCloneResponse, http.Header, error) {
	var body io.Reader = nil
...
func (c *InstancesDeleteCall) DoHeader() (*InstancesDeleteResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *InstancesExportCall) DoHeader() (*InstancesExportResponse, http.Header, error) {
	var body io.Reader = nil
...
func (c *InstancesImportCall) DoHeader() (*InstancesImportResponse, http.Header, error) {
	var body io.Reader = nil
...
func (c *InstancesInsertCall) DoHeader() (*InstancesInsertResponse, http.Header, error) {
	var body io.Reader = nil
...
func (c *InstancesPatchCall) DoHeader() (*InstancesUpdateResponse, http.Header, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.databaseinstance)
	if err != nil {
		return nil, nil, err
...
func (c *InstancesPromoteReplicaCall) DoHeader() (*InstancesPromoteReplicaResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *InstancesResetSslConfigCall) DoHeader() (*InstancesResetSslConfigResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *InstancesRestartCall) DoHeader() (*InstancesRestartResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *InstancesRestoreBackupCall) DoHeader() (*InstancesRestoreBackupResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *InstancesSetRootPasswordCall) DoHeader() (*InstancesSetRootPasswordResponse, http.Header, error) {
	var body io.Reader = nil
...
func (c *InstancesUpdateCall) DoHeader() (*InstancesUpdateResponse, http.Header, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.databaseinstance)
	if err != nil {
		return nil, nil, err
...
func (c *OperationsGetCall) DoHeader() (*InstanceOperation, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *SslCertsDeleteCall) DoHeader() (*SslCertsDeleteResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
