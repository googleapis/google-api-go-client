...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *TrainedmodelsAnalyzeCall) Ctx(ctx context.Context) *TrainedmodelsAnalyzeCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *TrainedmodelsListCall) Ctx(ctx context.Context) *TrainedmodelsListCall {
	c.ctx_ = ctx
	return c
}
