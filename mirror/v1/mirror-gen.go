...
// is cancelled.
func (c *AccountsInsertCall) Ctx(ctx context.Context) *AccountsInsertCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ContactsDeleteCall) Ctx(ctx context.Context) *ContactsDeleteCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ContactsGetCall) Ctx(ctx context.Context) *ContactsGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ContactsInsertCall) Ctx(ctx context.Context) *ContactsInsertCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ContactsListCall) Ctx(ctx context.Context) *ContactsListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ContactsPatchCall) Ctx(ctx context.Context) *ContactsPatchCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ContactsUpdateCall) Ctx(ctx context.Context) *ContactsUpdateCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *LocationsGetCall) Ctx(ctx context.Context) *LocationsGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *LocationsListCall) Ctx(ctx context.Context) *LocationsListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *SubscriptionsUpdateCall) Ctx(ctx context.Context) *SubscriptionsUpdateCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *TimelineDeleteCall) Ctx(ctx context.Context) *TimelineDeleteCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *TimelineGetCall) Ctx(ctx context.Context) *TimelineGetCall {
	c.ctx_ = ctx
	return c
}
...
func (c *TimelineInsertCall) Ctx(ctx context.Context) *TimelineInsertCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *TimelineListCall) Ctx(ctx context.Context) *TimelineListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *TimelinePatchCall) Ctx(ctx context.Context) *TimelinePatchCall {
	c.ctx_ = ctx
	return c
}
...
// You do not need to provide a context with this method if one was
// specified using the ResumableMedia method.
func (c *TimelineUpdateCall) Ctx(ctx context.Context) *TimelineUpdateCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *TimelineAttachmentsDeleteCall) Ctx(ctx context.Context) *TimelineAttachmentsDeleteCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *TimelineAttachmentsGetCall) Ctx(ctx context.Context) *TimelineAttachmentsGetCall {
	c.ctx_ = ctx
	return c
}
...
// You do not need to provide a context with this method if one was
// specified using the ResumableMedia method.
func (c *TimelineAttachmentsInsertCall) Ctx(ctx context.Context) *TimelineAttachmentsInsertCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *TimelineAttachmentsListCall) Ctx(ctx context.Context) *TimelineAttachmentsListCall {
	c.ctx_ = ctx
	return c
}
