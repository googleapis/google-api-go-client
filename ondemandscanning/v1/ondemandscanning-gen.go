...
// AnalyzePackagesRequestV1: AnalyzePackagesRequest is the request to analyze a
...
type AnalyzePackagesRequestV1 struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "IncludeOsvData") to include in
...
// ListVulnerabilitiesResponseV1: ListVulnerabilitiesResponse contains a single
...
// Any non-2xx status code is an error. Response headers are in either
// *ListVulnerabilitiesResponseV1.ServerResponse.Header or (if a response was
