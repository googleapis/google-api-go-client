...
const basePathTemplate = "https://playmoviespartner.UNIVERSE_DOMAIN/"
...
// Avail: An Avail describes the Availability Window of a specific Edit in a
// given
...
type Avail struct {
	...
	// DisplayName: The name of the studio that owns the Edit referred in the
	// Avail.
	...
	// EpisodeAltId: Other identifier referring to the episode, as defined by
	// partner.
	...
	// EpisodeTitleInternalAlias: OPTIONAL.TV Only. Title used by involved parties
	// to refer to this episode.
	// Only available on TV Avails.
	// Example: "Coding at Google".
	EpisodeTitleInternalAlias string `json:"episodeTitleInternalAlias,omitempty"`
	// FormatProfile: Indicates the format profile covered by the transaction.
	//
	// Possible values:
	...
	//
	// Possible values:
	//   "LICENSE_TYPE_UNSPECIFIED" - Value could not be determined, please contact
	...
	// SeasonTitleInternalAlias: Title used by involved parties to refer to this
	// season.
	// Only available on TV Avails.
	...
	// SeriesTitleInternalAlias: Title used by involved parties to refer to this
	// series.
	// Only available on TV Avails.
	// Example: "Googlers, The".
	...
	// SuppressionLiftDate: First date an Edit could be publically announced as
	// becoming
	...
	// VideoId: Google-generated ID identifying the video linked to this Avail,
	// once
	// delivered.
	// Not part of EMA Specs.
	// Example: 'gtry456_xc'
	...
	// ForceSendFields is a list of field names (e.g. "AltId") to unconditionally
...
type ListAvailsResponse struct {
	...
	// TotalSize: See _List methods rules_ for more information about this field.
	TotalSize int64 `json:"totalSize,omitempty"`

	// ServerResponse contains the HTTP response code and headers from the server.
	googleapi.ServerResponse `json:"-"`
	// ForceSendFields is a list of field names (e.g. "Avails") to unconditionally
	// include in API requests. By default, fields with empty or default values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
...
// Order: An Order tracks the fulfillment of an Edit when delivered using
// the
...
type Order struct {
	...
	// PphName: Name of the post-production house that manages the Edit ordered.
	...
	//
	// Possible values:
	//   "ORDER_STATUS_UNSPECIFIED" - Value could not be determined, please contact
	// technical support if
	// it should.
	...
	//   "ORDER_STATUS_READY_FOR_QC" - Asset was delivered by partner, but is being
	// reviewed by Google's
	...
	// VideoId: Google-generated ID identifying the video linked to this Order,
	// once
	// delivered.
	// Example: 'gtry456_xc'.
	VideoId string `json:"videoId,omitempty"`
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ApprovedTime") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// StoreInfo: Information about a playable sequence (video) associated with an
// Edit
...
type StoreInfo struct {
	...
	// SeasonName: Default Season name, usually in the language of the country
	// of
	// origin.
	// Only available for TV Edits
	// Example: "Googlers, The - A Brave New World".
...
// *Avail.ServerResponse.Header or (if a response was returned at all) in
...
// PageSize sets the optional parameter "pageSize": See _List methods rules_
// for info about this field.
func (c *AccountsAvailsListCall) PageSize(pageSize int64) *AccountsAvailsListCall {
	c.urlParams_.Set("pageSize", fmt.Sprint(pageSize))
	return c
}

// PageToken sets the optional parameter "pageToken": See _List methods rules_
// for info about this field.
...
// PphNames sets the optional parameter "pphNames": See _List methods rules_
// for info about this field.
...
// StudioNames sets the optional parameter "studioNames": See _List methods
...
// Territories sets the optional parameter "territories": Filter Avails that
// match (case-insensitive) any of the given country codes,
...
// Title sets the optional parameter "title": Filter that matches Avails with a
...
// VideoIds sets the optional parameter "videoIds": Filter Avails that match
...
// Any non-2xx status code is an error. Response headers are in either
// *ListAvailsResponse.ServerResponse.Header or (if a response was returned at
...
// CustomId sets the optional parameter "customId": Filter Orders that match a
// case-insensitive, partner-specific custom id.
...
// Name sets the optional parameter "name": Filter that matches Orders with a
// `name`, `show`, `season` or `episode`
...
// Status sets the optional parameter "status": Filter Orders that match one of
// the given status.
//
// Possible values:
//
...
// VideoIds sets the optional parameter "videoIds": Filter Orders that match
// any of the given `video_id`s.
...
// Any non-2xx status code is an error. Response headers are in either
// *ListOrdersResponse.ServerResponse.Header or (if a response was returned at
// all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified was
// returned.
...
// Countries sets the optional parameter "countries": Filter StoreInfos that
// match (case-insensitive) any of the given country
...
// Mids sets the optional parameter "mids": Filter StoreInfos that match any of
// the given `mid`s.
...
// Name sets the optional parameter "name": Filter that matches StoreInfos with
// a `name` or `show_name`
// that contains the given case-insensitive name.
...
// SeasonIds sets the optional parameter "seasonIds": Filter StoreInfos that
// match any of the given `season_id`s.
...
// VideoId sets the optional parameter "videoId": Filter StoreInfos that match
// a given `video_id`.
...
// VideoIds sets the optional parameter "videoIds": Filter StoreInfos that
...
// Any non-2xx status code is an error. Response headers are in either
// *ListStoreInfosResponse.ServerResponse.Header or (if a response was returned
...
// Any non-2xx status code is an error. Response headers are in either
// *StoreInfo.ServerResponse.Header or (if a response was returned at all) in
// error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
