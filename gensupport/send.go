...
var Hook func(ctx context.Context, req *http.Request, name string) func(resp **http.Response) = defaultHook

func defaultHook(ctx context.Context, req *http.Request, name string) func(resp **http.Response) {
