...
type StatesServicer interface {
	Clear(stateKey int64) *StatesClearCall
	Delete(stateKey int64) *StatesDeleteCall
	Get(stateKey int64) *StatesGetCall
	List() *StatesListCall
	Update(stateKey int64, updaterequest *UpdateRequest) *StatesUpdateCall
}
