...
// Usage example:
//
//	import "google.golang.org/api/merchantapi/notifications/v1"
//	...
...
package merchantapi // import "google.golang.org/api/merchantapi/notifications/v1"
...
const apiId = "merchantapi:notifications_v1"
const apiName = "merchantapi"
const apiVersion = "notifications_v1"
...
func (c *AccountsNotificationsubscriptionsCreateCall) doRequest(alt string) (*http.Response, error) {
	...
	urls := googleapi.ResolveRelative(c.s.BasePath, "notifications/v1/{+parent}/notificationsubscriptions")
...
func (c *AccountsNotificationsubscriptionsDeleteCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "notifications/v1/{+name}")
	urls += "?" + c.urlParams_.Encode()
