...
// Exactly one of *AppEdit,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *AppEdit, .ServerResponse.Header
...
// Exactly one of *ApkListing,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *ApkListing, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *ApkListingsListResponse,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *ApkListingsListResponse, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *ApksAddExternallyHostedResponse,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *ApksAddExternallyHostedResponse, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *ApksListResponse,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *ApksListResponse, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Apk,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Apk, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *AppDetails,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *AppDetails, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *ExpansionFile,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *ExpansionFile, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *ExpansionFilesUploadResponse,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *ExpansionFilesUploadResponse, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *ImagesDeleteAllResponse,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *ImagesDeleteAllResponse, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *ImagesListResponse,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *ImagesListResponse, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *ImagesUploadResponse,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *ImagesUploadResponse, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Listing,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Listing, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *ListingsListResponse,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *ListingsListResponse, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Testers,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Testers, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Track,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Track, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *TracksListResponse,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *TracksListResponse, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Any non-2xx status code is an error.
// Response headers are in either *EntitlementsListResponse, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Any non-2xx status code is an error.
// Response headers are in either *InappproductsBatchResponse, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *InAppProduct,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *InAppProduct, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Any non-2xx status code is an error.
// Response headers are in either *InappproductsListResponse, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *ProductPurchase,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *ProductPurchase, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *SubscriptionPurchasesDeferResponse,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *SubscriptionPurchasesDeferResponse, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *SubscriptionPurchase,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *SubscriptionPurchase, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
