...
func (c *ZoneViewsAddResourcesCall) DoHeader() (*Operation, http.Header, error) {
	var body io.Reader = nil
...
func (c *ZoneViewsDeleteCall) DoHeader() (*Operation, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
// "ifNoneMatch": Makes the operation conditional on whether
// the object's Etag does not match the given value.
func (c *ZoneViewsGetServiceCall) IfNoneMatch(ifNoneMatch string) *ZoneViewsGetServiceCall {
	c.opt_["ifNoneMatch"] = ifNoneMatch
	return c
}
...
func (c *ZoneViewsGetServiceCall) DoHeader() (*ZoneViewsGetServiceResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *ZoneViewsInsertCall) DoHeader() (*Operation, http.Header, error) {
	var body io.Reader = nil
...
func (c *ZoneViewsListCall) DoHeader() (*ZoneViewsList, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["maxResults"]; ok {
...
func (c *ZoneViewsRemoveResourcesCall) DoHeader() (*Operation, http.Header, error) {
	var body io.Reader = nil
...
// "ifNoneMatch": Makes the operation conditional on whether
// the object's Etag does not match the given value.
func (c *ZoneViewsSetServiceCall) IfNoneMatch(ifNoneMatch string) *ZoneViewsSetServiceCall {
	c.opt_["ifNoneMatch"] = ifNoneMatch
	return c
}
...
func (c *ZoneViewsSetServiceCall) DoHeader() (*Operation, http.Header, error) {
	var body io.Reader = nil
