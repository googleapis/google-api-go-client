...
type Moment struct {
	...
	// StartDate: Timestamp of the action (when it occured) in RFC3339
	// format.
	StartDate string `json:"startDate,omitempty"`
	...
	// Verb: The action the user performed
	Verb *MomentVerb `json:"verb,omitempty"`
}

type MomentVerb struct {
	// Url: Url name of the verb
	Url string `json:"url,omitempty"`
}
