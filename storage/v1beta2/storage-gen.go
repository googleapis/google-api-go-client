...
type BucketsDeleteCallDoer interface {
	Do() error
	IfMetagenerationMatch(ifMetagenerationMatch uint64) BucketsDeleteCallDoer
	IfMetagenerationNotMatch(ifMetagenerationNotMatch uint64) BucketsDeleteCallDoer
...
type BucketsGetCallDoer interface {
	Do() (*Bucket, error)
	IfMetagenerationMatch(ifMetagenerationMatch uint64) BucketsGetCallDoer
	IfMetagenerationNotMatch(ifMetagenerationNotMatch uint64) BucketsGetCallDoer
...
type BucketsPatchCallDoer interface {
	Do() (*Bucket, error)
	IfMetagenerationMatch(ifMetagenerationMatch uint64) BucketsPatchCallDoer
	IfMetagenerationNotMatch(ifMetagenerationNotMatch uint64) BucketsPatchCallDoer
...
type BucketsUpdateCallDoer interface {
	Do() (*Bucket, error)
	IfMetagenerationMatch(ifMetagenerationMatch uint64) BucketsUpdateCallDoer
	IfMetagenerationNotMatch(ifMetagenerationNotMatch uint64) BucketsUpdateCallDoer
...
type ObjectAccessControlsDeleteCallDoer interface {
	Do() error
	Generation(generation uint64) ObjectAccessControlsDeleteCallDoer
...
type ObjectAccessControlsGetCallDoer interface {
	Do() (*ObjectAccessControl, error)
	Generation(generation uint64) ObjectAccessControlsGetCallDoer
...
type ObjectAccessControlsInsertCallDoer interface {
	Do() (*ObjectAccessControl, error)
	Generation(generation uint64) ObjectAccessControlsInsertCallDoer
...
type ObjectAccessControlsListCallDoer interface {
	Do() (*ObjectAccessControls, error)
	Generation(generation uint64) ObjectAccessControlsListCallDoer
...
type ObjectAccessControlsPatchCallDoer interface {
	Do() (*ObjectAccessControl, error)
	Generation(generation uint64) ObjectAccessControlsPatchCallDoer
...
type ObjectAccessControlsUpdateCallDoer interface {
	Do() (*ObjectAccessControl, error)
	Generation(generation uint64) ObjectAccessControlsUpdateCallDoer
...
type ObjectsComposeCallDoer interface {
	Do() (*Object, error)
	IfGenerationMatch(ifGenerationMatch uint64) ObjectsComposeCallDoer
	IfMetagenerationMatch(ifMetagenerationMatch uint64) ObjectsComposeCallDoer
...
type ObjectsCopyCallDoer interface {
	Do() (*Object, error)
	IfGenerationMatch(ifGenerationMatch uint64) ObjectsCopyCallDoer
	IfGenerationNotMatch(ifGenerationNotMatch uint64) ObjectsCopyCallDoer
	IfMetagenerationMatch(ifMetagenerationMatch uint64) ObjectsCopyCallDoer
	IfMetagenerationNotMatch(ifMetagenerationNotMatch uint64) ObjectsCopyCallDoer
	IfSourceGenerationMatch(ifSourceGenerationMatch uint64) ObjectsCopyCallDoer
	IfSourceGenerationNotMatch(ifSourceGenerationNotMatch uint64) ObjectsCopyCallDoer
	IfSourceMetagenerationMatch(ifSourceMetagenerationMatch uint64) ObjectsCopyCallDoer
	IfSourceMetagenerationNotMatch(ifSourceMetagenerationNotMatch uint64) ObjectsCopyCallDoer
	Projection(projection string) ObjectsCopyCallDoer
	SourceGeneration(sourceGeneration uint64) ObjectsCopyCallDoer
...
type ObjectsDeleteCallDoer interface {
	Do() error
	Generation(generation uint64) ObjectsDeleteCallDoer
	IfGenerationMatch(ifGenerationMatch uint64) ObjectsDeleteCallDoer
	IfGenerationNotMatch(ifGenerationNotMatch uint64) ObjectsDeleteCallDoer
	IfMetagenerationMatch(ifMetagenerationMatch uint64) ObjectsDeleteCallDoer
	IfMetagenerationNotMatch(ifMetagenerationNotMatch uint64) ObjectsDeleteCallDoer
...
type ObjectsGetCallDoer interface {
	Do() (*Object, error)
	Generation(generation uint64) ObjectsGetCallDoer
	IfGenerationMatch(ifGenerationMatch uint64) ObjectsGetCallDoer
	IfGenerationNotMatch(ifGenerationNotMatch uint64) ObjectsGetCallDoer
	IfMetagenerationMatch(ifMetagenerationMatch uint64) ObjectsGetCallDoer
	IfMetagenerationNotMatch(ifMetagenerationNotMatch uint64) ObjectsGetCallDoer
...
type ObjectsInsertCallDoer interface {
	Do() (*Object, error)
	IfGenerationMatch(ifGenerationMatch uint64) ObjectsInsertCallDoer
	IfGenerationNotMatch(ifGenerationNotMatch uint64) ObjectsInsertCallDoer
	IfMetagenerationMatch(ifMetagenerationMatch uint64) ObjectsInsertCallDoer
	IfMetagenerationNotMatch(ifMetagenerationNotMatch uint64) ObjectsInsertCallDoer
...
type ObjectsPatchCallDoer interface {
	Do() (*Object, error)
	Generation(generation uint64) ObjectsPatchCallDoer
	IfGenerationMatch(ifGenerationMatch uint64) ObjectsPatchCallDoer
	IfGenerationNotMatch(ifGenerationNotMatch uint64) ObjectsPatchCallDoer
	IfMetagenerationMatch(ifMetagenerationMatch uint64) ObjectsPatchCallDoer
	IfMetagenerationNotMatch(ifMetagenerationNotMatch uint64) ObjectsPatchCallDoer
...
type ObjectsUpdateCallDoer interface {
	Do() (*Object, error)
	Generation(generation uint64) ObjectsUpdateCallDoer
	IfGenerationMatch(ifGenerationMatch uint64) ObjectsUpdateCallDoer
	IfGenerationNotMatch(ifGenerationNotMatch uint64) ObjectsUpdateCallDoer
	IfMetagenerationMatch(ifMetagenerationMatch uint64) ObjectsUpdateCallDoer
	IfMetagenerationNotMatch(ifMetagenerationNotMatch uint64) ObjectsUpdateCallDoer
