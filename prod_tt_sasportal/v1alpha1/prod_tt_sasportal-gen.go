...
type SasPortalChannelWithScore struct {
	...
	// Score: The channel score, normalized to be in [0,1].
...
type SasPortalDevice struct {
	...
	// RecommendedChannels: Output only. Recommended channels.
	RecommendedChannels []*SasPortalChannelWithScore `json:"recommendedChannels,omitempty"`

	// RecommendedPowerDbmPerMhz: Output only. Recommended power for the
	// device.
	RecommendedPowerDbmPerMhz float64 `json:"recommendedPowerDbmPerMhz,omitempty"`
...
func (s *SasPortalDevice) UnmarshalJSON(data []byte) error {
	type NoMethod SasPortalDevice
	var s1 struct {
		RecommendedPowerDbmPerMhz gensupport.JSONFloat64 `json:"recommendedPowerDbmPerMhz"`
		*NoMethod
	}
	s1.NoMethod = (*NoMethod)(s)
	if err := json.Unmarshal(data, &s1); err != nil {
	...
	s.RecommendedPowerDbmPerMhz = float64(s1.RecommendedPowerDbmPerMhz)
	return nil
}
