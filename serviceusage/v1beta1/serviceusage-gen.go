...
type AdminQuotaPolicy struct {
	...
	// This name is generated by the server when the policy is
	// created.
	//
	// Example names would
	// be:
...
// * Maximum of default 5 service defined monitored resource
// descriptors
...
type MonitoredResourceDescriptor struct {
	...
	//
	// All service defined monitored resource types must be prefixed with
	// the
	...
	//   is 100.
	//
	// Note there are legacy service monitored resources not following this
	// rule.
	Type string `json:"type,omitempty"`
...
type QuotaOverride struct {
	...
	// requested the override. For example:
...
func (c *OperationsGetCall) doRequest(alt string) (*http.Response, error) {
	...
	reqHeaders.Set("x-goog-api-client", "gl-go/"+gensupport.GoVersion()+" gdcl/20200626")
