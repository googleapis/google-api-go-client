...
// At most one of Media and ResumableMedia may be set.
func (c *UsersDraftsCreateCall) ResumableMedia(ctx context.Context, r googleapi.Reader) *UsersDraftsCreateCall {
	c.ctx_ = ctx
	c.media_ = r
...
// ResumableMedia specifies the media to upload in chunks and can be cancelled with ctx.
// At most one of Media and ResumableMedia may be set.
func (c *UsersDraftsSendCall) ResumableMedia(ctx context.Context, r googleapi.Reader) *UsersDraftsSendCall {
	c.ctx_ = ctx
	c.media_ = r
	c.protocol_ = "resumable"
	return c
...
// ResumableMedia specifies the media to upload in chunks and can be cancelled with ctx.
// At most one of Media and ResumableMedia may be set.
func (c *UsersDraftsUpdateCall) ResumableMedia(ctx context.Context, r googleapi.Reader) *UsersDraftsUpdateCall {
	c.ctx_ = ctx
	c.media_ = r
	c.protocol_ = "resumable"
	return c
...
// ResumableMedia specifies the media to upload in chunks and can be cancelled with ctx.
// At most one of Media and ResumableMedia may be set.
func (c *UsersMessagesImportCall) ResumableMedia(ctx context.Context, r googleapi.Reader) *UsersMessagesImportCall {
	c.ctx_ = ctx
	c.media_ = r
	c.protocol_ = "resumable"
	return c
...
// ResumableMedia specifies the media to upload in chunks and can be cancelled with ctx.
// At most one of Media and ResumableMedia may be set.
func (c *UsersMessagesInsertCall) ResumableMedia(ctx context.Context, r googleapi.Reader) *UsersMessagesInsertCall {
	c.ctx_ = ctx
	c.media_ = r
	c.protocol_ = "resumable"
	return c
...
// ResumableMedia specifies the media to upload in chunks and can be cancelled with ctx.
// At most one of Media and ResumableMedia may be set.
func (c *UsersMessagesSendCall) ResumableMedia(ctx context.Context, r googleapi.Reader) *UsersMessagesSendCall {
	c.ctx_ = ctx
	c.media_ = r
	c.protocol_ = "resumable"
	return c
