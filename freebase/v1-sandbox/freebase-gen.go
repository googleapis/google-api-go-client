...
func (c *ReconcileCall) Do() (*ReconcileGet, error) {
	...
	urls := googleapi.ResolveRelative("https://www.googleapis.com/freebase/v1-sandbox/", "reconcile")
	urls += "?" + params.Encode()
...
func (c *SearchCall) Do() error {
	...
	urls := googleapi.ResolveRelative("https://www.googleapis.com/freebase/v1-sandbox/", "search")
	urls += "?" + params.Encode()
	req, _ := http.NewRequest("GET", urls, body)
	googleapi.SetOpaque(req.URL)
	req.Header.Set("User-Agent", "google-api-go-client/0.5")
