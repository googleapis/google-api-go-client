...
func (r *ActivitiesService) Insert(userId string, activity *Activity) *ActivitiesInsertCall {
	c := &ActivitiesInsertCall{s: r.s, urlParams_: urlValues()}
	c.userId = userId
	c.activity = activity
	return c
}
...
func (r *AudiencesService) List(userId string) *AudiencesListCall {
	c := &AudiencesListCall{s: r.s, urlParams_: urlValues()}
	c.userId = userId
	return c
}
...
func (r *CirclesService) AddPeople(circleId string) *CirclesAddPeopleCall {
	c := &CirclesAddPeopleCall{s: r.s, urlParams_: urlValues()}
	c.circleId = circleId
	return c
}
...
func (c *CirclesAddPeopleCall) Email(email []string) *CirclesAddPeopleCall {
	c.urlParams_.Del("email")
	for _, v := range email {
		c.urlParams_.Add("email", fmt.Sprintf("%v", v))
	}
	return c
}
...
func (c *CirclesAddPeopleCall) UserId(userId []string) *CirclesAddPeopleCall {
	c.urlParams_.Del("userId")
	for _, v := range userId {
		c.urlParams_.Add("userId", fmt.Sprintf("%v", v))
	}
	return c
}
...
func (r *CirclesService) Get(circleId string) *CirclesGetCall {
	c := &CirclesGetCall{s: r.s, urlParams_: urlValues()}
	c.circleId = circleId
	return c
}
...
func (r *CirclesService) Insert(userId string, circle *Circle) *CirclesInsertCall {
	c := &CirclesInsertCall{s: r.s, urlParams_: urlValues()}
	c.userId = userId
	c.circle = circle
	return c
}
...
func (r *CirclesService) List(userId string) *CirclesListCall {
	c := &CirclesListCall{s: r.s, urlParams_: urlValues()}
	c.userId = userId
	return c
}
...
func (r *CirclesService) Patch(circleId string, circle *Circle) *CirclesPatchCall {
	c := &CirclesPatchCall{s: r.s, urlParams_: urlValues()}
	c.circleId = circleId
	c.circle = circle
	return c
}
...
func (r *CirclesService) Remove(circleId string) *CirclesRemoveCall {
	c := &CirclesRemoveCall{s: r.s, urlParams_: urlValues()}
	c.circleId = circleId
	return c
}
...
func (r *CirclesService) RemovePeople(circleId string) *CirclesRemovePeopleCall {
	c := &CirclesRemovePeopleCall{s: r.s, urlParams_: urlValues()}
	c.circleId = circleId
	return c
}
...
func (r *CirclesService) Update(circleId string, circle *Circle) *CirclesUpdateCall {
	c := &CirclesUpdateCall{s: r.s, urlParams_: urlValues()}
	c.circleId = circleId
	c.circle = circle
	return c
}
...
func (r *MediaService) Insert(userId string, collection string, media *Media) *MediaInsertCall {
	c := &MediaInsertCall{s: r.s, urlParams_: urlValues()}
	c.userId = userId
	c.collection = collection
	c.media = media
	return c
...
func (r *PeopleService) ListByCircle(circleId string) *PeopleListByCircleCall {
	c := &PeopleListByCircleCall{s: r.s, urlParams_: urlValues()}
	c.circleId = circleId
	return c
}
