...
type LineitemsDownloadlineitemsCallDoer interface {
	...
	Fields(s ...googleapi.Field) LineitemsDownloadlineitemsCallDoer
}
...
type LineitemsUploadlineitemsCallDoer interface {
	...
	Fields(s ...googleapi.Field) LineitemsUploadlineitemsCallDoer
}
...
type LineitemsServicer interface {
	Downloadlineitems(downloadlineitemsrequest *DownloadLineItemsRequest) LineitemsDownloadlineitemsCallDoer
	Uploadlineitems(uploadlineitemsrequest *UploadLineItemsRequest) LineitemsUploadlineitemsCallDoer
}
...
type QueriesCreatequeryCallDoer interface {
	Do() (*Query, error)
	Fields(s ...googleapi.Field) QueriesCreatequeryCallDoer
}
...
type QueriesDeletequeryCallDoer interface {
	Do() error
	Fields(s ...googleapi.Field) QueriesDeletequeryCallDoer
}
...
type QueriesGetqueryCallDoer interface {
	Do() (*Query, error)
	Fields(s ...googleapi.Field) QueriesGetqueryCallDoer
}
...
type QueriesListqueriesCallDoer interface {
	...
	Fields(s ...googleapi.Field) QueriesListqueriesCallDoer
}
...
type QueriesRunqueryCallDoer interface {
	Do() error
	Fields(s ...googleapi.Field) QueriesRunqueryCallDoer
}
...
type QueriesServicer interface {
	Createquery(query *Query) QueriesCreatequeryCallDoer
	Deletequery(queryId int64) QueriesDeletequeryCallDoer
	Getquery(queryId int64) QueriesGetqueryCallDoer
	Listqueries() QueriesListqueriesCallDoer
	Runquery(queryId int64, runqueryrequest *RunQueryRequest) QueriesRunqueryCallDoer
}
...
type ReportsListreportsCallDoer interface {
	...
	Fields(s ...googleapi.Field) ReportsListreportsCallDoer
}
...
type ReportsServicer interface {
	Listreports(queryId int64) ReportsListreportsCallDoer
}
