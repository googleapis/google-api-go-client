...
type AchievementDefinitionsListCallDoer interface {
	...
	Language(language string) AchievementDefinitionsListCallDoer
	MaxResults(maxResults int64) AchievementDefinitionsListCallDoer
	PageToken(pageToken string) AchievementDefinitionsListCallDoer
	Fields(s ...googleapi.Field) AchievementDefinitionsListCallDoer
}
...
// AchievementDefinitionsServicer makes it easy to provide your own testable versions of AchievementDefinitionsService.
type AchievementDefinitionsServicer interface {
	List() AchievementDefinitionsListCallDoer
}
...
type AchievementsIncrementCallDoer interface {
	...
	RequestId(requestId int64) AchievementsIncrementCallDoer
	Fields(s ...googleapi.Field) AchievementsIncrementCallDoer
}
...
type AchievementsListCallDoer interface {
	...
	Language(language string) AchievementsListCallDoer
	MaxResults(maxResults int64) AchievementsListCallDoer
	PageToken(pageToken string) AchievementsListCallDoer
	State(state string) AchievementsListCallDoer
	Fields(s ...googleapi.Field) AchievementsListCallDoer
}
...
type AchievementsRevealCallDoer interface {
	...
	Fields(s ...googleapi.Field) AchievementsRevealCallDoer
}
...
type AchievementsSetStepsAtLeastCallDoer interface {
	...
	Fields(s ...googleapi.Field) AchievementsSetStepsAtLeastCallDoer
}
...
type AchievementsUnlockCallDoer interface {
	...
	Fields(s ...googleapi.Field) AchievementsUnlockCallDoer
}
...
type AchievementsUpdateMultipleCallDoer interface {
	...
	Fields(s ...googleapi.Field) AchievementsUpdateMultipleCallDoer
}
...
// AchievementsServicer makes it easy to provide your own testable versions of AchievementsService.
type AchievementsServicer interface {
	Increment(achievementId string, stepsToIncrement int64) AchievementsIncrementCallDoer
	List(playerId string) AchievementsListCallDoer
	Reveal(achievementId string) AchievementsRevealCallDoer
	SetStepsAtLeast(achievementId string, steps int64) AchievementsSetStepsAtLeastCallDoer
	Unlock(achievementId string) AchievementsUnlockCallDoer
	UpdateMultiple(achievementupdatemultiplerequest *AchievementUpdateMultipleRequest) AchievementsUpdateMultipleCallDoer
}
...
type ApplicationsGetCallDoer interface {
	...
	Language(language string) ApplicationsGetCallDoer
	PlatformType(platformType string) ApplicationsGetCallDoer
	Fields(s ...googleapi.Field) ApplicationsGetCallDoer
}
...
type ApplicationsPlayedCallDoer interface {
	Do() error
	Fields(s ...googleapi.Field) ApplicationsPlayedCallDoer
}
...
// ApplicationsServicer makes it easy to provide your own testable versions of ApplicationsService.
type ApplicationsServicer interface {
	Get(applicationId string) ApplicationsGetCallDoer
	Played() ApplicationsPlayedCallDoer
}
...
type EventsListByPlayerCallDoer interface {
	...
	Language(language string) EventsListByPlayerCallDoer
	MaxResults(maxResults int64) EventsListByPlayerCallDoer
	PageToken(pageToken string) EventsListByPlayerCallDoer
	Fields(s ...googleapi.Field) EventsListByPlayerCallDoer
}
...
type EventsListDefinitionsCallDoer interface {
	...
	Language(language string) EventsListDefinitionsCallDoer
	MaxResults(maxResults int64) EventsListDefinitionsCallDoer
	PageToken(pageToken string) EventsListDefinitionsCallDoer
	Fields(s ...googleapi.Field) EventsListDefinitionsCallDoer
}
...
type EventsRecordCallDoer interface {
	...
	Language(language string) EventsRecordCallDoer
	Fields(s ...googleapi.Field) EventsRecordCallDoer
}
...
type EventsServicer interface {
	ListByPlayer() EventsListByPlayerCallDoer
	ListDefinitions() EventsListDefinitionsCallDoer
	Record(eventrecordrequest *EventRecordRequest) EventsRecordCallDoer
}
...
type LeaderboardsGetCallDoer interface {
	...
	Language(language string) LeaderboardsGetCallDoer
	Fields(s ...googleapi.Field) LeaderboardsGetCallDoer
}
...
type LeaderboardsListCallDoer interface {
	...
	Language(language string) LeaderboardsListCallDoer
	MaxResults(maxResults int64) LeaderboardsListCallDoer
	PageToken(pageToken string) LeaderboardsListCallDoer
	Fields(s ...googleapi.Field) LeaderboardsListCallDoer
}
...
// LeaderboardsServicer makes it easy to provide your own testable versions of LeaderboardsService.
type LeaderboardsServicer interface {
	Get(leaderboardId string) LeaderboardsGetCallDoer
	List() LeaderboardsListCallDoer
}
...
type MetagameGetMetagameConfigCallDoer interface {
	...
	Fields(s ...googleapi.Field) MetagameGetMetagameConfigCallDoer
}
...
type MetagameListCategoriesByPlayerCallDoer interface {
	...
	Language(language string) MetagameListCategoriesByPlayerCallDoer
	MaxResults(maxResults int64) MetagameListCategoriesByPlayerCallDoer
	PageToken(pageToken string) MetagameListCategoriesByPlayerCallDoer
	Fields(s ...googleapi.Field) MetagameListCategoriesByPlayerCallDoer
}
...
// MetagameServicer makes it easy to provide your own testable versions of MetagameService.
type MetagameServicer interface {
	GetMetagameConfig() MetagameGetMetagameConfigCallDoer
	ListCategoriesByPlayer(playerId string, collection string) MetagameListCategoriesByPlayerCallDoer
}
...
type PlayersGetCallDoer interface {
	Do() (*Player, error)
	Language(language string) PlayersGetCallDoer
	Fields(s ...googleapi.Field) PlayersGetCallDoer
}
...
type PlayersListCallDoer interface {
	...
	Language(language string) PlayersListCallDoer
	MaxResults(maxResults int64) PlayersListCallDoer
	PageToken(pageToken string) PlayersListCallDoer
	Fields(s ...googleapi.Field) PlayersListCallDoer
}
...
// PlayersServicer makes it easy to provide your own testable versions of PlayersService.
type PlayersServicer interface {
	Get(playerId string) PlayersGetCallDoer
	List(collection string) PlayersListCallDoer
}
...
type PushtokensRemoveCallDoer interface {
	Do() error
	Fields(s ...googleapi.Field) PushtokensRemoveCallDoer
}
...
type PushtokensUpdateCallDoer interface {
	Do() error
	Fields(s ...googleapi.Field) PushtokensUpdateCallDoer
}
...
// PushtokensServicer makes it easy to provide your own testable versions of PushtokensService.
type PushtokensServicer interface {
	Remove(pushtokenid *PushTokenId) PushtokensRemoveCallDoer
	Update(pushtoken *PushToken) PushtokensUpdateCallDoer
}
...
type QuestMilestonesClaimCallDoer interface {
	Do() error
	Fields(s ...googleapi.Field) QuestMilestonesClaimCallDoer
}
...
// QuestMilestonesServicer makes it easy to provide your own testable versions of QuestMilestonesService.
type QuestMilestonesServicer interface {
	Claim(questId string, milestoneId string, requestId int64) QuestMilestonesClaimCallDoer
}
...
type QuestsAcceptCallDoer interface {
	Do() (*Quest, error)
	Language(language string) QuestsAcceptCallDoer
	Fields(s ...googleapi.Field) QuestsAcceptCallDoer
}
...
type QuestsListCallDoer interface {
	...
	Language(language string) QuestsListCallDoer
	MaxResults(maxResults int64) QuestsListCallDoer
	PageToken(pageToken string) QuestsListCallDoer
	Fields(s ...googleapi.Field) QuestsListCallDoer
}
...
// QuestsServicer makes it easy to provide your own testable versions of QuestsService.
type QuestsServicer interface {
	Accept(questId string) QuestsAcceptCallDoer
	List(playerId string) QuestsListCallDoer
}
...
type RevisionsCheckCallDoer interface {
	...
	Fields(s ...googleapi.Field) RevisionsCheckCallDoer
}
...
type RevisionsServicer interface {
	Check(clientRevision string) RevisionsCheckCallDoer
}
...
type RoomsCreateCallDoer interface {
	Do() (*Room, error)
	Language(language string) RoomsCreateCallDoer
	Fields(s ...googleapi.Field) RoomsCreateCallDoer
}
...
type RoomsDeclineCallDoer interface {
	Do() (*Room, error)
	Language(language string) RoomsDeclineCallDoer
	Fields(s ...googleapi.Field) RoomsDeclineCallDoer
}
...
type RoomsDismissCallDoer interface {
	Do() error
	Fields(s ...googleapi.Field) RoomsDismissCallDoer
}
...
type RoomsGetCallDoer interface {
	Do() (*Room, error)
	Language(language string) RoomsGetCallDoer
	Fields(s ...googleapi.Field) RoomsGetCallDoer
}
...
type RoomsJoinCallDoer interface {
	Do() (*Room, error)
	Language(language string) RoomsJoinCallDoer
	Fields(s ...googleapi.Field) RoomsJoinCallDoer
}
...
type RoomsLeaveCallDoer interface {
	Do() (*Room, error)
	Language(language string) RoomsLeaveCallDoer
	Fields(s ...googleapi.Field) RoomsLeaveCallDoer
}
...
type RoomsListCallDoer interface {
	Do() (*RoomList, error)
	Language(language string) RoomsListCallDoer
	MaxResults(maxResults int64) RoomsListCallDoer
	PageToken(pageToken string) RoomsListCallDoer
	Fields(s ...googleapi.Field) RoomsListCallDoer
}
...
type RoomsReportStatusCallDoer interface {
	Do() (*RoomStatus, error)
	Language(language string) RoomsReportStatusCallDoer
	Fields(s ...googleapi.Field) RoomsReportStatusCallDoer
}
...
// RoomsServicer makes it easy to provide your own testable versions of RoomsService.
type RoomsServicer interface {
	Create(roomcreaterequest *RoomCreateRequest) RoomsCreateCallDoer
	Decline(roomId string) RoomsDeclineCallDoer
	Dismiss(roomId string) RoomsDismissCallDoer
	Get(roomId string) RoomsGetCallDoer
	Join(roomId string, roomjoinrequest *RoomJoinRequest) RoomsJoinCallDoer
	Leave(roomId string, roomleaverequest *RoomLeaveRequest) RoomsLeaveCallDoer
	List() RoomsListCallDoer
	ReportStatus(roomId string, roomp2pstatuses *RoomP2PStatuses) RoomsReportStatusCallDoer
}
...
type ScoresGetCallDoer interface {
	...
	IncludeRankType(includeRankType string) ScoresGetCallDoer
	Language(language string) ScoresGetCallDoer
	MaxResults(maxResults int64) ScoresGetCallDoer
	PageToken(pageToken string) ScoresGetCallDoer
	Fields(s ...googleapi.Field) ScoresGetCallDoer
}
...
type ScoresListCallDoer interface {
	...
	Language(language string) ScoresListCallDoer
	MaxResults(maxResults int64) ScoresListCallDoer
	PageToken(pageToken string) ScoresListCallDoer
	Fields(s ...googleapi.Field) ScoresListCallDoer
}
...
type ScoresListWindowCallDoer interface {
	Do() (*LeaderboardScores, error)
	Language(language string) ScoresListWindowCallDoer
	MaxResults(maxResults int64) ScoresListWindowCallDoer
	PageToken(pageToken string) ScoresListWindowCallDoer
	ResultsAbove(resultsAbove int64) ScoresListWindowCallDoer
	ReturnTopIfAbsent(returnTopIfAbsent bool) ScoresListWindowCallDoer
	Fields(s ...googleapi.Field) ScoresListWindowCallDoer
}
...
type ScoresSubmitCallDoer interface {
	...
	Language(language string) ScoresSubmitCallDoer
	ScoreTag(scoreTag string) ScoresSubmitCallDoer
	Fields(s ...googleapi.Field) ScoresSubmitCallDoer
}
...
type ScoresSubmitMultipleCallDoer interface {
	...
	Language(language string) ScoresSubmitMultipleCallDoer
	Fields(s ...googleapi.Field) ScoresSubmitMultipleCallDoer
}
...
// ScoresServicer makes it easy to provide your own testable versions of ScoresService.
type ScoresServicer interface {
	Get(playerId string, leaderboardId string, timeSpan string) ScoresGetCallDoer
	List(leaderboardId string, collection string, timeSpan string) ScoresListCallDoer
	ListWindow(leaderboardId string, collection string, timeSpan string) ScoresListWindowCallDoer
	Submit(leaderboardId string, score int64) ScoresSubmitCallDoer
	SubmitMultiple(playerscoresubmissionlist *PlayerScoreSubmissionList) ScoresSubmitMultipleCallDoer
}
...
type SnapshotsGetCallDoer interface {
	Do() (*Snapshot, error)
	Language(language string) SnapshotsGetCallDoer
...
type SnapshotsListCallDoer interface {
	...
	Language(language string) SnapshotsListCallDoer
...
type SnapshotsServicer interface {
	Get(snapshotId string) SnapshotsGetCallDoer
	List(playerId string) SnapshotsListCallDoer
}
...
type TurnBasedMatchesCancelCallDoer interface {
	Do() error
	Fields(s ...googleapi.Field) TurnBasedMatchesCancelCallDoer
}
...
type TurnBasedMatchesCreateCallDoer interface {
	...
	Language(language string) TurnBasedMatchesCreateCallDoer
	Fields(s ...googleapi.Field) TurnBasedMatchesCreateCallDoer
}
...
type TurnBasedMatchesDeclineCallDoer interface {
	Do() (*TurnBasedMatch, error)
	Language(language string) TurnBasedMatchesDeclineCallDoer
	Fields(s ...googleapi.Field) TurnBasedMatchesDeclineCallDoer
}
...
type TurnBasedMatchesDismissCallDoer interface {
	Do() error
	Fields(s ...googleapi.Field) TurnBasedMatchesDismissCallDoer
}
...
type TurnBasedMatchesFinishCallDoer interface {
	Do() (*TurnBasedMatch, error)
	Language(language string) TurnBasedMatchesFinishCallDoer
	Fields(s ...googleapi.Field) TurnBasedMatchesFinishCallDoer
}
...
type TurnBasedMatchesGetCallDoer interface {
	Do() (*TurnBasedMatch, error)
	IncludeMatchData(includeMatchData bool) TurnBasedMatchesGetCallDoer
	Language(language string) TurnBasedMatchesGetCallDoer
	Fields(s ...googleapi.Field) TurnBasedMatchesGetCallDoer
}
...
type TurnBasedMatchesJoinCallDoer interface {
	Do() (*TurnBasedMatch, error)
	Language(language string) TurnBasedMatchesJoinCallDoer
	Fields(s ...googleapi.Field) TurnBasedMatchesJoinCallDoer
}
...
type TurnBasedMatchesLeaveCallDoer interface {
	Do() (*TurnBasedMatch, error)
	Language(language string) TurnBasedMatchesLeaveCallDoer
	Fields(s ...googleapi.Field) TurnBasedMatchesLeaveCallDoer
}
...
type TurnBasedMatchesLeaveTurnCallDoer interface {
	Do() (*TurnBasedMatch, error)
	Language(language string) TurnBasedMatchesLeaveTurnCallDoer
	PendingParticipantId(pendingParticipantId string) TurnBasedMatchesLeaveTurnCallDoer
	Fields(s ...googleapi.Field) TurnBasedMatchesLeaveTurnCallDoer
}
...
type TurnBasedMatchesListCallDoer interface {
	...
	IncludeMatchData(includeMatchData bool) TurnBasedMatchesListCallDoer
	Language(language string) TurnBasedMatchesListCallDoer
	MaxCompletedMatches(maxCompletedMatches int64) TurnBasedMatchesListCallDoer
	MaxResults(maxResults int64) TurnBasedMatchesListCallDoer
	PageToken(pageToken string) TurnBasedMatchesListCallDoer
	Fields(s ...googleapi.Field) TurnBasedMatchesListCallDoer
}
...
type TurnBasedMatchesRematchCallDoer interface {
	...
	Language(language string) TurnBasedMatchesRematchCallDoer
	RequestId(requestId int64) TurnBasedMatchesRematchCallDoer
	Fields(s ...googleapi.Field) TurnBasedMatchesRematchCallDoer
}
...
type TurnBasedMatchesSyncCallDoer interface {
	...
	IncludeMatchData(includeMatchData bool) TurnBasedMatchesSyncCallDoer
	Language(language string) TurnBasedMatchesSyncCallDoer
	MaxCompletedMatches(maxCompletedMatches int64) TurnBasedMatchesSyncCallDoer
	MaxResults(maxResults int64) TurnBasedMatchesSyncCallDoer
	PageToken(pageToken string) TurnBasedMatchesSyncCallDoer
	Fields(s ...googleapi.Field) TurnBasedMatchesSyncCallDoer
}
...
type TurnBasedMatchesTakeTurnCallDoer interface {
	Do() (*TurnBasedMatch, error)
	Language(language string) TurnBasedMatchesTakeTurnCallDoer
	Fields(s ...googleapi.Field) TurnBasedMatchesTakeTurnCallDoer
}
...
// TurnBasedMatchesServicer makes it easy to provide your own testable versions of TurnBasedMatchesService.
type TurnBasedMatchesServicer interface {
	Cancel(matchId string) TurnBasedMatchesCancelCallDoer
	Create(turnbasedmatchcreaterequest *TurnBasedMatchCreateRequest) TurnBasedMatchesCreateCallDoer
	Decline(matchId string) TurnBasedMatchesDeclineCallDoer
	Dismiss(matchId string) TurnBasedMatchesDismissCallDoer
	Finish(matchId string, turnbasedmatchresults *TurnBasedMatchResults) TurnBasedMatchesFinishCallDoer
	Get(matchId string) TurnBasedMatchesGetCallDoer
	Join(matchId string) TurnBasedMatchesJoinCallDoer
	Leave(matchId string) TurnBasedMatchesLeaveCallDoer
	LeaveTurn(matchId string, matchVersion int64) TurnBasedMatchesLeaveTurnCallDoer
	List() TurnBasedMatchesListCallDoer
	Rematch(matchId string) TurnBasedMatchesRematchCallDoer
	Sync() TurnBasedMatchesSyncCallDoer
	TakeTurn(matchId string, turnbasedmatchturn *TurnBasedMatchTurn) TurnBasedMatchesTakeTurnCallDoer
}
