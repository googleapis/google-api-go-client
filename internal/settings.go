...
type DialSettings struct {
	...
	// TelemetryAttributes allow for passing static key/value pairs
	// (e.g. "gcp.client.service") to be added to all OpenTelemetry spans
	// and metrics generated by this transport.
