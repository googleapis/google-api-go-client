...
type ObjectConditions struct {
	// ExcludePrefixes: `excludePrefixes` must follow the constraints
	...
	// the include-prefix or the exclude-prefix can be empty, if specified.
	// * Each include-prefix must include a distinct portion of the object
	// namespace, i.e. no include-prefix may be a prefix of another
	// include-prefix. * Each exclude-prefix must exclude a distinct portion
	// of the bucket, i.e., no exclude-prefix may be a prefix of another
	// exclude-prefix`. * If `includePrefixes` is specified, then each
	// exclude-prefix must exclude paths that were explicitly included by
