...
func (c *ChangesCreateCall) IfNoneMatch(ifNoneMatch string) *ChangesCreateCall {
...
func (c *ChangesCreateCall) DoHeader() (http.Header, *Change, error) {
...
func (c *ChangesListCall) DoHeader() (http.Header, *ChangesListResponse, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
// "ifNoneMatch": Makes the operation conditional on whether
// the object's Etag does not match the given value.
func (c *ManagedZonesCreateCall) IfNoneMatch(ifNoneMatch string) *ManagedZonesCreateCall {
	c.opt_["ifNoneMatch"] = ifNoneMatch
	return c
}
...
func (c *ManagedZonesCreateCall) DoHeader() (http.Header, *ManagedZone, error) {
	var body io.Reader = nil
...
// "ifNoneMatch": Makes the operation conditional on whether
// the object's Etag does not match the given value.
func (c *ManagedZonesDeleteCall) IfNoneMatch(ifNoneMatch string) *ManagedZonesDeleteCall {
	c.opt_["ifNoneMatch"] = ifNoneMatch
	return c
}
...
func (c *ManagedZonesDeleteCall) DoHeader() (http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
// "ifNoneMatch": Makes the operation conditional on whether
// the object's Etag does not match the given value.
func (c *ManagedZonesGetCall) IfNoneMatch(ifNoneMatch string) *ManagedZonesGetCall {
	c.opt_["ifNoneMatch"] = ifNoneMatch
	return c
}
...
func (c *ManagedZonesGetCall) DoHeader() (http.Header, *ManagedZone, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
// "ifNoneMatch": Makes the operation conditional on whether
// the object's Etag does not match the given value.
func (c *ManagedZonesListCall) IfNoneMatch(ifNoneMatch string) *ManagedZonesListCall {
	c.opt_["ifNoneMatch"] = ifNoneMatch
	return c
}
...
func (c *ManagedZonesListCall) DoHeader() (http.Header, *ManagedZonesListResponse, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["maxResults"]; ok {
...
// "ifNoneMatch": Makes the operation conditional on whether
// the object's Etag does not match the given value.
func (c *ResourceRecordSetsListCall) IfNoneMatch(ifNoneMatch string) *ResourceRecordSetsListCall {
	c.opt_["ifNoneMatch"] = ifNoneMatch
	return c
}
...
func (c *ResourceRecordSetsListCall) DoHeader() (http.Header, *ResourceRecordSetsListResponse, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["maxResults"]; ok {
