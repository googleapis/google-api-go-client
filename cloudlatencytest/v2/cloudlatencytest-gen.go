...
func (c *StatscollectionUpdateaggregatedstatsCall) Do() (ret *AggregatedStatsReply, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *StatscollectionUpdatestatsCall) Do() (ret *StatsReply, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
