...
type AclServicer interface {
	Delete(calendarId string, ruleId string) *AclDeleteCall
	Get(calendarId string, ruleId string) *AclGetCall
	Insert(calendarId string, aclrule *AclRule) *AclInsertCall
	List(calendarId string) *AclListCall
	Patch(calendarId string, ruleId string, aclrule *AclRule) *AclPatchCall
	Update(calendarId string, ruleId string, aclrule *AclRule) *AclUpdateCall
	Watch(calendarId string, channel *Channel) *AclWatchCall
}
...
type CalendarListServicer interface {
	Delete(calendarId string) *CalendarListDeleteCall
	Get(calendarId string) *CalendarListGetCall
	Insert(calendarlistentry *CalendarListEntry) *CalendarListInsertCall
	List() *CalendarListListCall
	Patch(calendarId string, calendarlistentry *CalendarListEntry) *CalendarListPatchCall
	Update(calendarId string, calendarlistentry *CalendarListEntry) *CalendarListUpdateCall
	Watch(channel *Channel) *CalendarListWatchCall
}
...
type CalendarsServicer interface {
	Clear(calendarId string) *CalendarsClearCall
	Delete(calendarId string) *CalendarsDeleteCall
	Get(calendarId string) *CalendarsGetCall
	Insert(calendar *Calendar) *CalendarsInsertCall
	Patch(calendarId string, calendar *Calendar) *CalendarsPatchCall
	Update(calendarId string, calendar *Calendar) *CalendarsUpdateCall
}
...
type EventsServicer interface {
	Delete(calendarId string, eventId string) *EventsDeleteCall
	Get(calendarId string, eventId string) *EventsGetCall
	Import(calendarId string, event *Event) *EventsImportCall
	Insert(calendarId string, event *Event) *EventsInsertCall
	Instances(calendarId string, eventId string) *EventsInstancesCall
	List(calendarId string) *EventsListCall
	Move(calendarId string, eventId string, destinationid string) *EventsMoveCall
	Patch(calendarId string, eventId string, event *Event) *EventsPatchCall
	QuickAdd(calendarId string, text string) *EventsQuickAddCall
	Update(calendarId string, eventId string, event *Event) *EventsUpdateCall
	Watch(calendarId string, channel *Channel) *EventsWatchCall
}
...
type FreebusyServicer interface {
	Query(freebusyrequest *FreeBusyRequest) *FreebusyQueryCall
}
...
type SettingsServicer interface {
	Get(setting string) *SettingsGetCall
	List() *SettingsListCall
	Watch(channel *Channel) *SettingsWatchCall
}
