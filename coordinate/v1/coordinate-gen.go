...
func (r *CustomFieldDefService) List(teamId string) *CustomFieldDefListCall {
	c := &CustomFieldDefListCall{s: r.s, urlParams_: make(urlParams)}
	c.teamId = teamId
	return c
}
...
func (r *JobsService) Get(teamId string, jobId uint64) *JobsGetCall {
	c := &JobsGetCall{s: r.s, urlParams_: make(urlParams)}
	c.teamId = teamId
	c.jobId = jobId
	return c
}
...
func (r *JobsService) Insert(teamId string, address string, lat float64, lng float64, title string, job *Job) *JobsInsertCall {
	c := &JobsInsertCall{s: r.s, urlParams_: make(urlParams)}
	c.teamId = teamId
	c.address = address
	c.lat = lat
	c.lng = lng
...
func (c *JobsInsertCall) CustomField(customField []string) *JobsInsertCall {
	c.urlParams_.setMulti("customField", customField)
	return c
}
...
func (r *JobsService) List(teamId string) *JobsListCall {
	c := &JobsListCall{s: r.s, urlParams_: make(urlParams)}
	c.teamId = teamId
	return c
}
...
func (r *JobsService) Patch(teamId string, jobId uint64, job *Job) *JobsPatchCall {
	c := &JobsPatchCall{s: r.s, urlParams_: make(urlParams)}
	c.teamId = teamId
	c.jobId = jobId
	c.job = job
	return c
...
func (r *JobsService) Update(teamId string, jobId uint64, job *Job) *JobsUpdateCall {
	c := &JobsUpdateCall{s: r.s, urlParams_: make(urlParams)}
	c.teamId = teamId
	c.jobId = jobId
	c.job = job
	return c
...
func (r *LocationService) List(teamId string, workerEmail string, startTimestampMs uint64) *LocationListCall {
	c := &LocationListCall{s: r.s, urlParams_: make(urlParams)}
	c.teamId = teamId
...
func (r *ScheduleService) Get(teamId string, jobId uint64) *ScheduleGetCall {
	c := &ScheduleGetCall{s: r.s, urlParams_: make(urlParams)}
	c.teamId = teamId
	c.jobId = jobId
	return c
}
...
func (r *ScheduleService) Patch(teamId string, jobId uint64, schedule *Schedule) *SchedulePatchCall {
	c := &SchedulePatchCall{s: r.s, urlParams_: make(urlParams)}
	c.teamId = teamId
	c.jobId = jobId
	c.schedule = schedule
	return c
...
func (r *ScheduleService) Update(teamId string, jobId uint64, schedule *Schedule) *ScheduleUpdateCall {
	c := &ScheduleUpdateCall{s: r.s, urlParams_: make(urlParams)}
	c.teamId = teamId
	c.jobId = jobId
	c.schedule = schedule
	return c
...
func (r *TeamService) List() *TeamListCall {
	c := &TeamListCall{s: r.s, urlParams_: make(urlParams)}
	return c
}
...
func (r *WorkerService) List(teamId string) *WorkerListCall {
	c := &WorkerListCall{s: r.s, urlParams_: make(urlParams)}
	c.teamId = teamId
	return c
}
