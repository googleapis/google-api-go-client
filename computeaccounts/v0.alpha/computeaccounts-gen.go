...
func (c *GlobalAccountsOperationsGetCall) DoHeader() (http.Header, *Operation, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *GlobalAccountsOperationsListCall) DoHeader() (http.Header, *OperationList, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *GroupsAddMemberCall) DoHeader() (http.Header, *Operation, error) {
	var body io.Reader = nil
...
func (c *GroupsDeleteCall) DoHeader() (http.Header, *Operation, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *GroupsGetCall) DoHeader() (http.Header, *Group, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *GroupsInsertCall) DoHeader() (http.Header, *Operation, error) {
	var body io.Reader = nil
...
func (c *GroupsListCall) DoHeader() (http.Header, *GroupList, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["filter"]; ok {
...
func (c *GroupsRemoveMemberCall) DoHeader() (http.Header, *Operation, error) {
	var body io.Reader = nil
...
func (c *LinuxGetAuthorizedKeysViewCall) DoHeader() (http.Header, *LinuxGetAuthorizedKeysViewResponse, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *LinuxGetLinuxAccountViewsCall) DoHeader() (http.Header, *LinuxGetLinuxAccountViewsResponse, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	params.Set("instance", fmt.Sprintf("%v", c.instance))
...
func (c *UsersAddPublicKeyCall) DoHeader() (http.Header, *Operation, error) {
	var body io.Reader = nil
...
func (c *UsersDeleteCall) DoHeader() (http.Header, *Operation, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *UsersInsertCall) DoHeader() (http.Header, *Operation, error) {
	var body io.Reader = nil
...
func (c *UsersListCall) DoHeader() (http.Header, *UserList, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["filter"]; ok {
...
func (c *UsersRemovePublicKeyCall) DoHeader() (http.Header, *Operation, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
