...
// Google
// Cloud Platform, such as a BigQuery dataset or a Cloud Pub/Sub
// topic.
// Clients can use the `linked_resource` field in the Entry resource to
// refer to
...
type GoogleCloudDatacatalogV1beta1Entry struct {
	...
	// LinkedResource: Output only. The resource this metadata entry refers
	// to.
	//
...
type GoogleCloudDatacatalogV1beta1SearchCatalogRequest struct {
	...
	//   * `last_access_timestamp [asc|desc]`, defaults to descending if
	// not
	//     specified
...
// GoogleCloudDatacatalogV1beta1TagTemplate: A tag template defines the
// schema of the tags used to attach to Data Catalog
// resources. It defines the mapping of accepted field names and types
// that can
// be used within the tag. The tag template also controls the access to
// the tag.
...
// match
// your query but are not returned, even in subsequent pages of results.
// These
// missing results may vary across repeated calls to search. Do not rely
// on
...
// The user should enable the Data Catalog API in the project identified
// by
...
// Delete: Alpha feature.
// Deletes an EntryGroup. Only entry groups that do not contain entries
// can be
// deleted. The user should enable the Data Catalog API in the
// project
...
// Create: Alpha feature.
// Creates an entry. Currently only entries of 'FILESET' type can be
// created.
// The user should enable the Data Catalog API in the project identified
// by
// the `parent` parameter (see [Data Catalog Resource
...
// Delete: Alpha feature.
// Deletes an existing entry. Only entries created
// through
// CreateEntry
...
// method id "datacatalog.projects.locations.entryGroups.entries.setIamPolicy":

type ProjectsLocationsEntryGroupsEntriesSetIamPolicyCall struct {
	s                   *Service
	resource            string
	setiampolicyrequest *SetIamPolicyRequest
	urlParams_          gensupport.URLParams
...
//   - `datacatalog.entryGroups.setIamPolicy` to set policies on entry
// groups.
func (r *ProjectsLocationsEntryGroupsEntriesService) SetIamPolicy(resource string, setiampolicyrequest *SetIamPolicyRequest) *ProjectsLocationsEntryGroupsEntriesSetIamPolicyCall {
	c := &ProjectsLocationsEntryGroupsEntriesSetIamPolicyCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.resource = resource
	c.setiampolicyrequest = setiampolicyrequest
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *ProjectsLocationsEntryGroupsEntriesSetIamPolicyCall) Fields(s ...googleapi.Field) *ProjectsLocationsEntryGroupsEntriesSetIamPolicyCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *ProjectsLocationsEntryGroupsEntriesSetIamPolicyCall) Context(ctx context.Context) *ProjectsLocationsEntryGroupsEntriesSetIamPolicyCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns an http.Header that can be modified by the caller to
// add HTTP headers to the request.
func (c *ProjectsLocationsEntryGroupsEntriesSetIamPolicyCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *ProjectsLocationsEntryGroupsEntriesSetIamPolicyCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("x-goog-api-client", "gl-go/1.11.0 gdcl/20191210")
	for k, v := range c.header_ {
		reqHeaders[k] = v
...
// Do executes the "datacatalog.projects.locations.entryGroups.entries.setIamPolicy" call.
// Exactly one of *Policy or error will be non-nil. Any non-2xx status
// code is an error. Response headers are in either
// *Policy.ServerResponse.Header or (if a response was returned at all)
// in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified
// was returned.
func (c *ProjectsLocationsEntryGroupsEntriesSetIamPolicyCall) Do(opts ...googleapi.CallOption) (*Policy, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
...
// to update the
// field type. The user should enable the Data Catalog API in the
// project
// identified by the `name` parameter (see [Data Catalog Resource
// Project]
// (/data-catalog/docs/concepts/resource-project) for more information).
