...
type GroupsServicer interface {
	Get(groupUniqueId string) GroupsGetCallDoer
	Patch(groupUniqueId string, groups *Groups) GroupsPatchCallDoer
	Update(groupUniqueId string, groups *Groups) GroupsUpdateCallDoer
}
