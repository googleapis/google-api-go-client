...
func NewAccountsOmnichannelSettingsService(s *APIService) *AccountsOmnichannelSettingsService {
	...
	rs.GbpAccounts = NewAccountsOmnichannelSettingsGbpAccountsService(s)
...
type AccountsOmnichannelSettingsService struct {
	...
	GbpAccounts *AccountsOmnichannelSettingsGbpAccountsService

	LfpProviders *AccountsOmnichannelSettingsLfpProvidersService
}

func NewAccountsOmnichannelSettingsGbpAccountsService(s *APIService) *AccountsOmnichannelSettingsGbpAccountsService {
	rs := &AccountsOmnichannelSettingsGbpAccountsService{s: s}
	return rs
}

type AccountsOmnichannelSettingsGbpAccountsService struct {
	s *APIService
}
...
type About struct {
	...
	//   "ACTIVE" - The review process is active.
...
type GbpAccount struct {
	...
	// `accounts/{account}/omnichannelSettings/{omnichannel_setting}/gbpAccount/{gbp
	// _account}`
	Name string `json:"name,omitempty"`
...
type InventoryVerification struct {
	...
	// Possible values:
	//   "STATE_UNSPECIFIED" - Default value. This value is unused.
	//   "ACTION_REQUIRED" - When merchant fails the inventory verification
	// process, but still have remaining attempts.
	//   "RUNNING" - The inventory verification process is running.
...
type LfpLink struct {
	...
	// ProviderId: Required. The ID of the LFP provider.
...
type LfpProvider struct {
	...
	// LfpProviderId: The ID of the LFP provider.
	LfpProviderId string `json:"lfpProviderId,omitempty"`
...
type LinkLfpProviderRequest struct {
	...
	ExternalAccountId string `json:"externalAccountId,omitempty"`
	// LfpProviderId: Required. The id of the LFP provider to link.
	LfpProviderId string `json:"lfpProviderId,omitempty"`
	// ForceSendFields is a list of field names (e.g. "ExternalAccountId") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
...
// ListLfpProvidersResponse: Response message for the ListLfpProviders method.
type ListLfpProvidersResponse struct {
...
func (s ListLfpProvidersResponse) MarshalJSON() ([]byte, error) {
	type NoMethod ListLfpProvidersResponse
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}
...
// LsfType: Collection of information related to the Local Store Front (LSF)
// type.
type LsfType struct {
	// LsfType: Required. The Local Store Front (LSF) type.
	//
	// Possible values:
	//   "TYPE_UNSPECIFIED" - Default value. This value is unused.
	...
	// State: Output only. The state of the LSF.
	//
	// Possible values:
	//   "STATE_UNSPECIFIED" - Default value. This value is unused.
	//   "ACTIVE" - The review process is active.
	...
	//   "RUNNING" - The review process is running.
	State string `json:"state,omitempty"`
	// ForceSendFields is a list of field names (e.g. "LsfType") to unconditionally
	// include in API requests. By default, fields with empty or default values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "LsfType") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
func (s LsfType) MarshalJSON() ([]byte, error) {
	type NoMethod LsfType
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}
...
type OmnichannelSetting struct {
	...
	// InventoryVerification: Optional. The inventory verification process state
	// for this country.
	...
	// LsfType: Optional. The Local Store Front (LSF
	// (https://support.google.com/merchants/answer/7178526)) type and state for
	// this country.
	LsfType *LsfType `json:"lsfType,omitempty"`
	...
	// PickupTypes: Optional. The Pickup types asnd state for this country.
	PickupTypes []*PickupType `json:"pickupTypes,omitempty"`
	// RegionCode: Immutable. Region code defined by CLDR
	// (https://cldr.unicode.org/).
	RegionCode string `json:"regionCode,omitempty"`
	// State: Output only. The state of the omnichannel setting.
	//
	// Possible values:
	//   "STATE_UNSPECIFIED" - Default value. This value is unused.
	//   "ACTIVE" - The merchant's omnichannel setting is active.
	//   "ACTION_REQUIRED" - The merchant's omnichannel setting requires action.
	//   "RUNNING" - The merchant's omnichannel setting is running.
	State string `json:"state,omitempty"`
...
// PickupType: Collection of information related to the pickup type.
type PickupType struct {
	// PickupType: Required. The type of the pickup.
	//
	// Possible values:
	//   "TYPE_UNSPECIFIED" - Default value. This value is unused.
	//   "PICKUP_TODAY" - [Pickup
	// today](https://support.google.com/merchants/answer/14634281?hl=en&ref_topic=1
	// 5145747&sjid=6892280366904591178-NC#).
	//   "PICKUP_LATER" - [Pickup
	// later](https://support.google.com/merchants/answer/14634020?hl=en&ref_topic=1
	// 5145747&sjid=6892280366904591178-NC#).
	PickupType string `json:"pickupType,omitempty"`
	// State: Output only. The state of the PickupType.
	//
	// Possible values:
	//   "STATE_UNSPECIFIED" - Default value. This value is unused.
	//   "ACTIVE" - The review process is active.
	...
	//   "RUNNING" - The review process is running.
	State string `json:"state,omitempty"`
	// ForceSendFields is a list of field names (e.g. "PickupType") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "PickupType") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
func (s PickupType) MarshalJSON() ([]byte, error) {
	type NoMethod PickupType
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}
...
func (c *AccountsOmnichannelSettingsCreateCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.omnichannelsetting)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
...
func (c *AccountsOmnichannelSettingsRequestInventoryVerificationCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.requestinventoryverificationrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
...
type AccountsOmnichannelSettingsGbpAccountsLinkGbpAccountCall struct {
	s                     *APIService
	parent                string
...
//     listed. Format:
//     `accounts/{account}/omnichannelSettings/{omnichannel_setting}`.
func (r *AccountsOmnichannelSettingsGbpAccountsService) LinkGbpAccount(parent string, linkgbpaccountrequest *LinkGbpAccountRequest) *AccountsOmnichannelSettingsGbpAccountsLinkGbpAccountCall {
	c := &AccountsOmnichannelSettingsGbpAccountsLinkGbpAccountCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.parent = parent
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse for more
// details.
func (c *AccountsOmnichannelSettingsGbpAccountsLinkGbpAccountCall) Fields(s ...googleapi.Field) *AccountsOmnichannelSettingsGbpAccountsLinkGbpAccountCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}

// Context sets the context to be used in this call's Do method.
func (c *AccountsOmnichannelSettingsGbpAccountsLinkGbpAccountCall) Context(ctx context.Context) *AccountsOmnichannelSettingsGbpAccountsLinkGbpAccountCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns a http.Header that can be modified by the caller to add
// headers to the request.
func (c *AccountsOmnichannelSettingsGbpAccountsLinkGbpAccountCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *AccountsOmnichannelSettingsGbpAccountsLinkGbpAccountCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.linkgbpaccountrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
...
// Do executes the "merchantapi.accounts.omnichannelSettings.gbpAccounts.linkGbpAccount" call.
// Any non-2xx status code is an error. Response headers are in either
// *LinkGbpAccountResponse.ServerResponse.Header or (if a response was returned
// at all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified was
// returned.
func (c *AccountsOmnichannelSettingsGbpAccountsLinkGbpAccountCall) Do(opts ...googleapi.CallOption) (*LinkGbpAccountResponse, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
...
type AccountsOmnichannelSettingsGbpAccountsListCall struct {
	s            *APIService
	parent       string
	urlParams_   gensupport.URLParams
	ifNoneMatch_ string
...
//     listed. Format:
//     `accounts/{account}/omnichannelSettings/{omnichannel_setting}`.
func (r *AccountsOmnichannelSettingsGbpAccountsService) List(parent string) *AccountsOmnichannelSettingsGbpAccountsListCall {
	c := &AccountsOmnichannelSettingsGbpAccountsListCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.parent = parent
	return c
}
...
func (c *AccountsOmnichannelSettingsGbpAccountsListCall) PageSize(pageSize int64) *AccountsOmnichannelSettingsGbpAccountsListCall {
	c.urlParams_.Set("pageSize", fmt.Sprint(pageSize))
	return c
}
...
func (c *AccountsOmnichannelSettingsGbpAccountsListCall) PageToken(pageToken string) *AccountsOmnichannelSettingsGbpAccountsListCall {
	c.urlParams_.Set("pageToken", pageToken)
	return c
}
...
// object's ETag matches the given value. This is useful for getting updates
// only after the object has changed since the last request.
func (c *AccountsOmnichannelSettingsGbpAccountsListCall) IfNoneMatch(entityTag string) *AccountsOmnichannelSettingsGbpAccountsListCall {
	c.ifNoneMatch_ = entityTag
	return c
}

// Context sets the context to be used in this call's Do method.
func (c *AccountsOmnichannelSettingsGbpAccountsListCall) Context(ctx context.Context) *AccountsOmnichannelSettingsGbpAccountsListCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns a http.Header that can be modified by the caller to add
// headers to the request.
func (c *AccountsOmnichannelSettingsGbpAccountsListCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *AccountsOmnichannelSettingsGbpAccountsListCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "", c.header_)
	if c.ifNoneMatch_ != "" {
		reqHeaders.Set("If-None-Match", c.ifNoneMatch_)
	}
...
// Do executes the "merchantapi.accounts.omnichannelSettings.gbpAccounts.list" call.
// Any non-2xx status code is an error. Response headers are in either
// *ListGbpAccountsResponse.ServerResponse.Header or (if a response was
// returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
func (c *AccountsOmnichannelSettingsGbpAccountsListCall) Do(opts ...googleapi.CallOption) (*ListGbpAccountsResponse, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
...
// A non-nil error returned from f will halt the iteration.
// The provided context supersedes any context provided to the Context method.
func (c *AccountsOmnichannelSettingsGbpAccountsListCall) Pages(ctx context.Context, f func(*ListGbpAccountsResponse) error) error {
	c.ctx_ = ctx
	defer c.PageToken(c.urlParams_.Get("pageToken"))
	for {
		x, err := c.Do()
...
// specified country.
//
//   - parent: The name of the parent resource under which the LFP provider is
//     linked. Format:
//     `accounts/{account}/omnichannelSettings/{omnichannel_setting}`.
func (r *AccountsOmnichannelSettingsLfpProvidersService) LinkLfpProvider(parent string, linklfpproviderrequest *LinkLfpProviderRequest) *AccountsOmnichannelSettingsLfpProvidersLinkLfpProviderCall {
...
func (c *AccountsOmnichannelSettingsLfpProvidersLinkLfpProviderCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.linklfpproviderrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "accounts/v1beta/{+parent}/lfpProviders:linkLfpProvider")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
type AccountsOmnichannelSettingsLfpProvidersListCall struct {
	s            *APIService
	parent       string
	urlParams_   gensupport.URLParams
	ifNoneMatch_ string
...
// List: List the LFP provider settings for a given merchant in a given
// country.
//
//   - parent: The name of the parent resource under which the LFP providers are
//     listed. Format:
//     `accounts/{account}/omnichannelSettings/{omnichannel_setting}`.
func (r *AccountsOmnichannelSettingsLfpProvidersService) List(parent string) *AccountsOmnichannelSettingsLfpProvidersListCall {
	c := &AccountsOmnichannelSettingsLfpProvidersListCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.parent = parent
	return c
}
...
// value is 50. The maximum value is 1000; If a value higher than the maximum
// is specified, then the `pageSize` will default to the maximum.
func (c *AccountsOmnichannelSettingsLfpProvidersListCall) PageSize(pageSize int64) *AccountsOmnichannelSettingsLfpProvidersListCall {
	c.urlParams_.Set("pageSize", fmt.Sprint(pageSize))
	return c
}

// PageToken sets the optional parameter "pageToken": A page token, received
// from a previous `ListLfpProviders` call. Provide the page token to retrieve
// the subsequent page. When paginating, all other parameters provided to
// `ListLfpProviders` must match the call that provided the page token.
func (c *AccountsOmnichannelSettingsLfpProvidersListCall) PageToken(pageToken string) *AccountsOmnichannelSettingsLfpProvidersListCall {
	c.urlParams_.Set("pageToken", pageToken)
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse for more
// details.
func (c *AccountsOmnichannelSettingsLfpProvidersListCall) Fields(s ...googleapi.Field) *AccountsOmnichannelSettingsLfpProvidersListCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// object's ETag matches the given value. This is useful for getting updates
// only after the object has changed since the last request.
func (c *AccountsOmnichannelSettingsLfpProvidersListCall) IfNoneMatch(entityTag string) *AccountsOmnichannelSettingsLfpProvidersListCall {
	c.ifNoneMatch_ = entityTag
	return c
}

// Context sets the context to be used in this call's Do method.
func (c *AccountsOmnichannelSettingsLfpProvidersListCall) Context(ctx context.Context) *AccountsOmnichannelSettingsLfpProvidersListCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns a http.Header that can be modified by the caller to add
// headers to the request.
func (c *AccountsOmnichannelSettingsLfpProvidersListCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *AccountsOmnichannelSettingsLfpProvidersListCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "", c.header_)
	if c.ifNoneMatch_ != "" {
		reqHeaders.Set("If-None-Match", c.ifNoneMatch_)
	}
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "accounts/v1beta/{+parent}/lfpProviders")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("GET", urls, body)
	if err != nil {
		return nil, err
...
// Do executes the "merchantapi.accounts.omnichannelSettings.lfpProviders.list" call.
// Any non-2xx status code is an error. Response headers are in either
// *ListLfpProvidersResponse.ServerResponse.Header or (if a response was
// returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
func (c *AccountsOmnichannelSettingsLfpProvidersListCall) Do(opts ...googleapi.CallOption) (*ListLfpProvidersResponse, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
...
// A non-nil error returned from f will halt the iteration.
// The provided context supersedes any context provided to the Context method.
func (c *AccountsOmnichannelSettingsLfpProvidersListCall) Pages(ctx context.Context, f func(*ListLfpProvidersResponse) error) error {
	c.ctx_ = ctx
	defer c.PageToken(c.urlParams_.Get("pageToken"))
	for {
		x, err := c.Do()
