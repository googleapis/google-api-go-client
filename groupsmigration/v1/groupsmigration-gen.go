...
func (c *ArchiveInsertCall) Media(r io.Reader, opt ...googleapi.UploadOption) *ArchiveInsertCall {
	c.media_ = r
...
// At most one of Media and ResumableMedia may be set.
func (c *ArchiveInsertCall) ResumableMedia(ctx context.Context, r io.Reader, opt ...googleapi.UploadOption) *ArchiveInsertCall {
	c.ctx_ = ctx
	c.media_ = r
