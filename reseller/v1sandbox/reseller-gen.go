...
// is cancelled.
func (c *CustomersGetCall) Ctx(ctx context.Context) *CustomersGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *CustomersInsertCall) Ctx(ctx context.Context) *CustomersInsertCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *CustomersPatchCall) Ctx(ctx context.Context) *CustomersPatchCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *CustomersUpdateCall) Ctx(ctx context.Context) *CustomersUpdateCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *SubscriptionsActivateCall) Ctx(ctx context.Context) *SubscriptionsActivateCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *SubscriptionsChangePlanCall) Ctx(ctx context.Context) *SubscriptionsChangePlanCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *SubscriptionsChangeRenewalSettingsCall) Ctx(ctx context.Context) *SubscriptionsChangeRenewalSettingsCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *SubscriptionsChangeSeatsCall) Ctx(ctx context.Context) *SubscriptionsChangeSeatsCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *SubscriptionsStartPaidServiceCall) Ctx(ctx context.Context) *SubscriptionsStartPaidServiceCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *SubscriptionsSuspendCall) Ctx(ctx context.Context) *SubscriptionsSuspendCall {
	c.ctx_ = ctx
	return c
}
