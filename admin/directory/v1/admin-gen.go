...
type UserLanguage struct {
	...
	// LanguageCode: Language Code. Should be used for storing ISO 639
	// LanguageCode string representation for language. See the Language
	// Codes (/admin-sdk/directory/v1/languages) page for the list of
	// supported codes. Valid language codes outside the supported set will
	// be accepted by the API but may lead to unexpected behavior. Illegal
	// values cause SchemaException. If this is set `customLanguage` can't
	// be set.
	LanguageCode string `json:"languageCode,omitempty"`

	// Preference: Preference. Optional field, which if present, controls
	// whether the specified `languageCode` is stored as the user's
	// preferred language. If `customLanguage` is set, this can't be set.
