...
func (c *DivisionsSearchCall) DoHeader() (http.Header, *DivisionSearchResponse, error) {
...
func (c *ElectionsElectionQueryCall) DoHeader() (http.Header, *ElectionsQueryResponse, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *ElectionsVoterInfoQueryCall) DoHeader() (http.Header, *VoterInfoResponse, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *RepresentativesRepresentativeInfoByAddressCall) DoHeader() (http.Header, *RepresentativeInfoResponse, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *RepresentativesRepresentativeInfoByDivisionCall) DoHeader() (http.Header, *RepresentativeInfoData, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["levels"]; ok {
