...
//
// For product documentation, see: https://cloud.google.com/datamigration/
//
// Creating a client
//
// Usage example:
...
type CloudSqlSettings struct {
	...
	// DatabaseVersion: The database engine type and version (such as
	// `MYSQL_5_7` / `POSTGRES_9_6`).
	//
	// Possible values:
...
// https://cloud.google.com/database-migration/docs/reference/rest/v1beta1/projects.locations.migrationJobs/generateSshScript) to produce the script that will help set up the reverse SSH tunnel, and to set up the VPC peering between the Cloud SQL private network and the
// VPC.
