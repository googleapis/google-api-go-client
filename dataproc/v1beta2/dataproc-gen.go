...
type GceClusterConfig struct {
	...
	//   "INHERIT_FROM_SUBNETWORK" - Private access to or from Google
	// Services configuration inherited from subnetowrk configuration
	//   "OUTBOUND" - Enables outbound private IPv6 access to Google
	// Services from Dataproc cluster
	//   "BIDIRECTIONAL" - Enables bidirectionl private IPv6 access between
	// Google Services and Dataproc cluster
...
// MetastoreConfig: Specifies the metastore configuration.
type MetastoreConfig struct {
	// DataprocMetastoreService: Optional. Relative resource name of an
	// existing Dataproc Metastore service.
