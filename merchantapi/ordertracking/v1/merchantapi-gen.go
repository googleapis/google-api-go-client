...
// Usage example:
//
//	import "google.golang.org/api/merchantapi/ordertracking/v1"
//	...
...
package merchantapi // import "google.golang.org/api/merchantapi/ordertracking/v1"
...
const apiId = "merchantapi:ordertracking_v1"
const apiName = "merchantapi"
const apiVersion = "ordertracking_v1"
...
func (c *AccountsOrderTrackingSignalsCreateCall) doRequest(alt string) (*http.Response, error) {
	...
	urls := googleapi.ResolveRelative(c.s.BasePath, "ordertracking/v1/{+parent}/orderTrackingSignals")
