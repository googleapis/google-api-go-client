...
type BackupRunsServicer interface {
	Get(project string, instance string, id int64) *BackupRunsGetCall
	List(project string, instance string) *BackupRunsListCall
}
...
// DatabasesDeleteCallDoer makes it easy to provide your own testable version of Do.
type DatabasesDeleteCallDoer interface {
	Do() (*Operation, error)
}
...
// DatabasesGetCallDoer makes it easy to provide your own testable version of Do.
type DatabasesGetCallDoer interface {
	Do() (*Database, error)
}
...
// DatabasesInsertCallDoer makes it easy to provide your own testable version of Do.
type DatabasesInsertCallDoer interface {
	Do() (*Operation, error)
}
...
// DatabasesListCallDoer makes it easy to provide your own testable version of Do.
type DatabasesListCallDoer interface {
	Do() (*DatabasesListResponse, error)
}
...
// DatabasesPatchCallDoer makes it easy to provide your own testable version of Do.
type DatabasesPatchCallDoer interface {
	Do() (*Operation, error)
}
...
// DatabasesUpdateCallDoer makes it easy to provide your own testable version of Do.
type DatabasesUpdateCallDoer interface {
	Do() (*Operation, error)
}
...
// DatabasesServicer makes it easy to provide your own testable versions of DatabasesService.
type DatabasesServicer interface {
	Delete(project string, instance string, database string) *DatabasesDeleteCall
	Get(project string, instance string, database string) *DatabasesGetCall
	Insert(project string, instance string, database *Database) *DatabasesInsertCall
	List(project string, instance string) *DatabasesListCall
	Patch(project string, instance string, database string, database2 *Database) *DatabasesPatchCall
	Update(project string, instance string, database string, database2 *Database) *DatabasesUpdateCall
}
...
// InstancesStartReplicaCallDoer makes it easy to provide your own testable version of Do.
type InstancesStartReplicaCallDoer interface {
	Do() (*Operation, error)
}
...
// InstancesStopReplicaCallDoer makes it easy to provide your own testable version of Do.
type InstancesStopReplicaCallDoer interface {
	Do() (*Operation, error)
}
...
type InstancesServicer interface {
	Clone(project string, instance string, instancesclonerequest *InstancesCloneRequest) *InstancesCloneCall
	Delete(project string, instance string) *InstancesDeleteCall
	Export(project string, instance string, instancesexportrequest *InstancesExportRequest) *InstancesExportCall
	Get(project string, instance string) *InstancesGetCall
	Import(project string, instance string, instancesimportrequest *InstancesImportRequest) *InstancesImportCall
	Insert(project string, databaseinstance *DatabaseInstance) *InstancesInsertCall
	List(project string) *InstancesListCall
	Patch(project string, instance string, databaseinstance *DatabaseInstance) *InstancesPatchCall
	PromoteReplica(project string, instance string) *InstancesPromoteReplicaCall
	ResetSslConfig(project string, instance string) *InstancesResetSslConfigCall
	Restart(project string, instance string) *InstancesRestartCall
	RestoreBackup(project string, instance string, instancesrestorebackuprequest *InstancesRestoreBackupRequest) *InstancesRestoreBackupCall
	StartReplica(project string, instance string) *InstancesStartReplicaCall
	StopReplica(project string, instance string) *InstancesStopReplicaCall
	Update(project string, instance string, databaseinstance *DatabaseInstance) *InstancesUpdateCall
}
...
type OperationsServicer interface {
	...
	List(project string, instance string) *OperationsListCall
}
...
type SslCertsServicer interface {
	Delete(project string, instance string, sha1Fingerprint string) *SslCertsDeleteCall
	Get(project string, instance string, sha1Fingerprint string) *SslCertsGetCall
	Insert(project string, instance string, sslcertsinsertrequest *SslCertsInsertRequest) *SslCertsInsertCall
	List(project string, instance string) *SslCertsListCall
}
...
type TiersServicer interface {
	List(project string) *TiersListCall
}
...
// UsersUpdateCallDoer makes it easy to provide your own testable version of Do.
type UsersUpdateCallDoer interface {
	Do() (*Operation, error)
}
...
type UsersServicer interface {
	Delete(project string, instance string, host string, name string) *UsersDeleteCall
	Insert(project string, instance string, user *User) *UsersInsertCall
	List(project string, instance string) *UsersListCall
	Update(project string, instance string, host string, name string, user *User) *UsersUpdateCall
}
