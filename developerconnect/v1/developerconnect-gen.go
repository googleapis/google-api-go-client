...
type ProjectsLocationsConnectionsProcessGitLabEnterpriseWebhookCall struct {
	s                                     *Service
	parent                                string
...
//   - parent: Project and location where the webhook will be received. Format:
//     `projects/*/locations/*`.
func (r *ProjectsLocationsConnectionsService) ProcessGitLabEnterpriseWebhook(parent string, processgitlabenterprisewebhookrequest *ProcessGitLabEnterpriseWebhookRequest) *ProjectsLocationsConnectionsProcessGitLabEnterpriseWebhookCall {
	c := &ProjectsLocationsConnectionsProcessGitLabEnterpriseWebhookCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.parent = parent
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse for more
// details.
func (c *ProjectsLocationsConnectionsProcessGitLabEnterpriseWebhookCall) Fields(s ...googleapi.Field) *ProjectsLocationsConnectionsProcessGitLabEnterpriseWebhookCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}

// Context sets the context to be used in this call's Do method.
func (c *ProjectsLocationsConnectionsProcessGitLabEnterpriseWebhookCall) Context(ctx context.Context) *ProjectsLocationsConnectionsProcessGitLabEnterpriseWebhookCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns a http.Header that can be modified by the caller to add
// headers to the request.
func (c *ProjectsLocationsConnectionsProcessGitLabEnterpriseWebhookCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *ProjectsLocationsConnectionsProcessGitLabEnterpriseWebhookCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	var body io.Reader = nil
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/{+parent}/connections:processGitLabEnterpriseWebhook")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
// Do executes the "developerconnect.projects.locations.connections.processGitLabEnterpriseWebhook" call.
// Any non-2xx status code is an error. Response headers are in either
// *Empty.ServerResponse.Header or (if a response was returned at all) in
// error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
func (c *ProjectsLocationsConnectionsProcessGitLabEnterpriseWebhookCall) Do(opts ...googleapi.CallOption) (*Empty, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
...
type ProjectsLocationsConnectionsProcessGitLabWebhookCall struct {
	s                           *Service
	parent                      string
...
//   - parent: Project and location where the webhook will be received. Format:
//     `projects/*/locations/*`.
func (r *ProjectsLocationsConnectionsService) ProcessGitLabWebhook(parent string, processgitlabwebhookrequest *ProcessGitLabWebhookRequest) *ProjectsLocationsConnectionsProcessGitLabWebhookCall {
	c := &ProjectsLocationsConnectionsProcessGitLabWebhookCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.parent = parent
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse for more
// details.
func (c *ProjectsLocationsConnectionsProcessGitLabWebhookCall) Fields(s ...googleapi.Field) *ProjectsLocationsConnectionsProcessGitLabWebhookCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}

// Context sets the context to be used in this call's Do method.
func (c *ProjectsLocationsConnectionsProcessGitLabWebhookCall) Context(ctx context.Context) *ProjectsLocationsConnectionsProcessGitLabWebhookCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns a http.Header that can be modified by the caller to add
// headers to the request.
func (c *ProjectsLocationsConnectionsProcessGitLabWebhookCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *ProjectsLocationsConnectionsProcessGitLabWebhookCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	var body io.Reader = nil
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/{+parent}/connections:processGitLabWebhook")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
// Do executes the "developerconnect.projects.locations.connections.processGitLabWebhook" call.
// Any non-2xx status code is an error. Response headers are in either
// *Empty.ServerResponse.Header or (if a response was returned at all) in
// error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
func (c *ProjectsLocationsConnectionsProcessGitLabWebhookCall) Do(opts ...googleapi.CallOption) (*Empty, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
