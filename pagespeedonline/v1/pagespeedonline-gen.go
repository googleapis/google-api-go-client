...
// DoHeader executes the "pagespeedonline.pagespeedapi.runpagespeed" call.
...
func (c *PagespeedapiRunpagespeedCall) DoHeader() (ret *Result, resHeader http.Header, err error) {
