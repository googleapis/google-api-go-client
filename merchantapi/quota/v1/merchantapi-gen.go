...
// Usage example:
//
//	import "google.golang.org/api/merchantapi/quota/v1"
//	...
...
package merchantapi // import "google.golang.org/api/merchantapi/quota/v1"
...
const apiId = "merchantapi:quota_v1"
const apiName = "merchantapi"
const apiVersion = "quota_v1"
...
func NewAccountsLimitsService(s *Service) *AccountsLimitsService {
...
func (c *AccountsLimitsGetCall) doRequest(alt string) (*http.Response, error) {
	...
	urls := googleapi.ResolveRelative(c.s.BasePath, "quota/v1/{+name}")
...
func (c *AccountsLimitsListCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "quota/v1/{+parent}/limits")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("GET", urls, nil)
	if err != nil {
		return nil, err
...
func (c *AccountsQuotasListCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "quota/v1/{+parent}/quotas")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("GET", urls, nil)
	if err != nil {
		return nil, err
