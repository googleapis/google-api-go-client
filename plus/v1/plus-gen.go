...
type ActivitiesServicer interface {
	Get(activityId string) *ActivitiesGetCall
	List(userId string, collection string) *ActivitiesListCall
	Search(query string) *ActivitiesSearchCall
}
...
type CommentsServicer interface {
	Get(commentId string) *CommentsGetCall
	List(activityId string) *CommentsListCall
}
...
type MomentsServicer interface {
	Insert(userId string, collection string, moment *Moment) *MomentsInsertCall
	List(userId string, collection string) *MomentsListCall
	Remove(id string) *MomentsRemoveCall
}
...
type PeopleServicer interface {
	Get(userId string) *PeopleGetCall
	List(userId string, collection string) *PeopleListCall
	ListByActivity(activityId string, collection string) *PeopleListByActivityCall
	Search(query string) *PeopleSearchCall
}
