...
// Usage example:
//
//	import "google.golang.org/api/merchantapi/lfp/v1"
//	...
...
package merchantapi // import "google.golang.org/api/merchantapi/lfp/v1"
...
const apiId = "merchantapi:lfp_v1"
const apiName = "merchantapi"
const apiVersion = "lfp_v1"
...
func (c *AccountsLfpInventoriesInsertCall) doRequest(alt string) (*http.Response, error) {
	...
	urls := googleapi.ResolveRelative(c.s.BasePath, "lfp/v1/{+parent}/lfpInventories:insert")
...
func (c *AccountsLfpMerchantStatesGetCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "lfp/v1/{+name}")
	urls += "?" + c.urlParams_.Encode()
...
func (c *AccountsLfpSalesInsertCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "lfp/v1/{+parent}/lfpSales:insert")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
func (c *AccountsLfpStoresInsertCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "lfp/v1/{+parent}/lfpStores:insert")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
func (c *AccountsLfpStoresListCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "lfp/v1/{+parent}/lfpStores")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("GET", urls, nil)
	if err != nil {
		return nil, err
