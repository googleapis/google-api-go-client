...
// is cancelled.
func (c *SearchanalyticsQueryCall) Ctx(ctx context.Context) *SearchanalyticsQueryCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *SitemapsDeleteCall) Ctx(ctx context.Context) *SitemapsDeleteCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *SitemapsGetCall) Ctx(ctx context.Context) *SitemapsGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *SitemapsListCall) Ctx(ctx context.Context) *SitemapsListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *SitemapsSubmitCall) Ctx(ctx context.Context) *SitemapsSubmitCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *SitesAddCall) Ctx(ctx context.Context) *SitesAddCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *SitesDeleteCall) Ctx(ctx context.Context) *SitesDeleteCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *UrlcrawlerrorscountsQueryCall) Ctx(ctx context.Context) *UrlcrawlerrorscountsQueryCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *UrlcrawlerrorssamplesGetCall) Ctx(ctx context.Context) *UrlcrawlerrorssamplesGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *UrlcrawlerrorssamplesListCall) Ctx(ctx context.Context) *UrlcrawlerrorssamplesListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *UrlcrawlerrorssamplesMarkAsFixedCall) Ctx(ctx context.Context) *UrlcrawlerrorssamplesMarkAsFixedCall {
	c.ctx_ = ctx
	return c
}
