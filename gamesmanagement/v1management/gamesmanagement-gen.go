...
type AchievementsServicer interface {
	Reset(achievementId string) *AchievementsResetCall
	ResetAll() *AchievementsResetAllCall
	ResetAllForAllPlayers() *AchievementsResetAllForAllPlayersCall
	ResetForAllPlayers(achievementId string) *AchievementsResetForAllPlayersCall
	ResetMultipleForAllPlayers(achievementresetmultipleforallrequest *AchievementResetMultipleForAllRequest) *AchievementsResetMultipleForAllPlayersCall
}
...
type ApplicationsServicer interface {
	ListHidden(applicationId string) *ApplicationsListHiddenCall
}
...
type EventsServicer interface {
	Reset(eventId string) *EventsResetCall
	ResetAll() *EventsResetAllCall
	ResetAllForAllPlayers() *EventsResetAllForAllPlayersCall
	ResetForAllPlayers(eventId string) *EventsResetForAllPlayersCall
	ResetMultipleForAllPlayers(eventsresetmultipleforallrequest *EventsResetMultipleForAllRequest) *EventsResetMultipleForAllPlayersCall
}
...
type PlayersServicer interface {
	Hide(applicationId string, playerId string) *PlayersHideCall
	Unhide(applicationId string, playerId string) *PlayersUnhideCall
}
...
type QuestsServicer interface {
	Reset(questId string) *QuestsResetCall
	ResetAll() *QuestsResetAllCall
	ResetAllForAllPlayers() *QuestsResetAllForAllPlayersCall
	ResetForAllPlayers(questId string) *QuestsResetForAllPlayersCall
	ResetMultipleForAllPlayers(questsresetmultipleforallrequest *QuestsResetMultipleForAllRequest) *QuestsResetMultipleForAllPlayersCall
}
...
type RoomsServicer interface {
	Reset() *RoomsResetCall
	ResetForAllPlayers() *RoomsResetForAllPlayersCall
}
...
type ScoresServicer interface {
	Reset(leaderboardId string) *ScoresResetCall
	ResetAll() *ScoresResetAllCall
	ResetAllForAllPlayers() *ScoresResetAllForAllPlayersCall
	ResetForAllPlayers(leaderboardId string) *ScoresResetForAllPlayersCall
	ResetMultipleForAllPlayers(scoresresetmultipleforallrequest *ScoresResetMultipleForAllRequest) *ScoresResetMultipleForAllPlayersCall
}
...
type TurnBasedMatchesServicer interface {
	Reset() *TurnBasedMatchesResetCall
	ResetForAllPlayers() *TurnBasedMatchesResetForAllPlayersCall
}
