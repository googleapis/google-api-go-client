...
func (c *DatasetsAllocateIdsCall) DoHeader() (*AllocateIdsResponse, http.Header, error) {
...
func (c *DatasetsBeginTransactionCall) DoHeader() (*BeginTransactionResponse, http.Header, error) {
	var body io.Reader = nil
...
func (c *DatasetsCommitCall) DoHeader() (*CommitResponse, http.Header, error) {
	var body io.Reader = nil
...
func (c *DatasetsLookupCall) DoHeader() (*LookupResponse, http.Header, error) {
	var body io.Reader = nil
...
func (c *DatasetsRollbackCall) DoHeader() (*RollbackResponse, http.Header, error) {
	var body io.Reader = nil
...
func (c *DatasetsRunQueryCall) DoHeader() (*RunQueryResponse, http.Header, error) {
	var body io.Reader = nil
