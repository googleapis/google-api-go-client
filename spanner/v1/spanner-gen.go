...
type Instance struct {
	...
	// `READY`. See the documentation for more information about nodes.
...
type ReplicaInfo struct {
	...
	// region types documentation for more details.
...
type Session struct {
	...
	// expression: `a-z?`. * Label values must be between 0 and 63
