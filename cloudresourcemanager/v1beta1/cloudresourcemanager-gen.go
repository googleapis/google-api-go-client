...
type ProjectsServicer interface {
	Create(project *Project) *ProjectsCreateCall
	Delete(projectId string) *ProjectsDeleteCall
	Get(projectId string) *ProjectsGetCall
	List() *ProjectsListCall
	Undelete(projectId string) *ProjectsUndeleteCall
	Update(projectId string, project *Project) *ProjectsUpdateCall
}
