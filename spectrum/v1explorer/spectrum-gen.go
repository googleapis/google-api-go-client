...
func (c *PawsGetSpectrumCall) Do() (ret *PawsGetSpectrumResponse, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
func (c *PawsGetSpectrumCall) DoHeader() (ret *PawsGetSpectrumResponse, resHeader http.Header, err error) {
...
// Do performs a round-trip call to the server.
func (c *PawsGetSpectrumBatchCall) Do() (ret *PawsGetSpectrumBatchResponse, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// regardless of the status code returned. This can be useful for checking for
// header values such as "Etag" even when http.StatusNotModified is returned.
func (c *PawsGetSpectrumBatchCall) DoHeader() (ret *PawsGetSpectrumBatchResponse, resHeader http.Header, err error) {
	var body io.Reader = nil
...
// Do performs a round-trip call to the server.
func (c *PawsInitCall) Do() (ret *PawsInitResponse, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// regardless of the status code returned. This can be useful for checking for
// header values such as "Etag" even when http.StatusNotModified is returned.
func (c *PawsInitCall) DoHeader() (ret *PawsInitResponse, resHeader http.Header, err error) {
	var body io.Reader = nil
...
// Do performs a round-trip call to the server.
func (c *PawsNotifySpectrumUseCall) Do() (ret *PawsNotifySpectrumUseResponse, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// regardless of the status code returned. This can be useful for checking for
// header values such as "Etag" even when http.StatusNotModified is returned.
func (c *PawsNotifySpectrumUseCall) DoHeader() (ret *PawsNotifySpectrumUseResponse, resHeader http.Header, err error) {
	var body io.Reader = nil
...
// Do performs a round-trip call to the server.
func (c *PawsRegisterCall) Do() (ret *PawsRegisterResponse, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// regardless of the status code returned. This can be useful for checking for
// header values such as "Etag" even when http.StatusNotModified is returned.
func (c *PawsRegisterCall) DoHeader() (ret *PawsRegisterResponse, resHeader http.Header, err error) {
	var body io.Reader = nil
...
// Do performs a round-trip call to the server.
func (c *PawsVerifyDeviceCall) Do() (ret *PawsVerifyDeviceResponse, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// regardless of the status code returned. This can be useful for checking for
// header values such as "Etag" even when http.StatusNotModified is returned.
func (c *PawsVerifyDeviceCall) DoHeader() (ret *PawsVerifyDeviceResponse, resHeader http.Header, err error) {
	var body io.Reader = nil
