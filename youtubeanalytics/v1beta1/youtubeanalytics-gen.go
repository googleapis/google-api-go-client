...
func (c *BatchReportDefinitionsListCall) DoHeader() (http.Header, *BatchReportDefinitionList, error) {
...
func (c *BatchReportsListCall) DoHeader() (http.Header, *BatchReportList, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *GroupItemsInsertCall) DoHeader() (http.Header, *GroupItem, error) {
	var body io.Reader = nil
...
func (c *GroupItemsListCall) DoHeader() (http.Header, *GroupItemListResponse, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *GroupsInsertCall) DoHeader() (http.Header, *Group, error) {
	var body io.Reader = nil
...
func (c *GroupsListCall) DoHeader() (http.Header, *GroupListResponse, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *GroupsUpdateCall) DoHeader() (http.Header, *Group, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.group)
	if err != nil {
		return nil, nil, err
...
func (c *ReportsQueryCall) DoHeader() (http.Header, *ResultTable, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
