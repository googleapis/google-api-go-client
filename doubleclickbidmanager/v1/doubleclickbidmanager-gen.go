...
// is cancelled.
func (c *LineitemsDownloadlineitemsCall) Ctx(ctx context.Context) *LineitemsDownloadlineitemsCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *LineitemsUploadlineitemsCall) Ctx(ctx context.Context) *LineitemsUploadlineitemsCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *QueriesCreatequeryCall) Ctx(ctx context.Context) *QueriesCreatequeryCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *QueriesDeletequeryCall) Ctx(ctx context.Context) *QueriesDeletequeryCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *QueriesGetqueryCall) Ctx(ctx context.Context) *QueriesGetqueryCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *QueriesListqueriesCall) Ctx(ctx context.Context) *QueriesListqueriesCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *QueriesRunqueryCall) Ctx(ctx context.Context) *QueriesRunqueryCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ReportsListreportsCall) Ctx(ctx context.Context) *ReportsListreportsCall {
	c.ctx_ = ctx
	return c
}
