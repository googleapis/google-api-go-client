...
// is cancelled.
func (c *ProjectsLogServicesListCall) Ctx(ctx context.Context) *ProjectsLogServicesListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsLogServicesIndexesListCall) Ctx(ctx context.Context) *ProjectsLogServicesIndexesListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsLogServicesSinksCreateCall) Ctx(ctx context.Context) *ProjectsLogServicesSinksCreateCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsLogServicesSinksDeleteCall) Ctx(ctx context.Context) *ProjectsLogServicesSinksDeleteCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsLogServicesSinksGetCall) Ctx(ctx context.Context) *ProjectsLogServicesSinksGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsLogServicesSinksListCall) Ctx(ctx context.Context) *ProjectsLogServicesSinksListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsLogServicesSinksUpdateCall) Ctx(ctx context.Context) *ProjectsLogServicesSinksUpdateCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsLogsDeleteCall) Ctx(ctx context.Context) *ProjectsLogsDeleteCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsLogsListCall) Ctx(ctx context.Context) *ProjectsLogsListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsLogsEntriesWriteCall) Ctx(ctx context.Context) *ProjectsLogsEntriesWriteCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsLogsSinksCreateCall) Ctx(ctx context.Context) *ProjectsLogsSinksCreateCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsLogsSinksDeleteCall) Ctx(ctx context.Context) *ProjectsLogsSinksDeleteCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsLogsSinksGetCall) Ctx(ctx context.Context) *ProjectsLogsSinksGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsLogsSinksListCall) Ctx(ctx context.Context) *ProjectsLogsSinksListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsLogsSinksUpdateCall) Ctx(ctx context.Context) *ProjectsLogsSinksUpdateCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsSinksCreateCall) Ctx(ctx context.Context) *ProjectsSinksCreateCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsSinksDeleteCall) Ctx(ctx context.Context) *ProjectsSinksDeleteCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsSinksGetCall) Ctx(ctx context.Context) *ProjectsSinksGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsSinksListCall) Ctx(ctx context.Context) *ProjectsSinksListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsSinksUpdateCall) Ctx(ctx context.Context) *ProjectsSinksUpdateCall {
	c.ctx_ = ctx
	return c
}
