...
func (c *DeploymentsDeleteCall) DoHeader() (*Operation, http.Header, error) {
...
func (c *DeploymentsInsertCall) DoHeader() (*Operation, http.Header, error) {
	var body io.Reader = nil
...
func (c *DeploymentsPatchCall) DoHeader() (*Operation, http.Header, error) {
	var body io.Reader = nil
...
func (c *DeploymentsUpdateCall) DoHeader() (*Operation, http.Header, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.deployment2)
	if err != nil {
		return nil, nil, err
...
func (c *ManifestsGetCall) DoHeader() (*Manifest, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *ManifestsListCall) DoHeader() (*ManifestsListResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["filter"]; ok {
...
func (c *OperationsGetCall) DoHeader() (*Operation, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *OperationsListCall) DoHeader() (*OperationsListResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["filter"]; ok {
...
func (c *ResourcesGetCall) DoHeader() (*Resource, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *ResourcesListCall) DoHeader() (*ResourcesListResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["filter"]; ok {
...
func (c *TypesListCall) DoHeader() (*TypesListResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["filter"]; ok {
