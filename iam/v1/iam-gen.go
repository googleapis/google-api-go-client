...
//
// Previously issued Access tokens for a service account will be
// rejected
// while the service account is disabled but will start working again if
// the
// account is re-enabled. Issuance of new tokens will fail while the
// account
// is disabled.
//
