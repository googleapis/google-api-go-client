...
const basePathTemplate = "https://proximitybeacon.UNIVERSE_DOMAIN/"
...
// AdvertisedId: Defines a unique identifier of a beacon as broadcast by the
// device.
type AdvertisedId struct {
	// Id: The actual beacon identifier, as broadcast by the beacon hardware. Must
	// be
	...
	// base64
	// encoding should be of the binary byte-stream and not any textual (such
	// as
...
type AttachmentInfo struct {
	...
	// NamespacedType: Specifies what kind of attachment this is. Tells a client
	// how to
...
type Beacon struct {
	// AdvertisedId: The identifier of a beacon as advertised by it. This field
	// must be
	...
	// Description: Free text used to identify and describe the beacon. Maximum
	// length 140
	// characters.
	// Optional.
	Description string `json:"description,omitempty"`
	// EphemeralIdRegistration: Write-only registration parameters for beacons
	// using Eddystone-EID
	...
	// ExpectedStability: Expected location stability. This is set when the beacon
	// is registered or
	...
	// IndoorLevel: The indoor level information for this beacon, if known. As
	// returned by the
	// Google Maps API.
	// Optional.
	IndoorLevel *IndoorLevel `json:"indoorLevel,omitempty"`
	// LatLng: The location of the beacon, expressed as a latitude and longitude
	// pair.
	...
	// PlaceId: The Google Places API (/places/place-id) Place ID of the place
	// where
	...
	// Properties: Properties of the beacon device, for example battery type or
	// firmware
	// version.
	// Optional.
	Properties map[string]string `json:"properties,omitempty"`
	// ProvisioningKey: Some beacons may require a user to provide an authorization
	// key before
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AdvertisedId") to include in API
...
type BeaconAttachment struct {
	// AttachmentName: Resource name of this attachment. Attachment names have the
	// format:
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AttachmentName") to include in
...
type DeleteAttachmentsResponse struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "NumDeleted") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type Diagnostics struct {
	...
	//   "WRONG_LOCATION" - The beacon has been reported far from its expected
	// location (the beacon's
	...
	//   "LOW_BATTERY" - The battery level for the beacon is low enough that, given
	// the beacon's
	// current use, its battery will run out with in the next 60 days.
	// This
	// indicates that the battery should be replaced soon.
	//   "LOW_ACTIVITY" - The beacon has been reported at a very low rate or not at
	// all. This may
	...
	// BeaconName: Resource name of the beacon. For Eddystone-EID beacons, this
	// may
	// be the beacon's current EID, or the beacon's "stable" Eddystone-UID.
	BeaconName string `json:"beaconName,omitempty"`
	// EstimatedLowBatteryDate: The date when the battery is expected to be low. If
...
type EphemeralIdRegistration struct {
	// BeaconEcdhPublicKey: The beacon's public key used for the Elliptic curve
	// Diffie-Hellman
	...
	// InitialClockValue: The initial clock value of the beacon. The beacon's clock
	// must have
	...
	// RotationPeriodExponent: Indicates the nominal period between each rotation
	// of the beacon's
	...
	// ServiceEcdhPublicKey: The service's public key used for the Elliptic curve
	// Diffie-Hellman
	// key exchange. When this field is populated, `beacon_ecdh_public_key`
	// must also be populated, and `beacon_identity_key` must not be.
	ServiceEcdhPublicKey string `json:"serviceEcdhPublicKey,omitempty"`
	// ForceSendFields is a list of field names (e.g. "BeaconEcdhPublicKey") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "BeaconEcdhPublicKey") to include
...
// EphemeralIdRegistrationParams: Information a client needs to provision and
// register beacons that
...
type EphemeralIdRegistrationParams struct {
	// MaxRotationPeriodExponent: Indicates the maximum rotation period supported
	// by the service.
	// See
	...
	// MinRotationPeriodExponent: Indicates the minimum rotation period supported
	// by the service.
	// See
	// EddystoneEidRegistration.rotation_period_exponent
	MinRotationPeriodExponent int64 `json:"minRotationPeriodExponent,omitempty"`
	// ServiceEcdhPublicKey: The beacon service's public key for use by a beacon to
	// derive its
	...
	// ServerResponse contains the HTTP response code and headers from the server.
	googleapi.ServerResponse `json:"-"`
	// ForceSendFields is a list of field names (e.g. "MaxRotationPeriodExponent")
	// to unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "MaxRotationPeriodExponent") to
...
type GetInfoForObservedBeaconsRequest struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "NamespacedTypes") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// GetInfoForObservedBeaconsResponse: Information about the requested beacons,
// optionally including attachment
// data.
type GetInfoForObservedBeaconsResponse struct {
	...
	// ServerResponse contains the HTTP response code and headers from the server.
	googleapi.ServerResponse `json:"-"`
	// ForceSendFields is a list of field names (e.g. "Beacons") to unconditionally
	// include in API requests. By default, fields with empty or default values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "Beacons") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// IndoorLevel: Indoor level, a human-readable string as returned by Google
// Maps APIs,
...
type ListBeaconsResponse struct {
	...
	// NextPageToken: An opaque pagination token that the client may provide in
	// their next
	// request to retrieve the next page of results.
	NextPageToken string `json:"nextPageToken,omitempty"`
	// TotalCount: Estimate of the total number of beacons matched by the query.
	// Higher
...
type ListDiagnosticsResponse struct {
	...
	// NextPageToken: Token that can be used for pagination. Returned only if
	// the
...
// ListNamespacesResponse: Response to ListNamespacesRequest that contains all
...
// Namespace: An attachment namespace defines read and write access for all the
// attachments
...
type Namespace struct {
	// NamespaceName: Resource name of this namespace. Namespaces names have the
	// format:
	// <code>namespaces/<var>namespace</var></code>.
	NamespaceName string `json:"namespaceName,omitempty"`
	// ServingVisibility: Specifies what clients may receive attachments under this
	// namespace
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "NamespaceName") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type Observation struct {
	...
	// must be authorized to resolve the given beacon. Otherwise no data will
	// be
	// returned for that beacon.
	// Required.
	AdvertisedId *AdvertisedId `json:"advertisedId,omitempty"`
	// Telemetry: The array of telemetry bytes received from the beacon. The server
	// is
...
// Getforobserved: Given one or more beacon observations, returns any beacon
// information
// and attachments accessible to your application. Authorize by using
// the
// API
// key
// (https://developers.google.com/beacons/proximity/get-started#request_a_browser_api_key)
// for the application.
...
// *GetInfoForObservedBeaconsResponse.ServerResponse.Header or (if a response
...
// beacon to activate. If the project id is not
...
// ProjectId sets the optional parameter "projectId": The project id of the
// beacon to deactivate. If the project id is not
// specified then the project making the request is used. The project id
// must
...
// Decommission: Decommissions the specified beacon in the service. This beacon
// will no
...
// ProjectId sets the optional parameter "projectId": The project id of the
// beacon to decommission. If the project id is not
// specified then the project making the request is used. The project id
// must match the project that owns the beacon.
...
// Delete: Deletes the specified beacon including all diagnostics data for the
// beacon
...
// ProjectId sets the optional parameter "projectId": The project id of the
// beacon to delete. If not provided, the project
...
// ProjectId sets the optional parameter "projectId": The project id of the
// beacon to request. If the project id is not specified
...
// Any non-2xx status code is an error. Response headers are in either
// *Beacon.ServerResponse.Header or (if a response was returned at all) in
// error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
...
// records to return for this request, up to a
...
// ProjectId sets the optional parameter "projectId": The project id to list
// beacons under. If not present then the project
...
// Q sets the optional parameter "q": Filter query string that supports the
// following field filters:
//
//   - **description:"<string>"**
...
// Any non-2xx status code is an error. Response headers are in either
// *ListBeaconsResponse.ServerResponse.Header or (if a response was returned at
...
// ProjectId sets the optional parameter "projectId": The project id of the
// project the beacon will be registered to. If
...
// Update: Updates the information about the specified beacon. **Any field that
// you do
...
// ProjectId sets the optional parameter "projectId": The project id of the
// beacon to update. If the project id is not
// specified then the project making the request is used. The project id
// must match the project that owns the beacon.
...
// BatchDelete: Deletes multiple attachments on a given beacon. This operation
// is
...
// Developers Console project.
//
//   - beaconName: The beacon whose attachments should be deleted. A beacon name
//     has the
//     format "beacons/N!beaconId" where the beaconId is the base16 ID
//     broadcast
//     by the beacon and N is a code for the beacon's type. Possible values
//     are
//     `3` for Eddystone-UID, `4` for Eddystone-EID, `1` for iBeacon, or `5`
//     for AltBeacon. For Eddystone-EID beacons, you may use either the
//     current EID or the beacon's "stable" UID.
...
// NamespacedType sets the optional parameter "namespacedType": Specifies the
// namespace and type of attachments to delete in
...
// ProjectId sets the optional parameter "projectId": The project id to delete
// beacon attachments under. This field can be
...
// Any non-2xx status code is an error. Response headers are in either
// *DeleteAttachmentsResponse.ServerResponse.Header or (if a response was
...
// Create: Associates the given data with the specified beacon. Attachment data
// must
// contain two parts:
// <ul>
...
// ProjectId sets the optional parameter "projectId": The project id of the
// project the attachment will belong to. If
// the project id is not specified then the project making the request
// is used.
...
// Any non-2xx status code is an error. Response headers are in either
// *BeaconAttachment.ServerResponse.Header or (if a response was returned at
// all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified was
// returned.
...
// ProjectId sets the optional parameter "projectId": The project id of the
// attachment to delete. If not provided, the project
// that is making the request is used.
...
// the Google Developers Console project.
//
//   - beaconName: Beacon whose attachments should be fetched. A beacon name has
//     the
//     format "beacons/N!beaconId" where the beaconId is the base16 ID
//     broadcast
//     by the beacon and N is a code for the beacon's type. Possible values
...
// NamespacedType sets the optional parameter "namespacedType": Specifies the
// namespace and type of attachment to include in response
// in
...
// Any non-2xx status code is an error. Response headers are in either
// *ListBeaconAttachmentsResponse.ServerResponse.Header or (if a response was
// returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
...
// AlertFilter sets the optional parameter "alertFilter": Requests only beacons
// that have the given alert. For example, to find
...
// PageToken sets the optional parameter "pageToken": Requests results that
// occur after the `page_token`, obtained from the
...
// ProjectId sets the optional parameter "projectId": Requests only diagnostic
// records for the given project id. If not set,
...
// Update: Updates the information about the specified namespace. Only the
// namespace
...
// ProjectId sets the optional parameter "projectId": The project id of the
// namespace to update. If the project id is not
// specified then the project making the request is used. The project id
// must match the project that owns the beacon.
...
// Any non-2xx status code is an error. Response headers are in either
// *EphemeralIdRegistrationParams.ServerResponse.Header or (if a response was
// returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
