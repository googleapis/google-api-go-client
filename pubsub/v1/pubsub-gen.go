...
// is cancelled.
func (c *ProjectsSubscriptionsAcknowledgeCall) Ctx(ctx context.Context) {
	c.ctx_ = ctx
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsSubscriptionsCreateCall) Ctx(ctx context.Context) {
	c.ctx_ = ctx
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsSubscriptionsDeleteCall) Ctx(ctx context.Context) {
	c.ctx_ = ctx
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsSubscriptionsGetCall) Ctx(ctx context.Context) {
	c.ctx_ = ctx
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsSubscriptionsGetIamPolicyCall) Ctx(ctx context.Context) {
	c.ctx_ = ctx
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsSubscriptionsListCall) Ctx(ctx context.Context) {
	c.ctx_ = ctx
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsSubscriptionsModifyAckDeadlineCall) Ctx(ctx context.Context) {
	c.ctx_ = ctx
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsSubscriptionsModifyPushConfigCall) Ctx(ctx context.Context) {
	c.ctx_ = ctx
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsSubscriptionsPullCall) Ctx(ctx context.Context) {
	c.ctx_ = ctx
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsSubscriptionsSetIamPolicyCall) Ctx(ctx context.Context) {
	c.ctx_ = ctx
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsSubscriptionsTestIamPermissionsCall) Ctx(ctx context.Context) {
	c.ctx_ = ctx
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsTopicsCreateCall) Ctx(ctx context.Context) {
	c.ctx_ = ctx
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsTopicsDeleteCall) Ctx(ctx context.Context) {
	c.ctx_ = ctx
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsTopicsGetCall) Ctx(ctx context.Context) {
	c.ctx_ = ctx
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsTopicsGetIamPolicyCall) Ctx(ctx context.Context) {
	c.ctx_ = ctx
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsTopicsListCall) Ctx(ctx context.Context) {
	c.ctx_ = ctx
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsTopicsPublishCall) Ctx(ctx context.Context) {
	c.ctx_ = ctx
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsTopicsSetIamPolicyCall) Ctx(ctx context.Context) {
	c.ctx_ = ctx
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsTopicsTestIamPermissionsCall) Ctx(ctx context.Context) {
	c.ctx_ = ctx
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ProjectsTopicsSubscriptionsListCall) Ctx(ctx context.Context) {
	c.ctx_ = ctx
}
