...
type PoolsServicer interface {
	Delete(projectName string, zone string, poolName string, poolsdeleterequest *PoolsDeleteRequest) *PoolsDeleteCall
	Get(projectName string, zone string, poolName string) *PoolsGetCall
	Insert(projectName string, zone string, pool *Pool) *PoolsInsertCall
	List(projectName string, zone string) *PoolsListCall
	Resize(projectName string, zone string, poolName string) *PoolsResizeCall
	Updatetemplate(projectName string, zone string, poolName string, template *Template) *PoolsUpdatetemplateCall
}
...
type ReplicasServicer interface {
	Delete(projectName string, zone string, poolName string, replicaName string, replicasdeleterequest *ReplicasDeleteRequest) *ReplicasDeleteCall
	Get(projectName string, zone string, poolName string, replicaName string) *ReplicasGetCall
	List(projectName string, zone string, poolName string) *ReplicasListCall
	Restart(projectName string, zone string, poolName string, replicaName string) *ReplicasRestartCall
}
