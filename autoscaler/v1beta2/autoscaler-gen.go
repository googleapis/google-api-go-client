...
func (c *AutoscalersDeleteCall) DoHeader() (*Operation, http.Header, error) {
...
func (c *AutoscalersGetCall) DoHeader() (*Autoscaler, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *AutoscalersInsertCall) DoHeader() (*Operation, http.Header, error) {
	var body io.Reader = nil
...
func (c *AutoscalersListCall) DoHeader() (*AutoscalerListResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *AutoscalersPatchCall) DoHeader() (*Operation, http.Header, error) {
	var body io.Reader = nil
...
func (c *AutoscalersUpdateCall) DoHeader() (*Operation, http.Header, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.autoscaler2)
	if err != nil {
		return nil, nil, err
