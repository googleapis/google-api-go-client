...
// or in sequential chunks.  Either r or rb will be non-nil.
// After PrepareUpload has been called, media should no longer be used.  The media content should be accessed either via r or rb.
func PrepareUpload(media io.Reader, chunkSize int) (r io.Reader, rb *ResumableBuffer) {
