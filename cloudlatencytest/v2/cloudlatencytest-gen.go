...
func (c *StatscollectionUpdateaggregatedstatsCall) DoHeader() (http.Header, *AggregatedStatsReply, error) {
...
func (c *StatscollectionUpdatestatsCall) DoHeader() (http.Header, *StatsReply, error) {
	var body io.Reader = nil
