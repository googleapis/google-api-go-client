...
type ApproveEntitlementPlanChangeRequest struct {
	// PendingPlanName: Required. Name of the pending plan that is being approved.
...
type Entitlement struct {
	...
	// If this entitlement was not cancelled, this field will be empty. Possible
	// values include "unknown", "expired", "user-cancelled", "account-closed",
	...
	// empty. This field will be populated even if the entitlement is not active
	// yet. If there is no upcoming offer, the field will be empty.
	NewOfferEndTime string `json:"newOfferEndTime,omitempty"`
	// NewOfferStartTime: Output only. The timestamp when the new offer will become
	// effective. This field will be populated even if the entitlement is not
	// active yet. If there is no upcoming offer, the field will be empty.
	...
	// change is moving to an offer. This field is not populated for entitlements
	// which are not active yet. Format:
	...
	// NewPendingOfferDuration: Output only. The offer duration of the new offer in
	// ISO 8601 duration format. This field is not populated for entitlements which
	// are not active yet, only for pending offer changes. If the offer was created
