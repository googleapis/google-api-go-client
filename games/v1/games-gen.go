...
// BatchRecordEventsRequest: Request message for
// PlayerGameEvents.BatchRecordEvents Next ID: 7
type BatchRecordEventsRequest struct {
	// DroidGuardBlob: Optional. The DroidGuard blob generated by the client. This
	// is used to detect abuse signals from the devices
	DroidGuardBlob string `json:"droidGuardBlob,omitempty"`
	// Events: Required. A list of player game events to be recorded. Maximum of 30
	// events per batch request.
	Events []*PlayerGameEvent `json:"events,omitempty"`
	// PackageName: Required. Application package name (e.g., "com.example.game").
	PackageName string `json:"packageName,omitempty"`
	// RequestTime: Required. The time from the client when this specific batch of
	// events was submitted.
	RequestTime string `json:"requestTime,omitempty"`
	// Salt: Optional. The salt used to generate content binding for the DroidGuard
	// blob. This is used to prevent replay attacks.
	Salt string `json:"salt,omitempty"`
	// ForceSendFields is a list of field names (e.g. "DroidGuardBlob") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "DroidGuardBlob") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
func (s BatchRecordEventsRequest) MarshalJSON() ([]byte, error) {
	type NoMethod BatchRecordEventsRequest
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}

// BatchRecordEventsResponse: A successful response indicates that the batch of
// events has been processed.
type BatchRecordEventsResponse struct {
	// FailedRequests: Map of failed events, keyed by their zero-based index in
	// `BatchRecordEventsRequest.events`. Omitted keys indicate successful
	// recording.
	FailedRequests map[string]Status `json:"failedRequests,omitempty"`

	// ServerResponse contains the HTTP response code and headers from the server.
	googleapi.ServerResponse `json:"-"`
	// ForceSendFields is a list of field names (e.g. "FailedRequests") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "FailedRequests") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
func (s BatchRecordEventsResponse) MarshalJSON() ([]byte, error) {
	type NoMethod BatchRecordEventsResponse
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}
...
// PlayerGameEvent: A representation of a single player game event triggered by
// a player's event in a game. This might be completing a level, unlocking an
// item, or finishing a match.
type PlayerGameEvent struct {
	// EventId: Required. A unique client-generated UUID for this specific event
	// instance. Used for server-side idempotency and deduplication. Submitting an
	// event with a previously recorded event_id for the same player will be
	// ignored.
	EventId string `json:"eventId,omitempty"`
	// EventName: Required. Client-defined name of the event (e.g.,
	// "run_completed", "level_up"). Maximum length: 100 characters.
	EventName string `json:"eventName,omitempty"`
	// EventProperties: Optional. Key-value properties providing details about the
	// event. - Maximum number of properties: 25. - Property key maximum length:
	// 100 characters. - String values within PropertyValue maximum length: 1024
	// characters.
	EventProperties map[string]PropertyValue `json:"eventProperties,omitempty"`
	// EventTime: Required. The time from the client when this specific event was
	// performed.
...
func (s PlayerGameEvent) MarshalJSON() ([]byte, error) {
	type NoMethod PlayerGameEvent
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}
...
// PropertyValue: Wrapper for the value.
