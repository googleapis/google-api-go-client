...
func (c *SubscriptionsAcknowledgeCall) DoHeader() (http.Header, *Empty, error) {
...
func (c *SubscriptionsDeleteCall) DoHeader() (http.Header, *Empty, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *SubscriptionsModifyAckDeadlineCall) DoHeader() (http.Header, *Empty, error) {
	var body io.Reader = nil
...
func (c *SubscriptionsModifyPushConfigCall) DoHeader() (http.Header, *Empty, error) {
	var body io.Reader = nil
...
func (c *TopicsDeleteCall) DoHeader() (http.Header, *Empty, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *TopicsPublishCall) DoHeader() (http.Header, *Empty, error) {
	var body io.Reader = nil
