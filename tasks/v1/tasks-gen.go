...
func (c *TasklistsGetCall) DoHeader() (http.Header, *TaskList, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *TasklistsInsertCall) DoHeader() (http.Header, *TaskList, error) {
	var body io.Reader = nil
...
func (c *TasklistsListCall) DoHeader() (http.Header, *TaskLists, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *TasklistsPatchCall) DoHeader() (http.Header, *TaskList, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.tasklist)
	if err != nil {
		return nil, nil, err
...
func (c *TasklistsUpdateCall) DoHeader() (http.Header, *TaskList, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.tasklist)
	if err != nil {
		return nil, nil, err
...
func (c *TasksInsertCall) DoHeader() (http.Header, *Task, error) {
	var body io.Reader = nil
...
func (c *TasksListCall) DoHeader() (http.Header, *Tasks, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *TasksMoveCall) DoHeader() (http.Header, *Task, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["parent"]; ok {
...
func (c *TasksPatchCall) DoHeader() (http.Header, *Task, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.task)
	if err != nil {
		return nil, nil, err
...
func (c *TasksUpdateCall) DoHeader() (http.Header, *Task, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.task)
	if err != nil {
		return nil, nil, err
