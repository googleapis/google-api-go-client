...
type AppEngineHttpTarget struct {
	...
	// used for job request deduplication
	// (https://docs.cloud.google.com/scheduler/docs/overview#job-deduplication).
	...
	// setting `Content-Type` to a particular media type when creating the job. For
	// example, you can set `Content-Type` to "application/json". The headers
	// below are output only. They cannot be set or overridden: * `Content-Length`:
	// This is computed by Cloud Scheduler. * `X-Google-*`: For Google internal use
	// only. * `X-AppEngine-*`: For Google internal use only. In addition, some App
	// Engine headers, which contain job-specific information, are also be sent to
	// the job handler.
...
// CmekConfig: Describes the project/location configuration of Cloud Scheduler
// Resources.
type CmekConfig struct {
	// KmsKeyName: Optional. Resource name of the Cloud KMS key, of the form
	// `projects/PROJECT_ID/locations/LOCATION_ID/keyRings/KEY_RING_ID/cryptoKeys/KE
	// Y_ID`, that will be used to encrypt Jobs in the region. Setting this as
...
type HttpTarget struct {
	...
	// internally by Google. If present in an external user request, it is replaced
	// by the internal header. * `X-AppEngine-*`: Used internally by Google. If
	...
	// "application/octet-stream". You can override this default by explicitly
	// setting `Content-Type` to a particular media type when creating the job. For
	// example, you can set `Content-Type` to "application/json". The total size
...
type Job struct {
	...
	// available locations can be obtained by calling locations.list
	// (/scheduler/docs/reference/rest/v1/projects.locations/list). For more
	// information, see Cloud Scheduler locations (/scheduler/docs/locations). *
	...
	// English-like schedule (/scheduler/docs/configuring/cron-job-schedules) As a
...
// information, see Retry jobs (/scheduler/docs/configuring/retry-jobs). By
...
type RetryConfig struct {
	...
	// Retry jobs (/scheduler/docs/configuring/retry-jobs#max-doublings). The
...
// GetCmekConfig: Gets the Scheduler config in the project/region.
//
//   - name: The config name. For example:
//     projects/PROJECT_ID/locations/LOCATION_ID/cmekConfig.
...
func (c *ProjectsLocationsGetCmekConfigCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "cloudscheduler.projects.locations.getCmekConfig", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "cloudscheduler.projects.locations.getCmekConfig" call.
// Any non-2xx status code is an error. Response headers are in either
...
func (c *ProjectsLocationsGetCmekConfigCall) Do(opts ...googleapi.CallOption) (*CmekConfig, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "cloudscheduler.projects.locations.getCmekConfig", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// UpdateCmekConfig: Initializes or Updates the a scheduler config.
//
//   - name: Identifier. The config resource name which includes the project and
//     location and must end in 'cmekConfig', in the format
//     projects/PROJECT_ID/locations/LOCATION_ID/cmekConfig`.
...
func (c *ProjectsLocationsUpdateCmekConfigCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "cloudscheduler.projects.locations.updateCmekConfig", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "cloudscheduler.projects.locations.updateCmekConfig" call.
// Any non-2xx status code is an error. Response headers are in either
// *Operation.ServerResponse.Header or (if a response was returned at all) in
// error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
func (c *ProjectsLocationsUpdateCmekConfigCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "cloudscheduler.projects.locations.updateCmekConfig", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *ProjectsLocationsOperationsCancelCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "cloudscheduler.projects.locations.operations.cancel", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "cloudscheduler.projects.locations.operations.cancel" call.
// Any non-2xx status code is an error. Response headers are in either
// *Empty.ServerResponse.Header or (if a response was returned at all) in
// error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
func (c *ProjectsLocationsOperationsCancelCall) Do(opts ...googleapi.CallOption) (*Empty, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "cloudscheduler.projects.locations.operations.cancel", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *ProjectsLocationsOperationsDeleteCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "cloudscheduler.projects.locations.operations.delete", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "cloudscheduler.projects.locations.operations.delete" call.
// Any non-2xx status code is an error. Response headers are in either
// *Empty.ServerResponse.Header or (if a response was returned at all) in
// error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
func (c *ProjectsLocationsOperationsDeleteCall) Do(opts ...googleapi.CallOption) (*Empty, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "cloudscheduler.projects.locations.operations.delete", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *ProjectsLocationsOperationsGetCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "cloudscheduler.projects.locations.operations.get", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "cloudscheduler.projects.locations.operations.get" call.
// Any non-2xx status code is an error. Response headers are in either
// *Operation.ServerResponse.Header or (if a response was returned at all) in
// error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
func (c *ProjectsLocationsOperationsGetCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "cloudscheduler.projects.locations.operations.get", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
func (c *ProjectsLocationsOperationsListCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "cloudscheduler.projects.locations.operations.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "cloudscheduler.projects.locations.operations.list" call.
// Any non-2xx status code is an error. Response headers are in either
...
func (c *ProjectsLocationsOperationsListCall) Do(opts ...googleapi.CallOption) (*ListOperationsResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "cloudscheduler.projects.locations.operations.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
