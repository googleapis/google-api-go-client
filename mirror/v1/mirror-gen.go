...
type MenuItem struct {
	...
	// timeline item.
	// - OPEN_URI - Open the payload of the menu item in the
	// browser.
	// - PLAY_VIDEO - Open the payload of the menu item in the
	// Glass video player.
	// - SEND_MESSAGE - Initiate sending a message to
	// the timeline item's creator:
	// - If the creator.phoneNumber is set
	// and Glass is connected to an Android phone, the message is an SMS.
	// -
