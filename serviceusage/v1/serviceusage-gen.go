...
type BatchEnableServicesRequest struct {
	...
	// user enabling the service. A single request can enable a maximum of
	// 20 services at a time. If more than 20 services are specified, the
	// request will fail, and no state changes will occur.
...
type DisableServiceRequest struct {
	...
	// which depend on this service should also be disabled. If not set, an
	// error will be generated if any enabled services depend on the service
	// to be disabled. When set, the service, and any enabled services that
	// depend on it, will be disabled together.
	DisableDependentServices bool `json:"disableDependentServices,omitempty"`

	// ForceSendFields is a list of field names (e.g.
	// "CheckIfServiceHasUsage") to unconditionally include in API requests.
	// By default, fields with empty values are omitted from API requests.
	// However, any non-pointer, non-interface field appearing in
	// ForceSendFields will be sent to the server regardless of whether the
	// field is empty or not. This may be used to include empty fields in
	...
	// NullFields is a list of field names (e.g. "CheckIfServiceHasUsage")
	// to include in API requests with the JSON null value. By default,
	// fields with empty values are omitted from API requests. However, any
	// field with an empty value appearing in NullFields will be sent to the
	// server as null. It is an error if a field in this list has a
...
// the project number. A single request can get a maximum of 30 services
// at a time.
...
// should use Cloud Asset Inventory API, which provides higher
