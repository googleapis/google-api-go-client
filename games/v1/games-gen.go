...
type AchievementDefinitionsServicer interface {
	List() *AchievementDefinitionsListCall
}
...
type AchievementsServicer interface {
	Increment(achievementId string, stepsToIncrement int64) *AchievementsIncrementCall
	List(playerId string) *AchievementsListCall
	Reveal(achievementId string) *AchievementsRevealCall
	SetStepsAtLeast(achievementId string, steps int64) *AchievementsSetStepsAtLeastCall
	Unlock(achievementId string) *AchievementsUnlockCall
	UpdateMultiple(achievementupdatemultiplerequest *AchievementUpdateMultipleRequest) *AchievementsUpdateMultipleCall
}
...
type ApplicationsServicer interface {
	Get(applicationId string) *ApplicationsGetCall
	Played() *ApplicationsPlayedCall
}
...
type EventsServicer interface {
	ListByPlayer() *EventsListByPlayerCall
	ListDefinitions() *EventsListDefinitionsCall
	Record(eventrecordrequest *EventRecordRequest) *EventsRecordCall
}
...
type LeaderboardsServicer interface {
	Get(leaderboardId string) *LeaderboardsGetCall
	List() *LeaderboardsListCall
}
...
type MetagameServicer interface {
	GetMetagameConfig() *MetagameGetMetagameConfigCall
	ListCategoriesByPlayer(playerId string, collection string) *MetagameListCategoriesByPlayerCall
}
...
type PlayersServicer interface {
	Get(playerId string) *PlayersGetCall
	List(collection string) *PlayersListCall
}
...
type PushtokensServicer interface {
	Remove(pushtokenid *PushTokenId) *PushtokensRemoveCall
	Update(pushtoken *PushToken) *PushtokensUpdateCall
}
...
type QuestMilestonesServicer interface {
	Claim(questId string, milestoneId string, requestId int64) *QuestMilestonesClaimCall
}
...
type QuestsServicer interface {
	Accept(questId string) *QuestsAcceptCall
	List(playerId string) *QuestsListCall
}
...
type RevisionsServicer interface {
	Check(clientRevision string) *RevisionsCheckCall
}
...
type RoomsServicer interface {
	Create(roomcreaterequest *RoomCreateRequest) *RoomsCreateCall
	Decline(roomId string) *RoomsDeclineCall
	Dismiss(roomId string) *RoomsDismissCall
	Get(roomId string) *RoomsGetCall
	Join(roomId string, roomjoinrequest *RoomJoinRequest) *RoomsJoinCall
	Leave(roomId string, roomleaverequest *RoomLeaveRequest) *RoomsLeaveCall
	List() *RoomsListCall
	ReportStatus(roomId string, roomp2pstatuses *RoomP2PStatuses) *RoomsReportStatusCall
}
...
type ScoresServicer interface {
	Get(playerId string, leaderboardId string, timeSpan string) *ScoresGetCall
	List(leaderboardId string, collection string, timeSpan string) *ScoresListCall
	ListWindow(leaderboardId string, collection string, timeSpan string) *ScoresListWindowCall
	Submit(leaderboardId string, score int64) *ScoresSubmitCall
	SubmitMultiple(playerscoresubmissionlist *PlayerScoreSubmissionList) *ScoresSubmitMultipleCall
}
...
type SnapshotsServicer interface {
	Get(snapshotId string) *SnapshotsGetCall
	List(playerId string) *SnapshotsListCall
}
...
type TurnBasedMatchesServicer interface {
	Cancel(matchId string) *TurnBasedMatchesCancelCall
	Create(turnbasedmatchcreaterequest *TurnBasedMatchCreateRequest) *TurnBasedMatchesCreateCall
	Decline(matchId string) *TurnBasedMatchesDeclineCall
	Dismiss(matchId string) *TurnBasedMatchesDismissCall
	Finish(matchId string, turnbasedmatchresults *TurnBasedMatchResults) *TurnBasedMatchesFinishCall
	Get(matchId string) *TurnBasedMatchesGetCall
	Join(matchId string) *TurnBasedMatchesJoinCall
	Leave(matchId string) *TurnBasedMatchesLeaveCall
	LeaveTurn(matchId string, matchVersion int64) *TurnBasedMatchesLeaveTurnCall
	List() *TurnBasedMatchesListCall
	Rematch(matchId string) *TurnBasedMatchesRematchCall
	Sync() *TurnBasedMatchesSyncCall
	TakeTurn(matchId string, turnbasedmatchturn *TurnBasedMatchTurn) *TurnBasedMatchesTakeTurnCall
}
