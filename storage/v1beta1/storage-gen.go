...
func (c *ObjectsInsertCall) Media(r io.Reader, opt ...googleapi.UploadOption) *ObjectsInsertCall {
	c.media_ = r
...
// At most one of Media and ResumableMedia may be set.
func (c *ObjectsInsertCall) ResumableMedia(ctx context.Context, r io.Reader, opt ...googleapi.UploadOption) *ObjectsInsertCall {
	c.ctx_ = ctx
	c.media_ = r
