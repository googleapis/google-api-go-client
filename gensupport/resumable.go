...
func (rx *ResumableUpload) Upload(ctx context.Context) (resp *http.Response, err error) {
	for {
		...
		// contract to our callers: exactly on of resp and err will be non-nil.  This means
		// it's up to us to close the reponse body if we are returning a non-nil error.
		if err != nil {
