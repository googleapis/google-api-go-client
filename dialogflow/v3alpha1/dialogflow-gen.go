...
type GoogleCloudDialogflowCxV3beta1PageInfoFormInfo struct {
	...
	// State: Always present for WebhookRequest. Ignored for WebhookResponse.
...
// that can be returned by a conversational agent.
//
// Response messages are also used for output audio synthesis. The approach
// is
// as follows:
//
//   - If at least one OutputAudioText response is present, then all
//     OutputAudioText responses are linearly concatenated, and the result is
//
// used
//
...
//
// This approach allows for more sophisticated user experience scenarios,
// where
...
type GoogleCloudDialogflowCxV3beta1ResponseMessage struct {
	...
	// ForceSendFields is a list of field names (e.g. "ConversationSuccess") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ConversationSuccess") to include
...
// that the conversation succeeded, i.e., the bot handled the issue
// that the customer talked to it about.
//
// Dialogflow only uses this to determine which conversations should be
// counted as successful and doesn't process the metadata in this message
// in
// any way. Note that Dialogflow also considers conversations that get to
// the
...
// GoogleCloudDialogflowCxV3beta1ResponseMessageHumanAgentHandoff: Indicates
// that the conversation should be handed off to a human agent.
//
...
type GoogleCloudDialogflowCxV3beta1SessionInfo struct {
	// Parameters: Optional for WebhookRequest. Optional for WebhookResponse.
...
type GoogleCloudDialogflowCxV3beta1WebhookRequestIntentInfo struct {
	...
	// ForceSendFields is a list of field names (e.g. "LastMatchedIntent") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "LastMatchedIntent") to include in
...
// possibly annotated with an entity. The part
...
// Cloud Pub/Sub subscribers for conversation
// lifecycle events.
...
// event name instead of the natural
...
type GoogleCloudDialogflowV2Intent struct {
	...
	// RootFollowupIntentName: Read-only. The unique identifier of the root intent
	// in the chain of
	...
	// and in the intent. Also, each slot
...
type GoogleCloudDialogflowV2IntentMessageBrowseCarouselCard struct {
	...
	// Items: Required. List of items in the Browse Carousel Card. Minimum of
	// two
...
// message that allows the user to jump out to the app
...
// the select item for when it is triggered in a
// dialog.
...
// that the user can tap to quickly post a reply
// to the conversation.
...
type GoogleCloudDialogflowV2IntentParameter struct {
	...
	// Mandatory: Optional. Indicates whether the parameter is required. That
	// is,
...
// of the original request that was passed to
...
// feeling or association, for a unit
...
// GoogleCloudDialogflowV2beta1AnnotatedConversationDataset: Represents an
// annotated conversation dataset.
// ConversationDataset can have multiple AnnotatedConversationDataset, each
// of
...
type GoogleCloudDialogflowV2beta1AnnotatedConversationDataset struct {
	// CompletedExampleCount: Output only. Number of examples that have annotations
	// in the annotated
	...
	DisplayName string `json:"displayName,omitempty"`
	// ExampleCount: Output only. Number of examples in the annotated conversation
	// dataset.
	...
	Name string `json:"name,omitempty"`
	// QuestionTypeName: Output only. Question type name that identifies a labeling
	// task.
	...
	// ForceSendFields is a list of field names (e.g. "CompletedExampleCount") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
...
// Business Messaging (RBM) rich card.
//
...
// Messaging (RBM) suggested client-side action that the user
...
// Dial: Opens the user's default dialer app with the specified phone
// number
...
// GoogleCloudDialogflowV2beta1IntentMessageRbmSuggestedActionRbmSuggestedAction
// OpenUri: Opens the user's default web browser app to the specified
// uri
...
// Messaging (RBM) suggested reply that the user can click
...
type GoogleCloudDialogflowV2beta1LabelConversationResponse struct {
	// AnnotatedConversationDataset: New annotated conversation dataset created by
	// the labeling task.
	...
	// ForceSendFields is a list of field names (e.g.
	// "AnnotatedConversationDataset") to unconditionally include in API requests.
	// By default, fields with empty or default values are omitted from API
	// requests. See https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields
	// for more details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AnnotatedConversationDataset") to
	// include in API requests with the JSON null value. By default, fields with
	// empty values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// GoogleCloudDialogflowV2beta1SentimentAnalysisResult: The result of sentiment
// analysis as configured by
// `sentiment_analysis_request_config`.
...
// GoogleCloudDialogflowV2beta1SessionEntityType: Represents a session entity
// type.
//
// Extends or replaces a custom entity type at the user session level (we
// refer to the entity types defined at the agent level as "custom
...
// GoogleCloudDialogflowV3alpha1ExportAgentResponse: The response message for
// Agents.ExportAgent.
