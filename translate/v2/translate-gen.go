...
// is cancelled.
func (c *DetectionsListCall) Ctx(ctx context.Context) *DetectionsListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *LanguagesListCall) Ctx(ctx context.Context) *LanguagesListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *TranslationsListCall) Ctx(ctx context.Context) *TranslationsListCall {
	c.ctx_ = ctx
	return c
}
