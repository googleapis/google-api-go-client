...
// Exactly one of *Asp,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Asp, .ServerResponse.Header
...
// Exactly one of *Asps,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Asps, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *ChromeOsDevice,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *ChromeOsDevice, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *ChromeOsDevices,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *ChromeOsDevices, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Alias,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Alias, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Aliases,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Aliases, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Member,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Member, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Members,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Members, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *MobileDevice,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *MobileDevice, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *MobileDevices,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *MobileDevices, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Notification,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Notification, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Notifications,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Notifications, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *OrgUnit,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *OrgUnit, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *OrgUnits,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *OrgUnits, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Schema,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Schema, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Schemas,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Schemas, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Token,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Token, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Tokens,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Tokens, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Users,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Users, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *UserPhoto,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *UserPhoto, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *VerificationCodes,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *VerificationCodes, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
