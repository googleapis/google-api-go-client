...
func (c *ProjectsIconsCreateCall) ResumableMedia(ctx context.Context, r io.Reader, size int64, chunkSize int64, mediaType string) *ProjectsIconsCreateCall {
	c.ctx_ = ctx
	c.media_ = r
...
// Parameter mediaType identifies the MIME media type of the upload, such as "image/png".
// If mediaType is "", it will be auto-detected.
func (c *RastersFilesInsertCall) ResumableMedia(ctx context.Context, r io.Reader, size int64, chunkSize int64, mediaType string) *RastersFilesInsertCall {
	c.ctx_ = ctx
	c.media_ = r
	c.mediaType_ = mediaType
	c.size_ = size
...
// Parameter mediaType identifies the MIME media type of the upload, such as "image/png".
// If mediaType is "", it will be auto-detected.
func (c *TablesFilesInsertCall) ResumableMedia(ctx context.Context, r io.Reader, size int64, chunkSize int64, mediaType string) *TablesFilesInsertCall {
	c.ctx_ = ctx
	c.media_ = r
	c.mediaType_ = mediaType
	c.size_ = size
