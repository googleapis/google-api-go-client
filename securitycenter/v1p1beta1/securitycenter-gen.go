...
type GetPolicyOptions struct {
	// RequestedPolicyVersion: Optional. The policy format version to be returned.
...
// notification config is a Security Command Center resource that contains the
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudSecuritycenterV1p1beta1SecurityMarks.ServerResponse.Header or
...
// characters, and contains alphanumeric characters, underscores or hyphens
// only.
...
//
//   - parent: Name of the organization to list notification configs. Its format
//     is "organizations/[organization_id]".
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudSecuritycenterV1p1beta1Finding.ServerResponse.Header or (if a
