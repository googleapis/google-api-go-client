...
func (r *ProjectsService) PatchTraces(projectId string, traces *Traces) *ProjectsPatchTracesCall {
	c := &ProjectsPatchTracesCall{s: r.s, urlParams_: make(internal.URLParams)}
...
func (r *ProjectsTracesService) Get(projectId string, traceId string) *ProjectsTracesGetCall {
	c := &ProjectsTracesGetCall{s: r.s, urlParams_: make(internal.URLParams)}
	c.projectId = projectId
	c.traceId = traceId
	return c
}
...
func (r *ProjectsTracesService) List(projectId string) *ProjectsTracesListCall {
	c := &ProjectsTracesListCall{s: r.s, urlParams_: make(internal.URLParams)}
	c.projectId = projectId
	return c
}
...
func (r *V1Service) GetDiscovery() *V1GetDiscoveryCall {
	c := &V1GetDiscoveryCall{s: r.s, urlParams_: make(internal.URLParams)}
	return c
}
