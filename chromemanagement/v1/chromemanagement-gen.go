...
// GoogleChromeManagementV1FindInstalledAppProfilesResponse: Response
// containing a list of profiles with queried app installed.
type GoogleChromeManagementV1FindInstalledAppProfilesResponse struct {
	// NextPageToken: Token to specify the next page of the request.
	NextPageToken string `json:"nextPageToken,omitempty"`
	// Profiles: A list of profiles which have the app installed. Sorted in
	// ascending alphabetical order on the profile.Email field.
	Profiles []*GoogleChromeManagementV1ProfileAppInstallInstance `json:"profiles,omitempty"`
	// TotalSize: Total number of profiles matching request.
	TotalSize int64 `json:"totalSize,omitempty"`
...
func (s GoogleChromeManagementV1FindInstalledAppProfilesResponse) MarshalJSON() ([]byte, error) {
	type NoMethod GoogleChromeManagementV1FindInstalledAppProfilesResponse
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}
...
// GoogleChromeManagementV1ProfileAppInstallInstance: Describes a profile
// reporting Chrome Profile information.
type GoogleChromeManagementV1ProfileAppInstallInstance struct {
	// Email: Output only. The email of the profile.
	Email string `json:"email,omitempty"`
	// ProfileId: Output only. The Chrome client side profile ID.
	ProfileId string `json:"profileId,omitempty"`
	// ProfileOrgUnitId: Output only. The organizational unit id of the profile.
	ProfileOrgUnitId string `json:"profileOrgUnitId,omitempty"`
...
func (s GoogleChromeManagementV1ProfileAppInstallInstance) MarshalJSON() ([]byte, error) {
	type NoMethod GoogleChromeManagementV1ProfileAppInstallInstance
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}
...
type GoogleChromeManagementVersionsV1ConnectorConfigDetails struct {
	...
	// MipLabelConfig: MIP label connector config.
	MipLabelConfig *GoogleChromeManagementVersionsV1MipLabelConfig `json:"mipLabelConfig,omitempty"`
...
// GoogleChromeManagementVersionsV1MipLabelConfig: MIP label connector config.
type GoogleChromeManagementVersionsV1MipLabelConfig struct {
	// Domains: Optional. Domain can be used optionally for the corner case where
	// one Dasher customer ID maps to multiple Microsoft tenant ID. Each domain can
	// be verified with at most one Microsoft tenant.
	Domains []string `json:"domains,omitempty"`
	// MicrosoftTenantId: Required. Microsoft tenant ID.
...
func (s GoogleChromeManagementVersionsV1MipLabelConfig) MarshalJSON() ([]byte, error) {
	type NoMethod GoogleChromeManagementVersionsV1MipLabelConfig
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}
...
type CustomersReportsFindInstalledAppProfilesCall struct {
	s            *Service
	customer     string
	urlParams_   gensupport.URLParams
	ifNoneMatch_ string
...
// FindInstalledAppProfiles: Generate report of managed Chrome profiles that
// have a specified app installed.
//
//   - customer: Customer id or "my_customer" to use the customer associated to
//     the account making the request.
func (r *CustomersReportsService) FindInstalledAppProfiles(customer string) *CustomersReportsFindInstalledAppProfilesCall {
	c := &CustomersReportsFindInstalledAppProfilesCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.customer = customer
	return c
}

// AppId sets the optional parameter "appId": Required. Unique identifier of
// the app. For Chrome apps and extensions, the 32-character id (e.g.
// ehoadneljpdggcbbknedodolkkjodefl). For Android apps, the package name (e.g.
// com.evernote).
func (c *CustomersReportsFindInstalledAppProfilesCall) AppId(appId string) *CustomersReportsFindInstalledAppProfilesCall {
	c.urlParams_.Set("appId", appId)
	return c
}
...
//	"HOSTED_APP" - Chrome hosted app.
//	"ANDROID_APP" - ARC++ app.
func (c *CustomersReportsFindInstalledAppProfilesCall) AppType(appType string) *CustomersReportsFindInstalledAppProfilesCall {
	c.urlParams_.Set("appType", appType)
	return c
}
...
// AND-separated fields in EBNF syntax. Note: OR operations are not supported
// in this filter. Supported filter fields: * last_active_date
func (c *CustomersReportsFindInstalledAppProfilesCall) Filter(filter string) *CustomersReportsFindInstalledAppProfilesCall {
	c.urlParams_.Set("filter", filter)
	return c
}

// OrderBy sets the optional parameter "orderBy": Field used to order results.
// Supported order by fields: * email * profile_id * profile_permanent_id
func (c *CustomersReportsFindInstalledAppProfilesCall) OrderBy(orderBy string) *CustomersReportsFindInstalledAppProfilesCall {
	c.urlParams_.Set("orderBy", orderBy)
	return c
}
...
// OrgUnitId sets the optional parameter "orgUnitId": The ID of the
// organizational unit.
func (c *CustomersReportsFindInstalledAppProfilesCall) OrgUnitId(orgUnitId string) *CustomersReportsFindInstalledAppProfilesCall {
	c.urlParams_.Set("orgUnitId", orgUnitId)
	return c
}
...
// PageSize sets the optional parameter "pageSize": Maximum number of results
// to return. Maximum and default are 100.
func (c *CustomersReportsFindInstalledAppProfilesCall) PageSize(pageSize int64) *CustomersReportsFindInstalledAppProfilesCall {
	c.urlParams_.Set("pageSize", fmt.Sprint(pageSize))
	return c
}
...
// PageToken sets the optional parameter "pageToken": Token to specify the page
// of the request to be returned.
func (c *CustomersReportsFindInstalledAppProfilesCall) PageToken(pageToken string) *CustomersReportsFindInstalledAppProfilesCall {
	c.urlParams_.Set("pageToken", pageToken)
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse for more
// details.
func (c *CustomersReportsFindInstalledAppProfilesCall) Fields(s ...googleapi.Field) *CustomersReportsFindInstalledAppProfilesCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// object's ETag matches the given value. This is useful for getting updates
// only after the object has changed since the last request.
func (c *CustomersReportsFindInstalledAppProfilesCall) IfNoneMatch(entityTag string) *CustomersReportsFindInstalledAppProfilesCall {
	c.ifNoneMatch_ = entityTag
	return c
}

// Context sets the context to be used in this call's Do method.
func (c *CustomersReportsFindInstalledAppProfilesCall) Context(ctx context.Context) *CustomersReportsFindInstalledAppProfilesCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns a http.Header that can be modified by the caller to add
// headers to the request.
func (c *CustomersReportsFindInstalledAppProfilesCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *CustomersReportsFindInstalledAppProfilesCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "", c.header_)
	if c.ifNoneMatch_ != "" {
		reqHeaders.Set("If-None-Match", c.ifNoneMatch_)
	}
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/{+customer}/reports:findInstalledAppProfiles")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("GET", urls, nil)
	if err != nil {
		return nil, err
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "chromemanagement.customers.reports.findInstalledAppProfiles", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "chromemanagement.customers.reports.findInstalledAppProfiles" call.
// Any non-2xx status code is an error. Response headers are in either
// *GoogleChromeManagementV1FindInstalledAppProfilesResponse.ServerResponse.Head
// er or (if a response was returned at all) in
// error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
func (c *CustomersReportsFindInstalledAppProfilesCall) Do(opts ...googleapi.CallOption) (*GoogleChromeManagementV1FindInstalledAppProfilesResponse, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
	...
	ret := &GoogleChromeManagementV1FindInstalledAppProfilesResponse{
		ServerResponse: googleapi.ServerResponse{
			Header:         res.Header,
			HTTPStatusCode: res.StatusCode,
		},
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "chromemanagement.customers.reports.findInstalledAppProfiles", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
