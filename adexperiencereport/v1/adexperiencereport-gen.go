...
type PlatformSummary struct {
	...
	// or will begin on this platform. Not set when the filter_status is
	// OFF.
	EnforcementTime string `json:"enforcementTime,omitempty"`

	// FilterStatus: The site's enforcement status on this platform.
	//
	// Possible values:
	//   "UNKNOWN" - N/A.
	...
	// complete the Search Console verification process for the site before
