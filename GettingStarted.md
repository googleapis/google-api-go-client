...
To do this, you can use [transport.APIKey](http://godoc.org/google.golang.org/api/googleapi/transport#APIKey):
...
For a more complete example, see the https://github.com/google/google-api-go-client/tree/master/examples/urlshortener.go
