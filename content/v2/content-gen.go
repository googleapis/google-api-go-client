...
// Response headers are in either *AccountsAuthInfoResponse.ServerResponse.Header
...
// Any non-2xx status code is an error.
// Response headers are in either *AccountsCustomBatchResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *AccountsListResponse or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *AccountsListResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *AccountshippingCustomBatchResponse or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *AccountshippingCustomBatchResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *AccountShipping or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *AccountShipping.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Any non-2xx status code is an error.
// Response headers are in either *AccountshippingListResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *AccountstatusesCustomBatchResponse or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *AccountstatusesCustomBatchResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *AccountStatus or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *AccountStatus.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Any non-2xx status code is an error.
// Response headers are in either *AccountstatusesListResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *AccounttaxCustomBatchResponse or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *AccounttaxCustomBatchResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *AccountTax or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *AccountTax.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *AccounttaxListResponse or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *AccounttaxListResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *DatafeedsCustomBatchResponse or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *DatafeedsCustomBatchResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Datafeed or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Datafeed.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *DatafeedsListResponse or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *DatafeedsListResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *DatafeedstatusesCustomBatchResponse or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *DatafeedstatusesCustomBatchResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *DatafeedStatus or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *DatafeedStatus.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *DatafeedstatusesListResponse or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *DatafeedstatusesListResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *InventoryCustomBatchResponse or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *InventoryCustomBatchResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *InventorySetResponse or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *InventorySetResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Any non-2xx status code is an error.
// Response headers are in either *OrdersAcknowledgeResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *OrdersAdvanceTestOrderResponse or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *OrdersAdvanceTestOrderResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *OrdersCancelResponse or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *OrdersCancelResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *OrdersCancelLineItemResponse or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *OrdersCancelLineItemResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *OrdersCreateTestOrderResponse or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *OrdersCreateTestOrderResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Any non-2xx status code is an error.
// Response headers are in either *OrdersCustomBatchResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *OrdersGetByMerchantOrderIdResponse or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *OrdersGetByMerchantOrderIdResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *OrdersGetTestOrderTemplateResponse or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *OrdersGetTestOrderTemplateResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *OrdersListResponse or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *OrdersListResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *OrdersRefundResponse or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *OrdersRefundResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *OrdersReturnLineItemResponse or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *OrdersReturnLineItemResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Any non-2xx status code is an error.
// Response headers are in either *OrdersShipLineItemsResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *OrdersUpdateMerchantOrderIdResponse or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *OrdersUpdateMerchantOrderIdResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *OrdersUpdateShipmentResponse or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *OrdersUpdateShipmentResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Any non-2xx status code is an error.
// Response headers are in either *ProductsCustomBatchResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Product or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Product.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *ProductsListResponse or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *ProductsListResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *ProductstatusesCustomBatchResponse or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *ProductstatusesCustomBatchResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *ProductStatus or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *ProductStatus.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Any non-2xx status code is an error.
// Response headers are in either *ProductstatusesListResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
