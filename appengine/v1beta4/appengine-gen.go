...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *AppsModulesDeleteCall) Ctx(ctx context.Context) *AppsModulesDeleteCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *AppsModulesGetCall) Ctx(ctx context.Context) *AppsModulesGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *AppsModulesListCall) Ctx(ctx context.Context) *AppsModulesListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *AppsModulesPatchCall) Ctx(ctx context.Context) *AppsModulesPatchCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *AppsModulesVersionsCreateCall) Ctx(ctx context.Context) *AppsModulesVersionsCreateCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *AppsModulesVersionsDeleteCall) Ctx(ctx context.Context) *AppsModulesVersionsDeleteCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *AppsModulesVersionsGetCall) Ctx(ctx context.Context) *AppsModulesVersionsGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *AppsModulesVersionsListCall) Ctx(ctx context.Context) *AppsModulesVersionsListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *AppsOperationsGetCall) Ctx(ctx context.Context) *AppsOperationsGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *AppsOperationsListCall) Ctx(ctx context.Context) *AppsOperationsListCall {
	c.ctx_ = ctx
	return c
}
