...
// is cancelled.
func (c *WebResourceDeleteCall) Ctx(ctx context.Context) *WebResourceDeleteCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *WebResourceGetCall) Ctx(ctx context.Context) *WebResourceGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *WebResourceGetTokenCall) Ctx(ctx context.Context) *WebResourceGetTokenCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *WebResourceInsertCall) Ctx(ctx context.Context) *WebResourceInsertCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *WebResourceListCall) Ctx(ctx context.Context) *WebResourceListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *WebResourcePatchCall) Ctx(ctx context.Context) *WebResourcePatchCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *WebResourceUpdateCall) Ctx(ctx context.Context) *WebResourceUpdateCall {
	c.ctx_ = ctx
	return c
}
