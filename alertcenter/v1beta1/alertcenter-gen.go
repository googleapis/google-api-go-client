...
type RuleViolationInfo struct {
	...
	//   "CHROME_BLOCK_DATA_COPIED" - Block text copied from Chrome.
	//   "CHROME_WARN_DATA_COPIED" - Warn on text copied from Chrome.
	...
	//   "CHROME_NETWORK_REQUEST" - Network request from Chrome.
