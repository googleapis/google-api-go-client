...
func (s *Service) Reconcile() *ReconcileCall {
	c := &ReconcileCall{s: s, urlParams_: urlValues()}
	return c
}
...
func (c *ReconcileCall) Kind(kind []string) *ReconcileCall {
	c.urlParams_.Del("kind")
	for _, v := range kind {
		c.urlParams_.Add("kind", fmt.Sprintf("%v", v))
	}
	return c
}
...
func (c *ReconcileCall) Lang(lang []string) *ReconcileCall {
	c.urlParams_.Del("lang")
	for _, v := range lang {
		c.urlParams_.Add("lang", fmt.Sprintf("%v", v))
	}
	return c
}
...
func (c *ReconcileCall) Name(name string) *ReconcileCall {
	c.urlParams_.Set("name", fmt.Sprintf("%v", name))
	return c
}
...
func (c *ReconcileCall) Prop(prop []string) *ReconcileCall {
	c.urlParams_.Del("prop")
	for _, v := range prop {
		c.urlParams_.Add("prop", fmt.Sprintf("%v", v))
	}
	return c
}
...
func (s *Service) Search() *SearchCall {
	c := &SearchCall{s: s, urlParams_: urlValues()}
	return c
}
...
func (c *SearchCall) AsOfTime(asOfTime string) *SearchCall {
	c.urlParams_.Set("asOfTime", fmt.Sprintf("%v", asOfTime))
	return c
}
...
func (c *SearchCall) Callback(callback string) *SearchCall {
	c.urlParams_.Set("callback", fmt.Sprintf("%v", callback))
	return c
}
...
func (c *SearchCall) Domain(domain []string) *SearchCall {
	c.urlParams_.Del("domain")
	for _, v := range domain {
		c.urlParams_.Add("domain", fmt.Sprintf("%v", v))
	}
	return c
}
...
func (c *SearchCall) Encode(encode string) *SearchCall {
	c.urlParams_.Set("encode", fmt.Sprintf("%v", encode))
	return c
}
...
func (c *SearchCall) Help(help string) *SearchCall {
	c.urlParams_.Set("help", fmt.Sprintf("%v", help))
	return c
}
...
func (c *SearchCall) Mid(mid []string) *SearchCall {
	c.urlParams_.Del("mid")
	for _, v := range mid {
		c.urlParams_.Add("mid", fmt.Sprintf("%v", v))
	}
	return c
}
...
func (c *SearchCall) MqlOutput(mqlOutput string) *SearchCall {
	c.urlParams_.Set("mqlOutput", fmt.Sprintf("%v", mqlOutput))
	return c
}
...
func (c *SearchCall) Output(output string) *SearchCall {
	c.urlParams_.Set("output", fmt.Sprintf("%v", output))
	return c
}
...
func (c *SearchCall) Query(query string) *SearchCall {
	c.urlParams_.Set("query", fmt.Sprintf("%v", query))
	return c
}
...
func (c *SearchCall) Scoring(scoring string) *SearchCall {
	c.urlParams_.Set("scoring", fmt.Sprintf("%v", scoring))
	return c
}
...
func (c *SearchCall) Spell(spell string) *SearchCall {
	c.urlParams_.Set("spell", fmt.Sprintf("%v", spell))
	return c
}
...
func (c *SearchCall) Type(type_ []string) *SearchCall {
	c.urlParams_.Del("type_")
	for _, v := range type_ {
		c.urlParams_.Add("type_", fmt.Sprintf("%v", v))
	}
	return c
}
...
func (c *SearchCall) With(with []string) *SearchCall {
	c.urlParams_.Del("with")
	for _, v := range with {
		c.urlParams_.Add("with", fmt.Sprintf("%v", v))
	}
	return c
}
...
func (c *SearchCall) Without(without []string) *SearchCall {
	c.urlParams_.Del("without")
	for _, v := range without {
		c.urlParams_.Add("without", fmt.Sprintf("%v", v))
	}
	return c
}
