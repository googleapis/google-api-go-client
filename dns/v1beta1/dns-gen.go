...
func (c *ChangesCreateCall) Do() (ret *Change, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *ChangesListCall) Do() (ret *ChangesListResponse, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *ManagedZonesCreateCall) Do() (ret *ManagedZone, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *ManagedZonesDeleteCall) Do() (err error) {
	_, err = c.DoHeader()
	return err
}
...
// Do performs a round-trip call to the server.
func (c *ManagedZonesGetCall) Do() (ret *ManagedZone, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *ManagedZonesListCall) Do() (ret *ManagedZonesListResponse, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *ResourceRecordSetsListCall) Do() (ret *ResourceRecordSetsListResponse, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
