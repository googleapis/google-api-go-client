...
type AuthenticationConfig struct {
	BasicAuthSetting *BasicAuthConfig `json:"basicAuthSetting,omitempty"`

	// Name: Name of authentication config. Format:
	// projects/{project}/locations/{location}/contactCenters/{contact_center
	// }/authentication-config
	Name string `json:"name,omitempty"`

	SamlSetting *SamlConfig `json:"samlSetting,omitempty"`

	// ServerResponse contains the HTTP response code and headers from the
	// server.
	googleapi.ServerResponse `json:"-"`

	// ForceSendFields is a list of field names (e.g. "BasicAuthSetting") to
	// unconditionally include in API requests. By default, fields with
	// empty or default values are omitted from API requests. However, any
	// non-pointer, non-interface field appearing in ForceSendFields will be
	// sent to the server regardless of whether the field is empty or not.
	...
	// NullFields is a list of field names (e.g. "BasicAuthSetting") to
...
func (s *BasicAuthConfig) MarshalJSON() ([]byte, error) {
	type NoMethod BasicAuthConfig
	raw := NoMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}
...
type ContactCenter struct {
	...
	// CustomerDomainPrefix: Required. Immutable. At least 2 and max 16 char
	// long, must conform to RFC 1035
...
// ListContactCentersResponse: Message for response to listing
// ContactCenters
type ListContactCentersResponse struct {
	...
	// NullFields is a list of field names (e.g. "ContactCenters") to
	// include in API requests with the JSON null value. By default, fields
	// with empty values are omitted from API requests. However, any field
	// with an empty value appearing in NullFields will be sent to the
	// server as null. It is an error if a field in this list has a
...
type SamlConfig struct {
	// Cert: X.509 public certificate for IdP
	Cert string `json:"cert,omitempty"`

	// EmailMapping: IdP field that maps to the user’s email address
	EmailMapping string `json:"emailMapping,omitempty"`

	// EntityId: The entity ID for the identity provider. Example:
	// https://[IDP Domain]/saml/metadata
	EntityId string `json:"entityId,omitempty"`

	// LoginUri: The sso login url. Example: https://[IDP
	// Domain]/saml/sso/login
...
func (s *SamlConfig) MarshalJSON() ([]byte, error) {
	type NoMethod SamlConfig
	raw := NoMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}
...
type URIs struct {
	...
	// VirtualAgentStreamingServiceUri: Virtual Agent Streaming Service Uri
	...
	// NullFields is a list of field names (e.g. "ChatBotUri") to include in
	// API requests with the JSON null value. By default, fields with empty
	// values are omitted from API requests. However, any field with an
	// empty value appearing in NullFields will be sent to the server as
	// null. It is an error if a field in this list has a non-empty value.
...
// method id "contactcenteraiplatform.projects.locations.list":
...
// method id "contactcenteraiplatform.projects.locations.queryContactCenterQuota":
...
// method id "contactcenteraiplatform.projects.locations.contactCenters.create":
...
// ContactCenterId sets the optional parameter "contactCenterId":
// Required. Id of the requesting object If auto-generating Id
// server-side, remove this field and contact_center_id from the
...
// method id "contactcenteraiplatform.projects.locations.contactCenters.delete":
...
// method id "contactcenteraiplatform.projects.locations.contactCenters.get":
...
// Exactly one of *ContactCenter or error will be non-nil. Any non-2xx
// status code is an error. Response headers are in either
// *ContactCenter.ServerResponse.Header or (if a response was returned
...
// method id "contactcenteraiplatform.projects.locations.contactCenters.getAuthentication-config":

type ProjectsLocationsContactCentersGetAuthenticationConfigCall struct {
	s            *Service
	name         string
	urlParams_   gensupport.URLParams
	ifNoneMatch_ string
...
//
//   - name: The name of the AuthenticationConfig resource. Format:
//     projects/{project}/locations/{location}/contactCenters/{contact_cent
//     er}/authentication-config.
func (r *ProjectsLocationsContactCentersService) GetAuthenticationConfig(name string) *ProjectsLocationsContactCentersGetAuthenticationConfigCall {
	c := &ProjectsLocationsContactCentersGetAuthenticationConfigCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.name = name
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *ProjectsLocationsContactCentersGetAuthenticationConfigCall) Fields(s ...googleapi.Field) *ProjectsLocationsContactCentersGetAuthenticationConfigCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// request. Use googleapi.IsNotModified to check whether the response
// error from Do is the result of In-None-Match.
func (c *ProjectsLocationsContactCentersGetAuthenticationConfigCall) IfNoneMatch(entityTag string) *ProjectsLocationsContactCentersGetAuthenticationConfigCall {
	c.ifNoneMatch_ = entityTag
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *ProjectsLocationsContactCentersGetAuthenticationConfigCall) Context(ctx context.Context) *ProjectsLocationsContactCentersGetAuthenticationConfigCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns an http.Header that can be modified by the caller to
// add HTTP headers to the request.
func (c *ProjectsLocationsContactCentersGetAuthenticationConfigCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *ProjectsLocationsContactCentersGetAuthenticationConfigCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("x-goog-api-client", "gl-go/"+gensupport.GoVersion()+" gdcl/"+internal.Version)
	for k, v := range c.header_ {
		reqHeaders[k] = v
...
// Do executes the "contactcenteraiplatform.projects.locations.contactCenters.getAuthentication-config" call.
// Exactly one of *AuthenticationConfig or error will be non-nil. Any
// non-2xx status code is an error. Response headers are in either
// *AuthenticationConfig.ServerResponse.Header or (if a response was
// returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was
// because http.StatusNotModified was returned.
func (c *ProjectsLocationsContactCentersGetAuthenticationConfigCall) Do(opts ...googleapi.CallOption) (*AuthenticationConfig, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
...
// method id "contactcenteraiplatform.projects.locations.contactCenters.list":
...
// Exactly one of *ListContactCentersResponse or error will be non-nil.
// Any non-2xx status code is an error. Response headers are in either
// *ListContactCentersResponse.ServerResponse.Header or (if a response
...
// method id "contactcenteraiplatform.projects.locations.contactCenters.patch":
...
// method id "contactcenteraiplatform.projects.locations.contactCenters.updateAuthentication-config":

type ProjectsLocationsContactCentersUpdateAuthenticationConfigCall struct {
	s                    *Service
	name                 string
...
//     projects/{project}/locations/{location}/contactCenters/{contact_cent
//     er}/authentication-config.
func (r *ProjectsLocationsContactCentersService) UpdateAuthenticationConfig(name string, authenticationconfig *AuthenticationConfig) *ProjectsLocationsContactCentersUpdateAuthenticationConfigCall {
	c := &ProjectsLocationsContactCentersUpdateAuthenticationConfigCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.name = name
	c.authenticationconfig = authenticationconfig
	return c
}

// UpdateMask sets the optional parameter "updateMask": Required.
// Indicates which fields in the provided authentication config to
// update. Must be specified and non-empty.
func (c *ProjectsLocationsContactCentersUpdateAuthenticationConfigCall) UpdateMask(updateMask string) *ProjectsLocationsContactCentersUpdateAuthenticationConfigCall {
	c.urlParams_.Set("updateMask", updateMask)
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *ProjectsLocationsContactCentersUpdateAuthenticationConfigCall) Fields(s ...googleapi.Field) *ProjectsLocationsContactCentersUpdateAuthenticationConfigCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *ProjectsLocationsContactCentersUpdateAuthenticationConfigCall) Context(ctx context.Context) *ProjectsLocationsContactCentersUpdateAuthenticationConfigCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns an http.Header that can be modified by the caller to
// add HTTP headers to the request.
func (c *ProjectsLocationsContactCentersUpdateAuthenticationConfigCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *ProjectsLocationsContactCentersUpdateAuthenticationConfigCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("x-goog-api-client", "gl-go/"+gensupport.GoVersion()+" gdcl/"+internal.Version)
	for k, v := range c.header_ {
		reqHeaders[k] = v
	...
	reqHeaders.Set("User-Agent", c.s.userAgent())
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.authenticationconfig)
	if err != nil {
		return nil, err
	}
	reqHeaders.Set("Content-Type", "application/json")
...
// Do executes the "contactcenteraiplatform.projects.locations.contactCenters.updateAuthentication-config" call.
// Exactly one of *AuthenticationConfig or error will be non-nil. Any
// non-2xx status code is an error. Response headers are in either
// *AuthenticationConfig.ServerResponse.Header or (if a response was
// returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was
// because http.StatusNotModified was returned.
func (c *ProjectsLocationsContactCentersUpdateAuthenticationConfigCall) Do(opts ...googleapi.CallOption) (*AuthenticationConfig, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
...
// method id "contactcenteraiplatform.projects.locations.operations.cancel":
...
// method id "contactcenteraiplatform.projects.locations.operations.delete":
...
// method id "contactcenteraiplatform.projects.locations.operations.get":
...
// method id "contactcenteraiplatform.projects.locations.operations.list":
