...
func NewProjectsLocationsService(s *Service) *ProjectsLocationsService {
	...
	rs.FeatureConfigs = NewProjectsLocationsFeatureConfigsService(s)
...
func NewProjectsLocationsFeatureConfigsService(s *Service) *ProjectsLocationsFeatureConfigsService {
	rs := &ProjectsLocationsFeatureConfigsService{s: s}
	return rs
}
...
// FeatureConfig: FeatureConfig contains configurations for a Fleet
// feature. FeatureConfig can be applied to MembershipFeature(s) to
// setup per-membership FeatureSpec.
...
// FeatureConfigState: FeatureConfigState describes the state of a
...
func (s *FeatureConfigState) MarshalJSON() ([]byte, error) {
	type NoMethod FeatureConfigState
	raw := NoMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

// FeatureSpec: FeatureSpec contains user input per-feature spec
// information.
...
// ListFeatureConfigsResponse: Response message for the
// `GkeHubFeature.ListFeatureConfigs` method.
...
func (s *ListFeatureConfigsResponse) MarshalJSON() ([]byte, error) {
	type NoMethod ListFeatureConfigsResponse
	raw := NoMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}
...
// MembershipFeature: MembershipFeature represents the settings and
// status of a Fleet Feature enabled on a single Fleet Membership.
...
// ResourceState: ResourceState describes the state of a
// MembershipFeature *resource* in the GkeHub API. See `FeatureState`
...
// method id "gkehub.projects.locations.featureConfigs.create":
...
//
// - parent: The name of parent where the FeatureConfig will be created.
//   Specified in the format
//   `projects/{project}/locations/global/featureConfigs/{feature_type}/{
//   feature_config}/`.
func (r *ProjectsLocationsFeatureConfigsService) Create(parent string, featureconfig *FeatureConfig) *ProjectsLocationsFeatureConfigsCreateCall {
	c := &ProjectsLocationsFeatureConfigsCreateCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.parent = parent
	c.featureconfig = featureconfig
	return c
}

// FeatureConfigId sets the optional parameter "featureConfigId": The ID
// of the feature config to create.
func (c *ProjectsLocationsFeatureConfigsCreateCall) FeatureConfigId(featureConfigId string) *ProjectsLocationsFeatureConfigsCreateCall {
	c.urlParams_.Set("featureConfigId", featureConfigId)
	return c
}

// RequestId sets the optional parameter "requestId": Idempotent request
// UUID.
func (c *ProjectsLocationsFeatureConfigsCreateCall) RequestId(requestId string) *ProjectsLocationsFeatureConfigsCreateCall {
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *ProjectsLocationsFeatureConfigsCreateCall) Fields(s ...googleapi.Field) *ProjectsLocationsFeatureConfigsCreateCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *ProjectsLocationsFeatureConfigsCreateCall) Context(ctx context.Context) *ProjectsLocationsFeatureConfigsCreateCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns an http.Header that can be modified by the caller to
// add HTTP headers to the request.
func (c *ProjectsLocationsFeatureConfigsCreateCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *ProjectsLocationsFeatureConfigsCreateCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("x-goog-api-client", "gl-go/"+gensupport.GoVersion()+" gdcl/"+internal.Version)
	for k, v := range c.header_ {
		reqHeaders[k] = v
	...
	reqHeaders.Set("User-Agent", c.s.userAgent())
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.featureconfig)
	if err != nil {
		return nil, err
	}
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v2alpha/{+parent}/featureConfigs")
	urls += "?" + c.urlParams_.Encode()
...
// Do executes the "gkehub.projects.locations.featureConfigs.create" call.
...
// to check whether the returned error was because
// http.StatusNotModified was returned.
func (c *ProjectsLocationsFeatureConfigsCreateCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
...
// method id "gkehub.projects.locations.featureConfigs.delete":
...
//
// - name: The name of the membershipFeature to be deleted. Specified in
//   the format `projects/*/locations/*/featureConfigs/**`.
func (r *ProjectsLocationsFeatureConfigsService) Delete(name string) *ProjectsLocationsFeatureConfigsDeleteCall {
	c := &ProjectsLocationsFeatureConfigsDeleteCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.name = name
	return c
}
...
// RequestId sets the optional parameter "requestId": Idempotent request
// UUID.
func (c *ProjectsLocationsFeatureConfigsDeleteCall) RequestId(requestId string) *ProjectsLocationsFeatureConfigsDeleteCall {
	c.urlParams_.Set("requestId", requestId)
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *ProjectsLocationsFeatureConfigsDeleteCall) Fields(s ...googleapi.Field) *ProjectsLocationsFeatureConfigsDeleteCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *ProjectsLocationsFeatureConfigsDeleteCall) Context(ctx context.Context) *ProjectsLocationsFeatureConfigsDeleteCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns an http.Header that can be modified by the caller to
// add HTTP headers to the request.
func (c *ProjectsLocationsFeatureConfigsDeleteCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *ProjectsLocationsFeatureConfigsDeleteCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("x-goog-api-client", "gl-go/"+gensupport.GoVersion()+" gdcl/"+internal.Version)
	for k, v := range c.header_ {
		reqHeaders[k] = v
...
// Do executes the "gkehub.projects.locations.featureConfigs.delete" call.
// Exactly one of *Operation or error will be non-nil. Any non-2xx
// status code is an error. Response headers are in either
// *Operation.ServerResponse.Header or (if a response was returned at
// all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified
// to check whether the returned error was because
// http.StatusNotModified was returned.
func (c *ProjectsLocationsFeatureConfigsDeleteCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
...
// method id "gkehub.projects.locations.featureConfigs.get":
...
// Get: ========= FeatureConfig Services ========= Gets details of a
// featureConfig.
//
// - name: The FeatureConfig resource name in the format
//   `projects/*/locations/*/featureConfigs/**`.
func (r *ProjectsLocationsFeatureConfigsService) Get(name string) *ProjectsLocationsFeatureConfigsGetCall {
	c := &ProjectsLocationsFeatureConfigsGetCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.name = name
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *ProjectsLocationsFeatureConfigsGetCall) Fields(s ...googleapi.Field) *ProjectsLocationsFeatureConfigsGetCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// request. Use googleapi.IsNotModified to check whether the response
// error from Do is the result of In-None-Match.
func (c *ProjectsLocationsFeatureConfigsGetCall) IfNoneMatch(entityTag string) *ProjectsLocationsFeatureConfigsGetCall {
	c.ifNoneMatch_ = entityTag
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *ProjectsLocationsFeatureConfigsGetCall) Context(ctx context.Context) *ProjectsLocationsFeatureConfigsGetCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns an http.Header that can be modified by the caller to
// add HTTP headers to the request.
func (c *ProjectsLocationsFeatureConfigsGetCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *ProjectsLocationsFeatureConfigsGetCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("x-goog-api-client", "gl-go/"+gensupport.GoVersion()+" gdcl/"+internal.Version)
	for k, v := range c.header_ {
		reqHeaders[k] = v
...
// Do executes the "gkehub.projects.locations.featureConfigs.get" call.
// Exactly one of *FeatureConfig or error will be non-nil. Any non-2xx
// status code is an error. Response headers are in either
// *FeatureConfig.ServerResponse.Header or (if a response was returned
// at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was
// because http.StatusNotModified was returned.
func (c *ProjectsLocationsFeatureConfigsGetCall) Do(opts ...googleapi.CallOption) (*FeatureConfig, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
...
// method id "gkehub.projects.locations.featureConfigs.list":
...
//
// - parent: The parent where the FeatureConfigs will be listed. In the
//   format: `projects/*/locations/*`.
func (r *ProjectsLocationsFeatureConfigsService) List(parent string) *ProjectsLocationsFeatureConfigsListCall {
	c := &ProjectsLocationsFeatureConfigsListCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.parent = parent
	return c
}

// Filter sets the optional parameter "filter": Lists FeatureConfigs
// that match the filter expression, following the syntax outlined in
// https://google.aip.dev/160.
func (c *ProjectsLocationsFeatureConfigsListCall) Filter(filter string) *ProjectsLocationsFeatureConfigsListCall {
	c.urlParams_.Set("filter", filter)
	return c
}
...
func (c *ProjectsLocationsFeatureConfigsListCall) OrderBy(orderBy string) *ProjectsLocationsFeatureConfigsListCall {
...
func (c *ProjectsLocationsFeatureConfigsListCall) PageSize(pageSize int64) *ProjectsLocationsFeatureConfigsListCall {
	c.urlParams_.Set("pageSize", fmt.Sprint(pageSize))
	return c
}
...
func (c *ProjectsLocationsFeatureConfigsListCall) PageToken(pageToken string) *ProjectsLocationsFeatureConfigsListCall {
	c.urlParams_.Set("pageToken", pageToken)
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *ProjectsLocationsFeatureConfigsListCall) Fields(s ...googleapi.Field) *ProjectsLocationsFeatureConfigsListCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// request. Use googleapi.IsNotModified to check whether the response
// error from Do is the result of In-None-Match.
func (c *ProjectsLocationsFeatureConfigsListCall) IfNoneMatch(entityTag string) *ProjectsLocationsFeatureConfigsListCall {
	c.ifNoneMatch_ = entityTag
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *ProjectsLocationsFeatureConfigsListCall) Context(ctx context.Context) *ProjectsLocationsFeatureConfigsListCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns an http.Header that can be modified by the caller to
// add HTTP headers to the request.
func (c *ProjectsLocationsFeatureConfigsListCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *ProjectsLocationsFeatureConfigsListCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("x-goog-api-client", "gl-go/"+gensupport.GoVersion()+" gdcl/"+internal.Version)
	for k, v := range c.header_ {
		reqHeaders[k] = v
...
// Do executes the "gkehub.projects.locations.featureConfigs.list" call.
// Exactly one of *ListFeatureConfigsResponse or error will be non-nil.
// Any non-2xx status code is an error. Response headers are in either
// *ListFeatureConfigsResponse.ServerResponse.Header or (if a response
// was returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was
// because http.StatusNotModified was returned.
func (c *ProjectsLocationsFeatureConfigsListCall) Do(opts ...googleapi.CallOption) (*ListFeatureConfigsResponse, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
	...
	ret := &ListFeatureConfigsResponse{
		ServerResponse: googleapi.ServerResponse{
			Header:         res.Header,
			HTTPStatusCode: res.StatusCode,
		},
...
// A non-nil error returned from f will halt the iteration.
// The provided context supersedes any context provided to the Context method.
func (c *ProjectsLocationsFeatureConfigsListCall) Pages(ctx context.Context, f func(*ListFeatureConfigsResponse) error) error {
	c.ctx_ = ctx
	defer c.PageToken(c.urlParams_.Get("pageToken")) // reset paging to original point
	for {
		x, err := c.Do()
...
// method id "gkehub.projects.locations.memberships.features.create":
...
//
// - parent: The name of parent where the MembershipFeature will be
...
// method id "gkehub.projects.locations.memberships.features.delete":
...
//
// - name: The name of the membershipFeature to be deleted. Specified in
//   the format `projects/*/locations/*/memberships/*/features/*`.
...
// method id "gkehub.projects.locations.memberships.features.get":
...
// Exactly one of *MembershipFeature or error will be non-nil. Any
// non-2xx status code is an error. Response headers are in either
// *MembershipFeature.ServerResponse.Header or (if a response was
// returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was
// because http.StatusNotModified was returned.
...
// method id "gkehub.projects.locations.memberships.features.list":
...
//
// - parent: The parent where the MembershipFeature will be listed. In
...
// Filter sets the optional parameter "filter": Lists MembershipFeatures
// that match the filter expression, following the syntax outlined in
// https://google.aip.dev/160. Examples: - Feature with the name
// "helloworld" in project "foo-proj" and membership "member-bar": name
// =
// "projects/foo-proj/locations/global/memberships/member-bar/features/he
// lloworld" - Features that have a label called `foo`: labels.foo:* -
...
// Exactly one of *ListMembershipFeaturesResponse or error will be
// non-nil. Any non-2xx status code is an error. Response headers are in
// either *ListMembershipFeaturesResponse.ServerResponse.Header or (if a
...
// method id "gkehub.projects.locations.memberships.features.patch":
...
//
// - name: Output only. The resource name of the membershipFeature, in
//   the format:
//   `projects/{project}/locations/{location}/memberships/{membership}/fe
//   atures/{feature}`. Note that `membershipFeatures` is shortened to
//   `features` in the resource name. (see
//   http://go/aip/122#collection-identifiers).
