...
type EditsServicer interface {
	Commit(packageNameid string, editId string) *EditsCommitCall
	Delete(packageNameid string, editId string) *EditsDeleteCall
	Get(packageNameid string, editId string) *EditsGetCall
	Insert(packageNameid string, appedit *AppEdit) *EditsInsertCall
	Validate(packageNameid string, editId string) *EditsValidateCall
}
...
type EntitlementsServicer interface {
	List(packageName string) *EntitlementsListCall
}
...
type InappproductsServicer interface {
	Batch(inappproductsbatchrequest *InappproductsBatchRequest) *InappproductsBatchCall
	Delete(packageNameid string, skuid string) *InappproductsDeleteCall
	Get(packageName string, skuid string) *InappproductsGetCall
	Insert(packageNameid string, inappproduct *InAppProduct) *InappproductsInsertCall
	List(packageNameid string) *InappproductsListCall
	Patch(packageNameid string, skuid string, inappproduct *InAppProduct) *InappproductsPatchCall
	Update(packageNameid string, skuid string, inappproduct *InAppProduct) *InappproductsUpdateCall
}
