...
// GoogleCloudAiplatformV1beta1AudioResponseFormat: Configuration for
// audio-specific output formatting.
type GoogleCloudAiplatformV1beta1AudioResponseFormat struct {
...
func (s GoogleCloudAiplatformV1beta1AudioResponseFormat) MarshalJSON() ([]byte, error) {
	type NoMethod GoogleCloudAiplatformV1beta1AudioResponseFormat
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}
...
type GoogleCloudAiplatformV1beta1CodeExecutionResult struct {
	...
	//   "OUTCOME_OK" - Code execution completed successfully. `output` contains
	// the stdout, if any.
	//   "OUTCOME_FAILED" - Code execution failed. `output` contains the stderr and
	// stdout, if any.
...
// GoogleCloudAiplatformV1beta1FunctionCall: A predicted FunctionCall returned
...
type GoogleCloudAiplatformV1beta1FunctionCallingConfig struct {
	...
	// Mode is ANY. Function names should match FunctionDeclaration.name. With mode
	// set to ANY, model will predict a function call from the set of function
	// names provided.
...
type GoogleCloudAiplatformV1beta1GenerationConfig struct {
	...
	// ImageConfig: Optional. Config for image generation features. Deprecated: Use
	...
	ResponseFormat []*GoogleCloudAiplatformV1beta1ResponseFormat `json:"responseFormat,omitempty"`
...
// GoogleCloudAiplatformV1beta1ImageResponseFormat: Configuration for
// image-specific output formatting.
type GoogleCloudAiplatformV1beta1ImageResponseFormat struct {
...
func (s GoogleCloudAiplatformV1beta1ImageResponseFormat) MarshalJSON() ([]byte, error) {
	type NoMethod GoogleCloudAiplatformV1beta1ImageResponseFormat
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}
...
type GoogleCloudAiplatformV1beta1Part struct {
	...
	// MediaProcessing: Optional. How the model processes this part's media for
	// understanding. Only meaningful for video parts (`inline_data` or `file_data`
...
// GoogleCloudAiplatformV1beta1ResponseFormat: Configuration for the model to
// configure output formatting and delivery.
type GoogleCloudAiplatformV1beta1ResponseFormat struct {
	// Audio: Audio output format.
	Audio *GoogleCloudAiplatformV1beta1AudioResponseFormat `json:"audio,omitempty"`
	// Image: Image output format.
	Image *GoogleCloudAiplatformV1beta1ImageResponseFormat `json:"image,omitempty"`
	// Text: Text output format.
	Text *GoogleCloudAiplatformV1beta1TextResponseFormat `json:"text,omitempty"`
	// Video: Video output format.
	Video *GoogleCloudAiplatformV1beta1VideoResponseFormat `json:"video,omitempty"`
...
func (s GoogleCloudAiplatformV1beta1ResponseFormat) MarshalJSON() ([]byte, error) {
	type NoMethod GoogleCloudAiplatformV1beta1ResponseFormat
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}
...
func (s GoogleCloudAiplatformV1beta1TextResponseFormat) MarshalJSON() ([]byte, error) {
	type NoMethod GoogleCloudAiplatformV1beta1TextResponseFormat
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}
...
// GoogleCloudAiplatformV1beta1VideoResponseFormat: Configuration for
// video-specific output formatting.
type GoogleCloudAiplatformV1beta1VideoResponseFormat struct {
...
func (s GoogleCloudAiplatformV1beta1VideoResponseFormat) MarshalJSON() ([]byte, error) {
	type NoMethod GoogleCloudAiplatformV1beta1VideoResponseFormat
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}
