...
// Product.title * Product.uri * Product.images * Product.price_info If
// "*" is provided, all fields are returned. Product.name is always
// returned no matter what mask is set. If an unsupported or unknown
