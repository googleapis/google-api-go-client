...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *TemplatesDeleteCall) Ctx(ctx context.Context) *TemplatesDeleteCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *TemplatesGetCall) Ctx(ctx context.Context) *TemplatesGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *TemplatesInsertCall) Ctx(ctx context.Context) *TemplatesInsertCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *TemplatesListCall) Ctx(ctx context.Context) *TemplatesListCall {
	c.ctx_ = ctx
	return c
}
