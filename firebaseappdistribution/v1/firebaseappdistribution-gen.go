...
// GoogleFirebaseAppdistroV1alphaTestReleaseRequest: The request message
// for `TestRelease`.
type GoogleFirebaseAppdistroV1alphaTestReleaseRequest struct {
}

// GoogleFirebaseAppdistroV1alphaTestReleaseResponse: The response
// message for `TestRelease`.
type GoogleFirebaseAppdistroV1alphaTestReleaseResponse struct {
	// TestMatrix: Resource name of the test matrix Format:
	// `v1/projects/{project_id}/testMatrices/{test_matrix_id}`
	...
	// ForceSendFields is a list of field names (e.g. "TestMatrix") to
	// unconditionally include in API requests. By default, fields with
	// empty or default values are omitted from API requests. However, any
	// non-pointer, non-interface field appearing in ForceSendFields will be
	// sent to the server regardless of whether the field is empty or not.
	...
	// NullFields is a list of field names (e.g. "TestMatrix") to include in
	// API requests with the JSON null value. By default, fields with empty
	// values are omitted from API requests. However, any field with an
	// empty value appearing in NullFields will be sent to the server as
	// null. It is an error if a field in this list has a non-empty value.
...
func (s *GoogleFirebaseAppdistroV1alphaTestReleaseResponse) MarshalJSON() ([]byte, error) {
	type NoMethod GoogleFirebaseAppdistroV1alphaTestReleaseResponse
	raw := NoMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}
...
// method id "firebaseappdistribution.projects.apps.releases.test":

type ProjectsAppsReleasesTestCall struct {
	s                                                *Service
	name                                             string
	googlefirebaseappdistrov1alphatestreleaserequest *GoogleFirebaseAppdistroV1alphaTestReleaseRequest
	urlParams_                                       gensupport.URLParams
	ctx_                                             context.Context
	header_                                          http.Header
}

// Test: Run automated test(s) on release.
//
//   - name: The name of the release resource to test. Format:
//     `projects/{project_number}/apps/{app_id}/releases/{release_id}`.
func (r *ProjectsAppsReleasesService) Test(name string, googlefirebaseappdistrov1alphatestreleaserequest *GoogleFirebaseAppdistroV1alphaTestReleaseRequest) *ProjectsAppsReleasesTestCall {
	c := &ProjectsAppsReleasesTestCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.name = name
	c.googlefirebaseappdistrov1alphatestreleaserequest = googlefirebaseappdistrov1alphatestreleaserequest
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *ProjectsAppsReleasesTestCall) Fields(s ...googleapi.Field) *ProjectsAppsReleasesTestCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *ProjectsAppsReleasesTestCall) Context(ctx context.Context) *ProjectsAppsReleasesTestCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns an http.Header that can be modified by the caller to
// add HTTP headers to the request.
func (c *ProjectsAppsReleasesTestCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *ProjectsAppsReleasesTestCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("x-goog-api-client", "gl-go/"+gensupport.GoVersion()+" gdcl/"+internal.Version)
	for k, v := range c.header_ {
		reqHeaders[k] = v
	...
	reqHeaders.Set("User-Agent", c.s.userAgent())
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.googlefirebaseappdistrov1alphatestreleaserequest)
	if err != nil {
		return nil, err
	}
	reqHeaders.Set("Content-Type", "application/json")
...
// Do executes the "firebaseappdistribution.projects.apps.releases.test" call.
// Exactly one of *GoogleFirebaseAppdistroV1alphaTestReleaseResponse or
// error will be non-nil. Any non-2xx status code is an error. Response
// headers are in either
// *GoogleFirebaseAppdistroV1alphaTestReleaseResponse.ServerResponse.Head
// er or (if a response was returned at all) in
// error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was
// returned.
func (c *ProjectsAppsReleasesTestCall) Do(opts ...googleapi.CallOption) (*GoogleFirebaseAppdistroV1alphaTestReleaseResponse, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
	...
	ret := &GoogleFirebaseAppdistroV1alphaTestReleaseResponse{
		ServerResponse: googleapi.ServerResponse{
			Header:         res.Header,
			HTTPStatusCode: res.StatusCode,
		},
	...
	//   "flatPath": "v1/projects/{projectsId}/apps/{appsId}/releases/{releasesId}:test",
	//   "httpMethod": "POST",
	//   "id": "firebaseappdistribution.projects.apps.releases.test",
	//   "parameterOrder": [
	//     "name"
	//   ],
	//   "parameters": {
	//     "name": {
	//       "description": "Required. The name of the release resource to test. Format: `projects/{project_number}/apps/{app_id}/releases/{release_id}`",
	//       "location": "path",
	//       "pattern": "^projects/[^/]+/apps/[^/]+/releases/[^/]+$",
	//       "required": true,
	//       "type": "string"
	...
	//   "path": "v1/{+name}:test",
	//   "request": {
	//     "$ref": "GoogleFirebaseAppdistroV1alphaTestReleaseRequest"
	//   },
	//   "response": {
	//     "$ref": "GoogleFirebaseAppdistroV1alphaTestReleaseResponse"
	//   },
	//   "scopes": [
	//     "https://www.googleapis.com/auth/cloud-platform"
	//   ]
