...
func (c *ProjectsClustersListCall) DoHeader() (*ListAggregatedClustersResponse, http.Header, error) {
...
func (c *ProjectsOperationsListCall) DoHeader() (*ListAggregatedOperationsResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *ProjectsZonesClustersCreateCall) DoHeader() (*Operation, http.Header, error) {
	var body io.Reader = nil
...
func (c *ProjectsZonesClustersDeleteCall) DoHeader() (*Operation, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *ProjectsZonesClustersGetCall) DoHeader() (*Cluster, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *ProjectsZonesClustersListCall) DoHeader() (*ListClustersResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *ProjectsZonesOperationsGetCall) DoHeader() (*Operation, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *ProjectsZonesOperationsListCall) DoHeader() (*ListOperationsResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
