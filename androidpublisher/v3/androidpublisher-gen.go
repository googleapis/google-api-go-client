...
type InAppProduct struct {
	...
	// ResubscribeEligibility: Whether or not the developer wants the
	// specific subscription to be resubscribable. If the developer doesn't
	// use PBL2.0, this value is ignored since the feature is only for
	// developers using PBL2.0. This feature allows users to resubscribe to
	// an expired subscription directly from the subscription center by
	// clicking on a "Resubscribe" CTA under the entry for the expired
	// subscription.
	ResubscribeEligibility string `json:"resubscribeEligibility,omitempty"`
...
type InAppProductListing struct {
	// Benefits: The localized entitlement benefits of the in-app product.
	// These are supported only for subscriptions.
	Benefits []string `json:"benefits,omitempty"`

	// Description: The localized description of the in-app product. These
	// are deprecated for subscriptions.
	Description string `json:"description,omitempty"`

	// Title: The localized title of the in-app product.
...
type TrackRelease struct {
	...
	// highest priority. Default priority is 0. in_app_update_priority can
	// not be updated once the release is rolled out. See
