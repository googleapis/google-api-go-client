...
// CleanupConnectionMetadata: Metadata provided through GetOperation request
// for the LRO generated by Cleanup Connection API
type CleanupConnectionMetadata struct {
}
...
// the LRO generated by Delete Connection API
...
type DnsRecordSet struct {
	...
	// 3.6.1) for examples see https://cloud.google.com/dns/records/json-record.
	...
	// Ttl: Required. The period of time for which this RecordSet can be cached by
	// resolvers.
...
// address ranges for this private service access connection.
type GoogleCloudServicenetworkingV1ConsumerConfigReservedRange struct {
	...
	// valid IPv4 address in the x.x.x.x format. This value combined with the IP
...
// connection resource. A private connection is implemented as a VPC Network
// Peering connection between a service producer's VPC network and a service
...
type GoogleCloudServicenetworkingV1betaConnection struct {
	...
	Peering string `json:"peering,omitempty"`
	// ReservedPeeringRanges: The name of one or more allocated IP address ranges
	// for this service producer of type `PEERING`. Note that invoking this method
...
// created or discovered by a private access management service.
type GoogleCloudServicenetworkingV1betaSubnetwork struct {
	...
	Name string `json:"name,omitempty"`
	// Network: In the Shared VPC host project, the VPC network that's peered with
...
// peering states for the given service and consumer project.
...
// request for the LRO generated by Partial Delete Connection API
type PartialDeleteConnectionMetadata struct {
}

// PeeredDnsDomain: DNS domain suffix for which requests originating in the
// producer VPC network are resolved in the associated consumer VPC network.
...
// the LRO generated by CreatePeeredDnsDomain API.
...
type Range struct {
	// IpCidrRange: CIDR range in "10.x.x.x/y" format that is within the allocated
...
// for the LRO generated by RemoveDnsRecordSet API
...
// RemoveDnsZoneMetadata: Metadata provided through GetOperation request for
// the LRO generated by RemoveDnsZone API
...
// Route: Represents a route that was created or discovered by a private access
// management service.
type Route struct {
	...
	Name string `json:"name,omitempty"`
	// Network: Fully-qualified URL of the VPC network in the producer host tenant
...
type SearchRangeRequest struct {
	// IpPrefixLength: Required. The prefix length of the IP range. Use usual CIDR
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "IpPrefixLength") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// for the LRO generated by UpdateDnsRecordSet API
...
type VpcServiceControls struct {
	// Enabled: Output only. Indicates whether the VPC Service Controls are enabled
	// or disabled for the connection. If the consumer called the
...
func (c *OperationsGetCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "servicenetworking.operations.get", "request", internallog.HTTPRequest(req, nil))
...
func (c *OperationsGetCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "servicenetworking.operations.get", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// AddSubnetwork: For service producers, provisions a new subnet in a peered
// service's shared VPC network in the requested region and with the requested
// size that's expressed as a CIDR range (number of leading bits of ipV4
// network mask). The method checks against the assigned allocated ranges to
// find a non-conflicting IP address range. The method will reuse a subnet if
...
//
//   - parent: A tenant project in the service producer organization, in the
...
//     service, such as `service-peering.example.com`. This service must already
//     be enabled in the service consumer's project.
...
func (c *ServicesAddSubnetworkCall) doRequest(alt string) (*http.Response, error) {
	...
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.addsubnetworkrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "servicenetworking.services.addSubnetwork", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ServicesAddSubnetworkCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "servicenetworking.services.addSubnetwork", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// SearchRange: Service producers can use this method to find a currently
// unused range within consumer allocated ranges. This returned range is not
// reserved, and not guaranteed to remain unused. It will validate previously
// provided allocated ranges, find non-conflicting sub-range of requested size
// (expressed in number of leading bits of ipv4 network mask, as in CIDR range
// notation). Operation
//
//   - parent: This is in a form services/{service}. {service} the name of the
...
func (c *ServicesSearchRangeCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.searchrangerequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "servicenetworking.services.searchRange", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ServicesSearchRangeCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "servicenetworking.services.searchRange", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// UpdateConnections: Updates the allocated ranges that are assigned to a
// connection. The response from the `get` operation will be of type
...
// Force sets the optional parameter "force": If a previously defined allocated
// range is removed, force flag must be set to true.
func (c *ServicesUpdateConnectionsCall) Force(force bool) *ServicesUpdateConnectionsCall {
	c.urlParams_.Set("force", fmt.Sprint(force))
	return c
}

// UpdateMask sets the optional parameter "updateMask": The update mask. If
// this is omitted, it defaults to "*". You can only update the listed peering
// ranges.
...
func (c *ServicesUpdateConnectionsCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.googlecloudservicenetworkingv1betaconnection)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "servicenetworking.services.updateConnections", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ServicesUpdateConnectionsCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "servicenetworking.services.updateConnections", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// Create: Creates a private connection that establishes a VPC Network Peering
...
// only needs to be invoked once. The response from the `get` operation will be
// of type `Connection` if the operation successfully completes.
//
...
func (c *ServicesConnectionsCreateCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "servicenetworking.services.connections.create", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ServicesConnectionsCreateCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "servicenetworking.services.connections.create", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// project number, such as in `12345` that includes the VPC service consumer's
...
func (c *ServicesConnectionsListCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "servicenetworking.services.connections.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ServicesConnectionsListCall) Do(opts ...googleapi.CallOption) (*ListConnectionsResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "servicenetworking.services.connections.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
