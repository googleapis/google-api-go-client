...
// managed DNS zone in the shared
...
type AddDnsZoneRequest struct {
	...
	// producer host project and
	// the peering zone in the consumer project. Must be unique within
	// both
	// projects. The name must be 1-63 characters long, must begin with a
	// letter,
	// end with a letter or digit, and only contain lowercase letters,
	// digits or
	// dashes.
...
// private managed DNS zone in the shared
// producer host project. The name, type, ttl, and data values must all
// exactly
...
// private managed DNS zone in the shared
// producer host project. The name, type, ttl, and data values of the
// existing
// record set must all exactly match an existing record set in the
// specified
// zone.
...
// in the
// shared producer host project and matching peering zones in the
// consumer
// project.
