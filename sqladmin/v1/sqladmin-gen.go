...
type DatabaseInstance struct {
	...
	// ReplicationCluster: Optional. The pair of a primary instance and disaster
	// recovery (DR) replica. A DR replica is a cross-region replica that you
	// designate for failover in the event that the primary instance has regional
	// failure.
...
// Switchover: Switches over from the primary instance to the replica instance.
//
// - instance: Cloud SQL read replica instance name.
