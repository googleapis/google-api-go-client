...
// AwsAccessRole: Authentication method for Amazon Web Services (AWS)
// that uses Google owned Google service account to assume into
// customer's AWS IAM Role.
type AwsAccessRole struct {
	// IamRoleId: The user’s AWS IAM Role that trusts the Google-owned AWS
	// IAM user Connection.
	...
	// NullFields is a list of field names (e.g. "IamRoleId") to include in
...
// AwsProperties: Connection properties specific to Amazon Web Services
// (AWS).
type AwsProperties struct {
	// AccessRole: Authentication using Google owned service account to
	// assume into customer's AWS IAM Role.
...
// AzureProperties: Container for connection properties specific to
// Azure.
type AzureProperties struct {
	...
	// FederatedApplicationClientId: The client ID of the user's Azure
	// Active Directory Application used for a federated connection.
	FederatedApplicationClientId string `json:"federatedApplicationClientId,omitempty"`

	// Identity: Output only. A unique Google-owned and Google-generated
	// identity for the Connection. This identity will be used to access the
	...
	// RedirectUri: The URL user will be redirected to after granting
...
// CloudResourceProperties: Container for connection properties for
// delegation of access to GCP resources.
type CloudResourceProperties struct {
	// ServiceAccountId: Output only. The account ID of the service created
	// for the purpose of this connection. The service account does not have
	// any permissions associated with it when it is created. After
	// creation, customers delegate permissions to the service account. When
	// the connection is used in the context of an operation in BigQuery,
	// the service account will be used to connect to the desired resources
	// in GCP. The account ID is in the form of:
	...
	// NullFields is a list of field names (e.g. "ServiceAccountId") to
	// include in API requests with the JSON null value. By default, fields
	// with empty values are omitted from API requests. However, any field
	// with an empty value appearing in NullFields will be sent to the
	// server as null. It is an error if a field in this list has a
...
// CloudSpannerProperties: Connection properties specific to Cloud
// Spanner.
type CloudSpannerProperties struct {
	// Database: Cloud Spanner database in the form
	// `project/instance/database'
	Database string `json:"database,omitempty"`

	// DatabaseRole: Optional. Cloud Spanner database role for fine-grained
	// access control. The Cloud Spanner admin should have provisioned the
	...
	// MaxParallelism: Allows setting max parallelism per query when
	// executing on Spanner independent compute resources. If unspecified,
	// default values of parallelism are chosen that are dependent on the
	// Cloud Spanner instance configuration. REQUIRES: `use_parallelism`
	// must be set. REQUIRES: `use_data_boost` must be set.
	MaxParallelism int64 `json:"maxParallelism,omitempty"`

	// UseDataBoost: If set, the request will be executed via Spanner
	// independent compute resources. REQUIRES: `use_parallelism` must be
	// set.
	...
	// UseServerlessAnalytics: Deprecated: prefer use_data_boost instead. If
	// the serverless analytics service should be used to read data from
	// Cloud Spanner. Note: `use_parallelism` must be set when using
...
type Connection struct {
	...
	// Name: Output only. The resource name of the connection in the form
	// of:
	// `projects/{project_id}/locations/{location_id}/connections/{connection
	// _id}`
	Name string `json:"name,omitempty"`

	// SalesforceDataCloud: Optional. Salesforce DataCloud properties. This
	// field is intended for use only by Salesforce partner projects. This
...
// MetastoreServiceConfig: Configuration of the Dataproc Metastore
// Service.
...
// SalesforceDataCloudProperties: Connection properties specific to
// Salesforce DataCloud. This is intended for use only by Salesforce
// partner projects.
type SalesforceDataCloudProperties struct {
	// Identity: Output only. A unique Google-owned and Google-generated
	// service account identity for the connection.
	Identity string `json:"identity,omitempty"`
...
type SparkHistoryServerConfig struct {
	...
	// Cluster to act as a Spark History Server for the connection. Example:
...
// SparkProperties: Container for connection properties to execute
// stored procedures for Apache Spark.
type SparkProperties struct {
	// MetastoreServiceConfig: Optional. Dataproc Metastore Service
	...
	// any permissions associated with it when it is created. After
	// creation, customers delegate permissions to the service account. When
	// the connection is used in the context of a stored procedure for
	// Apache Spark in BigQuery, the service account is used to connect to
	// the desired resources in Google Cloud. The account ID is in the form
	// of: bqcx--@gcp-sa-bigquery-consp.iam.gserviceaccount.com
	ServiceAccountId string `json:"serviceAccountId,omitempty"`

	// SparkHistoryServerConfig: Optional. Spark History Server
	// configuration for the connection.
	SparkHistoryServerConfig *SparkHistoryServerConfig `json:"sparkHistoryServerConfig,omitempty"`

	// ForceSendFields is a list of field names (e.g.
	// "MetastoreServiceConfig") to unconditionally include in API requests.
	// By default, fields with empty or default values are omitted from API
	// requests. However, any non-pointer, non-interface field appearing in
	// ForceSendFields will be sent to the server regardless of whether the
	// field is empty or not. This may be used to include empty fields in
	...
	// NullFields is a list of field names (e.g. "MetastoreServiceConfig")
	// to include in API requests with the JSON null value. By default,
	// fields with empty values are omitted from API requests. However, any
	// field with an empty value appearing in NullFields will be sent to the
	// server as null. It is an error if a field in this list has a
