...
// RepresentativeInfoByAddress: Looks up political geography and representative
...
// Address sets the optional parameter "address": The address to look up. May
// only be specified if the field ocdId is not given in the URL
...
// IncludeOffices sets the optional parameter "includeOffices": Whether to
// return information about offices and officials. If false, only the top-level
...
// Levels sets the optional parameter "levels": A list of office levels to
// filter by. Only offices that serve at least one of these levels will be
...
// Roles sets the optional parameter "roles": A list of office roles to filter
// by. Only offices fulfilling one of these roles will be returned. Divisions
...
func (c *RepresentativesRepresentativeInfoByAddressCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "civicinfo.representatives.representativeInfoByAddress", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *RepresentativesRepresentativeInfoByAddressCall) Do(opts ...googleapi.CallOption) (*RepresentativeInfoResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "civicinfo.representatives.representativeInfoByAddress", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// RepresentativeInfoByDivision: Looks up representative information for a
...
// Recursive sets the optional parameter "recursive": If true, information
// about all divisions contained in the division requested will be included as
// well. For example, if querying ocd-division/country:us/district:dc, this
// would also return all DC's wards and ANCs.
...
func (c *RepresentativesRepresentativeInfoByDivisionCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "civicinfo.representatives.representativeInfoByDivision", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *RepresentativesRepresentativeInfoByDivisionCall) Do(opts ...googleapi.CallOption) (*RepresentativeInfoData, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "civicinfo.representatives.representativeInfoByDivision", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
