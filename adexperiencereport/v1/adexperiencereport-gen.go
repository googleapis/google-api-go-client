...
func (c *SitesGetCall) doRequest(alt string) (*http.Response, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "adexperiencereport.sites.get", "request", internallog.HTTPRequest(req, nil))
...
func (c *SitesGetCall) Do(opts ...googleapi.CallOption) (*SiteSummaryResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "adexperiencereport.sites.get", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
// List: Lists sites that are failing in the Ad Experience Report on at least
// one platform.
...
func (c *ViolatingSitesListCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "adexperiencereport.violatingSites.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}
...
func (c *ViolatingSitesListCall) Do(opts ...googleapi.CallOption) (*ViolatingSitesResponse, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "adexperiencereport.violatingSites.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
