...
// can the end time be earlier than the start time. For GAUGE metrics,
// the startTime value is technically optional; if no value is
...
// `cloud_endpoints.service` - `mesh_istio.mesh_uid` -
