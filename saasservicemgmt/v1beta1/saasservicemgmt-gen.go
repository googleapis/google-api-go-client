...
func NewProjectsLocationsService(s *Service) *ProjectsLocationsService {
	...
	rs.ReplicationsInternal = NewProjectsLocationsReplicationsInternalService(s)
...
type ProjectsLocationsService struct {
	...
	ReplicationsInternal *ProjectsLocationsReplicationsInternalService
...
func NewProjectsLocationsReplicationsInternalService(s *Service) *ProjectsLocationsReplicationsInternalService {
	rs := &ProjectsLocationsReplicationsInternalService{s: s}
	return rs
}

type ProjectsLocationsReplicationsInternalService struct {
	s *Service
}
...
// ListReplicationsInternalResponse: The response structure for the
// ListReplicationsInternal method.
type ListReplicationsInternalResponse struct {
	// NextPageToken: If present, the next page token can be provided to a
	// subsequent ListReplicationsInternal call to list the next page. If empty,
	// there are no more pages.
	NextPageToken string `json:"nextPageToken,omitempty"`
	// ReplicationsInternal: The resulting replication internals.
	ReplicationsInternal []*ReplicationInternal `json:"replicationsInternal,omitempty"`
	// Unreachable: Locations that could not be reached.
	Unreachable []string `json:"unreachable,omitempty"`
...
func (s ListReplicationsInternalResponse) MarshalJSON() ([]byte, error) {
	type NoMethod ListReplicationsInternalResponse
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}
...
// ReplicationInternal: ReplicationInternal is a resource that represents the
// replication of a resource to multiple locations. This is an internal
// resource to achieve replication before GA and will not expose to the public
// API.
type ReplicationInternal struct {
	// Annotations: Optional. Annotations is an unstructured key-value map stored
	// with a resource that may be set by external tools to store and retrieve
	// arbitrary metadata. They are not queryable and should be preserved when
	// modifying objects. More info:
	...
	// categorization. similar to Kubernetes resource labels.
	Labels map[string]string `json:"labels,omitempty"`
	// MaxRetryCount: Optional. The maximum number of retries for the replication.
	// If the replication fails from a retryable error, it will be retried for this
	// number of times.
	MaxRetryCount int64 `json:"maxRetryCount,omitempty"`
	// Name: Identifier. The resource name (full URI of the resource) following the
	// standard naming scheme:
	// "projects/{project}/locations/{location}/replicationInternal/{replication_int
	// ernal_id}"
	Name string `json:"name,omitempty"`
	...
	// Stats: Output only. The stats of the replication. One key for each location
	// in target_locations
	Stats map[string]ReplicationStats `json:"stats,omitempty"`
...
func (s ReplicationInternal) MarshalJSON() ([]byte, error) {
	type NoMethod ReplicationInternal
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}

// ReplicationStats: ReplicationStats contains the stats of the replication. It
// contains the resources that are pending, finished, failed, and the errors if
// any.
type ReplicationStats struct {
	...
	FinishedResources []string `json:"finishedResources,omitempty"`
...
func (s ReplicationStats) MarshalJSON() ([]byte, error) {
	type NoMethod ReplicationStats
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}
...
type ProjectsLocationsReplicationsInternalCreateCall struct {
	s                   *Service
	parent              string
...
func (r *ProjectsLocationsReplicationsInternalService) Create(parent string, replicationinternal *ReplicationInternal) *ProjectsLocationsReplicationsInternalCreateCall {
	c := &ProjectsLocationsReplicationsInternalCreateCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.parent = parent
	c.replicationinternal = replicationinternal
	return c
}

// ReplicationInternalId sets the optional parameter "replicationInternalId":
...
func (c *ProjectsLocationsReplicationsInternalCreateCall) ReplicationInternalId(replicationInternalId string) *ProjectsLocationsReplicationsInternalCreateCall {
	c.urlParams_.Set("replicationInternalId", replicationInternalId)
	return c
}
...
func (c *ProjectsLocationsReplicationsInternalCreateCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.replicationinternal)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1beta1/{+parent}/replicationsInternal")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "saasservicemgmt.projects.locations.replicationsInternal.create", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "saasservicemgmt.projects.locations.replicationsInternal.create" call.
// Any non-2xx status code is an error. Response headers are in either
// *ReplicationInternal.ServerResponse.Header or (if a response was returned at
...
func (c *ProjectsLocationsReplicationsInternalCreateCall) Do(opts ...googleapi.CallOption) (*ReplicationInternal, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "saasservicemgmt.projects.locations.replicationsInternal.create", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}

type ProjectsLocationsReplicationsInternalDeleteCall struct {
	s          *Service
	name       string
	urlParams_ gensupport.URLParams
	ctx_       context.Context
...
func (r *ProjectsLocationsReplicationsInternalService) Delete(name string) *ProjectsLocationsReplicationsInternalDeleteCall {
	c := &ProjectsLocationsReplicationsInternalDeleteCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.name = name
	return c
}

// Etag sets the optional parameter "etag": The etag known to the client for
// the expected state of the replication internal. This is used with
...
// provide optimistic concurrency based on the expected existence of the
// replication internal. The Any wildcard (`*`) requires that the resource must
...
func (c *ProjectsLocationsReplicationsInternalDeleteCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "", c.header_)
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1beta1/{+name}")
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "saasservicemgmt.projects.locations.replicationsInternal.delete", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "saasservicemgmt.projects.locations.replicationsInternal.delete" call.
// Any non-2xx status code is an error. Response headers are in either
// *Empty.ServerResponse.Header or (if a response was returned at all) in
// error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
func (c *ProjectsLocationsReplicationsInternalDeleteCall) Do(opts ...googleapi.CallOption) (*Empty, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "saasservicemgmt.projects.locations.replicationsInternal.delete", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}

type ProjectsLocationsReplicationsInternalGetCall struct {
	s            *Service
	name         string
	urlParams_   gensupport.URLParams
	ifNoneMatch_ string
...
func (r *ProjectsLocationsReplicationsInternalService) Get(name string) *ProjectsLocationsReplicationsInternalGetCall {
	c := &ProjectsLocationsReplicationsInternalGetCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.name = name
	return c
}
...
func (c *ProjectsLocationsReplicationsInternalGetCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "", c.header_)
	if c.ifNoneMatch_ != "" {
		reqHeaders.Set("If-None-Match", c.ifNoneMatch_)
	}
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "saasservicemgmt.projects.locations.replicationsInternal.get", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "saasservicemgmt.projects.locations.replicationsInternal.get" call.
// Any non-2xx status code is an error. Response headers are in either
// *ReplicationInternal.ServerResponse.Header or (if a response was returned at
// all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified was
...
func (c *ProjectsLocationsReplicationsInternalGetCall) Do(opts ...googleapi.CallOption) (*ReplicationInternal, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "saasservicemgmt.projects.locations.replicationsInternal.get", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}

type ProjectsLocationsReplicationsInternalListCall struct {
	s            *Service
	parent       string
	urlParams_   gensupport.URLParams
	ifNoneMatch_ string
...
func (r *ProjectsLocationsReplicationsInternalService) List(parent string) *ProjectsLocationsReplicationsInternalListCall {
	c := &ProjectsLocationsReplicationsInternalListCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.parent = parent
	return c
}
...
// PageSize sets the optional parameter "pageSize": The maximum number of
// replication internals to send per page.
...
func (c *ProjectsLocationsReplicationsInternalListCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "", c.header_)
	if c.ifNoneMatch_ != "" {
		reqHeaders.Set("If-None-Match", c.ifNoneMatch_)
	}
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "saasservicemgmt.projects.locations.replicationsInternal.list", "request", internallog.HTTPRequest(req, nil))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "saasservicemgmt.projects.locations.replicationsInternal.list" call.
// Any non-2xx status code is an error. Response headers are in either
// *ListReplicationsInternalResponse.ServerResponse.Header or (if a response
...
func (c *ProjectsLocationsReplicationsInternalListCall) Do(opts ...googleapi.CallOption) (*ListReplicationsInternalResponse, error) {
	...
	ret := &ListReplicationsInternalResponse{
		ServerResponse: googleapi.ServerResponse{
			Header:         res.Header,
			HTTPStatusCode: res.StatusCode,
		},
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "saasservicemgmt.projects.locations.replicationsInternal.list", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
...
type ProjectsLocationsReplicationsInternalPatchCall struct {
	s                   *Service
	name                string
	replicationinternal *ReplicationInternal
	urlParams_          gensupport.URLParams
...
//   - name: Identifier. The resource name (full URI of the resource) following
//     the standard naming scheme:
//     "projects/{project}/locations/{location}/replicationInternal/{replication_i
//     nternal_id}".
func (r *ProjectsLocationsReplicationsInternalService) Patch(name string, replicationinternal *ReplicationInternal) *ProjectsLocationsReplicationsInternalPatchCall {
	c := &ProjectsLocationsReplicationsInternalPatchCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.name = name
	c.replicationinternal = replicationinternal
	return c
}
...
// UpdateMask sets the optional parameter "updateMask": Field mask is used to
// specify the fields to be overwritten in the ReplicationInternal resource by
...
// ReplicationInternal will be overwritten.
...
func (c *ProjectsLocationsReplicationsInternalPatchCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	body, err := googleapi.WithoutDataWrapper.JSONBuffer(c.replicationinternal)
	if err != nil {
		return nil, err
	...
	c.s.logger.DebugContext(c.ctx_, "api request", "serviceName", apiName, "rpcName", "saasservicemgmt.projects.locations.replicationsInternal.patch", "request", internallog.HTTPRequest(req, body.Bytes()))
	return gensupport.SendRequest(c.ctx_, c.s.client, req)
}

// Do executes the "saasservicemgmt.projects.locations.replicationsInternal.patch" call.
// Any non-2xx status code is an error. Response headers are in either
// *ReplicationInternal.ServerResponse.Header or (if a response was returned at
// all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified was
...
func (c *ProjectsLocationsReplicationsInternalPatchCall) Do(opts ...googleapi.CallOption) (*ReplicationInternal, error) {
	...
	c.s.logger.DebugContext(c.ctx_, "api response", "serviceName", apiName, "rpcName", "saasservicemgmt.projects.locations.replicationsInternal.patch", "response", internallog.HTTPResponse(res, b))
	return ret, nil
}
