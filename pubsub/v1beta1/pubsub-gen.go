...
func (c *SubscriptionsCreateCall) DoHeader() (http.Header, *Subscription, error) {
	var body io.Reader = nil
...
func (c *SubscriptionsGetCall) DoHeader() (http.Header, *Subscription, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *SubscriptionsListCall) DoHeader() (http.Header, *ListSubscriptionsResponse, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *SubscriptionsPullCall) DoHeader() (http.Header, *PullResponse, error) {
	var body io.Reader = nil
...
func (c *SubscriptionsPullBatchCall) DoHeader() (http.Header, *PullBatchResponse, error) {
	var body io.Reader = nil
...
func (c *TopicsCreateCall) DoHeader() (http.Header, *Topic, error) {
	var body io.Reader = nil
...
func (c *TopicsGetCall) DoHeader() (http.Header, *Topic, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *TopicsListCall) DoHeader() (http.Header, *ListTopicsResponse, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["maxResults"]; ok {
...
func (c *TopicsPublishBatchCall) DoHeader() (http.Header, *PublishBatchResponse, error) {
	var body io.Reader = nil
