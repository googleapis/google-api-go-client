...
type BuildConfig struct {
	...
	// functions can only use Artifact Registry. If unspecified, it defaults
	// to `ARTIFACT_REGISTRY`. If `docker_repository` field is specified,
	// this field should either be left unspecified or set to
	// `ARTIFACT_REGISTRY`.
	//
	// Possible values:
