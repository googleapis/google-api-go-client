...
// is cancelled.
func (c *GoogleServiceAccountsGetCall) Ctx(ctx context.Context) *GoogleServiceAccountsGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *TransferJobsCreateCall) Ctx(ctx context.Context) *TransferJobsCreateCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *TransferJobsGetCall) Ctx(ctx context.Context) *TransferJobsGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *TransferJobsListCall) Ctx(ctx context.Context) *TransferJobsListCall {
	c.ctx_ = ctx
	return c
}
...
func (c *TransferJobsListCall) Do() (*ListTransferJobsResponse, error) {
	...
	var ret *ListTransferJobsResponse
	if err := json.NewDecoder(res.Body).Decode(&ret); err != nil {
		return nil, err
	}
	return ret, nil
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *TransferJobsPatchCall) Ctx(ctx context.Context) *TransferJobsPatchCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *TransferOperationsCancelCall) Ctx(ctx context.Context) *TransferOperationsCancelCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *TransferOperationsDeleteCall) Ctx(ctx context.Context) *TransferOperationsDeleteCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *TransferOperationsGetCall) Ctx(ctx context.Context) *TransferOperationsGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *TransferOperationsListCall) Ctx(ctx context.Context) *TransferOperationsListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *TransferOperationsPauseCall) Ctx(ctx context.Context) *TransferOperationsPauseCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *TransferOperationsResumeCall) Ctx(ctx context.Context) *TransferOperationsResumeCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *V1GetGoogleServiceAccountCall) Ctx(ctx context.Context) *V1GetGoogleServiceAccountCall {
	c.ctx_ = ctx
	return c
}
