...
func (c *ActivitiesListCall) Do() (ret *Activities, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *ActivitiesWatchCall) Do() (ret *Channel, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *CustomerUsageReportsGetCall) Do() (ret *UsageReports, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *UserUsageReportGetCall) Do() (ret *UsageReports, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
