...
type AccountsServicer interface {
	Authinfo() *AccountsAuthinfoCall
	Custombatch(accountscustombatchrequest *AccountsCustomBatchRequest) *AccountsCustombatchCall
	Delete(merchantId uint64, accountId uint64) *AccountsDeleteCall
	Get(merchantId uint64, accountId uint64) *AccountsGetCall
	Insert(merchantId uint64, account *Account) *AccountsInsertCall
	List(merchantId uint64) *AccountsListCall
	Patch(merchantId uint64, accountId uint64, account *Account) *AccountsPatchCall
	Update(merchantId uint64, accountId uint64, account *Account) *AccountsUpdateCall
}
...
type AccountshippingServicer interface {
	Custombatch(accountshippingcustombatchrequest *AccountshippingCustomBatchRequest) *AccountshippingCustombatchCall
	Get(merchantId uint64, accountId uint64) *AccountshippingGetCall
	List(merchantId uint64) *AccountshippingListCall
	Patch(merchantId uint64, accountId uint64, accountshipping *AccountShipping) *AccountshippingPatchCall
	Update(merchantId uint64, accountId uint64, accountshipping *AccountShipping) *AccountshippingUpdateCall
}
...
type AccountstatusesServicer interface {
	Custombatch(accountstatusescustombatchrequest *AccountstatusesCustomBatchRequest) *AccountstatusesCustombatchCall
	Get(merchantId uint64, accountId uint64) *AccountstatusesGetCall
	List(merchantId uint64) *AccountstatusesListCall
}
...
type AccounttaxServicer interface {
	Custombatch(accounttaxcustombatchrequest *AccounttaxCustomBatchRequest) *AccounttaxCustombatchCall
	Get(merchantId uint64, accountId uint64) *AccounttaxGetCall
	List(merchantId uint64) *AccounttaxListCall
	Patch(merchantId uint64, accountId uint64, accounttax *AccountTax) *AccounttaxPatchCall
	Update(merchantId uint64, accountId uint64, accounttax *AccountTax) *AccounttaxUpdateCall
}
...
type DatafeedsServicer interface {
	Custombatch(datafeedscustombatchrequest *DatafeedsCustomBatchRequest) *DatafeedsCustombatchCall
	Delete(merchantId uint64, datafeedId uint64) *DatafeedsDeleteCall
	Get(merchantId uint64, datafeedId uint64) *DatafeedsGetCall
	Insert(merchantId uint64, datafeed *Datafeed) *DatafeedsInsertCall
	List(merchantId uint64) *DatafeedsListCall
	Patch(merchantId uint64, datafeedId uint64, datafeed *Datafeed) *DatafeedsPatchCall
	Update(merchantId uint64, datafeedId uint64, datafeed *Datafeed) *DatafeedsUpdateCall
}
...
type DatafeedstatusesServicer interface {
	Custombatch(datafeedstatusescustombatchrequest *DatafeedstatusesCustomBatchRequest) *DatafeedstatusesCustombatchCall
	Get(merchantId uint64, datafeedId uint64) *DatafeedstatusesGetCall
	List(merchantId uint64) *DatafeedstatusesListCall
}
...
type InventoryServicer interface {
	Custombatch(inventorycustombatchrequest *InventoryCustomBatchRequest) *InventoryCustombatchCall
	Set(merchantId uint64, storeCode string, productId string, inventorysetrequest *InventorySetRequest) *InventorySetCall
}
...
type ProductsServicer interface {
	Custombatch(productscustombatchrequest *ProductsCustomBatchRequest) *ProductsCustombatchCall
	Delete(merchantId uint64, productId string) *ProductsDeleteCall
	Get(merchantId uint64, productId string) *ProductsGetCall
	Insert(merchantId uint64, product *Product) *ProductsInsertCall
	List(merchantId uint64) *ProductsListCall
}
...
type ProductstatusesServicer interface {
	Custombatch(productstatusescustombatchrequest *ProductstatusesCustomBatchRequest) *ProductstatusesCustombatchCall
	Get(merchantId uint64, productId string) *ProductstatusesGetCall
	List(merchantId uint64) *ProductstatusesListCall
}
