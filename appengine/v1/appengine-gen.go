...
// by changing the serving status of the version to 'STOPPEDwith
// the
// [apps.services.versions.patch`](https://cloud.google.com/appengine
// /docs/admin-api/reference/rest/v1/apps.services.versions/patch)
// method.
