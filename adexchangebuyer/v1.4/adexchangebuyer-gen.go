...
// Exactly one of *AccountsList or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *AccountsList.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *BillingInfo or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *BillingInfo.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *BillingInfoList or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *BillingInfoList.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Budget or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Budget.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Any non-2xx status code is an error.
// Response headers are in either *ClientAccessCapabilities.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *ListClientAccessCapabilitiesResponse or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *ListClientAccessCapabilitiesResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Creative or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Creative.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *CreativesList or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *CreativesList.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *NegotiationDto or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *NegotiationDto.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Any non-2xx status code is an error.
// Response headers are in either *DeleteOrderDealsResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *AddOrderDealsResponse or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *AddOrderDealsResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *GetOrderDealsResponse or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *GetOrderDealsResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Any non-2xx status code is an error.
// Response headers are in either *EditAllOrderDealsResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *AddOrderNotesResponse or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *AddOrderNotesResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *GetOrderNotesResponse or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *GetOrderNotesResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *MarketplaceOffer or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *MarketplaceOffer.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *GetOffersResponse or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *GetOffersResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *MarketplaceOrder or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *MarketplaceOrder.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *CreateOrdersResponse or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *CreateOrdersResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *GetOrdersResponse or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *GetOrdersResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *NegotiationRoundDto or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *NegotiationRoundDto.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *GetNegotiationsResponse or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *GetNegotiationsResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *OfferDto or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *OfferDto.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *ListOffersResponse or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *ListOffersResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *PerformanceReportList or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *PerformanceReportList.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *PretargetingConfig or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *PretargetingConfig.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *PretargetingConfigList or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *PretargetingConfigList.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
