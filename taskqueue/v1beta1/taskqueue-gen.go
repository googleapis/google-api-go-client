...
type TaskqueuesServicer interface {
	Get(project string, taskqueue string) *TaskqueuesGetCall
}
...
type TasksServicer interface {
	Delete(project string, taskqueue string, task string) *TasksDeleteCall
	Get(project string, taskqueue string, task string) *TasksGetCall
	Lease(project string, taskqueue string, numTasks int64, leaseSecs int64) *TasksLeaseCall
	List(project string, taskqueue string) *TasksListCall
}
