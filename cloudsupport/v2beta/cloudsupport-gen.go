...
func (c *SupportEventSubscriptionsCreateCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v2beta/{+parent}/supportEventSubscriptions")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
func (c *SupportEventSubscriptionsExpungeCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v2beta/{+name}:expunge")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
// "https://cloudsupport.googleapis.com/v2beta/$support_event_subscription?updat
// eMask=pub_sub_topic" ``` Python: ```python import googleapiclient.discovery
...
// $(gcloud auth print-access-token)" \
// "https://cloudsupport.googleapis.com/v2beta/$support_event_subscription:undel
// ete" ``` Python: ```python import googleapiclient.discovery api_version =
// "v2beta" supportApiService = googleapiclient.discovery.build(
// serviceName="cloudsupport", version=api_version,
// discoveryServiceUrl=f"https://cloudsupport.googleapis.com/$discovery/rest?ver
// sion={api_version}", ) request =
...
func (c *SupportEventSubscriptionsUndeleteCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v2beta/{+name}:undelete")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
