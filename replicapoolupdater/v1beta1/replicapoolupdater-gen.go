...
type RollingUpdatesServicer interface {
	Cancel(project string, zone string, rollingUpdate string) *RollingUpdatesCancelCall
	Get(project string, zone string, rollingUpdate string) *RollingUpdatesGetCall
	Insert(project string, zone string, rollingupdate *RollingUpdate) *RollingUpdatesInsertCall
	List(project string, zone string) *RollingUpdatesListCall
	ListInstanceUpdates(project string, zone string, rollingUpdate string) *RollingUpdatesListInstanceUpdatesCall
	Pause(project string, zone string, rollingUpdate string) *RollingUpdatesPauseCall
	Resume(project string, zone string, rollingUpdate string) *RollingUpdatesResumeCall
	Rollback(project string, zone string, rollingUpdate string) *RollingUpdatesRollbackCall
}
