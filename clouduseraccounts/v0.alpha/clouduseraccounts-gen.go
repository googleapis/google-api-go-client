...
// is cancelled.
func (c *GlobalAccountsOperationsDeleteCall) Ctx(ctx context.Context) *GlobalAccountsOperationsDeleteCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *GlobalAccountsOperationsGetCall) Ctx(ctx context.Context) *GlobalAccountsOperationsGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *GlobalAccountsOperationsListCall) Ctx(ctx context.Context) *GlobalAccountsOperationsListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *GroupsAddMemberCall) Ctx(ctx context.Context) *GroupsAddMemberCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *GroupsDeleteCall) Ctx(ctx context.Context) *GroupsDeleteCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *GroupsGetCall) Ctx(ctx context.Context) *GroupsGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *GroupsGetIamPolicyCall) Ctx(ctx context.Context) *GroupsGetIamPolicyCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *GroupsInsertCall) Ctx(ctx context.Context) *GroupsInsertCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *GroupsListCall) Ctx(ctx context.Context) *GroupsListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *GroupsRemoveMemberCall) Ctx(ctx context.Context) *GroupsRemoveMemberCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *GroupsSetIamPolicyCall) Ctx(ctx context.Context) *GroupsSetIamPolicyCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *GroupsTestIamPermissionsCall) Ctx(ctx context.Context) *GroupsTestIamPermissionsCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *LinuxGetAuthorizedKeysViewCall) Ctx(ctx context.Context) *LinuxGetAuthorizedKeysViewCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *LinuxGetLinuxAccountViewsCall) Ctx(ctx context.Context) *LinuxGetLinuxAccountViewsCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *UsersAddPublicKeyCall) Ctx(ctx context.Context) *UsersAddPublicKeyCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *UsersDeleteCall) Ctx(ctx context.Context) *UsersDeleteCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *UsersGetCall) Ctx(ctx context.Context) *UsersGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *UsersGetIamPolicyCall) Ctx(ctx context.Context) *UsersGetIamPolicyCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *UsersInsertCall) Ctx(ctx context.Context) *UsersInsertCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *UsersListCall) Ctx(ctx context.Context) *UsersListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *UsersRemovePublicKeyCall) Ctx(ctx context.Context) *UsersRemovePublicKeyCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *UsersSetIamPolicyCall) Ctx(ctx context.Context) *UsersSetIamPolicyCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *UsersTestIamPermissionsCall) Ctx(ctx context.Context) *UsersTestIamPermissionsCall {
	c.ctx_ = ctx
	return c
}
