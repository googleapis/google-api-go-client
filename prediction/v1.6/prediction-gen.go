...
func (c *TrainedmodelsAnalyzeCall) DoHeader() (*Analyze, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *TrainedmodelsGetCall) DoHeader() (*Insert2, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *TrainedmodelsInsertCall) DoHeader() (*Insert2, http.Header, error) {
	var body io.Reader = nil
...
func (c *TrainedmodelsListCall) DoHeader() (*List, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *TrainedmodelsUpdateCall) DoHeader() (*Insert2, http.Header, error) {
	var body io.Reader = nil
