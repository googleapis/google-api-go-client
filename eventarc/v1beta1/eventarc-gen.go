...
type CloudRunService struct {
	...
	// Region: Optional. The region the Cloud Run service is deployed in. If
	// not set, the location of the trigger is used. For triggers in the
	// "global" location, setting this field is mandatory.
