...
func (c *UrlGetCall) DoHeader() (http.Header, *Url, error) {
...
func (c *UrlInsertCall) DoHeader() (http.Header, *Url, error) {
	var body io.Reader = nil
...
func (c *UrlListCall) DoHeader() (http.Header, *UrlHistory, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["projection"]; ok {
