...
func (c *CustomFieldDefListCall) DoHeader() (http.Header, *CustomFieldDefListResponse, error) {
...
func (c *JobsGetCall) DoHeader() (http.Header, *Job, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *JobsInsertCall) DoHeader() (http.Header, *Job, error) {
	var body io.Reader = nil
...
func (c *JobsListCall) DoHeader() (http.Header, *JobListResponse, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *JobsPatchCall) DoHeader() (http.Header, *Job, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.job)
	if err != nil {
		return nil, nil, err
...
func (c *JobsUpdateCall) DoHeader() (http.Header, *Job, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.job)
	if err != nil {
		return nil, nil, err
...
func (c *LocationListCall) DoHeader() (http.Header, *LocationListResponse, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *ScheduleGetCall) DoHeader() (http.Header, *Schedule, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *SchedulePatchCall) DoHeader() (http.Header, *Schedule, error) {
	var body io.Reader = nil
...
func (c *ScheduleUpdateCall) DoHeader() (http.Header, *Schedule, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.schedule)
	if err != nil {
		return nil, nil, err
...
func (c *TeamListCall) DoHeader() (http.Header, *TeamListResponse, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *WorkerListCall) DoHeader() (http.Header, *WorkerListResponse, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
