...
const apiId = "ondemandscanning:v1"
...
// AnalyzePackagesRequestV1: AnalyzePackagesRequest is the request to
...
type AnalyzePackagesRequestV1 struct {
	...
	// ForceSendFields is a list of field names (e.g. "IncludeOsvData") to
	// unconditionally include in API requests. By default, fields with
	// empty or default values are omitted from API requests. However, any
	// non-pointer, non-interface field appearing in ForceSendFields will be
	// sent to the server regardless of whether the field is empty or not.
	...
	// NullFields is a list of field names (e.g. "IncludeOsvData") to
...
func (s *AnalyzePackagesRequestV1) MarshalJSON() ([]byte, error) {
	type NoMethod AnalyzePackagesRequestV1
	raw := NoMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}
...
// ListVulnerabilitiesResponseV1: ListVulnerabilitiesResponse contains a
...
func (s *ListVulnerabilitiesResponseV1) MarshalJSON() ([]byte, error) {
	type NoMethod ListVulnerabilitiesResponseV1
	raw := NoMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}
...
type ProjectsLocationsScansAnalyzePackagesCall struct {
	s                        *Service
	parent                   string
	analyzepackagesrequestv1 *AnalyzePackagesRequestV1
	urlParams_               gensupport.URLParams
	ctx_                     context.Context
	header_                  http.Header
}
...
func (r *ProjectsLocationsScansService) AnalyzePackages(parent string, analyzepackagesrequestv1 *AnalyzePackagesRequestV1) *ProjectsLocationsScansAnalyzePackagesCall {
	...
	c.parent = parent
	c.analyzepackagesrequestv1 = analyzepackagesrequestv1
	return c
}
...
func (c *ProjectsLocationsScansAnalyzePackagesCall) doRequest(alt string) (*http.Response, error) {
	...
	reqHeaders.Set("User-Agent", c.s.userAgent())
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.analyzepackagesrequestv1)
	if err != nil {
		return nil, err
	}
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/{+parent}/scans:analyzePackages")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
func (c *ProjectsLocationsScansVulnerabilitiesListCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/{+parent}/vulnerabilities")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("GET", urls, body)
	if err != nil {
		return nil, err
...
// Exactly one of *ListVulnerabilitiesResponseV1 or error will be
// non-nil. Any non-2xx status code is an error. Response headers are in
// either *ListVulnerabilitiesResponseV1.ServerResponse.Header or (if a
// response was returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was
// because http.StatusNotModified was returned.
func (c *ProjectsLocationsScansVulnerabilitiesListCall) Do(opts ...googleapi.CallOption) (*ListVulnerabilitiesResponseV1, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
	...
	ret := &ListVulnerabilitiesResponseV1{
		ServerResponse: googleapi.ServerResponse{
			Header:         res.Header,
			HTTPStatusCode: res.StatusCode,
		},
...
// A non-nil error returned from f will halt the iteration.
// The provided context supersedes any context provided to the Context method.
func (c *ProjectsLocationsScansVulnerabilitiesListCall) Pages(ctx context.Context, f func(*ListVulnerabilitiesResponseV1) error) error {
	c.ctx_ = ctx
	defer c.PageToken(c.urlParams_.Get("pageToken")) // reset paging to original point
	for {
		x, err := c.Do()
