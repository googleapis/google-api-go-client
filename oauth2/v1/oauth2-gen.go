...
func (c *GetCertForOpenIdConnectCall) DoHeader() (map[string]string, http.Header, error) {
...
// "ifNoneMatch": Makes the operation conditional on whether
// the object's Etag does not match the given value.
func (c *GetCertForOpenIdConnectRawCall) IfNoneMatch(ifNoneMatch string) *GetCertForOpenIdConnectRawCall {
	c.opt_["ifNoneMatch"] = ifNoneMatch
	return c
}
...
func (c *GetCertForOpenIdConnectRawCall) DoHeader() (*Raw, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
// "ifNoneMatch": Makes the operation conditional on whether
// the object's Etag does not match the given value.
func (c *GetRobotMetadataRawCall) IfNoneMatch(ifNoneMatch string) *GetRobotMetadataRawCall {
	c.opt_["ifNoneMatch"] = ifNoneMatch
	return c
}
...
func (c *GetRobotMetadataRawCall) DoHeader() (*Raw, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
// "ifNoneMatch": Makes the operation conditional on whether
// the object's Etag does not match the given value.
func (c *GetRobotMetadataX509Call) IfNoneMatch(ifNoneMatch string) *GetRobotMetadataX509Call {
	c.opt_["ifNoneMatch"] = ifNoneMatch
	return c
}
...
func (c *GetRobotMetadataX509Call) DoHeader() (map[string]string, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
