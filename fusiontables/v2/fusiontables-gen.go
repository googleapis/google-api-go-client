...
type ColumnServicer interface {
	Delete(tableId string, columnId string) *ColumnDeleteCall
	Get(tableId string, columnId string) *ColumnGetCall
	Insert(tableId string, column *Column) *ColumnInsertCall
	List(tableId string) *ColumnListCall
	Patch(tableId string, columnId string, column *Column) *ColumnPatchCall
	Update(tableId string, columnId string, column *Column) *ColumnUpdateCall
}
...
type QueryServicer interface {
	Sql(sql string) *QuerySqlCall
	SqlGet(sql string) *QuerySqlGetCall
}
...
type StyleServicer interface {
	Delete(tableId string, styleId int64) *StyleDeleteCall
	Get(tableId string, styleId int64) *StyleGetCall
	Insert(tableId string, stylesetting *StyleSetting) *StyleInsertCall
	List(tableId string) *StyleListCall
	Patch(tableId string, styleId int64, stylesetting *StyleSetting) *StylePatchCall
	Update(tableId string, styleId int64, stylesetting *StyleSetting) *StyleUpdateCall
}
...
type TableServicer interface {
	Copy(tableId string) *TableCopyCall
	Delete(tableId string) *TableDeleteCall
	Get(tableId string) *TableGetCall
	ImportRows(tableId string) *TableImportRowsCall
	ImportTable(name string) *TableImportTableCall
	Insert(table *Table) *TableInsertCall
	List() *TableListCall
	Patch(tableId string, table *Table) *TablePatchCall
	ReplaceRows(tableId string) *TableReplaceRowsCall
	Update(tableId string, table *Table) *TableUpdateCall
}
...
type TaskServicer interface {
	Delete(tableId string, taskId string) *TaskDeleteCall
	Get(tableId string, taskId string) *TaskGetCall
	List(tableId string) *TaskListCall
}
...
type TemplateServicer interface {
	Delete(tableId string, templateId int64) *TemplateDeleteCall
	Get(tableId string, templateId int64) *TemplateGetCall
	Insert(tableId string, template *Template) *TemplateInsertCall
	List(tableId string) *TemplateListCall
	Patch(tableId string, templateId int64, template *Template) *TemplatePatchCall
	Update(tableId string, templateId int64, template *Template) *TemplateUpdateCall
}
