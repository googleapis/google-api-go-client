...
// GoogleCloudVisionV1AnnotateImageRequest: Request for performing
// Google Cloud Vision API tasks over a user-provided
// image, with user-requested features.
type GoogleCloudVisionV1AnnotateImageRequest struct {
	// Features: Requested features.
	Features []*GoogleCloudVisionV1Feature `json:"features,omitempty"`

	// Image: The image to be processed.
	Image *GoogleCloudVisionV1Image `json:"image,omitempty"`

	// ImageContext: Additional context that may accompany the image.
	ImageContext *GoogleCloudVisionV1ImageContext `json:"imageContext,omitempty"`
...
func (s *GoogleCloudVisionV1AnnotateImageRequest) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1AnnotateImageRequest
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

// GoogleCloudVisionV1AnnotateImageResponse: Response to an image
// annotation request.
type GoogleCloudVisionV1AnnotateImageResponse struct {
	// CropHintsAnnotation: If present, crop hints have completed
	// successfully.
	CropHintsAnnotation *GoogleCloudVisionV1CropHintsAnnotation `json:"cropHintsAnnotation,omitempty"`
	...
	// successfully.
	FaceAnnotations []*GoogleCloudVisionV1FaceAnnotation `json:"faceAnnotations,omitempty"`
	...
	// detected
	// text.
	FullTextAnnotation *GoogleCloudVisionV1TextAnnotation `json:"fullTextAnnotation,omitempty"`

	// ImagePropertiesAnnotation: If present, image properties were
	// extracted successfully.
	ImagePropertiesAnnotation *GoogleCloudVisionV1ImageProperties `json:"imagePropertiesAnnotation,omitempty"`

	// LabelAnnotations: If present, label detection has completed
	// successfully.
	LabelAnnotations []*GoogleCloudVisionV1EntityAnnotation `json:"labelAnnotations,omitempty"`

	// LandmarkAnnotations: If present, landmark detection has completed
	// successfully.
	LandmarkAnnotations []*GoogleCloudVisionV1EntityAnnotation `json:"landmarkAnnotations,omitempty"`

	// LogoAnnotations: If present, logo detection has completed
	// successfully.
	LogoAnnotations []*GoogleCloudVisionV1EntityAnnotation `json:"logoAnnotations,omitempty"`

	// SafeSearchAnnotation: If present, safe-search annotation has
	// completed successfully.
	SafeSearchAnnotation *GoogleCloudVisionV1SafeSearchAnnotation `json:"safeSearchAnnotation,omitempty"`

	// TextAnnotations: If present, text (OCR) detection has completed
	// successfully.
	TextAnnotations []*GoogleCloudVisionV1EntityAnnotation `json:"textAnnotations,omitempty"`

	// WebDetection: If present, web detection has completed successfully.
	WebDetection *GoogleCloudVisionV1WebDetection `json:"webDetection,omitempty"`
...
func (s *GoogleCloudVisionV1AnnotateImageResponse) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1AnnotateImageResponse
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

// GoogleCloudVisionV1BatchAnnotateImagesRequest: Multiple image
// annotation requests are batched into a single service call.
type GoogleCloudVisionV1BatchAnnotateImagesRequest struct {
	// Requests: Individual image annotation requests for this batch.
	Requests []*GoogleCloudVisionV1AnnotateImageRequest `json:"requests,omitempty"`
...
func (s *GoogleCloudVisionV1BatchAnnotateImagesRequest) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1BatchAnnotateImagesRequest
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

// GoogleCloudVisionV1BatchAnnotateImagesResponse: Response to a batch
// image annotation request.
type GoogleCloudVisionV1BatchAnnotateImagesResponse struct {
	// Responses: Individual responses to image annotation requests within
	// the batch.
	Responses []*GoogleCloudVisionV1AnnotateImageResponse `json:"responses,omitempty"`
...
func (s *GoogleCloudVisionV1BatchAnnotateImagesResponse) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1BatchAnnotateImagesResponse
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

// GoogleCloudVisionV1Block: Logical element on the page.
type GoogleCloudVisionV1Block struct {
	...
	BoundingBox *GoogleCloudVisionV1BoundingPoly `json:"boundingBox,omitempty"`

	// Paragraphs: List of paragraphs in this block (if this blocks is of
	// type text).
	Paragraphs []*GoogleCloudVisionV1Paragraph `json:"paragraphs,omitempty"`

	// Property: Additional information detected for the block.
	Property *GoogleCloudVisionV1TextAnnotationTextProperty `json:"property,omitempty"`
...
func (s *GoogleCloudVisionV1Block) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1Block
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

// GoogleCloudVisionV1BoundingPoly: A bounding polygon for the detected
// image annotation.
type GoogleCloudVisionV1BoundingPoly struct {
	// Vertices: The bounding polygon vertices.
	Vertices []*GoogleCloudVisionV1Vertex `json:"vertices,omitempty"`
...
func (s *GoogleCloudVisionV1BoundingPoly) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1BoundingPoly
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

// GoogleCloudVisionV1ColorInfo: Color information consists of RGB
// channels, score, and the fraction of
// the image that the color occupies in the image.
type GoogleCloudVisionV1ColorInfo struct {
...
func (s *GoogleCloudVisionV1ColorInfo) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1ColorInfo
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

func (s *GoogleCloudVisionV1ColorInfo) UnmarshalJSON(data []byte) error {
	type noMethod GoogleCloudVisionV1ColorInfo
	var s1 struct {
...
// GoogleCloudVisionV1CropHint: Single crop hint that is used to
// generate a new crop when serving an image.
type GoogleCloudVisionV1CropHint struct {
	// BoundingPoly: The bounding polygon for the crop region. The
	// coordinates of the bounding
	// box are in the original image's scale, as returned in `ImageParams`.
	BoundingPoly *GoogleCloudVisionV1BoundingPoly `json:"boundingPoly,omitempty"`
...
func (s *GoogleCloudVisionV1CropHint) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1CropHint
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

func (s *GoogleCloudVisionV1CropHint) UnmarshalJSON(data []byte) error {
	type noMethod GoogleCloudVisionV1CropHint
	var s1 struct {
...
// GoogleCloudVisionV1CropHintsAnnotation: Set of crop hints that are
// used to generate new crops when serving images.
type GoogleCloudVisionV1CropHintsAnnotation struct {
	// CropHints: Crop hint results.
	CropHints []*GoogleCloudVisionV1CropHint `json:"cropHints,omitempty"`
...
func (s *GoogleCloudVisionV1CropHintsAnnotation) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1CropHintsAnnotation
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

// GoogleCloudVisionV1CropHintsParams: Parameters for crop hints
// annotation request.
type GoogleCloudVisionV1CropHintsParams struct {
...
func (s *GoogleCloudVisionV1CropHintsParams) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1CropHintsParams
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

// GoogleCloudVisionV1DominantColorsAnnotation: Set of dominant colors
// and their corresponding scores.
type GoogleCloudVisionV1DominantColorsAnnotation struct {
	// Colors: RGB color values with their score and pixel fraction.
	Colors []*GoogleCloudVisionV1ColorInfo `json:"colors,omitempty"`
...
func (s *GoogleCloudVisionV1DominantColorsAnnotation) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1DominantColorsAnnotation
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

// GoogleCloudVisionV1EntityAnnotation: Set of detected entity features.
type GoogleCloudVisionV1EntityAnnotation struct {
	...
	Locations []*GoogleCloudVisionV1LocationInfo `json:"locations,omitempty"`
	...
	Properties []*GoogleCloudVisionV1Property `json:"properties,omitempty"`
...
func (s *GoogleCloudVisionV1EntityAnnotation) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1EntityAnnotation
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

func (s *GoogleCloudVisionV1EntityAnnotation) UnmarshalJSON(data []byte) error {
	type noMethod GoogleCloudVisionV1EntityAnnotation
	var s1 struct {
		Confidence gensupport.JSONFloat64 `json:"confidence"`
		Score      gensupport.JSONFloat64 `json:"score"`
...
// GoogleCloudVisionV1FaceAnnotation: A face annotation object contains
// the results of face detection.
type GoogleCloudVisionV1FaceAnnotation struct {
	...
	FdBoundingPoly *GoogleCloudVisionV1BoundingPoly `json:"fdBoundingPoly,omitempty"`
	...
	Landmarks []*GoogleCloudVisionV1FaceAnnotationLandmark `json:"landmarks,omitempty"`
...
func (s *GoogleCloudVisionV1FaceAnnotation) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1FaceAnnotation
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

func (s *GoogleCloudVisionV1FaceAnnotation) UnmarshalJSON(data []byte) error {
	type noMethod GoogleCloudVisionV1FaceAnnotation
	var s1 struct {
...
// GoogleCloudVisionV1FaceAnnotationLandmark: A face-specific landmark
// (for example, a face feature).
type GoogleCloudVisionV1FaceAnnotationLandmark struct {
	// Position: Face landmark position.
	Position *GoogleCloudVisionV1Position `json:"position,omitempty"`
...
func (s *GoogleCloudVisionV1FaceAnnotationLandmark) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1FaceAnnotationLandmark
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

// GoogleCloudVisionV1Feature: Users describe the type of Google Cloud
// Vision API tasks to perform over
...
// return.
type GoogleCloudVisionV1Feature struct {
...
func (s *GoogleCloudVisionV1Feature) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1Feature
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

// GoogleCloudVisionV1Image: Client image to perform Google Cloud Vision
// API tasks over.
type GoogleCloudVisionV1Image struct {
	...
	Source *GoogleCloudVisionV1ImageSource `json:"source,omitempty"`
...
func (s *GoogleCloudVisionV1Image) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1Image
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

// GoogleCloudVisionV1ImageContext: Image context and/or
// feature-specific parameters.
type GoogleCloudVisionV1ImageContext struct {
	// CropHintsParams: Parameters for crop hints annotation request.
	CropHintsParams *GoogleCloudVisionV1CropHintsParams `json:"cropHintsParams,omitempty"`
	...
	// image.
	LatLongRect *GoogleCloudVisionV1LatLongRect `json:"latLongRect,omitempty"`
...
func (s *GoogleCloudVisionV1ImageContext) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1ImageContext
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

// GoogleCloudVisionV1ImageProperties: Stores image properties, such as
// dominant colors.
type GoogleCloudVisionV1ImageProperties struct {
	// DominantColors: If present, dominant colors completed successfully.
	DominantColors *GoogleCloudVisionV1DominantColorsAnnotation `json:"dominantColors,omitempty"`
...
func (s *GoogleCloudVisionV1ImageProperties) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1ImageProperties
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

// GoogleCloudVisionV1ImageSource: External image source (Google Cloud
// Storage image location).
type GoogleCloudVisionV1ImageSource struct {
...
func (s *GoogleCloudVisionV1ImageSource) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1ImageSource
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

// GoogleCloudVisionV1LatLongRect: Rectangle determined by min and max
// `LatLng` pairs.
type GoogleCloudVisionV1LatLongRect struct {
...
func (s *GoogleCloudVisionV1LatLongRect) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1LatLongRect
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

// GoogleCloudVisionV1LocationInfo: Detected entity location
// information.
type GoogleCloudVisionV1LocationInfo struct {
...
func (s *GoogleCloudVisionV1LocationInfo) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1LocationInfo
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

// GoogleCloudVisionV1Page: Detected page from OCR.
type GoogleCloudVisionV1Page struct {
	// Blocks: List of blocks of text, images etc on this page.
	Blocks []*GoogleCloudVisionV1Block `json:"blocks,omitempty"`
...
func (s *GoogleCloudVisionV1Page) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1Page
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

// GoogleCloudVisionV1Paragraph: Structural unit of text representing a
// number of words in certain order.
type GoogleCloudVisionV1Paragraph struct {
	...
	Words []*GoogleCloudVisionV1Word `json:"words,omitempty"`
...
func (s *GoogleCloudVisionV1Paragraph) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1Paragraph
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

// GoogleCloudVisionV1Position: A 3D position in the image, used
// primarily for Face detection landmarks.
// A valid Position must have both x and y coordinates.
// The position coordinates are in the same scale as the original image.
type GoogleCloudVisionV1Position struct {
	// X: X coordinate.
...
func (s *GoogleCloudVisionV1Position) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1Position
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

func (s *GoogleCloudVisionV1Position) UnmarshalJSON(data []byte) error {
	type noMethod GoogleCloudVisionV1Position
	var s1 struct {
...
// GoogleCloudVisionV1Property: A `Property` consists of a user-supplied
// name/value pair.
type GoogleCloudVisionV1Property struct {
...
func (s *GoogleCloudVisionV1Property) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1Property
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

// GoogleCloudVisionV1SafeSearchAnnotation: Set of features pertaining
// to the image, computed by computer vision
// methods over safe-search verticals (for example, adult, spoof,
// medical,
// violence).
type GoogleCloudVisionV1SafeSearchAnnotation struct {
...
func (s *GoogleCloudVisionV1SafeSearchAnnotation) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1SafeSearchAnnotation
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

// GoogleCloudVisionV1Symbol: A single symbol representation.
type GoogleCloudVisionV1Symbol struct {
...
func (s *GoogleCloudVisionV1Symbol) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1Symbol
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

// GoogleCloudVisionV1TextAnnotation: TextAnnotation contains a
...
// more
// detail.
type GoogleCloudVisionV1TextAnnotation struct {
	// Pages: List of pages detected by OCR.
	Pages []*GoogleCloudVisionV1Page `json:"pages,omitempty"`
...
func (s *GoogleCloudVisionV1TextAnnotation) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1TextAnnotation
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

// GoogleCloudVisionV1TextAnnotationDetectedBreak: Detected start or end
// of a structural component.
type GoogleCloudVisionV1TextAnnotationDetectedBreak struct {
...
func (s *GoogleCloudVisionV1TextAnnotationDetectedBreak) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1TextAnnotationDetectedBreak
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

// GoogleCloudVisionV1TextAnnotationDetectedLanguage: Detected language
// for a structural component.
type GoogleCloudVisionV1TextAnnotationDetectedLanguage struct {
...
func (s *GoogleCloudVisionV1TextAnnotationDetectedLanguage) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1TextAnnotationDetectedLanguage
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

func (s *GoogleCloudVisionV1TextAnnotationDetectedLanguage) UnmarshalJSON(data []byte) error {
	type noMethod GoogleCloudVisionV1TextAnnotationDetectedLanguage
	var s1 struct {
		Confidence gensupport.JSONFloat64 `json:"confidence"`
		*noMethod
...
// GoogleCloudVisionV1TextAnnotationTextProperty: Additional information
// detected on the structural component.
type GoogleCloudVisionV1TextAnnotationTextProperty struct {
	// DetectedBreak: Detected start or end of a text segment.
	DetectedBreak *GoogleCloudVisionV1TextAnnotationDetectedBreak `json:"detectedBreak,omitempty"`

	// DetectedLanguages: A list of detected languages together with
	// confidence.
	DetectedLanguages []*GoogleCloudVisionV1TextAnnotationDetectedLanguage `json:"detectedLanguages,omitempty"`
...
func (s *GoogleCloudVisionV1TextAnnotationTextProperty) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1TextAnnotationTextProperty
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

// GoogleCloudVisionV1Vertex: A vertex represents a 2D point in the
// image.
// NOTE: the vertex coordinates are in the same scale as the original
// image.
type GoogleCloudVisionV1Vertex struct {
	// X: X coordinate.
...
func (s *GoogleCloudVisionV1Vertex) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1Vertex
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

// GoogleCloudVisionV1WebDetection: Relevant information for the image
// from the Internet.
type GoogleCloudVisionV1WebDetection struct {
	// FullMatchingImages: Fully matching images from the Internet.
	// Can include resized copies of the query image.
	FullMatchingImages []*GoogleCloudVisionV1WebDetectionWebImage `json:"fullMatchingImages,omitempty"`

	// PagesWithMatchingImages: Web pages containing the matching images
	// from the Internet.
	PagesWithMatchingImages []*GoogleCloudVisionV1WebDetectionWebPage `json:"pagesWithMatchingImages,omitempty"`
	...
	// crops.
	PartialMatchingImages []*GoogleCloudVisionV1WebDetectionWebImage `json:"partialMatchingImages,omitempty"`

	// VisuallySimilarImages: The visually similar image results.
	VisuallySimilarImages []*GoogleCloudVisionV1WebDetectionWebImage `json:"visuallySimilarImages,omitempty"`

	// WebEntities: Deduced entities from similar images on the Internet.
	WebEntities []*GoogleCloudVisionV1WebDetectionWebEntity `json:"webEntities,omitempty"`
...
func (s *GoogleCloudVisionV1WebDetection) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1WebDetection
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

// GoogleCloudVisionV1WebDetectionWebEntity: Entity deduced from similar
// images on the Internet.
type GoogleCloudVisionV1WebDetectionWebEntity struct {
...
func (s *GoogleCloudVisionV1WebDetectionWebEntity) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1WebDetectionWebEntity
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

func (s *GoogleCloudVisionV1WebDetectionWebEntity) UnmarshalJSON(data []byte) error {
	type noMethod GoogleCloudVisionV1WebDetectionWebEntity
	var s1 struct {
		Score gensupport.JSONFloat64 `json:"score"`
		*noMethod
...
// GoogleCloudVisionV1WebDetectionWebImage: Metadata for online images.
type GoogleCloudVisionV1WebDetectionWebImage struct {
...
func (s *GoogleCloudVisionV1WebDetectionWebImage) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1WebDetectionWebImage
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

func (s *GoogleCloudVisionV1WebDetectionWebImage) UnmarshalJSON(data []byte) error {
	type noMethod GoogleCloudVisionV1WebDetectionWebImage
	var s1 struct {
		Score gensupport.JSONFloat64 `json:"score"`
		*noMethod
...
// GoogleCloudVisionV1WebDetectionWebPage: Metadata for web pages.
type GoogleCloudVisionV1WebDetectionWebPage struct {
...
func (s *GoogleCloudVisionV1WebDetectionWebPage) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1WebDetectionWebPage
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

func (s *GoogleCloudVisionV1WebDetectionWebPage) UnmarshalJSON(data []byte) error {
	type noMethod GoogleCloudVisionV1WebDetectionWebPage
	var s1 struct {
		Score gensupport.JSONFloat64 `json:"score"`
		*noMethod
...
// GoogleCloudVisionV1Word: A word representation.
type GoogleCloudVisionV1Word struct {
	...
	Symbols []*GoogleCloudVisionV1Symbol `json:"symbols,omitempty"`
...
func (s *GoogleCloudVisionV1Word) MarshalJSON() ([]byte, error) {
	type noMethod GoogleCloudVisionV1Word
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}
...
type ImagesAnnotateCall struct {
	s                                             *Service
	googlecloudvisionv1batchannotateimagesrequest *GoogleCloudVisionV1BatchAnnotateImagesRequest
...
func (r *ImagesService) Annotate(googlecloudvisionv1batchannotateimagesrequest *GoogleCloudVisionV1BatchAnnotateImagesRequest) *ImagesAnnotateCall {
	c := &ImagesAnnotateCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.googlecloudvisionv1batchannotateimagesrequest = googlecloudvisionv1batchannotateimagesrequest
	return c
}
...
func (c *ImagesAnnotateCall) doRequest(alt string) (*http.Response, error) {
	...
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.googlecloudvisionv1batchannotateimagesrequest)
	if err != nil {
		return nil, err
	}
...
// Exactly one of *GoogleCloudVisionV1BatchAnnotateImagesResponse or
// error will be non-nil. Any non-2xx status code is an error. Response
// headers are in either
// *GoogleCloudVisionV1BatchAnnotateImagesResponse.ServerResponse.Header
// or (if a response was returned at all) in
// error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was
// returned.
func (c *ImagesAnnotateCall) Do(opts ...googleapi.CallOption) (*GoogleCloudVisionV1BatchAnnotateImagesResponse, error) {
	...
	ret := &GoogleCloudVisionV1BatchAnnotateImagesResponse{
	...
	//   "request": {
	//     "$ref": "GoogleCloudVisionV1BatchAnnotateImagesRequest"
	//   },
	//   "response": {
	//     "$ref": "GoogleCloudVisionV1BatchAnnotateImagesResponse"
	//   },
	//   "scopes": [
