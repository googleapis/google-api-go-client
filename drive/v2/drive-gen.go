...
type ChangesServicer interface {
	Get(changeId string) *ChangesGetCall
	List() *ChangesListCall
	Watch(channel *Channel) *ChangesWatchCall
}
...
type ChildrenServicer interface {
	Delete(folderId string, childId string) *ChildrenDeleteCall
	Get(folderId string, childId string) *ChildrenGetCall
	Insert(folderId string, childreference *ChildReference) *ChildrenInsertCall
	List(folderId string) *ChildrenListCall
}
...
type CommentsServicer interface {
	Delete(fileId string, commentId string) *CommentsDeleteCall
	Get(fileId string, commentId string) *CommentsGetCall
	Insert(fileId string, comment *Comment) *CommentsInsertCall
	List(fileId string) *CommentsListCall
	Patch(fileId string, commentId string, comment *Comment) *CommentsPatchCall
	Update(fileId string, commentId string, comment *Comment) *CommentsUpdateCall
}
...
type FilesServicer interface {
	Copy(fileId string, file *File) *FilesCopyCall
	Delete(fileId string) *FilesDeleteCall
	EmptyTrash() *FilesEmptyTrashCall
	Get(fileId string) *FilesGetCall
	Insert(file *File) *FilesInsertCall
	List() *FilesListCall
	Patch(fileId string, file *File) *FilesPatchCall
	Touch(fileId string) *FilesTouchCall
	Trash(fileId string) *FilesTrashCall
	Untrash(fileId string) *FilesUntrashCall
	Update(fileId string, file *File) *FilesUpdateCall
	Watch(fileId string, channel *Channel) *FilesWatchCall
}
...
type ParentsServicer interface {
	Delete(fileId string, parentId string) *ParentsDeleteCall
	Get(fileId string, parentId string) *ParentsGetCall
	Insert(fileId string, parentreference *ParentReference) *ParentsInsertCall
	List(fileId string) *ParentsListCall
}
...
type PermissionsServicer interface {
	Delete(fileId string, permissionId string) *PermissionsDeleteCall
	Get(fileId string, permissionId string) *PermissionsGetCall
	GetIdForEmail(email string) *PermissionsGetIdForEmailCall
	Insert(fileId string, permission *Permission) *PermissionsInsertCall
	List(fileId string) *PermissionsListCall
	Patch(fileId string, permissionId string, permission *Permission) *PermissionsPatchCall
	Update(fileId string, permissionId string, permission *Permission) *PermissionsUpdateCall
}
...
type PropertiesServicer interface {
	Delete(fileId string, propertyKey string) *PropertiesDeleteCall
	Get(fileId string, propertyKey string) *PropertiesGetCall
	Insert(fileId string, property *Property) *PropertiesInsertCall
	List(fileId string) *PropertiesListCall
	Patch(fileId string, propertyKey string, property *Property) *PropertiesPatchCall
	Update(fileId string, propertyKey string, property *Property) *PropertiesUpdateCall
}
...
type RealtimeServicer interface {
	Get(fileId string) *RealtimeGetCall
	Update(fileId string) *RealtimeUpdateCall
}
...
type RepliesServicer interface {
	Delete(fileId string, commentId string, replyId string) *RepliesDeleteCall
	Get(fileId string, commentId string, replyId string) *RepliesGetCall
	Insert(fileId string, commentId string, commentreply *CommentReply) *RepliesInsertCall
	List(fileId string, commentId string) *RepliesListCall
	Patch(fileId string, commentId string, replyId string, commentreply *CommentReply) *RepliesPatchCall
	Update(fileId string, commentId string, replyId string, commentreply *CommentReply) *RepliesUpdateCall
}
...
type RevisionsServicer interface {
	Delete(fileId string, revisionId string) *RevisionsDeleteCall
	Get(fileId string, revisionId string) *RevisionsGetCall
	List(fileId string) *RevisionsListCall
	Patch(fileId string, revisionId string, revision *Revision) *RevisionsPatchCall
	Update(fileId string, revisionId string, revision *Revision) *RevisionsUpdateCall
}
