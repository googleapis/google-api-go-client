...
type BookshelvesServicer interface {
	Get(userId string, shelf string) *BookshelvesGetCall
	List(userId string) *BookshelvesListCall
}
...
type CloudloadingServicer interface {
	AddBook() *CloudloadingAddBookCall
	DeleteBook(volumeId string) *CloudloadingDeleteBookCall
	UpdateBook(bookscloudloadingresource *BooksCloudloadingResource) *CloudloadingUpdateBookCall
}
...
type DictionaryServicer interface {
	ListOfflineMetadata(cpksver string) *DictionaryListOfflineMetadataCall
}
...
type LayersServicer interface {
	Get(volumeId string, summaryId string) *LayersGetCall
	List(volumeId string) *LayersListCall
}
...
type MyconfigServicer interface {
	GetUserSettings() *MyconfigGetUserSettingsCall
	ReleaseDownloadAccess(volumeIds []string, cpksver string) *MyconfigReleaseDownloadAccessCall
	RequestAccess(source string, volumeId string, nonce string, cpksver string) *MyconfigRequestAccessCall
	SyncVolumeLicenses(source string, nonce string, cpksver string) *MyconfigSyncVolumeLicensesCall
	UpdateUserSettings(usersettings *Usersettings) *MyconfigUpdateUserSettingsCall
}
...
type OnboardingServicer interface {
	ListCategories() *OnboardingListCategoriesCall
	ListCategoryVolumes() *OnboardingListCategoryVolumesCall
}
...
type PromoofferServicer interface {
	Accept() *PromoofferAcceptCall
	Dismiss() *PromoofferDismissCall
	Get() *PromoofferGetCall
}
...
type VolumesServicer interface {
	Get(volumeId string) *VolumesGetCall
	List(q string) *VolumesListCall
}
