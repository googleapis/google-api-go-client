...
func (c *DeploymentsGetCall) DoHeader() (*Deployment, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *DeploymentsInsertCall) DoHeader() (*Deployment, http.Header, error) {
	var body io.Reader = nil
...
func (c *DeploymentsListCall) DoHeader() (*DeploymentsListResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *TemplatesGetCall) DoHeader() (*Template, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *TemplatesInsertCall) DoHeader() (*Template, http.Header, error) {
	var body io.Reader = nil
...
func (c *TemplatesListCall) DoHeader() (*TemplatesListResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["maxResults"]; ok {
