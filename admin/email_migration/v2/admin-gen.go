...
func (c *MailInsertCall) IfNoneMatch(entityTag string) *MailInsertCall {
...
// DoHeader executes the "emailMigration.mail.insert" call.
...
func (c *MailInsertCall) DoHeader() (resHeader http.Header, err error) {
