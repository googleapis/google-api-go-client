...
func (c *InstanceGroupManagersAbandonInstancesCall) DoHeader() (http.Header, *Operation, error) {
...
func (c *InstanceGroupManagersDeleteCall) DoHeader() (http.Header, *Operation, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *InstanceGroupManagersDeleteInstancesCall) DoHeader() (http.Header, *Operation, error) {
	var body io.Reader = nil
...
func (c *InstanceGroupManagersGetCall) DoHeader() (http.Header, *InstanceGroupManager, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *InstanceGroupManagersInsertCall) DoHeader() (http.Header, *Operation, error) {
	var body io.Reader = nil
...
func (c *InstanceGroupManagersListCall) DoHeader() (http.Header, *InstanceGroupManagerList, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *InstanceGroupManagersRecreateInstancesCall) DoHeader() (http.Header, *Operation, error) {
	var body io.Reader = nil
...
func (c *InstanceGroupManagersResizeCall) DoHeader() (http.Header, *Operation, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	params.Set("size", fmt.Sprintf("%v", c.size))
...
func (c *InstanceGroupManagersSetInstanceTemplateCall) DoHeader() (http.Header, *Operation, error) {
	var body io.Reader = nil
...
func (c *InstanceGroupManagersSetTargetPoolsCall) DoHeader() (http.Header, *Operation, error) {
	var body io.Reader = nil
...
func (c *ZoneOperationsGetCall) DoHeader() (http.Header, *Operation, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *ZoneOperationsListCall) DoHeader() (http.Header, *OperationList, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["filter"]; ok {
