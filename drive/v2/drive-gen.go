...
// At most one of Media and ResumableMedia may be set.
func (c *FilesInsertCall) ResumableMedia(ctx context.Context, r googleapi.Reader) *FilesInsertCall {
	c.ctx_ = ctx
	c.media_ = r
...
// ResumableMedia specifies the media to upload in chunks and can be cancelled with ctx.
// At most one of Media and ResumableMedia may be set.
func (c *FilesUpdateCall) ResumableMedia(ctx context.Context, r googleapi.Reader) *FilesUpdateCall {
	c.ctx_ = ctx
	c.media_ = r
	c.protocol_ = "resumable"
	return c
...
// ResumableMedia specifies the media to upload in chunks and can be cancelled with ctx.
// At most one of Media and ResumableMedia may be set.
func (c *RealtimeUpdateCall) ResumableMedia(ctx context.Context, r googleapi.Reader) *RealtimeUpdateCall {
	c.ctx_ = ctx
	c.media_ = r
	c.protocol_ = "resumable"
	return c
