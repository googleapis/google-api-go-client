...
// Usage example:
//
//	import "google.golang.org/api/merchantapi/promotions/v1"
//	...
...
package merchantapi // import "google.golang.org/api/merchantapi/promotions/v1"
...
const apiId = "merchantapi:promotions_v1"
const apiName = "merchantapi"
const apiVersion = "promotions_v1"
...
func (c *AccountsPromotionsGetCall) doRequest(alt string) (*http.Response, error) {
	...
	urls := googleapi.ResolveRelative(c.s.BasePath, "promotions/v1/{+name}")
...
func (c *AccountsPromotionsInsertCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "promotions/v1/{+parent}/promotions:insert")
	urls += "?" + c.urlParams_.Encode()
...
func (c *AccountsPromotionsListCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "promotions/v1/{+parent}/promotions")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("GET", urls, nil)
	if err != nil {
		return nil, err
