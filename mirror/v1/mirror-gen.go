...
func (c *TimelineInsertCall) ResumableMedia(ctx context.Context, r io.Reader) *TimelineInsertCall {
	c.ctx_ = ctx
	c.media_ = r
...
// or, as a special case for extra configuration, a googleapi.UploadParameters struct
// can be used. Refer to this struct's documentation for additional details.
func (c *TimelineUpdateCall) ResumableMedia(ctx context.Context, r io.Reader) *TimelineUpdateCall {
	c.ctx_ = ctx
	c.media_ = r
	c.protocol_ = "resumable"
	return c
...
// or, as a special case for extra configuration, a googleapi.UploadParameters struct
// can be used. Refer to this struct's documentation for additional details.
func (c *TimelineAttachmentsInsertCall) ResumableMedia(ctx context.Context, r io.Reader) *TimelineAttachmentsInsertCall {
	c.ctx_ = ctx
	c.media_ = r
	c.protocol_ = "resumable"
	return c
