...
func (c *MetricDescriptorsCreateCall) DoHeader() (*MetricDescriptor, http.Header, error) {
...
func (c *MetricDescriptorsDeleteCall) DoHeader() (*DeleteMetricDescriptorResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *MetricDescriptorsListCall) DoHeader() (*ListMetricDescriptorsResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *TimeseriesListCall) DoHeader() (*ListTimeseriesResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *TimeseriesWriteCall) DoHeader() (*WriteTimeseriesResponse, http.Header, error) {
	var body io.Reader = nil
...
func (c *TimeseriesDescriptorsListCall) DoHeader() (*ListTimeseriesDescriptorsResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	params.Set("youngest", fmt.Sprintf("%v", c.youngest))
