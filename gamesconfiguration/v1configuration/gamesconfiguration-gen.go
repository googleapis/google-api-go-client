...
func (c *ImageConfigurationsUploadCall) ResumableMedia(ctx context.Context, r io.Reader, size int64, chunkSize int64, mediaType string) *ImageConfigurationsUploadCall {
	c.ctx_ = ctx
	c.media_ = r
