...
type GoogleCloudAiplatformV1beta1Candidate struct {
	...
	// syntaxtically invalid (e.g. the function call generated is not parsable).
	...
	// calling is not enabled or the function is not in the function declaration).
...
// GoogleCloudAiplatformV1beta1GroundingMetadataSourceFlaggingUri: Source
// content flagging uri for a place or review. This is currently populated only
// for Google Maps grounding.
type GoogleCloudAiplatformV1beta1GroundingMetadataSourceFlaggingUri struct {
	// FlagContentUri: A link where users can flag a problem with the source (place
	// or review).
...
// GoogleCloudAiplatformV1beta1ImageConfig: Config for image generation
// features.
...
// integrations of prompt and responses.
type GoogleCloudAiplatformV1beta1ModelArmorConfig struct {
	...
	// ResponseTemplateName: Optional. The name of the Model Armor template to use
	// for response sanitization.
