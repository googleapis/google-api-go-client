...
func (c *InapppurchasesGetCall) Do() (ret *InappPurchase, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *PurchasesCancelCall) Do() (err error) {
	_, err = c.DoHeader()
	return err
}
...
// Do performs a round-trip call to the server.
func (c *PurchasesGetCall) Do() (ret *SubscriptionPurchase, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
