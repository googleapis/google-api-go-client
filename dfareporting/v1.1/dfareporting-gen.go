...
func (c *DimensionValuesQueryCall) Do() (ret *DimensionValueList, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *ReportsDeleteCall) Do() (err error) {
	_, err = c.DoHeader()
	return err
}
...
// Do performs a round-trip call to the server.
func (c *ReportsInsertCall) Do() (ret *Report, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *ReportsListCall) Do() (ret *ReportList, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *ReportsPatchCall) Do() (ret *Report, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *ReportsRunCall) Do() (ret *File, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *ReportsUpdateCall) Do() (ret *Report, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *ReportsFilesGetCall) Do() (ret *File, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *ReportsFilesListCall) Do() (ret *FileList, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *UserProfilesGetCall) Do() (ret *UserProfile, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *UserProfilesListCall) Do() (ret *UserProfileList, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
