...
// is cancelled.
func (c *MetricDescriptorsCreateCall) Ctx(ctx context.Context) *MetricDescriptorsCreateCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *MetricDescriptorsDeleteCall) Ctx(ctx context.Context) *MetricDescriptorsDeleteCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *MetricDescriptorsListCall) Ctx(ctx context.Context) *MetricDescriptorsListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *TimeseriesListCall) Ctx(ctx context.Context) *TimeseriesListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *TimeseriesWriteCall) Ctx(ctx context.Context) *TimeseriesWriteCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *TimeseriesDescriptorsListCall) Ctx(ctx context.Context) *TimeseriesDescriptorsListCall {
	c.ctx_ = ctx
	return c
}
