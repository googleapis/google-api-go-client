...
func (c *GroupsGetCall) DoHeader() (*Groups, http.Header, error) {
...
func (c *GroupsPatchCall) DoHeader() (*Groups, http.Header, error) {
	var body io.Reader = nil
...
func (c *GroupsUpdateCall) DoHeader() (*Groups, http.Header, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.groups)
	if err != nil {
		return nil, nil, err
