...
func New(client *http.Client) (*Service, error) {
	...
	s.AssetUpdates = NewAssetUpdatesService(s)
...
type Service struct {
	...
	AssetUpdates *AssetUpdatesService
...
func NewAssetUpdatesService(s *Service) *AssetUpdatesService {
	rs := &AssetUpdatesService{s: s}
	return rs
}

type AssetUpdatesService struct {
	s *Service
}

func NewFoldersService(s *Service) *FoldersService {
	rs := &FoldersService{s: s}
	rs.InventorySettings = NewFoldersInventorySettingsService(s)
	return rs
}
...
type FoldersService struct {
	...
	InventorySettings *FoldersInventorySettingsService
}

func NewFoldersInventorySettingsService(s *Service) *FoldersInventorySettingsService {
	rs := &FoldersInventorySettingsService{s: s}
	rs.ExportSettings = NewFoldersInventorySettingsExportSettingsService(s)
	return rs
}

type FoldersInventorySettingsService struct {
	s *Service

	ExportSettings *FoldersInventorySettingsExportSettingsService
}

func NewFoldersInventorySettingsExportSettingsService(s *Service) *FoldersInventorySettingsExportSettingsService {
	rs := &FoldersInventorySettingsExportSettingsService{s: s}
	return rs
}

type FoldersInventorySettingsExportSettingsService struct {
	s *Service
}

func NewOrganizationsService(s *Service) *OrganizationsService {
	rs := &OrganizationsService{s: s}
	rs.InventorySettings = NewOrganizationsInventorySettingsService(s)
	return rs
}
...
type OrganizationsService struct {
	...
	InventorySettings *OrganizationsInventorySettingsService
}

func NewOrganizationsInventorySettingsService(s *Service) *OrganizationsInventorySettingsService {
	rs := &OrganizationsInventorySettingsService{s: s}
	rs.ExportSettings = NewOrganizationsInventorySettingsExportSettingsService(s)
	return rs
}

type OrganizationsInventorySettingsService struct {
	s *Service

	ExportSettings *OrganizationsInventorySettingsExportSettingsService
}

func NewOrganizationsInventorySettingsExportSettingsService(s *Service) *OrganizationsInventorySettingsExportSettingsService {
	rs := &OrganizationsInventorySettingsExportSettingsService{s: s}
	return rs
}

type OrganizationsInventorySettingsExportSettingsService struct {
	s *Service
}

func NewProjectsService(s *Service) *ProjectsService {
	rs := &ProjectsService{s: s}
	rs.InventorySettings = NewProjectsInventorySettingsService(s)
	return rs
}
...
type ProjectsService struct {
	...
	InventorySettings *ProjectsInventorySettingsService
}

func NewProjectsInventorySettingsService(s *Service) *ProjectsInventorySettingsService {
	rs := &ProjectsInventorySettingsService{s: s}
	rs.ExportSettings = NewProjectsInventorySettingsExportSettingsService(s)
	return rs
}

type ProjectsInventorySettingsService struct {
	s *Service

	ExportSettings *ProjectsInventorySettingsExportSettingsService
}

func NewProjectsInventorySettingsExportSettingsService(s *Service) *ProjectsInventorySettingsExportSettingsService {
	rs := &ProjectsInventorySettingsExportSettingsService{s: s}
	return rs
}

type ProjectsInventorySettingsExportSettingsService struct {
	s *Service
}
...
type BigQueryDestination struct {
	...
	// given name will be created. In the case of scheduled export, the real
	// destination is [table] appended with a suffix indicating the
	// point-in-time of the snapshot. For example, suppose field [table] is
	// "mytable". When [separate_tables_per_asset_type] and is `FALSE`, the
	// destination will be "mytable_snapshot_20201122060000", and when
	// [separate_tables_per_asset_type] and is `TRUE` and the [asset_types]
	// contains "storage.googleapis.com/Bucket", the destination will be
...
// BigQuerySetting: Setting for scheduled export to BigQuery.
type BigQuerySetting struct {
	// Destination: Required. Destination on BigQuery. The output table
	// stores the fields in asset proto as columns in BigQuery.
	Destination *BigQueryDestination `json:"destination,omitempty"`

	// SnapshotSchedule: Schedule for scheduled export of asset snapshot.
	SnapshotSchedule *ScheduleConfig `json:"snapshotSchedule,omitempty"`
...
func (s *BigQuerySetting) MarshalJSON() ([]byte, error) {
	type NoMethod BigQuerySetting
	raw := NoMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}
...
type CreateExportSettingRequest struct {
	// ExportSetting: Required. The export setting details. The field `name`
	// must be empty and it will be generated in the format of:
	// projects/{PROJECT_NUMBER}/inventorySettings/exportSettings/{EXPORT_SET
	// TING_ID}
	// folders/{FOLDER_NUMBER}/inventorySettings/exportSettings/{EXPORT_SETTI
	// NG_ID}
	// organizations/{ORGANIZATION_NUMBER}/inventorySettings/exportSettings/{
	// EXPORT_SETTING_ID}
	ExportSetting *ExportSetting `json:"exportSetting,omitempty"`

	// ExportSettingId: Required. This is the client-assigned export setting
	// identifier encoded in UTF-8 and it needs to be unique under a
	// specific [InventorySettings].
	ExportSettingId string `json:"exportSettingId,omitempty"`

	// ForceSendFields is a list of field names (e.g. "ExportSetting") to
	// unconditionally include in API requests. By default, fields with
	// empty values are omitted from API requests. However, any non-pointer,
	// non-interface field appearing in ForceSendFields will be sent to the
	// server regardless of whether the field is empty or not. This may be
	...
	// NullFields is a list of field names (e.g. "ExportSetting") to include
	// in API requests with the JSON null value. By default, fields with
	// empty values are omitted from API requests. However, any field with
	// an empty value appearing in NullFields will be sent to the server as
	// null. It is an error if a field in this list has a non-empty value.
...
func (s *CreateExportSettingRequest) MarshalJSON() ([]byte, error) {
	type NoMethod CreateExportSettingRequest
	raw := NoMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}
...
// ExportAssetUpdatesRequest: Export asset updates request.
type ExportAssetUpdatesRequest struct {
	// AssetNames: A list of the full names of the assets to export the
	// updates for. See:
	// https://cloud.google.com/asset-inventory/docs/resource-name-format
	// Example:
	// `//compute.googleapis.com/projects/my_project_123/zones/zone1/instance
	// s/instance1`. If specified, only assets in the list will be returned.
	// At most one of asset_types and asset_names should be specified. If
	// neither is specified, all assets under the parent will be returned.
	AssetNames []string `json:"assetNames,omitempty"`

	// AssetTypes: A list of asset types to export the updates for. For
	...
	// specified, only matching assets will be returned. See Introduction to
	// Cloud Asset Inventory
	// (https://cloud.google.com/asset-inventory/docs/overview) for all
	// supported asset types. At most one of asset_types and asset_names
	// should be specified. If neither is specified, all assets under the
	...
	// UpdateTimeWindow: The time window configuration for the asset
	// updates. Both start_time and end_time must be within 35 days from
	// now. end_time is optional and not set, it is default to current
	// timestamp. The returned results contain all assets created, updated
	// or deleted within update_time_window.time_window.
	UpdateTimeWindow *UpdateTimeWindow `json:"updateTimeWindow,omitempty"`
...
func (s *ExportAssetUpdatesRequest) MarshalJSON() ([]byte, error) {
	type NoMethod ExportAssetUpdatesRequest
	raw := NoMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}
...
// ExportSetting: Settings that configure CAI to export assets on given
// schedules. An [InventorySettings] might have multiple
// [ExportSetting], each with a unique identifier.
type ExportSetting struct {
	// AssetTypes: Asset types of resources that will be exported on
	// schedule. For example: "compute.googleapis.com/Disk". Regular
	...
	// BigquerySetting: Setting to configure scheduled export output to
	// BigQuery. At least one of [gcs_settings] and [bigquery_settings]
	// should be set.
	BigquerySetting *BigQuerySetting `json:"bigquerySetting,omitempty"`

	// ContentType: Required. Asset content type. Currently only `RESOURCE`,
	// `IAM_POLICY`, `ORG_POLICY`, `ACCESS_POLICY` are supported.
	//
	// Possible values:
	//   "CONTENT_TYPE_UNSPECIFIED" - Unspecified content type.
	//   "RESOURCE" - Resource metadata.
	...
	// GcsSetting: Setting to configure scheduled export output to GCS. At
	// least one of [gcs_setting] and [bigquery_setting] should be set.
	GcsSetting *GcsSetting `json:"gcsSetting,omitempty"`

	// Name: The format will be:
	// organizations/{ORGANIZATION_NUMBER}/inventorySettings/exportSettings/{
	// exportSetting} or
	// folders/{FOLDER_NUMBER}/inventorySettings/exportSettings/{exportSettin
	// g} or
	// projects/{PROJECT_NUMBER}/inventorySettings/exportSettings/{exportSett
	// ing}
	Name string `json:"name,omitempty"`
...
func (s *ExportSetting) MarshalJSON() ([]byte, error) {
	type NoMethod ExportSetting
	raw := NoMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}
...
type GcsDestination struct {
	...
	// more information. In the case of scheduled export, a path indiciating
	// when the export happens will be added in between the bucket_name and
	// object_name. For example: the real destination for an scheduled
	...
	// "gs://bucket_name/object_name_prefix" already exists. In the case of
	// scheduled export, a path indiciating when the export happens will be
	// appended. For example: the real destination for an scheduled snapshot
	// is:
	// gs://bucket_name/object_name_prefix/{YYYY}/{MM}/{DD}/snapshot/{HHMMSS}
	// /{ASSET_TYPE}/{SHARD_NUMBER}
...
// GcsSetting: Setting for scheduled export to GCS.
type GcsSetting struct {
	// Destination: Required. Destination on Cloud Storage.
	Destination *GcsDestination `json:"destination,omitempty"`
...
func (s *GcsSetting) MarshalJSON() ([]byte, error) {
	type NoMethod GcsSetting
	raw := NoMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}
...
// InventorySettings: Inventory Settings. There is only one inventory
// settings for a given organization, folder or project. Users can
// update inventory settings using specific API, but cannot create or
// delete.
type InventorySettings struct {
	// ExportSettings: Output only. A list of export settings.
	ExportSettings []string `json:"exportSettings,omitempty"`

	// Name: Required. The format will be
	// projects/{PROJECT_NUMBER}/inventorySettings or
	...
	// ForceSendFields is a list of field names (e.g. "ExportSettings") to
	// unconditionally include in API requests. By default, fields with
	// empty values are omitted from API requests. However, any non-pointer,
	// non-interface field appearing in ForceSendFields will be sent to the
	// server regardless of whether the field is empty or not. This may be
	...
	// NullFields is a list of field names (e.g. "ExportSettings") to
	// include in API requests with the JSON null value. By default, fields
	// with empty values are omitted from API requests. However, any field
	// with an empty value appearing in NullFields will be sent to the
	// server as null. It is an error if a field in this list has a
...
func (s *InventorySettings) MarshalJSON() ([]byte, error) {
	type NoMethod InventorySettings
	raw := NoMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

// ListAssetUpdatesResponse: ListAssets response.
type ListAssetUpdatesResponse struct {
	// AssetUpdates: Asset updates in the time window.
	AssetUpdates []*Asset `json:"assetUpdates,omitempty"`

	// NextPageToken: Token to retrieve the next page of results. Set to
	// empty if there are no remaining results.
	NextPageToken string `json:"nextPageToken,omitempty"`

	// UpdateTimeWindow: Time window configuration of the list request.
	UpdateTimeWindow *UpdateTimeWindow `json:"updateTimeWindow,omitempty"`
	...
	// ForceSendFields is a list of field names (e.g. "AssetUpdates") to
	// unconditionally include in API requests. By default, fields with
	// empty values are omitted from API requests. However, any non-pointer,
	// non-interface field appearing in ForceSendFields will be sent to the
	// server regardless of whether the field is empty or not. This may be
	...
	// NullFields is a list of field names (e.g. "AssetUpdates") to include
	// in API requests with the JSON null value. By default, fields with
	// empty values are omitted from API requests. However, any field with
	// an empty value appearing in NullFields will be sent to the server as
	// null. It is an error if a field in this list has a non-empty value.
...
func (s *ListAssetUpdatesResponse) MarshalJSON() ([]byte, error) {
	type NoMethod ListAssetUpdatesResponse
	raw := NoMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

type ListExportSettingsResponse struct {
...
func (s *ListExportSettingsResponse) MarshalJSON() ([]byte, error) {
	type NoMethod ListExportSettingsResponse
	raw := NoMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}
...
// ScheduleConfig: Schedule for scheduled export. This is used to
// configure scheduled export for both GCS and BigQuery.
type ScheduleConfig struct {
	// Crontab: Required. Cron-tab formatted schedule by which the job will
	...
	// [crontab]. The value of this field must be a time zone name from the
	// tz database (https://en.wikipedia.org/wiki/Tz_database). Note that
...
// UpdateTimeWindow: Time window configuration for asset updates
// requests.
type UpdateTimeWindow struct {
	// TimeWindow: The time window.
	TimeWindow *TimeWindow `json:"timeWindow,omitempty"`

	// Type: The type of the time in time_window.
	//
	// Possible values:
	//   "TIME_TYPE_UNSPECIFIED" - If not specified, UPDATE_TIME is used.
	//   "UPDATE_TIME" - Update time of the Asset. Assets updated in the
	// window will be returned.
	//   "CAPTURE_TIME" - Capture time of the Asset update in Asset
	// Inventory. Assets updates captured by Asset Inventory in the window
	// will be returned. This definition should be used when full-fidelity
	// data is required in requests with consecutive time windows.
	Type string `json:"type,omitempty"`

	// ForceSendFields is a list of field names (e.g. "TimeWindow") to
	// unconditionally include in API requests. By default, fields with
	// empty values are omitted from API requests. However, any non-pointer,
	// non-interface field appearing in ForceSendFields will be sent to the
	// server regardless of whether the field is empty or not. This may be
	...
	// NullFields is a list of field names (e.g. "TimeWindow") to include in
	// API requests with the JSON null value. By default, fields with empty
	// values are omitted from API requests. However, any field with an
	// empty value appearing in NullFields will be sent to the server as
	// null. It is an error if a field in this list has a non-empty value.
...
func (s *UpdateTimeWindow) MarshalJSON() ([]byte, error) {
	type NoMethod UpdateTimeWindow
	raw := NoMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

// method id "cloudasset.assetUpdates.list":

type AssetUpdatesListCall struct {
	s            *Service
	parent       string
...
// List: Lists asset updates within a time window and returns paged
// results in response.
func (r *AssetUpdatesService) List(parent string) *AssetUpdatesListCall {
	c := &AssetUpdatesListCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.parent = parent
	return c
}

// AssetNames sets the optional parameter "assetNames": A list of the
// full names of the assets to list the updates for. See:
// https://cloud.google.com/asset-inventory/docs/resource-name-format
// Example:
// `//compute.googleapis.com/projects/my_project_123/zones/zone1/instance
// s/instance1`. If specified, only assets in the list will be returned.
// At most one of asset_types and asset_names should be specified. If
// neither is specified, all assets under the parent will be returned.
func (c *AssetUpdatesListCall) AssetNames(assetNames ...string) *AssetUpdatesListCall {
...
// types to list the updates for. For example:
...
// returned. At most one of asset_types and asset_names should be
// specified. If neither is specified, all assets under the parent will
// be returned.
func (c *AssetUpdatesListCall) AssetTypes(assetTypes ...string) *AssetUpdatesListCall {
...
//   "ACCESS_POLICY" - The Cloud Access context manager Policy set on an
// asset.
func (c *AssetUpdatesListCall) ContentType(contentType string) *AssetUpdatesListCall {
...
func (c *AssetUpdatesListCall) PageSize(pageSize int64) *AssetUpdatesListCall {
...
// of assets.
func (c *AssetUpdatesListCall) PageToken(pageToken string) *AssetUpdatesListCall {
	c.urlParams_.Set("pageToken", pageToken)
	return c
}

// UpdateTimeWindowTimeWindowEndTime sets the optional parameter
// "updateTimeWindow.timeWindow.endTime": End time of the time window
// (inclusive). If not specified, the current timestamp is used instead.
func (c *AssetUpdatesListCall) UpdateTimeWindowTimeWindowEndTime(updateTimeWindowTimeWindowEndTime string) *AssetUpdatesListCall {
	c.urlParams_.Set("updateTimeWindow.timeWindow.endTime", updateTimeWindowTimeWindowEndTime)
	return c
}

// UpdateTimeWindowTimeWindowStartTime sets the optional parameter
// "updateTimeWindow.timeWindow.startTime": Start time of the time
// window (exclusive).
func (c *AssetUpdatesListCall) UpdateTimeWindowTimeWindowStartTime(updateTimeWindowTimeWindowStartTime string) *AssetUpdatesListCall {
	c.urlParams_.Set("updateTimeWindow.timeWindow.startTime", updateTimeWindowTimeWindowStartTime)
	return c
}

// UpdateTimeWindowType sets the optional parameter
// "updateTimeWindow.type": The type of the time in time_window.
//
// Possible values:
//   "TIME_TYPE_UNSPECIFIED" - If not specified, UPDATE_TIME is used.
//   "UPDATE_TIME" - Update time of the Asset. Assets updated in the
...
// will be returned. This definition should be used when full-fidelity
// data is required in requests with consecutive time windows.
func (c *AssetUpdatesListCall) UpdateTimeWindowType(updateTimeWindowType string) *AssetUpdatesListCall {
	c.urlParams_.Set("updateTimeWindow.type", updateTimeWindowType)
	return c
}
...
// for more information.
func (c *AssetUpdatesListCall) Fields(s ...googleapi.Field) *AssetUpdatesListCall {
...
func (c *AssetUpdatesListCall) IfNoneMatch(entityTag string) *AssetUpdatesListCall {
...
// canceled.
func (c *AssetUpdatesListCall) Context(ctx context.Context) *AssetUpdatesListCall {
	c.ctx_ = ctx
	return c
}
...
func (c *AssetUpdatesListCall) Header() http.Header {
	if c.header_ == nil {
...
func (c *AssetUpdatesListCall) doRequest(alt string) (*http.Response, error) {
	...
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1p7beta1/{+parent}/assetUpdates")
...
// Do executes the "cloudasset.assetUpdates.list" call.
// Exactly one of *ListAssetUpdatesResponse or error will be non-nil.
// Any non-2xx status code is an error. Response headers are in either
// *ListAssetUpdatesResponse.ServerResponse.Header or (if a response was
// returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was
// because http.StatusNotModified was returned.
func (c *AssetUpdatesListCall) Do(opts ...googleapi.CallOption) (*ListAssetUpdatesResponse, error) {
	...
	//       "description": "The type of the time in time_window.",
	//       "enum": [
	...
	//     }
	//   },
	//   "path": "v1p7beta1/{+parent}/assetUpdates",
	//   "response": {
	//     "$ref": "ListAssetUpdatesResponse"
	//   },
	//   "scopes": [
	//     "https://www.googleapis.com/auth/cloud-platform"
	//   ]
...
func (c *AssetUpdatesListCall) Pages(ctx context.Context, f func(*ListAssetUpdatesResponse) error) error {
	c.ctx_ = ctx
...
// method id "cloudasset.folders.getInventorySettings":

type FoldersGetInventorySettingsCall struct {
	s            *Service
	name         string
	urlParams_   gensupport.URLParams
	ifNoneMatch_ string
...
// GetInventorySettings: Gets details about an inventory setting.
func (r *FoldersService) GetInventorySettings(name string) *FoldersGetInventorySettingsCall {
	c := &FoldersGetInventorySettingsCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.name = name
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *FoldersGetInventorySettingsCall) Fields(s ...googleapi.Field) *FoldersGetInventorySettingsCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// request. Use googleapi.IsNotModified to check whether the response
// error from Do is the result of In-None-Match.
func (c *FoldersGetInventorySettingsCall) IfNoneMatch(entityTag string) *FoldersGetInventorySettingsCall {
	c.ifNoneMatch_ = entityTag
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *FoldersGetInventorySettingsCall) Context(ctx context.Context) *FoldersGetInventorySettingsCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns an http.Header that can be modified by the caller to
// add HTTP headers to the request.
func (c *FoldersGetInventorySettingsCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *FoldersGetInventorySettingsCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("x-goog-api-client", "gl-go/"+gensupport.GoVersion()+" gdcl/20210211")
	for k, v := range c.header_ {
		reqHeaders[k] = v
...
// Do executes the "cloudasset.folders.getInventorySettings" call.
// Exactly one of *InventorySettings or error will be non-nil. Any
// non-2xx status code is an error. Response headers are in either
// *InventorySettings.ServerResponse.Header or (if a response was
// returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was
// because http.StatusNotModified was returned.
func (c *FoldersGetInventorySettingsCall) Do(opts ...googleapi.CallOption) (*InventorySettings, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
	...
	return ret, nil
	// {
	//   "description": "Gets details about an inventory setting.",
	//   "flatPath": "v1p7beta1/folders/{foldersId}/inventorySettings",
	//   "httpMethod": "GET",
	//   "id": "cloudasset.folders.getInventorySettings",
	//   "parameterOrder": [
	//     "name"
	//   ],
	//   "parameters": {
	//     "name": {
	//       "description": "Required. The name of the [InventorySettings] which has the format of: projects/{PROJECT_NUMBER}/inventorySettings folders/{FOLDER_NUMBER}/inventorySettings organizations/{ORGANIZATION_NUMBER}/inventorySettings",
	//       "location": "path",
...
// method id "cloudasset.folders.inventorySettings.exportSettings.create":

type FoldersInventorySettingsExportSettingsCreateCall struct {
	s                          *Service
	parent                     string
	createexportsettingrequest *CreateExportSettingRequest
	urlParams_                 gensupport.URLParams
	ctx_                       context.Context
	header_                    http.Header
}

// Create: Creates an export setting.
func (r *FoldersInventorySettingsExportSettingsService) Create(parent string, createexportsettingrequest *CreateExportSettingRequest) *FoldersInventorySettingsExportSettingsCreateCall {
	c := &FoldersInventorySettingsExportSettingsCreateCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.parent = parent
	c.createexportsettingrequest = createexportsettingrequest
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *FoldersInventorySettingsExportSettingsCreateCall) Fields(s ...googleapi.Field) *FoldersInventorySettingsExportSettingsCreateCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *FoldersInventorySettingsExportSettingsCreateCall) Context(ctx context.Context) *FoldersInventorySettingsExportSettingsCreateCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns an http.Header that can be modified by the caller to
// add HTTP headers to the request.
func (c *FoldersInventorySettingsExportSettingsCreateCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *FoldersInventorySettingsExportSettingsCreateCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("x-goog-api-client", "gl-go/"+gensupport.GoVersion()+" gdcl/20210211")
	for k, v := range c.header_ {
		reqHeaders[k] = v
	...
	reqHeaders.Set("User-Agent", c.s.userAgent())
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.createexportsettingrequest)
	if err != nil {
		return nil, err
	}
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1p7beta1/{+parent}/exportSettings")
	urls += "?" + c.urlParams_.Encode()
...
// Do executes the "cloudasset.folders.inventorySettings.exportSettings.create" call.
// Exactly one of *ExportSetting or error will be non-nil. Any non-2xx
// status code is an error. Response headers are in either
// *ExportSetting.ServerResponse.Header or (if a response was returned
// at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was
// because http.StatusNotModified was returned.
func (c *FoldersInventorySettingsExportSettingsCreateCall) Do(opts ...googleapi.CallOption) (*ExportSetting, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
	...
	return ret, nil
	// {
	//   "description": "Creates an export setting.",
	//   "flatPath": "v1p7beta1/folders/{foldersId}/inventorySettings/exportSettings",
	//   "httpMethod": "POST",
	//   "id": "cloudasset.folders.inventorySettings.exportSettings.create",
	//   "parameterOrder": [
	//     "parent"
	//   ],
	//   "parameters": {
	...
	//     }
	//   },
	//   "path": "v1p7beta1/{+parent}/exportSettings",
	//   "request": {
	//     "$ref": "CreateExportSettingRequest"
	//   },
	//   "response": {
	//     "$ref": "ExportSetting"
	//   },
...
// method id "cloudasset.folders.inventorySettings.exportSettings.delete":

type FoldersInventorySettingsExportSettingsDeleteCall struct {
	s          *Service
	name       string
	urlParams_ gensupport.URLParams
	ctx_       context.Context
...
// Delete: Deletes an export setting.
func (r *FoldersInventorySettingsExportSettingsService) Delete(name string) *FoldersInventorySettingsExportSettingsDeleteCall {
	c := &FoldersInventorySettingsExportSettingsDeleteCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.name = name
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *FoldersInventorySettingsExportSettingsDeleteCall) Fields(s ...googleapi.Field) *FoldersInventorySettingsExportSettingsDeleteCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *FoldersInventorySettingsExportSettingsDeleteCall) Context(ctx context.Context) *FoldersInventorySettingsExportSettingsDeleteCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns an http.Header that can be modified by the caller to
// add HTTP headers to the request.
func (c *FoldersInventorySettingsExportSettingsDeleteCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *FoldersInventorySettingsExportSettingsDeleteCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("x-goog-api-client", "gl-go/"+gensupport.GoVersion()+" gdcl/20210211")
	for k, v := range c.header_ {
		reqHeaders[k] = v
...
// Do executes the "cloudasset.folders.inventorySettings.exportSettings.delete" call.
...
// was returned.
func (c *FoldersInventorySettingsExportSettingsDeleteCall) Do(opts ...googleapi.CallOption) (*Empty, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
	...
	return ret, nil
	// {
	//   "description": "Deletes an export setting.",
	//   "flatPath": "v1p7beta1/folders/{foldersId}/inventorySettings/exportSettings/{exportSettingsId}",
	//   "httpMethod": "DELETE",
	//   "id": "cloudasset.folders.inventorySettings.exportSettings.delete",
	//   "parameterOrder": [
	//     "name"
	//   ],
	//   "parameters": {
...
// method id "cloudasset.folders.inventorySettings.exportSettings.get":

type FoldersInventorySettingsExportSettingsGetCall struct {
	s            *Service
	name         string
	urlParams_   gensupport.URLParams
	ifNoneMatch_ string
...
// Get: Gets details about an export setting.
func (r *FoldersInventorySettingsExportSettingsService) Get(name string) *FoldersInventorySettingsExportSettingsGetCall {
	c := &FoldersInventorySettingsExportSettingsGetCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.name = name
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *FoldersInventorySettingsExportSettingsGetCall) Fields(s ...googleapi.Field) *FoldersInventorySettingsExportSettingsGetCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// request. Use googleapi.IsNotModified to check whether the response
// error from Do is the result of In-None-Match.
func (c *FoldersInventorySettingsExportSettingsGetCall) IfNoneMatch(entityTag string) *FoldersInventorySettingsExportSettingsGetCall {
	c.ifNoneMatch_ = entityTag
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *FoldersInventorySettingsExportSettingsGetCall) Context(ctx context.Context) *FoldersInventorySettingsExportSettingsGetCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns an http.Header that can be modified by the caller to
// add HTTP headers to the request.
func (c *FoldersInventorySettingsExportSettingsGetCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *FoldersInventorySettingsExportSettingsGetCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("x-goog-api-client", "gl-go/"+gensupport.GoVersion()+" gdcl/20210211")
	for k, v := range c.header_ {
		reqHeaders[k] = v
...
// Do executes the "cloudasset.folders.inventorySettings.exportSettings.get" call.
// Exactly one of *ExportSetting or error will be non-nil. Any non-2xx
// status code is an error. Response headers are in either
// *ExportSetting.ServerResponse.Header or (if a response was returned
// at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was
// because http.StatusNotModified was returned.
func (c *FoldersInventorySettingsExportSettingsGetCall) Do(opts ...googleapi.CallOption) (*ExportSetting, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
	...
	return ret, nil
	// {
	//   "description": "Gets details about an export setting.",
	//   "flatPath": "v1p7beta1/folders/{foldersId}/inventorySettings/exportSettings/{exportSettingsId}",
	//   "httpMethod": "GET",
	//   "id": "cloudasset.folders.inventorySettings.exportSettings.get",
	//   "parameterOrder": [
	//     "name"
	//   ],
	//   "parameters": {
...
// method id "cloudasset.folders.inventorySettings.exportSettings.list":

type FoldersInventorySettingsExportSettingsListCall struct {
	s            *Service
	parent       string
	urlParams_   gensupport.URLParams
	ifNoneMatch_ string
...
// List: Lists all export settings under a [InventorySettings].
func (r *FoldersInventorySettingsExportSettingsService) List(parent string) *FoldersInventorySettingsExportSettingsListCall {
	c := &FoldersInventorySettingsExportSettingsListCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.parent = parent
	return c
}

// PageSize sets the optional parameter "pageSize": The maximum number
// of export settings to return. The service may return fewer than this
// value. If unspecified, at most 100 export settings will be returned.
// The maximum value is 100, as currently only a maximum of 100 export
// settings can be created under each parent.
func (c *FoldersInventorySettingsExportSettingsListCall) PageSize(pageSize int64) *FoldersInventorySettingsExportSettingsListCall {
	c.urlParams_.Set("pageSize", fmt.Sprint(pageSize))
	return c
}

// PageToken sets the optional parameter "pageToken": A page token,
// received from a previous `ListExportSettings` call. Provide this to
// retrieve the subsequent page. When paginating, all other parameters
// provided to `ListExportSettings` must match the call that provided
// the page token.
func (c *FoldersInventorySettingsExportSettingsListCall) PageToken(pageToken string) *FoldersInventorySettingsExportSettingsListCall {
	c.urlParams_.Set("pageToken", pageToken)
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *FoldersInventorySettingsExportSettingsListCall) Fields(s ...googleapi.Field) *FoldersInventorySettingsExportSettingsListCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// request. Use googleapi.IsNotModified to check whether the response
// error from Do is the result of In-None-Match.
func (c *FoldersInventorySettingsExportSettingsListCall) IfNoneMatch(entityTag string) *FoldersInventorySettingsExportSettingsListCall {
	c.ifNoneMatch_ = entityTag
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *FoldersInventorySettingsExportSettingsListCall) Context(ctx context.Context) *FoldersInventorySettingsExportSettingsListCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns an http.Header that can be modified by the caller to
// add HTTP headers to the request.
func (c *FoldersInventorySettingsExportSettingsListCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *FoldersInventorySettingsExportSettingsListCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("x-goog-api-client", "gl-go/"+gensupport.GoVersion()+" gdcl/20210211")
	for k, v := range c.header_ {
		reqHeaders[k] = v
...
// Do executes the "cloudasset.folders.inventorySettings.exportSettings.list" call.
// Exactly one of *ListExportSettingsResponse or error will be non-nil.
// Any non-2xx status code is an error. Response headers are in either
// *ListExportSettingsResponse.ServerResponse.Header or (if a response
// was returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was
// because http.StatusNotModified was returned.
func (c *FoldersInventorySettingsExportSettingsListCall) Do(opts ...googleapi.CallOption) (*ListExportSettingsResponse, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
	...
	ret := &ListExportSettingsResponse{
		ServerResponse: googleapi.ServerResponse{
			Header:         res.Header,
			HTTPStatusCode: res.StatusCode,
		},
	...
	return ret, nil
	// {
	//   "description": "Lists all export settings under a [InventorySettings].",
	//   "flatPath": "v1p7beta1/folders/{foldersId}/inventorySettings/exportSettings",
	//   "httpMethod": "GET",
	//   "id": "cloudasset.folders.inventorySettings.exportSettings.list",
	//   "parameterOrder": [
	//     "parent"
	//   ],
	//   "parameters": {
	//     "pageSize": {
	//       "description": "The maximum number of export settings to return. The service may return fewer than this value. If unspecified, at most 100 export settings will be returned. The maximum value is 100, as currently only a maximum of 100 export settings can be created under each parent.",
	//       "format": "int32",
	//       "location": "query",
	//       "type": "integer"
	//     },
	//     "pageToken": {
	//       "description": "A page token, received from a previous `ListExportSettings` call. Provide this to retrieve the subsequent page. When paginating, all other parameters provided to `ListExportSettings` must match the call that provided the page token.",
	//       "location": "query",
	//       "type": "string"
	//     },
	//     "parent": {
	//       "description": "Required. The parent [InventorySettings] whose export settings are to be listed.",
	//       "location": "path",
	//       "pattern": "^folders/[^/]+/inventorySettings$",
	//       "required": true,
	//       "type": "string"
	...
	//   "path": "v1p7beta1/{+parent}/exportSettings",
	//   "response": {
	//     "$ref": "ListExportSettingsResponse"
	//   },
	//   "scopes": [
	//     "https://www.googleapis.com/auth/cloud-platform"
	//   ]
...
// A non-nil error returned from f will halt the iteration.
// The provided context supersedes any context provided to the Context method.
func (c *FoldersInventorySettingsExportSettingsListCall) Pages(ctx context.Context, f func(*ListExportSettingsResponse) error) error {
	c.ctx_ = ctx
	defer c.PageToken(c.urlParams_.Get("pageToken")) // reset paging to original point
	for {
		x, err := c.Do()
...
// method id "cloudasset.folders.inventorySettings.exportSettings.patch":

type FoldersInventorySettingsExportSettingsPatchCall struct {
	s             *Service
	name          string
...
// Patch: Updates an export setting.
func (r *FoldersInventorySettingsExportSettingsService) Patch(name string, exportsetting *ExportSetting) *FoldersInventorySettingsExportSettingsPatchCall {
	c := &FoldersInventorySettingsExportSettingsPatchCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.name = name
	c.exportsetting = exportsetting
	return c
}

// UpdateMask sets the optional parameter "updateMask": Required. Only
// updates the `export_setting` fields indicated by this mask. The field
// mask must not be empty, and it must not contain fields that are
// immutable or only set by the server.
func (c *FoldersInventorySettingsExportSettingsPatchCall) UpdateMask(updateMask string) *FoldersInventorySettingsExportSettingsPatchCall {
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *FoldersInventorySettingsExportSettingsPatchCall) Fields(s ...googleapi.Field) *FoldersInventorySettingsExportSettingsPatchCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *FoldersInventorySettingsExportSettingsPatchCall) Context(ctx context.Context) *FoldersInventorySettingsExportSettingsPatchCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns an http.Header that can be modified by the caller to
// add HTTP headers to the request.
func (c *FoldersInventorySettingsExportSettingsPatchCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *FoldersInventorySettingsExportSettingsPatchCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("x-goog-api-client", "gl-go/"+gensupport.GoVersion()+" gdcl/20210211")
	for k, v := range c.header_ {
		reqHeaders[k] = v
	...
	reqHeaders.Set("User-Agent", c.s.userAgent())
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.exportsetting)
	if err != nil {
		return nil, err
	}
	reqHeaders.Set("Content-Type", "application/json")
...
// Do executes the "cloudasset.folders.inventorySettings.exportSettings.patch" call.
// Exactly one of *ExportSetting or error will be non-nil. Any non-2xx
// status code is an error. Response headers are in either
// *ExportSetting.ServerResponse.Header or (if a response was returned
// at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was
// because http.StatusNotModified was returned.
func (c *FoldersInventorySettingsExportSettingsPatchCall) Do(opts ...googleapi.CallOption) (*ExportSetting, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
	...
	return ret, nil
	// {
	//   "description": "Updates an export setting.",
	//   "flatPath": "v1p7beta1/folders/{foldersId}/inventorySettings/exportSettings/{exportSettingsId}",
	//   "httpMethod": "PATCH",
	//   "id": "cloudasset.folders.inventorySettings.exportSettings.patch",
	//   "parameterOrder": [
	//     "name"
	//   ],
	//   "parameters": {
	//     "name": {
	//       "description": "The format will be: organizations/{ORGANIZATION_NUMBER}/inventorySettings/exportSettings/{exportSetting} or folders/{FOLDER_NUMBER}/inventorySettings/exportSettings/{exportSetting} or projects/{PROJECT_NUMBER}/inventorySettings/exportSettings/{exportSetting}",
	//       "location": "path",
	//       "pattern": "^folders/[^/]+/inventorySettings/exportSettings/[^/]+$",
	//       "required": true,
	//       "type": "string"
	//     },
	//     "updateMask": {
	//       "description": "Required. Only updates the `export_setting` fields indicated by this mask. The field mask must not be empty, and it must not contain fields that are immutable or only set by the server.",
...
// method id "cloudasset.organizations.getInventorySettings":

type OrganizationsGetInventorySettingsCall struct {
	s            *Service
	name         string
	urlParams_   gensupport.URLParams
	ifNoneMatch_ string
...
// GetInventorySettings: Gets details about an inventory setting.
func (r *OrganizationsService) GetInventorySettings(name string) *OrganizationsGetInventorySettingsCall {
	c := &OrganizationsGetInventorySettingsCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.name = name
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *OrganizationsGetInventorySettingsCall) Fields(s ...googleapi.Field) *OrganizationsGetInventorySettingsCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// request. Use googleapi.IsNotModified to check whether the response
// error from Do is the result of In-None-Match.
func (c *OrganizationsGetInventorySettingsCall) IfNoneMatch(entityTag string) *OrganizationsGetInventorySettingsCall {
	c.ifNoneMatch_ = entityTag
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *OrganizationsGetInventorySettingsCall) Context(ctx context.Context) *OrganizationsGetInventorySettingsCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns an http.Header that can be modified by the caller to
// add HTTP headers to the request.
func (c *OrganizationsGetInventorySettingsCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *OrganizationsGetInventorySettingsCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("x-goog-api-client", "gl-go/"+gensupport.GoVersion()+" gdcl/20210211")
	for k, v := range c.header_ {
		reqHeaders[k] = v
...
// Do executes the "cloudasset.organizations.getInventorySettings" call.
// Exactly one of *InventorySettings or error will be non-nil. Any
// non-2xx status code is an error. Response headers are in either
// *InventorySettings.ServerResponse.Header or (if a response was
// returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was
// because http.StatusNotModified was returned.
func (c *OrganizationsGetInventorySettingsCall) Do(opts ...googleapi.CallOption) (*InventorySettings, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
	...
	// {
	//   "description": "Gets details about an inventory setting.",
	//   "flatPath": "v1p7beta1/organizations/{organizationsId}/inventorySettings",
	//   "httpMethod": "GET",
	//   "id": "cloudasset.organizations.getInventorySettings",
	//   "parameterOrder": [
	//     "name"
	//   ],
	//   "parameters": {
...
// method id "cloudasset.organizations.inventorySettings.exportSettings.create":

type OrganizationsInventorySettingsExportSettingsCreateCall struct {
	s                          *Service
	parent                     string
	createexportsettingrequest *CreateExportSettingRequest
	urlParams_                 gensupport.URLParams
...
// Create: Creates an export setting.
func (r *OrganizationsInventorySettingsExportSettingsService) Create(parent string, createexportsettingrequest *CreateExportSettingRequest) *OrganizationsInventorySettingsExportSettingsCreateCall {
	c := &OrganizationsInventorySettingsExportSettingsCreateCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.parent = parent
	c.createexportsettingrequest = createexportsettingrequest
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *OrganizationsInventorySettingsExportSettingsCreateCall) Fields(s ...googleapi.Field) *OrganizationsInventorySettingsExportSettingsCreateCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *OrganizationsInventorySettingsExportSettingsCreateCall) Context(ctx context.Context) *OrganizationsInventorySettingsExportSettingsCreateCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns an http.Header that can be modified by the caller to
// add HTTP headers to the request.
func (c *OrganizationsInventorySettingsExportSettingsCreateCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *OrganizationsInventorySettingsExportSettingsCreateCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("x-goog-api-client", "gl-go/"+gensupport.GoVersion()+" gdcl/20210211")
	for k, v := range c.header_ {
		reqHeaders[k] = v
...
// Do executes the "cloudasset.organizations.inventorySettings.exportSettings.create" call.
// Exactly one of *ExportSetting or error will be non-nil. Any non-2xx
// status code is an error. Response headers are in either
// *ExportSetting.ServerResponse.Header or (if a response was returned
// at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was
// because http.StatusNotModified was returned.
func (c *OrganizationsInventorySettingsExportSettingsCreateCall) Do(opts ...googleapi.CallOption) (*ExportSetting, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
	...
	// {
	//   "description": "Creates an export setting.",
	//   "flatPath": "v1p7beta1/organizations/{organizationsId}/inventorySettings/exportSettings",
	//   "httpMethod": "POST",
	//   "id": "cloudasset.organizations.inventorySettings.exportSettings.create",
	//   "parameterOrder": [
	//     "parent"
	//   ],
	//   "parameters": {
...
// method id "cloudasset.organizations.inventorySettings.exportSettings.delete":

type OrganizationsInventorySettingsExportSettingsDeleteCall struct {
	s          *Service
	name       string
	urlParams_ gensupport.URLParams
	ctx_       context.Context
...
// Delete: Deletes an export setting.
func (r *OrganizationsInventorySettingsExportSettingsService) Delete(name string) *OrganizationsInventorySettingsExportSettingsDeleteCall {
	c := &OrganizationsInventorySettingsExportSettingsDeleteCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.name = name
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *OrganizationsInventorySettingsExportSettingsDeleteCall) Fields(s ...googleapi.Field) *OrganizationsInventorySettingsExportSettingsDeleteCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *OrganizationsInventorySettingsExportSettingsDeleteCall) Context(ctx context.Context) *OrganizationsInventorySettingsExportSettingsDeleteCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns an http.Header that can be modified by the caller to
// add HTTP headers to the request.
func (c *OrganizationsInventorySettingsExportSettingsDeleteCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *OrganizationsInventorySettingsExportSettingsDeleteCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("x-goog-api-client", "gl-go/"+gensupport.GoVersion()+" gdcl/20210211")
	for k, v := range c.header_ {
		reqHeaders[k] = v
...
// Do executes the "cloudasset.organizations.inventorySettings.exportSettings.delete" call.
// Exactly one of *Empty or error will be non-nil. Any non-2xx status
// code is an error. Response headers are in either
// *Empty.ServerResponse.Header or (if a response was returned at all)
// in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified
// was returned.
func (c *OrganizationsInventorySettingsExportSettingsDeleteCall) Do(opts ...googleapi.CallOption) (*Empty, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
	...
	// {
	//   "description": "Deletes an export setting.",
	//   "flatPath": "v1p7beta1/organizations/{organizationsId}/inventorySettings/exportSettings/{exportSettingsId}",
	//   "httpMethod": "DELETE",
	//   "id": "cloudasset.organizations.inventorySettings.exportSettings.delete",
	//   "parameterOrder": [
	//     "name"
	//   ],
	//   "parameters": {
...
// method id "cloudasset.organizations.inventorySettings.exportSettings.get":

type OrganizationsInventorySettingsExportSettingsGetCall struct {
	s            *Service
	name         string
	urlParams_   gensupport.URLParams
	ifNoneMatch_ string
...
// Get: Gets details about an export setting.
func (r *OrganizationsInventorySettingsExportSettingsService) Get(name string) *OrganizationsInventorySettingsExportSettingsGetCall {
	c := &OrganizationsInventorySettingsExportSettingsGetCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.name = name
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *OrganizationsInventorySettingsExportSettingsGetCall) Fields(s ...googleapi.Field) *OrganizationsInventorySettingsExportSettingsGetCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// request. Use googleapi.IsNotModified to check whether the response
// error from Do is the result of In-None-Match.
func (c *OrganizationsInventorySettingsExportSettingsGetCall) IfNoneMatch(entityTag string) *OrganizationsInventorySettingsExportSettingsGetCall {
	c.ifNoneMatch_ = entityTag
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *OrganizationsInventorySettingsExportSettingsGetCall) Context(ctx context.Context) *OrganizationsInventorySettingsExportSettingsGetCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns an http.Header that can be modified by the caller to
// add HTTP headers to the request.
func (c *OrganizationsInventorySettingsExportSettingsGetCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *OrganizationsInventorySettingsExportSettingsGetCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("x-goog-api-client", "gl-go/"+gensupport.GoVersion()+" gdcl/20210211")
	for k, v := range c.header_ {
		reqHeaders[k] = v
...
// Do executes the "cloudasset.organizations.inventorySettings.exportSettings.get" call.
// Exactly one of *ExportSetting or error will be non-nil. Any non-2xx
// status code is an error. Response headers are in either
// *ExportSetting.ServerResponse.Header or (if a response was returned
// at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was
// because http.StatusNotModified was returned.
func (c *OrganizationsInventorySettingsExportSettingsGetCall) Do(opts ...googleapi.CallOption) (*ExportSetting, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
	...
	//   "flatPath": "v1p7beta1/organizations/{organizationsId}/inventorySettings/exportSettings/{exportSettingsId}",
	//   "httpMethod": "GET",
	//   "id": "cloudasset.organizations.inventorySettings.exportSettings.get",
	//   "parameterOrder": [
	//     "name"
	//   ],
	//   "parameters": {
...
// method id "cloudasset.organizations.inventorySettings.exportSettings.list":

type OrganizationsInventorySettingsExportSettingsListCall struct {
	s            *Service
	parent       string
	urlParams_   gensupport.URLParams
	ifNoneMatch_ string
...
// List: Lists all export settings under a [InventorySettings].
func (r *OrganizationsInventorySettingsExportSettingsService) List(parent string) *OrganizationsInventorySettingsExportSettingsListCall {
	c := &OrganizationsInventorySettingsExportSettingsListCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.parent = parent
	return c
}
...
// The maximum value is 100, as currently only a maximum of 100 export
// settings can be created under each parent.
func (c *OrganizationsInventorySettingsExportSettingsListCall) PageSize(pageSize int64) *OrganizationsInventorySettingsExportSettingsListCall {
	c.urlParams_.Set("pageSize", fmt.Sprint(pageSize))
	return c
}
...
// provided to `ListExportSettings` must match the call that provided
// the page token.
func (c *OrganizationsInventorySettingsExportSettingsListCall) PageToken(pageToken string) *OrganizationsInventorySettingsExportSettingsListCall {
	c.urlParams_.Set("pageToken", pageToken)
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *OrganizationsInventorySettingsExportSettingsListCall) Fields(s ...googleapi.Field) *OrganizationsInventorySettingsExportSettingsListCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// request. Use googleapi.IsNotModified to check whether the response
// error from Do is the result of In-None-Match.
func (c *OrganizationsInventorySettingsExportSettingsListCall) IfNoneMatch(entityTag string) *OrganizationsInventorySettingsExportSettingsListCall {
	c.ifNoneMatch_ = entityTag
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *OrganizationsInventorySettingsExportSettingsListCall) Context(ctx context.Context) *OrganizationsInventorySettingsExportSettingsListCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns an http.Header that can be modified by the caller to
// add HTTP headers to the request.
func (c *OrganizationsInventorySettingsExportSettingsListCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *OrganizationsInventorySettingsExportSettingsListCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("x-goog-api-client", "gl-go/"+gensupport.GoVersion()+" gdcl/20210211")
	for k, v := range c.header_ {
		reqHeaders[k] = v
...
// Do executes the "cloudasset.organizations.inventorySettings.exportSettings.list" call.
// Exactly one of *ListExportSettingsResponse or error will be non-nil.
// Any non-2xx status code is an error. Response headers are in either
// *ListExportSettingsResponse.ServerResponse.Header or (if a response
// was returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was
// because http.StatusNotModified was returned.
func (c *OrganizationsInventorySettingsExportSettingsListCall) Do(opts ...googleapi.CallOption) (*ListExportSettingsResponse, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
	...
	//   "flatPath": "v1p7beta1/organizations/{organizationsId}/inventorySettings/exportSettings",
	//   "httpMethod": "GET",
	//   "id": "cloudasset.organizations.inventorySettings.exportSettings.list",
	//   "parameterOrder": [
	//     "parent"
	//   ],
	//   "parameters": {
...
// A non-nil error returned from f will halt the iteration.
// The provided context supersedes any context provided to the Context method.
func (c *OrganizationsInventorySettingsExportSettingsListCall) Pages(ctx context.Context, f func(*ListExportSettingsResponse) error) error {
	c.ctx_ = ctx
	defer c.PageToken(c.urlParams_.Get("pageToken")) // reset paging to original point
	for {
		x, err := c.Do()
...
// method id "cloudasset.organizations.inventorySettings.exportSettings.patch":

type OrganizationsInventorySettingsExportSettingsPatchCall struct {
	s             *Service
	name          string
	exportsetting *ExportSetting
	urlParams_    gensupport.URLParams
...
// Patch: Updates an export setting.
func (r *OrganizationsInventorySettingsExportSettingsService) Patch(name string, exportsetting *ExportSetting) *OrganizationsInventorySettingsExportSettingsPatchCall {
	c := &OrganizationsInventorySettingsExportSettingsPatchCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.name = name
	c.exportsetting = exportsetting
	return c
}
...
// mask must not be empty, and it must not contain fields that are
// immutable or only set by the server.
func (c *OrganizationsInventorySettingsExportSettingsPatchCall) UpdateMask(updateMask string) *OrganizationsInventorySettingsExportSettingsPatchCall {
	c.urlParams_.Set("updateMask", updateMask)
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *OrganizationsInventorySettingsExportSettingsPatchCall) Fields(s ...googleapi.Field) *OrganizationsInventorySettingsExportSettingsPatchCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *OrganizationsInventorySettingsExportSettingsPatchCall) Context(ctx context.Context) *OrganizationsInventorySettingsExportSettingsPatchCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns an http.Header that can be modified by the caller to
// add HTTP headers to the request.
func (c *OrganizationsInventorySettingsExportSettingsPatchCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *OrganizationsInventorySettingsExportSettingsPatchCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("x-goog-api-client", "gl-go/"+gensupport.GoVersion()+" gdcl/20210211")
	for k, v := range c.header_ {
		reqHeaders[k] = v
...
// Do executes the "cloudasset.organizations.inventorySettings.exportSettings.patch" call.
// Exactly one of *ExportSetting or error will be non-nil. Any non-2xx
// status code is an error. Response headers are in either
// *ExportSetting.ServerResponse.Header or (if a response was returned
// at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was
// because http.StatusNotModified was returned.
func (c *OrganizationsInventorySettingsExportSettingsPatchCall) Do(opts ...googleapi.CallOption) (*ExportSetting, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
	...
	//   "flatPath": "v1p7beta1/organizations/{organizationsId}/inventorySettings/exportSettings/{exportSettingsId}",
	//   "httpMethod": "PATCH",
	//   "id": "cloudasset.organizations.inventorySettings.exportSettings.patch",
	//   "parameterOrder": [
	//     "name"
	//   ],
	//   "parameters": {
...
// method id "cloudasset.projects.getInventorySettings":

type ProjectsGetInventorySettingsCall struct {
	s            *Service
	name         string
	urlParams_   gensupport.URLParams
	ifNoneMatch_ string
...
// GetInventorySettings: Gets details about an inventory setting.
func (r *ProjectsService) GetInventorySettings(name string) *ProjectsGetInventorySettingsCall {
	c := &ProjectsGetInventorySettingsCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.name = name
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *ProjectsGetInventorySettingsCall) Fields(s ...googleapi.Field) *ProjectsGetInventorySettingsCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// request. Use googleapi.IsNotModified to check whether the response
// error from Do is the result of In-None-Match.
func (c *ProjectsGetInventorySettingsCall) IfNoneMatch(entityTag string) *ProjectsGetInventorySettingsCall {
	c.ifNoneMatch_ = entityTag
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *ProjectsGetInventorySettingsCall) Context(ctx context.Context) *ProjectsGetInventorySettingsCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns an http.Header that can be modified by the caller to
// add HTTP headers to the request.
func (c *ProjectsGetInventorySettingsCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *ProjectsGetInventorySettingsCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("x-goog-api-client", "gl-go/"+gensupport.GoVersion()+" gdcl/20210211")
	for k, v := range c.header_ {
		reqHeaders[k] = v
...
// Do executes the "cloudasset.projects.getInventorySettings" call.
// Exactly one of *InventorySettings or error will be non-nil. Any
// non-2xx status code is an error. Response headers are in either
// *InventorySettings.ServerResponse.Header or (if a response was
// returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was
// because http.StatusNotModified was returned.
func (c *ProjectsGetInventorySettingsCall) Do(opts ...googleapi.CallOption) (*InventorySettings, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
	...
	// {
	//   "description": "Gets details about an inventory setting.",
	//   "flatPath": "v1p7beta1/projects/{projectsId}/inventorySettings",
	//   "httpMethod": "GET",
	//   "id": "cloudasset.projects.getInventorySettings",
	//   "parameterOrder": [
	//     "name"
	//   ],
	//   "parameters": {
...
// method id "cloudasset.projects.inventorySettings.exportSettings.create":

type ProjectsInventorySettingsExportSettingsCreateCall struct {
	s                          *Service
	parent                     string
	createexportsettingrequest *CreateExportSettingRequest
	urlParams_                 gensupport.URLParams
...
// Create: Creates an export setting.
func (r *ProjectsInventorySettingsExportSettingsService) Create(parent string, createexportsettingrequest *CreateExportSettingRequest) *ProjectsInventorySettingsExportSettingsCreateCall {
	c := &ProjectsInventorySettingsExportSettingsCreateCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.parent = parent
	c.createexportsettingrequest = createexportsettingrequest
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *ProjectsInventorySettingsExportSettingsCreateCall) Fields(s ...googleapi.Field) *ProjectsInventorySettingsExportSettingsCreateCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *ProjectsInventorySettingsExportSettingsCreateCall) Context(ctx context.Context) *ProjectsInventorySettingsExportSettingsCreateCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns an http.Header that can be modified by the caller to
// add HTTP headers to the request.
func (c *ProjectsInventorySettingsExportSettingsCreateCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *ProjectsInventorySettingsExportSettingsCreateCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("x-goog-api-client", "gl-go/"+gensupport.GoVersion()+" gdcl/20210211")
	for k, v := range c.header_ {
		reqHeaders[k] = v
...
// Do executes the "cloudasset.projects.inventorySettings.exportSettings.create" call.
// Exactly one of *ExportSetting or error will be non-nil. Any non-2xx
// status code is an error. Response headers are in either
// *ExportSetting.ServerResponse.Header or (if a response was returned
// at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was
// because http.StatusNotModified was returned.
func (c *ProjectsInventorySettingsExportSettingsCreateCall) Do(opts ...googleapi.CallOption) (*ExportSetting, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
	...
	// {
	//   "description": "Creates an export setting.",
	//   "flatPath": "v1p7beta1/projects/{projectsId}/inventorySettings/exportSettings",
	//   "httpMethod": "POST",
	//   "id": "cloudasset.projects.inventorySettings.exportSettings.create",
	//   "parameterOrder": [
	//     "parent"
	//   ],
	//   "parameters": {
...
// method id "cloudasset.projects.inventorySettings.exportSettings.delete":

type ProjectsInventorySettingsExportSettingsDeleteCall struct {
	s          *Service
	name       string
	urlParams_ gensupport.URLParams
	ctx_       context.Context
...
// Delete: Deletes an export setting.
func (r *ProjectsInventorySettingsExportSettingsService) Delete(name string) *ProjectsInventorySettingsExportSettingsDeleteCall {
	c := &ProjectsInventorySettingsExportSettingsDeleteCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.name = name
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *ProjectsInventorySettingsExportSettingsDeleteCall) Fields(s ...googleapi.Field) *ProjectsInventorySettingsExportSettingsDeleteCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *ProjectsInventorySettingsExportSettingsDeleteCall) Context(ctx context.Context) *ProjectsInventorySettingsExportSettingsDeleteCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns an http.Header that can be modified by the caller to
// add HTTP headers to the request.
func (c *ProjectsInventorySettingsExportSettingsDeleteCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *ProjectsInventorySettingsExportSettingsDeleteCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("x-goog-api-client", "gl-go/"+gensupport.GoVersion()+" gdcl/20210211")
	for k, v := range c.header_ {
		reqHeaders[k] = v
...
// Do executes the "cloudasset.projects.inventorySettings.exportSettings.delete" call.
// Exactly one of *Empty or error will be non-nil. Any non-2xx status
// code is an error. Response headers are in either
// *Empty.ServerResponse.Header or (if a response was returned at all)
// in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified
// was returned.
func (c *ProjectsInventorySettingsExportSettingsDeleteCall) Do(opts ...googleapi.CallOption) (*Empty, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
	...
	// {
	//   "description": "Deletes an export setting.",
	//   "flatPath": "v1p7beta1/projects/{projectsId}/inventorySettings/exportSettings/{exportSettingsId}",
	//   "httpMethod": "DELETE",
	//   "id": "cloudasset.projects.inventorySettings.exportSettings.delete",
	//   "parameterOrder": [
	//     "name"
	//   ],
	//   "parameters": {
...
// method id "cloudasset.projects.inventorySettings.exportSettings.get":

type ProjectsInventorySettingsExportSettingsGetCall struct {
	s            *Service
	name         string
	urlParams_   gensupport.URLParams
	ifNoneMatch_ string
...
// Get: Gets details about an export setting.
func (r *ProjectsInventorySettingsExportSettingsService) Get(name string) *ProjectsInventorySettingsExportSettingsGetCall {
	c := &ProjectsInventorySettingsExportSettingsGetCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.name = name
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *ProjectsInventorySettingsExportSettingsGetCall) Fields(s ...googleapi.Field) *ProjectsInventorySettingsExportSettingsGetCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// request. Use googleapi.IsNotModified to check whether the response
// error from Do is the result of In-None-Match.
func (c *ProjectsInventorySettingsExportSettingsGetCall) IfNoneMatch(entityTag string) *ProjectsInventorySettingsExportSettingsGetCall {
	c.ifNoneMatch_ = entityTag
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *ProjectsInventorySettingsExportSettingsGetCall) Context(ctx context.Context) *ProjectsInventorySettingsExportSettingsGetCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns an http.Header that can be modified by the caller to
// add HTTP headers to the request.
func (c *ProjectsInventorySettingsExportSettingsGetCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *ProjectsInventorySettingsExportSettingsGetCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("x-goog-api-client", "gl-go/"+gensupport.GoVersion()+" gdcl/20210211")
	for k, v := range c.header_ {
		reqHeaders[k] = v
...
// Do executes the "cloudasset.projects.inventorySettings.exportSettings.get" call.
// Exactly one of *ExportSetting or error will be non-nil. Any non-2xx
// status code is an error. Response headers are in either
// *ExportSetting.ServerResponse.Header or (if a response was returned
// at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was
// because http.StatusNotModified was returned.
func (c *ProjectsInventorySettingsExportSettingsGetCall) Do(opts ...googleapi.CallOption) (*ExportSetting, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
	...
	//   "flatPath": "v1p7beta1/projects/{projectsId}/inventorySettings/exportSettings/{exportSettingsId}",
	//   "httpMethod": "GET",
	//   "id": "cloudasset.projects.inventorySettings.exportSettings.get",
	//   "parameterOrder": [
	//     "name"
	//   ],
	//   "parameters": {
...
// method id "cloudasset.projects.inventorySettings.exportSettings.list":

type ProjectsInventorySettingsExportSettingsListCall struct {
	s            *Service
	parent       string
	urlParams_   gensupport.URLParams
	ifNoneMatch_ string
...
// List: Lists all export settings under a [InventorySettings].
func (r *ProjectsInventorySettingsExportSettingsService) List(parent string) *ProjectsInventorySettingsExportSettingsListCall {
	c := &ProjectsInventorySettingsExportSettingsListCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.parent = parent
	return c
}
...
// The maximum value is 100, as currently only a maximum of 100 export
// settings can be created under each parent.
func (c *ProjectsInventorySettingsExportSettingsListCall) PageSize(pageSize int64) *ProjectsInventorySettingsExportSettingsListCall {
	c.urlParams_.Set("pageSize", fmt.Sprint(pageSize))
	return c
}
...
// provided to `ListExportSettings` must match the call that provided
// the page token.
func (c *ProjectsInventorySettingsExportSettingsListCall) PageToken(pageToken string) *ProjectsInventorySettingsExportSettingsListCall {
	c.urlParams_.Set("pageToken", pageToken)
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *ProjectsInventorySettingsExportSettingsListCall) Fields(s ...googleapi.Field) *ProjectsInventorySettingsExportSettingsListCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// request. Use googleapi.IsNotModified to check whether the response
// error from Do is the result of In-None-Match.
func (c *ProjectsInventorySettingsExportSettingsListCall) IfNoneMatch(entityTag string) *ProjectsInventorySettingsExportSettingsListCall {
	c.ifNoneMatch_ = entityTag
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *ProjectsInventorySettingsExportSettingsListCall) Context(ctx context.Context) *ProjectsInventorySettingsExportSettingsListCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns an http.Header that can be modified by the caller to
// add HTTP headers to the request.
func (c *ProjectsInventorySettingsExportSettingsListCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *ProjectsInventorySettingsExportSettingsListCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("x-goog-api-client", "gl-go/"+gensupport.GoVersion()+" gdcl/20210211")
	for k, v := range c.header_ {
		reqHeaders[k] = v
...
// Do executes the "cloudasset.projects.inventorySettings.exportSettings.list" call.
// Exactly one of *ListExportSettingsResponse or error will be non-nil.
// Any non-2xx status code is an error. Response headers are in either
// *ListExportSettingsResponse.ServerResponse.Header or (if a response
// was returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was
// because http.StatusNotModified was returned.
func (c *ProjectsInventorySettingsExportSettingsListCall) Do(opts ...googleapi.CallOption) (*ListExportSettingsResponse, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
	...
	//   "flatPath": "v1p7beta1/projects/{projectsId}/inventorySettings/exportSettings",
	//   "httpMethod": "GET",
	//   "id": "cloudasset.projects.inventorySettings.exportSettings.list",
	//   "parameterOrder": [
	//     "parent"
	//   ],
	//   "parameters": {
...
// A non-nil error returned from f will halt the iteration.
// The provided context supersedes any context provided to the Context method.
func (c *ProjectsInventorySettingsExportSettingsListCall) Pages(ctx context.Context, f func(*ListExportSettingsResponse) error) error {
	c.ctx_ = ctx
	defer c.PageToken(c.urlParams_.Get("pageToken")) // reset paging to original point
	for {
		x, err := c.Do()
...
// method id "cloudasset.projects.inventorySettings.exportSettings.patch":

type ProjectsInventorySettingsExportSettingsPatchCall struct {
	s             *Service
	name          string
	exportsetting *ExportSetting
	urlParams_    gensupport.URLParams
...
// Patch: Updates an export setting.
func (r *ProjectsInventorySettingsExportSettingsService) Patch(name string, exportsetting *ExportSetting) *ProjectsInventorySettingsExportSettingsPatchCall {
	c := &ProjectsInventorySettingsExportSettingsPatchCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.name = name
	c.exportsetting = exportsetting
	return c
}
...
// mask must not be empty, and it must not contain fields that are
// immutable or only set by the server.
func (c *ProjectsInventorySettingsExportSettingsPatchCall) UpdateMask(updateMask string) *ProjectsInventorySettingsExportSettingsPatchCall {
	c.urlParams_.Set("updateMask", updateMask)
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *ProjectsInventorySettingsExportSettingsPatchCall) Fields(s ...googleapi.Field) *ProjectsInventorySettingsExportSettingsPatchCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *ProjectsInventorySettingsExportSettingsPatchCall) Context(ctx context.Context) *ProjectsInventorySettingsExportSettingsPatchCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns an http.Header that can be modified by the caller to
// add HTTP headers to the request.
func (c *ProjectsInventorySettingsExportSettingsPatchCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *ProjectsInventorySettingsExportSettingsPatchCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("x-goog-api-client", "gl-go/"+gensupport.GoVersion()+" gdcl/20210211")
	for k, v := range c.header_ {
		reqHeaders[k] = v
...
// Do executes the "cloudasset.projects.inventorySettings.exportSettings.patch" call.
// Exactly one of *ExportSetting or error will be non-nil. Any non-2xx
// status code is an error. Response headers are in either
// *ExportSetting.ServerResponse.Header or (if a response was returned
// at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was
// because http.StatusNotModified was returned.
func (c *ProjectsInventorySettingsExportSettingsPatchCall) Do(opts ...googleapi.CallOption) (*ExportSetting, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
	...
	//   "flatPath": "v1p7beta1/projects/{projectsId}/inventorySettings/exportSettings/{exportSettingsId}",
	//   "httpMethod": "PATCH",
	//   "id": "cloudasset.projects.inventorySettings.exportSettings.patch",
	//   "parameterOrder": [
	//     "name"
	//   ],
	//   "parameters": {
...
// method id "cloudasset.exportAssetUpdates":

type V1p7beta1ExportAssetUpdatesCall struct {
	s                         *Service
	parent                    string
	exportassetupdatesrequest *ExportAssetUpdatesRequest
	urlParams_                gensupport.URLParams
	ctx_                      context.Context
	header_                   http.Header
}

// ExportAssetUpdates: Exports asset updates within a time window to a
// given Cloud Storage location/BigQuery table. For Cloud Storage
// location destinations, the output format is newline-delimited JSON.
// Each line represents a google.cloud.asset.v1p7beta1.Asset in the JSON
...
// within 5 minutes.
func (r *V1p7beta1Service) ExportAssetUpdates(parent string, exportassetupdatesrequest *ExportAssetUpdatesRequest) *V1p7beta1ExportAssetUpdatesCall {
	c := &V1p7beta1ExportAssetUpdatesCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.parent = parent
	c.exportassetupdatesrequest = exportassetupdatesrequest
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *V1p7beta1ExportAssetUpdatesCall) Fields(s ...googleapi.Field) *V1p7beta1ExportAssetUpdatesCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *V1p7beta1ExportAssetUpdatesCall) Context(ctx context.Context) *V1p7beta1ExportAssetUpdatesCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns an http.Header that can be modified by the caller to
// add HTTP headers to the request.
func (c *V1p7beta1ExportAssetUpdatesCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *V1p7beta1ExportAssetUpdatesCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("x-goog-api-client", "gl-go/"+gensupport.GoVersion()+" gdcl/20210211")
	for k, v := range c.header_ {
		reqHeaders[k] = v
	...
	reqHeaders.Set("User-Agent", c.s.userAgent())
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.exportassetupdatesrequest)
	if err != nil {
		return nil, err
	}
	reqHeaders.Set("Content-Type", "application/json")
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1p7beta1/{+parent}:exportAssetUpdates")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
// Do executes the "cloudasset.exportAssetUpdates" call.
...
func (c *V1p7beta1ExportAssetUpdatesCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
	...
	return ret, nil
	// {
	//   "description": "Exports asset updates within a time window to a given Cloud Storage location/BigQuery table. For Cloud Storage location destinations, the output format is newline-delimited JSON. Each line represents a google.cloud.asset.v1p7beta1.Asset in the JSON format; for BigQuery table destinations, the output table stores the fields in asset proto as columns. This API implements the google.longrunning.Operation API , which allows you to keep track of the export. We recommend intervals of at least 2 seconds with exponential retry to poll the export operation result. For regular-size resource parent, the export operation usually finishes within 5 minutes.",
	//   "flatPath": "v1p7beta1/{v1p7beta1Id}/{v1p7beta1Id1}:exportAssetUpdates",
	//   "httpMethod": "POST",
	//   "id": "cloudasset.exportAssetUpdates",
	//   "parameterOrder": [
	//     "parent"
	//   ],
	//   "parameters": {
	...
	//     }
	//   },
	//   "path": "v1p7beta1/{+parent}:exportAssetUpdates",
	//   "request": {
	//     "$ref": "ExportAssetUpdatesRequest"
	//   },
	//   "response": {
	//     "$ref": "Operation"
	//   },
