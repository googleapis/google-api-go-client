...
func (c *ImageConfigurationsUploadCall) Media(r io.Reader, opt ...googleapi.UploadOption) *ImageConfigurationsUploadCall {
	c.media_ = r
...
// At most one of Media and ResumableMedia may be set.
func (c *ImageConfigurationsUploadCall) ResumableMedia(ctx context.Context, r io.Reader, opt ...googleapi.UploadOption) *ImageConfigurationsUploadCall {
	c.ctx_ = ctx
	c.media_ = r
