...
type About struct {
	...
	// Possible values are: * `allowed` * `allowedWithWarning` *
...
type App struct {
	...
	// The template will contain `{ids}` and/or `{exportIds}` to be replaced
	// by the actual file ids. See Open Files for the full documentation.
	...
	// SupportsImport: Whether this app supports importing from Docs
	// Editors.
...
type AppIcons struct {
	...
	// icon for the application * `document` - icon for a file associated
	// with the app * `documentShared` - icon for a shared file associated
	// with the app
...
type Comment struct {
	...
	// Deleted: Output only. Whether this comment has been deleted. If a
	// comment has been deleted the content will be cleared and this will
	...
	// Status: Output only. The status of this comment. Status can be
	// changed by posting a reply to a comment with the desired status. *
	// `open` - The comment is still open. * `resolved` - The comment has
...
type CommentReply struct {
	...
	// Deleted: Output only. Whether this reply has been deleted. If a reply
	// has been deleted the content will be cleared and this will only
...
type File struct {
	...
	// AppDataContents: Output only. Whether this file is in the Application
	// Data folder.
	AppDataContents bool `json:"appDataContents,omitempty"`

	// CanComment: Output only. Deprecated: Use `capabilities/canComment`
	// instead.
	CanComment bool `json:"canComment,omitempty"`
	...
	// DefaultOpenWithLink: Output only. A link to open this file with the
	// user's default app for this file. Only populated when the
	...
	// DownloadUrl: Output only. Short lived download URL for the file. This
	...
	// Editable: Output only. Deprecated: Use `capabilities/canEdit`
	// instead.
	...
	// `fullFileExtension` with trailing text that does not appear to be
	// part of the extension removed. This field is only populated for files
	// with content stored in Google Drive; it is not populated for Docs
	// Editors or shortcut files.
	FileExtension string `json:"fileExtension,omitempty"`

	// FileSize: Output only. Size in bytes of blobs and first party editor
	...
	// folder or a shortcut to a folder. The list of supported colors is
	// available in the folderColorPalette field of the About resource. If
	// an unsupported color is specified, it will be changed to the closest
	// color in the palette.
	FolderColorRgb string `json:"folderColorRgb,omitempty"`

	// FullFileExtension: Output only. The full file extension; extracted
	// from the title. May contain multiple concatenated extensions, such as
	// "tar.gz". Removing an extension from the title does not clear this
	// field; however, changing the extension on the title does update this
	// field. This field is only populated for files with content stored in
	...
	// ImageMediaMetadata: Output only. Metadata about image media. This
	// will only be present for image types, and its contents will depend on
	...
	// LastModifyingUserName: Output only. Name of the last user to modify
	// this file.
	...
	// Md5Checksum: Output only. An MD5 checksum for the content of this
	// file. This field is only populated for files with content stored in
	// Google Drive; it is not populated for Docs Editors or shortcut files.
	...
	// OpenWithLinks: Output only. A map of the id of each of the user's
	// apps to a link to open this file with that app. Only populated when
	...
	// OwnedByMe: Output only. Whether the file is owned by the current
	// user. Not populated for items in shared drives.
	OwnedByMe bool `json:"ownedByMe,omitempty"`

	// OwnerNames: Output only. Name(s) of the owner(s) of this file. Not
	...
	// specified as part of an insert request, the file will be placed
	...
	// source file. Update requests can also use the `addParents` and
	...
	// Permissions: Output only. The list of permissions for users with
	// access to this file. Not populated for items in shared drives.
	Permissions []*Permission `json:"permissions,omitempty"`

	// Properties: The list of properties.
	Properties []*Property `json:"properties,omitempty"`

	// QuotaBytesUsed: Output only. The number of quota bytes used by this
	// file.
	QuotaBytesUsed int64 `json:"quotaBytesUsed,omitempty,string"`
	...
	// Shareable: Output only. Deprecated: Use `capabilities/canShare`
	// instead.
	...
	// SharingUser: Output only. User that shared the item with the current
	// user, if available.
	...
	// Spaces: Output only. The list of spaces which contain the file.
	...
	// thumbnail. Typically lasts on the order of hours. Only populated when
	...
	// UserPermission: Output only. The permissions for the authenticated
	// user on this file.
	...
	// VideoMediaMetadata: Output only. Metadata about video media. This
	// will only be present for video types.
	...
	// the file in a browser using cookie based authentication. In cases
	// where the content is shared publicly, the content can be downloaded
	...
	// viewing their static web assets (HTML, CSS, JS, etc) via Google
...
type FileCapabilities struct {
	...
	// CanMoveTeamDriveItem: Output only. Deprecated: Use
	...
	// CanReadTeamDrive: Output only. Deprecated: Use `canReadDrive`
	// instead.
...
// FileImageMediaMetadata: Output only. Metadata about image media. This
// will only be present for image types, and its contents will depend on
// what can be parsed from the image content.
...
type FileLabels struct {
	...
	// Modified: Output only. Whether the file has been modified by this
	// user.
	Modified bool `json:"modified,omitempty"`

	// Restricted: Output only. Deprecated: Use
	// `copyRequiresWriterPermission` instead.
...
// FileVideoMediaMetadata: Output only. Metadata about video media. This
// will only be present for video types.
...
type Permission struct {
	...
	// Domain: Output only. The domain name of the entity this permission
	// refers to. This is an output-only field which is present when the
	// permission type is `user`, `group` or `domain`.
	Domain string `json:"domain,omitempty"`

	// EmailAddress: Output only. The email address of the user or group
	// this permission refers to. This is an output-only field which is
	...
	// `owner` * `organizer` * `fileOrganizer` * `writer` * `reader`
	Role string `json:"role,omitempty"`

	// SelfLink: Output only. A link back to this permission.
	SelfLink string `json:"selfLink,omitempty"`

	// TeamDrivePermissionDetails: Output only. Deprecated: Use
	...
	// Type: The account type. Allowed values are: * `user` * `group` *
	// `domain` * `anyone`
	Type string `json:"type,omitempty"`
...
type PermissionPermissionDetails struct {
	...
	// `commenter` is currently possible, though more may be supported in
	// the future.
	AdditionalRoles []string `json:"additionalRoles,omitempty"`
...
// or private to an application. The following limits apply to file
...
type Property struct {
	...
	// PRIVATE (default) and PUBLIC. Private properties can only be
	// retrieved using an authenticated request. An authenticated request
	// uses an access token obtained with a OAuth 2 client ID. You cannot
...
type Revision struct {
	...
	// FileSize: Output only. The size of the revision in bytes. This will
	...
	// Md5Checksum: Output only. An MD5 checksum for the content of this
	// revision. This will only be populated on files with content stored in
	// Drive.
	Md5Checksum string `json:"md5Checksum,omitempty"`
	...
	// OriginalFilename: Output only. The original filename when this
	// revision was created. This will only be populated on files with
	...
	// republished. This is only populated and can only be modified for Docs
	// Editors files.
	...
	// the domain. This is only populated and can only be modified for Docs
	// Editors files.
...
type User struct {
	...
	// IsAuthenticatedUser: Output only. Whether this user is the same as
	// the authenticated user for whom the request was made.
	IsAuthenticatedUser bool `json:"isAuthenticatedUser,omitempty"`

	// Kind: Output only. This is always `drive#user`.
	Kind string `json:"kind,omitempty"`

	// PermissionId: Output only. The user's ID as visible in the
...
type UserPicture struct {
	// Url: Output Only. A URL that points to a profile picture of this
	// user.
...
// Get: Deprecated: Use `changes.getStartPageToken` and `changes.list`
...
// StartChangeId sets the optional parameter "startChangeId":
...
// drive and its last parent is removed, the item is placed under its
// owner's root.
...
// MaxResults sets the optional parameter "maxResults": Maximum number
// of shared drives to return per page.
...
// this file to the corresponding Docs Editors format.
...
// item is placed under its owner's root.
...
// Slides use `files.export` (/drive/api/reference/rest/v2/files/export)
...
// Insert:  Inserts a new file. This method supports an */upload* URI
...
// with `files.insert` must specify the MIME type
// `application/vnd.google-apps.shortcut`. Apps should specify a file
// extension in the `title` property when inserting files with the API.
// For example, an operation to insert a JPEG file should specify
// something like "title": "cat.jpg" in the metadata. Subsequent `GET`
...
// Corpus sets the optional parameter "corpus": Deprecated: The body of
// items (files/documents) to which the query applies. Use `corpora`
// instead.
//
// Possible values:
//
...
// Spaces sets the optional parameter "spaces": A comma-separated list
// of spaces to query. Supported values are `drive`, and
// `appDataFolder`.
...
// Patch: Updates a file's metadata and/or content. When calling this
// method, only populate fields in the request that you want to modify.
// When updating fields, some fields might change automatically, such as
...
// Convert sets the optional parameter "convert": Deprecated: This
// parameter has no function.
...
// "modifiedDateBehavior": Determines the behavior in which
// `modifiedDate` is updated. This overrides `setModifiedDate`.
//
// Possible values:
//
//	"fromBody" - Set `modifiedDate` to the value provided in the body
//
// of the request. No change if no value was provided.
//
//	"fromBodyIfNeeded" - Set `modifiedDate` to the value provided in
//
// the body of the request depending on other contents of the update.
//
...
// Help Center (https://support.google.com/drive/answer/2409045). Note
...
// `modifiedDateBehavior=now`. To prevent any changes to the modified
// date set `modifiedDateBehavior=noChange`.
...
// indefinitely, using additional storage quota, up to a maximum of 200
// revisions. For details on how revisions are retained, see the Drive
// Help Center (https://support.google.com/drive/answer/2409045).
...
// **Warning:** Concurrent permissions operations on the same file are
// not supported; only the last update is applied.
//
// - fileId: The ID for the file or shared drive.
...
// Patch: Updates a permission using patch semantics. **Warning:**
// Concurrent permissions operations on the same file are not supported;
// only the last update is applied.
//
// - fileId: The ID for the file or shared drive.
...
// Update: Updates a permission. **Warning:** Concurrent permissions
