...
func (c *EditsApksUploadCall) ResumableMedia(ctx context.Context, r io.Reader, size int64, chunkSize int64, mediaType string) *EditsApksUploadCall {
	c.ctx_ = ctx
	c.media_ = r
...
// Parameter mediaType identifies the MIME media type of the upload, such as "image/png".
// If mediaType is "", it will be auto-detected.
func (c *EditsExpansionfilesUploadCall) ResumableMedia(ctx context.Context, r io.Reader, size int64, chunkSize int64, mediaType string) *EditsExpansionfilesUploadCall {
	c.ctx_ = ctx
	c.media_ = r
	c.mediaType_ = mediaType
	c.size_ = size
...
// Parameter mediaType identifies the MIME media type of the upload, such as "image/png".
// If mediaType is "", it will be auto-detected.
func (c *EditsImagesUploadCall) ResumableMedia(ctx context.Context, r io.Reader, size int64, chunkSize int64, mediaType string) *EditsImagesUploadCall {
	c.ctx_ = ctx
	c.media_ = r
	c.mediaType_ = mediaType
	c.size_ = size
