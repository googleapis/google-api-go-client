...
type BackupConfiguration struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "BinaryLogEnabled") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type CloneContext struct {
	...
	// source instance should be cloned. If not specified, the source instance
	// is
	...
	// ForceSendFields is a list of field names (e.g. "BinLogCoordinates") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "BinLogCoordinates") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type DatabaseFlags struct {
	// Name: The name of the flag. These flags are passed at instance startup,
	// so
	...
	// SQL documentation.
	Name string `json:"name,omitempty"`
	// Value: The value of the flag. Booleans should be set to <code>on</code> for
	// true
...
type DatabaseInstance struct {
	// BackendType: <code>FIRST_GEN</code>: First Generation instance. MySQL only.
	// <br
	...
	// <a
	// href="https://groups.google.com/d/msg/google-cloud-sql-announce/I_7-F9EBhT0/B
	// tvFtdFeAgAJ">this
	...
	Etag string `json:"etag,omitempty"`
	// FailoverReplica: The name and status of the failover replica. This property
	// is applicable
	...
	Kind string `json:"kind,omitempty"`
	// MasterInstanceName: The name of the instance which will act as master in the
	// replication setup.
	...
	// the instance. This property
	// is applicable only to Second Generation instances.
	ServiceAccountEmailAddress string `json:"serviceAccountEmailAddress,omitempty"`
	// Settings: The user settings.
	Settings *Settings `json:"settings,omitempty"`
	// State: The current serving state of the Cloud SQL instance. This can be one
	// of the
	...
	// reason.
	//   "BILLING_ISSUE" - The instance is suspended due to billing issues (e.g.,
	// GCP account issue)
	//   "LEGAL_ISSUE" - The instance is suspended due to illegal content (e.g.,
	// child pornography,
	// copyrighted material, etc.).
	//   "OPERATIONAL_ISSUE" - The instance is causing operational issues (e.g.,
...
type DatabaseInstanceFailoverReplica struct {
	...
	// Name: The name of the failover replica. If specified at instance creation,
	// a
...
type DemoteMasterContext struct {
	...
	// VerifyGtidConsistency: Verify GTID consistency for demote operation. Default
	// value:
	// <code>True</code>. Second Generation instances only.  Setting this flag
	// to
...
type DemoteMasterMySqlReplicaConfiguration struct {
	...
	// ClientKey: PEM representation of the slave's private key. The corresponsing
	// public key
	// is encoded in the client's certificate. The format of the slave's
	// private
	// key can be either PKCS #1 or PKCS #8.
	ClientKey string `json:"clientKey,omitempty"`
	// Kind: This is always <code>sql#demoteMasterMysqlReplicaConfiguration</code>.
	Kind string `json:"kind,omitempty"`
...
type ExportContext struct {
	...
	// Uri: The path to the file in Google Cloud Storage where the export will
	// be
...
type ImportContext struct {
	...
	// Database: The target database for the import. If <code>fileType</code>
	// is
...
type ImportContextBakImportOptions struct {
	...
	// ForceSendFields is a list of field names (e.g. "EncryptionOptions") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "EncryptionOptions") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type ImportContextBakImportOptionsEncryptionOptions struct {
	...
	// PvkPath: Path to the Certificate Private Key (.pvk)  in Cloud Storage, in
	// the
...
type LocationPreference struct {
	// FollowGaeApplication: The AppEngine application to follow, it must be in the
	// same region as the
	// Cloud SQL instance.
...
// MaintenanceWindow: Maintenance window. This specifies when a v2 Cloud SQL
// instance should
...
type MaintenanceWindow struct {
	...
	Kind string `json:"kind,omitempty"`
	// UpdateTrack: Maintenance timing setting: <code>canary</code> (Earlier)
	// or
...
// Operation: An Operation resource.&nbsp;For successful operations that return
// an
...
type ReplicaConfiguration struct {
	...
	// field is set to
	// <code>true</code> the replica will be designated as a failover replica.
	// In
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "FailoverTarget") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type UsersListResponse struct {
	...
	Kind string `json:"kind,omitempty"`
	// NextPageToken: An identifier that uniquely identifies the operation. You can
	// use this
	// identifier to retrieve the Operations resource that has information
	// about
	// the operation.
...
// Insert: Creates a new backup run on demand. This method is applicable only
// to
// Second Generation instances.
//
// - instance: Cloud SQL instance ID. This does not include the project ID.
...
// page token representing part of the larger set of
// results to view.
...
// and version you want to retrieve flags for. By default, this
...
// Failover: Failover the instance to its failover replica instance. Using
// this
// operation might cause your instance to restart.
//
// - instance: Cloud SQL instance ID. This does not include the project ID.
...
// sign
// the certificate that is currently in use, a CA that has been added but
// not
...
// VerifyConnectionOnly sets the optional parameter "verifyConnectionOnly":
...
// provided public key
// and signed by a private key specific to the target instance. Users may
// use
