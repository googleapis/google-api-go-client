...
// completes, some Products may still be returned by GetProduct or
// ListProducts. Depending on the number of Products, this operation
// could take hours to complete. To get a sample of Products that would
