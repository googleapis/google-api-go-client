...
type ZoneViewsServicer interface {
	AddResources(project string, zone string, resourceView string, zoneviewsaddresourcesrequest *ZoneViewsAddResourcesRequest) *ZoneViewsAddResourcesCall
	Delete(project string, zone string, resourceView string) *ZoneViewsDeleteCall
	Get(project string, zone string, resourceView string) *ZoneViewsGetCall
	GetService(project string, zone string, resourceView string) *ZoneViewsGetServiceCall
	Insert(project string, zone string, resourceview *ResourceView) *ZoneViewsInsertCall
	List(project string, zone string) *ZoneViewsListCall
	ListResources(project string, zone string, resourceView string) *ZoneViewsListResourcesCall
	RemoveResources(project string, zone string, resourceView string, zoneviewsremoveresourcesrequest *ZoneViewsRemoveResourcesRequest) *ZoneViewsRemoveResourcesCall
	SetService(project string, zone string, resourceView string, zoneviewssetservicerequest *ZoneViewsSetServiceRequest) *ZoneViewsSetServiceCall
}
