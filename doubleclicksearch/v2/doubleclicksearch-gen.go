...
// is cancelled.
func (c *ConversionGetCall) Ctx(ctx context.Context) *ConversionGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ConversionInsertCall) Ctx(ctx context.Context) *ConversionInsertCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ConversionPatchCall) Ctx(ctx context.Context) *ConversionPatchCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ConversionUpdateCall) Ctx(ctx context.Context) *ConversionUpdateCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ConversionUpdateAvailabilityCall) Ctx(ctx context.Context) *ConversionUpdateAvailabilityCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ReportsGetFileCall) Ctx(ctx context.Context) *ReportsGetFileCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ReportsRequestCall) Ctx(ctx context.Context) *ReportsRequestCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *SavedColumnsListCall) Ctx(ctx context.Context) *SavedColumnsListCall {
	c.ctx_ = ctx
	return c
}
