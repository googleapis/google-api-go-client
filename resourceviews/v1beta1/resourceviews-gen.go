...
type RegionViewsServicer interface {
	Addresources(projectName string, region string, resourceViewName string, regionviewsaddresourcesrequest *RegionViewsAddResourcesRequest) *RegionViewsAddresourcesCall
	Delete(projectName string, region string, resourceViewName string) *RegionViewsDeleteCall
	Get(projectName string, region string, resourceViewName string) *RegionViewsGetCall
	Insert(projectName string, region string, resourceview *ResourceView) *RegionViewsInsertCall
	List(projectName string, region string) *RegionViewsListCall
	Listresources(projectName string, region string, resourceViewName string) *RegionViewsListresourcesCall
	Removeresources(projectName string, region string, resourceViewName string, regionviewsremoveresourcesrequest *RegionViewsRemoveResourcesRequest) *RegionViewsRemoveresourcesCall
}
...
type ZoneViewsServicer interface {
	Addresources(projectName string, zone string, resourceViewName string, zoneviewsaddresourcesrequest *ZoneViewsAddResourcesRequest) *ZoneViewsAddresourcesCall
	Delete(projectName string, zone string, resourceViewName string) *ZoneViewsDeleteCall
	Get(projectName string, zone string, resourceViewName string) *ZoneViewsGetCall
	Insert(projectName string, zone string, resourceview *ResourceView) *ZoneViewsInsertCall
	List(projectName string, zone string) *ZoneViewsListCall
	Listresources(projectName string, zone string, resourceViewName string) *ZoneViewsListresourcesCall
	Removeresources(projectName string, zone string, resourceViewName string, zoneviewsremoveresourcesrequest *ZoneViewsRemoveResourcesRequest) *ZoneViewsRemoveresourcesCall
}
