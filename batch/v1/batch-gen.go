...
type TaskGroup struct {
	...
	// root user to execute runnables. If set to true, Batch will make sure
	// to run the runnables using a non-root user. Currently, the non-root
	// user Batch used is generated by OS Login. For more information, see
