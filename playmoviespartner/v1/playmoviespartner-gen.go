...
// is cancelled.
func (c *AccountsAvailsListCall) Ctx(ctx context.Context) *AccountsAvailsListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *AccountsExperienceLocalesGetCall) Ctx(ctx context.Context) *AccountsExperienceLocalesGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *AccountsExperienceLocalesListCall) Ctx(ctx context.Context) *AccountsExperienceLocalesListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *AccountsOrdersGetCall) Ctx(ctx context.Context) *AccountsOrdersGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *AccountsOrdersListCall) Ctx(ctx context.Context) *AccountsOrdersListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *AccountsStoreInfosListCall) Ctx(ctx context.Context) *AccountsStoreInfosListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *AccountsStoreInfosCountryGetCall) Ctx(ctx context.Context) *AccountsStoreInfosCountryGetCall {
	c.ctx_ = ctx
	return c
}
