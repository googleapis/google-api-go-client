...
func (c *UsersDataSourcesCreateCall) Do() (ret *DataSource, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *UsersDataSourcesDeleteCall) Do() (ret *DataSource, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *UsersDataSourcesGetCall) Do() (ret *DataSource, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *UsersDataSourcesListCall) Do() (ret *ListDataSourcesResponse, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *UsersDataSourcesPatchCall) Do() (ret *DataSource, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *UsersDataSourcesUpdateCall) Do() (ret *DataSource, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *UsersDataSourcesDatasetsDeleteCall) Do() (err error) {
	_, err = c.DoHeader()
	return err
}
...
// Do performs a round-trip call to the server.
func (c *UsersDataSourcesDatasetsGetCall) Do() (ret *Dataset, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *UsersDataSourcesDatasetsPatchCall) Do() (ret *Dataset, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *UsersDatasetAggregateCall) Do() (ret *AggregateResponse, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *UsersSessionsDeleteCall) Do() (err error) {
	_, err = c.DoHeader()
	return err
}
...
// Do performs a round-trip call to the server.
func (c *UsersSessionsListCall) Do() (ret *ListSessionsResponse, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *UsersSessionsUpdateCall) Do() (ret *Session, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
