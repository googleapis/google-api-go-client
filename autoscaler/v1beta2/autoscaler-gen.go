...
type AutoscalersServicer interface {
	Delete(project string, zone string, autoscaler string) *AutoscalersDeleteCall
	Get(project string, zone string, autoscaler string) *AutoscalersGetCall
	Insert(project string, zone string, autoscaler *Autoscaler) *AutoscalersInsertCall
	List(project string, zone string) *AutoscalersListCall
	Patch(project string, zone string, autoscaler string, autoscaler2 *Autoscaler) *AutoscalersPatchCall
	Update(project string, zone string, autoscaler string, autoscaler2 *Autoscaler) *AutoscalersUpdateCall
}
