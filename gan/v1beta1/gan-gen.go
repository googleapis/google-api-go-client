...
type AdvertisersServicer interface {
	Get(role string, roleId string) *AdvertisersGetCall
	List(role string, roleId string) *AdvertisersListCall
}
...
type CcOffersServicer interface {
	List(publisher string) *CcOffersListCall
}
...
type EventsServicer interface {
	List(role string, roleId string) *EventsListCall
}
...
type LinksServicer interface {
	Get(role string, roleId string, linkId int64) *LinksGetCall
	Insert(role string, roleId string, link *Link) *LinksInsertCall
	List(role string, roleId string) *LinksListCall
}
...
type PublishersServicer interface {
	Get(role string, roleId string) *PublishersGetCall
	List(role string, roleId string) *PublishersListCall
}
...
type ReportsServicer interface {
	Get(role string, roleId string, reportType string) *ReportsGetCall
}
