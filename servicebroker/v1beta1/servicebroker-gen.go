...
// GoogleCloudServicebrokerV1beta1__Broker: Broker represents a consumable
// collection of Service Registry catalogs
...
// GoogleCloudServicebrokerV1beta1__CreateBindingResponse: Response for the
...
// GoogleCloudServicebrokerV1beta1__CreateServiceInstanceResponse: Response for
// the `CreateServiceInstance()` method.
...
// GoogleCloudServicebrokerV1beta1__DeleteBindingResponse: Response for the
...
// GoogleCloudServicebrokerV1beta1__DeleteServiceInstanceResponse: Response for
// the `DeleteServiceInstance()` method.
...
type GoogleCloudServicebrokerV1beta1__GetBindingResponse struct {
	// Credentials: Credentials to use the binding.
	Credentials googleapi.RawMessage `json:"credentials,omitempty"`
	// DeploymentName: String containing the Deployment Manager deployment name
	// that was created
	// for this binding,
	DeploymentName string `json:"deploymentName,omitempty"`
	// Description: Used to communicate description of the response. Usually for
...
// GoogleCloudServicebrokerV1beta1__ListBindingsResponse: The response for the
// `ListBindings()` method.
...
// GoogleCloudServicebrokerV1beta1__ListBrokersResponse: The response for the
// `ListBrokers()` method.
type GoogleCloudServicebrokerV1beta1__ListBrokersResponse struct {
	...
	// ServerResponse contains the HTTP response code and headers from the server.
	googleapi.ServerResponse `json:"-"`
	// ForceSendFields is a list of field names (e.g. "Brokers") to unconditionally
	// include in API requests. By default, fields with empty or default values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "Brokers") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// GoogleCloudServicebrokerV1beta1__ListCatalogResponse: Response message for
...
// GoogleCloudServicebrokerV1beta1__ListServiceInstancesResponse: The response
...
// GoogleCloudServicebrokerV1beta1__Plan: Plan message describes a Service
// Plan.
...
// GoogleCloudServicebrokerV1beta1__Service: The resource model mostly follows
...
type GoogleCloudServicebrokerV1beta1__Service struct {
	...
	// BindingsRetrievable: Whether the service provides an endpoint to get service
	// bindings.
...
// GoogleCloudServicebrokerV1beta1__ServiceInstance: Message describing inputs
...
type GoogleCloudServicebrokerV1beta1__ServiceInstance struct {
	...
	// for this instance,
	DeploymentName string `json:"deploymentName,omitempty"`
	// Description: To return errors when GetInstance call is done via HTTP to be
	// unified with
	// other methods.
	Description string `json:"description,omitempty"`
...
// GoogleCloudServicebrokerV1beta1__UpdateServiceInstanceResponse: Response for
// the `UpdateServiceInstance()` method.
...
//
// - parent: The project in which to create broker.
...
// *GoogleCloudServicebrokerV1beta1__Broker.ServerResponse.Header or (if a
...
//
// - parent: Parent must match `projects/[PROJECT_ID]/brokers`.
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudServicebrokerV1beta1__ListBrokersResponse.ServerResponse.Header
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudServicebrokerV1beta1__ServiceInstance.ServerResponse.Header or
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudServicebrokerV1beta1__Operation.ServerResponse.Header or (if a
// response was returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudServicebrokerV1beta1__ListServiceInstancesResponse.ServerResponse
...
//   - name: Name must
//     match
//     `projects/[PROJECT_ID]/brokers/[BROKER_ID]/v2/service_instances/[INSTANCE_I
//     D]/service_binding/[BINDING_ID]`.
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudServicebrokerV1beta1__ListBindingsResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// Use googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudServicebrokerV1beta1__ListCatalogResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// Use googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudServicebrokerV1beta1__CreateServiceInstanceResponse.ServerRespons
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudServicebrokerV1beta1__DeleteServiceInstanceResponse.ServerRespons
// e.Header or (if a response was returned at all) in
// error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudServicebrokerV1beta1__UpdateServiceInstanceResponse.ServerRespons
// e.Header or (if a response was returned at all) in
// error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudServicebrokerV1beta1__CreateBindingResponse.ServerResponse.Header
//
//	or (if a response was returned at all) in error.(*googleapi.Error).Header.
//
// Use googleapi.IsNotModified to check whether the returned error was because
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudServicebrokerV1beta1__DeleteBindingResponse.ServerResponse.Header
//
//	or (if a response was returned at all) in error.(*googleapi.Error).Header.
//
// Use googleapi.IsNotModified to check whether the returned error was because
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudServicebrokerV1beta1__GetBindingResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// Use googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
