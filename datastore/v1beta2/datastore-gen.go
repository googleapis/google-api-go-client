...
func (c *DatasetsAllocateIdsCall) Do() (*AllocateIdsResponse, error) {
	...
	params.Set("alt", "json")
	urls := googleapi.ResolveRelative("https://www.googleapis.com/datastore/v1beta2/datasets/", "{datasetId}/allocateIds")
	urls += "?" + params.Encode()
...
func (c *DatasetsBeginTransactionCall) Do() (*BeginTransactionResponse, error) {
	...
	params := make(url.Values)
	params.Set("alt", "json")
	urls := googleapi.ResolveRelative("https://www.googleapis.com/datastore/v1beta2/datasets/", "{datasetId}/beginTransaction")
	urls += "?" + params.Encode()
	req, _ := http.NewRequest("POST", urls, body)
	req.URL.Path = strings.Replace(req.URL.Path, "{datasetId}", url.QueryEscape(c.datasetId), 1)
	googleapi.SetOpaque(req.URL)
...
func (c *DatasetsCommitCall) Do() (*CommitResponse, error) {
	...
	params := make(url.Values)
	params.Set("alt", "json")
	urls := googleapi.ResolveRelative("https://www.googleapis.com/datastore/v1beta2/datasets/", "{datasetId}/commit")
	urls += "?" + params.Encode()
	req, _ := http.NewRequest("POST", urls, body)
	req.URL.Path = strings.Replace(req.URL.Path, "{datasetId}", url.QueryEscape(c.datasetId), 1)
	googleapi.SetOpaque(req.URL)
...
func (c *DatasetsLookupCall) Do() (*LookupResponse, error) {
	...
	params := make(url.Values)
	params.Set("alt", "json")
	urls := googleapi.ResolveRelative("https://www.googleapis.com/datastore/v1beta2/datasets/", "{datasetId}/lookup")
	urls += "?" + params.Encode()
	req, _ := http.NewRequest("POST", urls, body)
	req.URL.Path = strings.Replace(req.URL.Path, "{datasetId}", url.QueryEscape(c.datasetId), 1)
	googleapi.SetOpaque(req.URL)
...
func (c *DatasetsRollbackCall) Do() (*RollbackResponse, error) {
	...
	params := make(url.Values)
	params.Set("alt", "json")
	urls := googleapi.ResolveRelative("https://www.googleapis.com/datastore/v1beta2/datasets/", "{datasetId}/rollback")
	urls += "?" + params.Encode()
	req, _ := http.NewRequest("POST", urls, body)
	req.URL.Path = strings.Replace(req.URL.Path, "{datasetId}", url.QueryEscape(c.datasetId), 1)
	googleapi.SetOpaque(req.URL)
...
func (c *DatasetsRunQueryCall) Do() (*RunQueryResponse, error) {
	...
	params := make(url.Values)
	params.Set("alt", "json")
	urls := googleapi.ResolveRelative("https://www.googleapis.com/datastore/v1beta2/datasets/", "{datasetId}/runQuery")
	urls += "?" + params.Encode()
	req, _ := http.NewRequest("POST", urls, body)
	req.URL.Path = strings.Replace(req.URL.Path, "{datasetId}", url.QueryEscape(c.datasetId), 1)
	googleapi.SetOpaque(req.URL)
