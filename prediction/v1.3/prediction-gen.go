...
func (r *TrainingService) Delete(data string) *TrainingDeleteCall {
	c := &TrainingDeleteCall{s: r.s, urlParams_: urlValues()}
	c.data = data
	return c
}
...
func (r *TrainingService) Get(data string) *TrainingGetCall {
	c := &TrainingGetCall{s: r.s, urlParams_: urlValues()}
	c.data = data
	return c
}
...
func (r *TrainingService) Insert(training *Training) *TrainingInsertCall {
	c := &TrainingInsertCall{s: r.s, urlParams_: urlValues()}
	c.training = training
	return c
}
...
func (r *TrainingService) Predict(data string, input *Input) *TrainingPredictCall {
	c := &TrainingPredictCall{s: r.s, urlParams_: urlValues()}
	c.data = data
	c.input = input
	return c
}
...
func (r *TrainingService) Update(data string, update *Update) *TrainingUpdateCall {
	c := &TrainingUpdateCall{s: r.s, urlParams_: urlValues()}
	c.data = data
	c.update = update
	return c
}
