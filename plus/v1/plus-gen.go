...
// is cancelled.
func (c *ActivitiesGetCall) Ctx(ctx context.Context) *ActivitiesGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ActivitiesSearchCall) Ctx(ctx context.Context) *ActivitiesSearchCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *MomentsInsertCall) Ctx(ctx context.Context) *MomentsInsertCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *MomentsListCall) Ctx(ctx context.Context) *MomentsListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *PeopleGetCall) Ctx(ctx context.Context) *PeopleGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *PeopleListCall) Ctx(ctx context.Context) *PeopleListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *PeopleListByActivityCall) Ctx(ctx context.Context) *PeopleListByActivityCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *PeopleSearchCall) Ctx(ctx context.Context) *PeopleSearchCall {
	c.ctx_ = ctx
	return c
}
