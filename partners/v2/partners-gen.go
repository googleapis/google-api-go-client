...
const basePathTemplate = "https://partners.UNIVERSE_DOMAIN/"
...
// AdWordsManagerAccountInfo: Information about a particular AdWords Manager
// Account.
...
type AdWordsManagerAccountInfo struct {
	...
	// NullFields is a list of field names (e.g. "CustomerName") to include in API
...
type Analytics struct {
	...
	// SearchViews: Instances of users seeing the `Company` in Google Partners
	// Search results
	// on the specified date.
...
// AnalyticsDataPoint: Details of the analytics events for a `Company` within a
// single day.
type AnalyticsDataPoint struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "EventCount") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// AnalyticsSummary: Analytics aggregated data for a `Company` for a given date
// range.
type AnalyticsSummary struct {
	// ContactsCount: Aggregated number of times users contacted the `Company`
	// for given date range.
	ContactsCount int64 `json:"contactsCount,omitempty"`
	// ProfileViewsCount: Aggregated number of profile views for the `Company` for
	// given date range.
	ProfileViewsCount int64 `json:"profileViewsCount,omitempty"`
	// SearchViewsCount: Aggregated number of times users saw the `Company`
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ContactsCount") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type AvailableOffer struct {
	...
	// Id: ID of this offer.
	Id int64 `json:"id,omitempty,string"`
	// MaxAccountAge: The maximum age of an account [in days] to be eligible.
	...
	//   "OFFER_LEVEL_DENY_PROBLEM" - Users/Agencies that have no offers because of
	// a problem.
	...
	// QualifiedCustomersComplete: Whether or not the list of qualified customers
	// is definitely complete.
	QualifiedCustomersComplete bool `json:"qualifiedCustomersComplete,omitempty"`
	// ShowSpecialOfferCopy: Should special text be shown on the offers page.
...
type Certification struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "Achieved") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type CertificationExamStatus struct {
	// NumberUsersPass: The number of people who have passed the certification
	// exam.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "NumberUsersPass") to include in
...
type CertificationStatus struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ExamStatuses") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// Company: A company resource in the Google Partners API. Once certified, it
// qualifies
// for being searched by advertisers.
type Company struct {
	// AdditionalWebsites: URL of the company's additional websites used to verify
	// the dynamic badges.
	...
	// AutoApprovalEmailDomains: Email domains that allow users with a matching
	...
	// CertificationStatuses: The list of Google Partners certification statuses
	// for the company.
	...
	//   "FULL_SERVICE_AGENCY" - Handles all aspects of the advertising process.
	...
	//   "PERFORMANCE_MARKETING" - Drives promotional efforts for immediate impact.
	//   "ADVERTISING_TOOL_DEVELOPMENT" - Focuses on bid management, conversion,
	// reporting.
	//   "PR" - Establishes favorable relationship with public through
	// low/no-cost
	// communications.
	//   "SELF_MANAGED" - Does not manage other company's accounts, manages own
	// marketing programs.
	//   "RESELLER" - Full-service AdWords account management for local businesses.
	CompanyTypes []string `json:"companyTypes,omitempty"`
	// ConvertedMinMonthlyBudget: The minimum monthly budget that the company
	...
	Name string `json:"name,omitempty"`
	// OriginalMinMonthlyBudget: The unconverted minimum monthly budget that the
	// company accepts for partner
	// business.
	OriginalMinMonthlyBudget *Money `json:"originalMinMonthlyBudget,omitempty"`
	// PrimaryAdwordsManagerAccountId: The Primary AdWords Manager Account id.
	PrimaryAdwordsManagerAccountId int64 `json:"primaryAdwordsManagerAccountId,omitempty,string"`
	// PrimaryLanguageCode: The primary language code of the company, as defined
	// by
	...
	// ProfileStatus: The public viewability status of the company's profile.
	//
	// Possible values:
	...
	// Ranks: Information related to the ranking of the company within the list
	// of
	// companies.
	...
	// SpecializationStatus: The list of Google Partners specialization statuses
	// for the company.
	...
	// ForceSendFields is a list of field names (e.g. "AdditionalWebsites") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AdditionalWebsites") to include
...
// CompanyRelation: A CompanyRelation resource representing information about a
// user's
...
type CompanyRelation struct {
	...
	// CompanyId: The ID of the company. There may be no id if this is a
	// pending company.5
	CompanyId string `json:"companyId,omitempty"`
	// CreationTime: The timestamp of when affiliation was requested.
	// @OutputOnly
	CreationTime string `json:"creationTime,omitempty"`
	// InternalCompanyId: The internal company ID.
	// Only available for a whitelisted set of api clients.
	InternalCompanyId string `json:"internalCompanyId,omitempty"`
	// IsPending: The flag that indicates if the company is pending verification.
	IsPending bool `json:"isPending,omitempty"`
	// LogoUrl: A URL to a profile photo, e.g. a G+ profile photo.
	LogoUrl string `json:"logoUrl,omitempty"`
	// ManagerAccount: The AdWords manager account # associated this company.
	...
	PrimaryLanguageCode string `json:"primaryLanguageCode,omitempty"`
	// ResolvedTimestamp: The timestamp when the user was approved.
	// @OutputOnly
	...
	//   "COMPANY_SEGMENT_NAL" - Segment representing a selected group of Partners
	//   "COMPANY_SEGMENT_PSP" - Segment representing Premier SMB Partners, an
	// AdWords partnership program.
	//   "COMPANY_SEGMENT_PPSP" - A segment of Premier SMB Partners that have
...
type CountryOfferInfo struct {
	...
	// OfferCountryCode: Country code for which offer codes may be requested.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "GetYAmount") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type CreateLeadRequest struct {
	...
	// href="https://www.google.com/recaptcha/">reCaptcha</a> challenge info.
	...
	// ForceSendFields is a list of field names (e.g. "Lead") to unconditionally
	// include in API requests. By default, fields with empty or default values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "Lead") to include in API requests
...
// Date: Represents a whole or partial calendar date, e.g. a birthday. The time
// of day
...
type Date struct {
	// Day: Day of month. Must be from 1 to 31 and valid for the year and month, or
	// 0
...
type DebugInfo struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ServerInfo") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type ExamStatus struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ExamType") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type GetPartnersStatusResponse struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ResponseMetadata") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// HistoricalOffer: Historical information about a Google Partners Offer.
type HistoricalOffer struct {
	...
	//   "OFFER_TYPE_SPEND_MATCH" - Spend Match up to Y.
	OfferType string `json:"offerType,omitempty"`
	// SenderName: Name (First + Last) of the partners user to whom the incentive
	// is allocated.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AdwordsUrl") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// LatLng: An object representing a latitude/longitude pair. This is expressed
// as a pair
...
// Lead: A lead resource that represents an advertiser contact for a `Company`.
// These
...
type Lead struct {
	...
	// GpsMotivations: List of reasons for using Google Partner Search and creating
	// a lead.
	//
	// Possible values:
	...
	// advertising.
	//   "GPSM_HELP_WITH_WEBSITE" - Advertiser needs help with their website.
	//   "GPSM_NO_WEBSITE" - Advertiser does not have a website.
	GpsMotivations []string `json:"gpsMotivations,omitempty"`
	// Id: ID of the lead.
	Id string `json:"id,omitempty"`
	// LanguageCode: Language code of the lead's language preference, as defined
	// by
	// <a href="https://tools.ietf.org/html/bcp47">BCP 47</a>
	// (IETF BCP 47, "Tags for Identifying Languages").
	LanguageCode string `json:"languageCode,omitempty"`
	// MarketingOptIn: Whether or not the lead signed up for marketing emails
	MarketingOptIn bool `json:"marketingOptIn,omitempty"`
	// MinMonthlyBudget: The minimum monthly budget lead source is willing to
	// spend.
	...
	// ServerResponse contains the HTTP response code and headers from the server.
	googleapi.ServerResponse `json:"-"`
	// ForceSendFields is a list of field names (e.g. "AdwordsCustomerId") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AdwordsCustomerId") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type ListAnalyticsResponse struct {
	...
	// AnalyticsSummary: Aggregated information across the response's
	// analytics.
...
type ListLeadsResponse struct {
	...
	// ServerResponse contains the HTTP response code and headers from the server.
	googleapi.ServerResponse `json:"-"`
	// ForceSendFields is a list of field names (e.g. "Leads") to unconditionally
	// include in API requests. By default, fields with empty or default values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
...
type ListOffersHistoryResponse struct {
	// CanShowEntireCompany: True if the user has the option to show entire company
	// history.
	CanShowEntireCompany bool `json:"canShowEntireCompany,omitempty"`
	// NextPageToken: Supply this token in a ListOffersHistoryRequest to retrieve
	// the next page.
	NextPageToken string `json:"nextPageToken,omitempty"`
	...
	// ServerResponse contains the HTTP response code and headers from the server.
	googleapi.ServerResponse `json:"-"`
	// ForceSendFields is a list of field names (e.g. "CanShowEntireCompany") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "CanShowEntireCompany") to include
	// in API requests with the JSON null value. By default, fields with empty
	// values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type ListOffersResponse struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AvailableOffers") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type LocalizedCompanyInfo struct {
	...
	// LanguageCode: Language code of the localized company info, as defined by
	// <a href="https://tools.ietf.org/html/bcp47">BCP 47</a>
	// (IETF BCP 47, "Tags for Identifying Languages").
	LanguageCode string `json:"languageCode,omitempty"`
	// Overview: Localized brief description that the company uses to advertise
	// themselves.
...
// Location: A location with address and geographic coordinates. May optionally
// contain a
// detailed (multi-field) version of the address.
type Location struct {
	// Address: The single string version of the address.
	Address string `json:"address,omitempty"`
	// AddressLine: The following address lines represent the most specific part of
	// any
	// address.
	AddressLine []string `json:"addressLine,omitempty"`
	// AdministrativeArea: Top-level administrative subdivision of this country.
	AdministrativeArea string `json:"administrativeArea,omitempty"`
	// DependentLocality: Dependent locality or sublocality. Used for UK dependent
	// localities, or
	// neighborhoods or boroughs in other locations.
	DependentLocality string `json:"dependentLocality,omitempty"`
	// LanguageCode: Language code of the address. Should be in BCP 47 format.
	LanguageCode string `json:"languageCode,omitempty"`
	...
	// SortingCode: Use of this code is very country-specific, but will refer to a
	// secondary
...
type LogMessageRequest struct {
	// ClientInfo: Map of client info, such as URL, browser navigator, browser
	// platform, etc.
...
type LogUserEventRequest struct {
	...
	// partner` top button.
	//   "AGENCY_CLICKED_JOIN_NOW_BUTTON_BOTTOM" - Agency clicked `Join now` bottom
	// button.
	...
	//   "SMB_COMPLETED_PARTNER_CONTACT_FORM_ON_GPS" - Advertiser completed partner
	// contact form on Google Partner Search.
	...
	// country association.
	//   "AGENCY_CLICKED_AFFILIATE_BUTTON_IN_MY_PROFILE_IN_PORTAL" - Agency clicked
	// `affiliate` button in profile portal.
	...
	//   "AGENCY_DIDNT_HAVE_AN_MCC_ASSOCIATED_ON_COMPLETE_PROFILE" - Agency did not
	// have an MCC associated on profile portal.
	...
	// as job function.
	//   "AGENCY_SELECTED_CREATIVE_AS_JOB_FUNCTION" - Agency selected `creative` as
	// job function.
	...
	//   "AGENCY_SELECTED_OPT_IN_BETA_TESTS_IN_MY_PROFILE_PORTAL" - Agency selected
	// `opt-in beta tests` in profile portal.
	...
	//   "AGENCY_SELECTED_OPT_IN_PERFORMANCE_SUGGESTIONS" - Agency selected `opt-in
	...
	//   "AGENCY_CLICKED_BACK_BUTTON_ON_CONNECT_WITH_COMPANY" - Agency clicked back
	// button on `connect with company`.
	...
	//   "AGENCY_CLICKED_LINK_TO_MCC_LINK_IN_PORTAL_NOTIFICATIONS" - Agency clicked
	// `link to MCC` link in portal notifications.
	...
	// left nav in portal.
	//   "AGENCY_CLICKED_INSIGHTS_UPLOAD_CONTENT" - Agency clicked `insights upload
	// content`.
	//   "AGENCY_CLICKED_INSIGHTS_VIEWED_DEPRECATED" - Agency clicked `insights
	// viewed deprecated`.
	//   "AGENCY_CLICKED_COMMUNITY_LEFT_NAV_IN_PORTAL" - Agency clicked `community`
	// left nav in portal.
	...
	// nav in portal.
	//   "AGENCY_CLICKED_SEND_BUTTON_ON_OFFERS_PAGE" - Agency clicked `send` button
	// on offers page.
	...
	//   "SMB_VIEWED_ADWORDS_SEARCH_CERTIFICATE" - Advertiser viewed AdWords Search
	// certificate.
	...
	// Partners.
	//   "VISITED_AGENCY_PORTAL" - User visited the agency portal portion of Google
	// Partners.
	...
	//   "AGENCY_UNSELECTED_OPT_IN_NEWS_INVITATIONS_AND_PROMOS" - Agency unselected
	// `opt-in news invitations and promotions`.
	//   "AGENCY_UNSELECTED_OPT_IN_BETA_TESTS_AND_MKT_RESEARCH" - Agency unselected
	// `opt-in beta tests and market research`.
	...
	//   "AGENCY_PROGRESS_INSIGHTS_VIEW_CONTENT" - Agency user is maklingg progress
	// viewing a content item.
	//   "AGENCY_CLICKED_CANCEL_ACCEPT_TOS_BUTTON" - Agency clicked `cancel Terms
	// Of Service` button.
	//   "SMB_ENTERED_WEBSITE_IN_CONTACT_PARTNER_FORM" - Advertiser entered website
	// in contact form.
...
type OptIns struct {
	// MarketComm: An opt-in about receiving email from Partners marketing teams.
	// Includes
	// member-only events and special promotional offers for Google products.
	MarketComm bool `json:"marketComm,omitempty"`
	// PerformanceSuggestions: An opt-in about receiving email with customized
	// AdWords campaign management
	// tips.
	PerformanceSuggestions bool `json:"performanceSuggestions,omitempty"`
	// PhoneContact: An opt-in to allow recieivng phone calls about their Partners
	// account.
	PhoneContact bool `json:"phoneContact,omitempty"`
	// PhysicalMail: An opt-in to receive special promotional gifts and material in
	// the mail.
	PhysicalMail bool `json:"physicalMail,omitempty"`
	// SpecialOffers: An opt-in about receiving email regarding new features and
	// products.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "MarketComm") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type PublicProfile struct {
	// DisplayImageUrl: The URL to the main display image of the public profile.
	// Being deprecated.
	DisplayImageUrl string `json:"displayImageUrl,omitempty"`
	// DisplayName: The display name of the public profile.
	DisplayName string `json:"displayName,omitempty"`
	// Id: The ID which can be used to retrieve more details about the public
	// profile.
	Id string `json:"id,omitempty"`
	// ProfileImage: The URL to the main profile image of the public profile.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "DisplayImageUrl") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type RequestMetadata struct {
	...
	// UserOverrides: Values to use instead of the user's respective defaults for
	// the current
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ExperimentIds") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type SpecializationStatus struct {
	...
	// ForceSendFields is a list of field names (e.g. "BadgeSpecialization") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "BadgeSpecialization") to include
	// in API requests with the JSON null value. By default, fields with empty
	// values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type TrafficSource struct {
	...
	// TrafficSubId: Second level identifier to indicate where the traffic comes
	// from.
	// An identifier has multiple letters created by a team which redirected
	// the
	// traffic to us.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "TrafficSourceId") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type User struct {
	// AfaInfoShared: Whether or not the user has opted to share their Academy for
	// Ads info with
	// Google Partners.
	...
	// ExamStatus: The list of exams the user ever taken. For each type of exam,
	// only one
	// entry is listed.
	...
	// LastAccessTime: The most recent time the user interacted with the Partners
	// site.
	// @OutputOnly
	LastAccessTime string `json:"lastAccessTime,omitempty"`
	// PrimaryEmails: The list of emails the user has access to/can select as
	// primary.
	// @OutputOnly
	...
	// PublicProfile: Information about a user's external public profile outside
	// Google Partners.
	PublicProfile *PublicProfile `json:"publicProfile,omitempty"`
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AfaInfoShared") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// UserOverrides: Values to use instead of the user's respective defaults.
// These are only
// honored by whitelisted products.
type UserOverrides struct {
	// IpAddress: IP address to use instead of the user's geo-located IP address.
...
type UserProfile struct {
	...
	// AdwordsManagerAccount: If the user has edit access to multiple accounts, the
	// user can choose the
	// preferred account and it is used when a personal account is needed. Can
	// be empty.
	AdwordsManagerAccount int64 `json:"adwordsManagerAccount,omitempty,string"`
	// Channels: A list of ids representing which channels the user selected they
	// were in.
	Channels []string `json:"channels,omitempty"`
	// EmailAddress: The email address the user has selected on the Partners site
	// as primary.
	EmailAddress string `json:"emailAddress,omitempty"`
	// EmailOptIns: The list of opt-ins for the user, related to communication
	// preferences.
	...
	// Markets: A list of ids representing which markets the user was interested
	// in.
	Markets []string `json:"markets,omitempty"`
	// MigrateToAfa: Whether or not to migrate the user's exam data to Academy for
	// Ads.
	MigrateToAfa bool `json:"migrateToAfa,omitempty"`
	// PhoneNumber: The user's phone number.
	PhoneNumber string `json:"phoneNumber,omitempty"`
	// PrimaryCountryCode: The user's primary country, an ISO 2-character code.
	PrimaryCountryCode string `json:"primaryCountryCode,omitempty"`
	// ProfilePublic: Whether the user's public profile is visible to anyone with
	// the URL.
...
// may return fewer analytics than requested.
...
// "requestMetadata.experimentIds": Experiment IDs the current request belongs
// to.
...
// RequestMetadataLocale sets the optional parameter "requestMetadata.locale":
...
// RequestMetadataTrafficSourceTrafficSourceId sets the optional parameter
// "requestMetadata.trafficSource.trafficSourceId": Identifier to indicate
...
// "requestMetadata.trafficSource.trafficSubId": Second level identifier to
...
// "requestMetadata.userOverrides.ipAddress": IP address to use instead of the
// user's geo-located IP address.
...
// "requestMetadata.userOverrides.userId": Logged-in user ID to impersonate
...
// *ListAnalyticsResponse.ServerResponse.Header or (if a response was returned
...
// Any non-2xx status code is an error. Response headers are in either
// *LogMessageResponse.ServerResponse.Header or (if a response was returned at
...
// CurrencyCode sets the optional parameter "currencyCode": If the company's
// budget is in a different currency code than this one, then
...
// OrderBy sets the optional parameter "orderBy": How to order addresses within
// the returned company. Currently, only
...
// View sets the optional parameter "view": The view of `Company` resource to
// be returned. This must not be
...
// Any non-2xx status code is an error. Response headers are in either
// *GetCompanyResponse.ServerResponse.Header or (if a response was returned at
// all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified was
// returned.
...
// Address sets the optional parameter "address": The address to use when
...
// CompanyName sets the optional parameter "companyName": Company name to
// search for.
...
// GpsMotivations sets the optional parameter "gpsMotivations": List of reasons
// for using Google Partner Search to get companies.
//
// Possible values:
//
...
// Industries sets the optional parameter "industries": List of industries the
...
// LanguageCodes sets the optional parameter "languageCodes": List of language
// codes that company can support. Only primary language
...
// "maxMonthlyBudget.currencyCode": The 3-letter currency code defined in ISO
// 4217.
...
// MaxMonthlyBudgetNanos sets the optional parameter "maxMonthlyBudget.nanos":
...
// MaxMonthlyBudgetUnits sets the optional parameter "maxMonthlyBudget.units":
...
// "minMonthlyBudget.currencyCode": The 3-letter currency code defined in ISO
// 4217.
...
// MinMonthlyBudgetNanos sets the optional parameter "minMonthlyBudget.nanos":
// Number of nano (10^-9) units of the amount.
// The value must be between -999,999,999 and +999,999,999 inclusive.
// If `units` is positive, `nanos` must be positive or zero.
// If `units` is zero, `nanos` can be positive, zero, or negative.
...
// MinMonthlyBudgetUnits sets the optional parameter "minMonthlyBudget.units":
// The whole units of the amount.
// For example if `currencyCode` is "USD", then 1 unit is one US dollar.
...
// OrderBy sets the optional parameter "orderBy": How to order addresses within
// the returned companies. Currently, only
// `address` and `address desc` is supported which will sorted by closest
// to
// farthest in distance from given address and farthest to closest
// distance
...
// PageSize sets the optional parameter "pageSize": Requested page size. Server
// may return fewer companies than requested.
...
// Services sets the optional parameter "services": List of services that the
// returned agencies should provide. If this is
...
// Specializations sets the optional parameter "specializations": List of
// specializations that the returned agencies should provide. If this
...
// View sets the optional parameter "view": The view of the `Company` resource
// to be returned. This must not be
// `COMPANY_VIEW_UNSPECIFIED`.
//
// Possible values:
//
...
// WebsiteUrl sets the optional parameter "websiteUrl": Website URL that will
// help to find a better matched company.
// .
...
// Any non-2xx status code is an error. Response headers are in either
// *CreateLeadResponse.ServerResponse.Header or (if a response was returned at
// all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified was
// returned.
...
// PageSize sets the optional parameter "pageSize": Requested page size. Server
// may return fewer leads than requested.
// If unspecified, server picks an appropriate default.
...
// Any non-2xx status code is an error. Response headers are in either
// *ListLeadsResponse.ServerResponse.Header or (if a response was returned at
// all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified was
// returned.
...
// Any non-2xx status code is an error. Response headers are in either
// *ListOffersResponse.ServerResponse.Header or (if a response was returned at
// all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified was
// returned.
...
// List: Lists the Historical Offers for the current user (or user's entire
// company)
...
// EntireCompany sets the optional parameter "entireCompany": if true, show
// history for the entire company.  Requires user to be admin.
...
// fields to order by, e.g.: "foo,bar,baz".
...
// PageSize sets the optional parameter "pageSize": Maximum number of rows to
// return per page.
...
// Any non-2xx status code is an error. Response headers are in either
// *ListOffersHistoryResponse.ServerResponse.Header or (if a response was
...
// Any non-2xx status code is an error. Response headers are in either
// *LogUserEventResponse.ServerResponse.Header or (if a response was returned
// at all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified was
// returned.
...
// Any non-2xx status code is an error. Response headers are in either
// *ListUserStatesResponse.ServerResponse.Header or (if a response was returned
// at all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified was
// returned.
...
// CreateCompanyRelation: Creates a user's company relation. Affiliates the
// user to a company.
//
...
// Any non-2xx status code is an error. Response headers are in either
// *CompanyRelation.ServerResponse.Header or (if a response was returned at
// all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified was
// returned.
...
// DeleteCompanyRelation: Deletes a user's company relation. Unaffiliaites the
// user from a company.
//
//   - userId: The ID of the user. Can be set to <code>me</code> to mean
//     the currently authenticated user.
...
// Get: Gets a user.
//
//   - userId: Identifier of the user. Can be set to <code>me</code> to mean the
//     currently
//
// authenticated user.
...
// UserView sets the optional parameter "userView": Specifies what parts of the
...
// UpdateProfile: Updates a user's profile. A user can only update their own
// profile and
...
// Any non-2xx status code is an error. Response headers are in either
// *GetPartnersStatusResponse.ServerResponse.Header or (if a response was
// returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
