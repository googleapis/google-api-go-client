...
package integrations // import "google.golang.org/api/integrations/v1"
...
func NewProjectsLocationsService(s *Service) *ProjectsLocationsService {
	...
	rs.Clients = NewProjectsLocationsClientsService(s)
	rs.CloudFunctions = NewProjectsLocationsCloudFunctionsService(s)
...
func NewProjectsLocationsClientsService(s *Service) *ProjectsLocationsClientsService {
	rs := &ProjectsLocationsClientsService{s: s}
	return rs
}
...
func NewProjectsLocationsCloudFunctionsService(s *Service) *ProjectsLocationsCloudFunctionsService {
	rs := &ProjectsLocationsCloudFunctionsService{s: s}
	return rs
}
...
func NewProjectsLocationsIntegrationsService(s *Service) *ProjectsLocationsIntegrationsService {
	...
	rs.Executionsnapshots = NewProjectsLocationsIntegrationsExecutionsnapshotsService(s)
...
func NewProjectsLocationsIntegrationsExecutionsnapshotsService(s *Service) *ProjectsLocationsIntegrationsExecutionsnapshotsService {
	rs := &ProjectsLocationsIntegrationsExecutionsnapshotsService{s: s}
	return rs
}
...
func NewProjectsLocationsProductsService(s *Service) *ProjectsLocationsProductsService {
	...
	rs.CloudFunctions = NewProjectsLocationsProductsCloudFunctionsService(s)
...
func NewProjectsLocationsProductsCloudFunctionsService(s *Service) *ProjectsLocationsProductsCloudFunctionsService {
	rs := &ProjectsLocationsProductsCloudFunctionsService{s: s}
	return rs
}
...
type EnterpriseCrmEventbusProtoAttributes struct {
	...
	// LogSettings: See go/integration-platform/analytics/logging_task.md for
	// details.
...
// EventBus. Please see go/cloud-crm-eng/platform/event_bus.md for more
// details.
...
type EnterpriseCrmEventbusProtoField struct {
	...
	// supplied by user so may or may not contain PII or SPII data. This field will
	// be scrubbed using DatapolScrubber#maybeScrub() with
	...
	// field value. for e.g. $param1$.CONCAT('test'). See
	// go/transform-functions-design for more details. Keep points - 1. Only input
...
// multiple output fields values from input fields values. Next id: 2
...
// scrubbing/truncation behavior and PII information. See
...
// alerting in the {@code TaskConfig} protos for tasks in an event. See
// go/eventbus-alert-config-examples for examples of the different alerts that
// can be configured.
...
// associated to every common Task we have. Next available: 26
type EnterpriseCrmEventbusProtoTaskMetadata struct {
	...
	// the 24p, 2x, gray color icon image format. See go/icons.
...
// framework: go/integration-platform-config-module-framework
...
// See go/eventbus-alert-config-examples for examples of the different alerts
...
type EnterpriseCrmEventbusProtoWorkflowAlertConfig struct {
	...
	ThresholdType string `json:"thresholdType,omitempty"`
	// ThresholdValue: The metric value, above or below which the alert should be
	// triggered. See go/eventbus-alert-config-examples.
	ThresholdValue  *EnterpriseCrmEventbusProtoBaseAlertConfigThresholdValue `json:"thresholdValue,omitempty"`
	WarningEnumList *EnterpriseCrmEventbusProtoBaseAlertConfigErrorEnumList  `json:"warningEnumList,omitempty"`
	// ForceSendFields is a list of field names (e.g. "AggregationPeriod") to
	// unconditionally include in API requests. By default, fields with empty or
...
type EnterpriseCrmFrontendsEventbusProtoTaskConfig struct {
	...
	// "parameters" field. Please refer to go/eventbus-task-spec-example for
...
// GoogleCloudIntegrationsV1alphaArchiveIntegrationVersionRequest: Request for
// ArchiveIntegrationVersion.
type GoogleCloudIntegrationsV1alphaArchiveIntegrationVersionRequest struct {
}

// GoogleCloudIntegrationsV1alphaArchiveIntegrationVersionResponse: Response
// for ArchiveIntegrationVersion.
...
// GoogleCloudIntegrationsV1alphaClientConfig: The configuration information
// for the Client
type GoogleCloudIntegrationsV1alphaClientConfig struct {
	...
	//   "CLIENT_STATE_ACTIVE" - The client is active and able to make calls to the
	// IP APIs
	...
	// CloudLoggingConfig: Determines the cloud logging configuration for the
	// project
...
func (s GoogleCloudIntegrationsV1alphaClientConfig) MarshalJSON() ([]byte, error) {
	type NoMethod GoogleCloudIntegrationsV1alphaClientConfig
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}

// GoogleCloudIntegrationsV1alphaCloudKmsConfig: Configuration information for
// Client's Cloud KMS information
type GoogleCloudIntegrationsV1alphaCloudKmsConfig struct {
	// Key: Required. A Cloud KMS key is a named object containing one or more key
	// versions, along with metadata for the key. A key exists on exactly one key
	// ring tied to a specific location.
	Key string `json:"key,omitempty"`
	// KeyVersion: Optional. Each version of a key contains key material used for
	// encryption or signing. A key's version is represented by an integer,
	...
	// KmsRing: Required. A key ring organizes keys in a specific Google Cloud
	// location and allows you to manage access control on groups of keys. A key
	// ring's name does not need to be unique across a Google Cloud project, but
...
func (s GoogleCloudIntegrationsV1alphaCloudKmsConfig) MarshalJSON() ([]byte, error) {
	type NoMethod GoogleCloudIntegrationsV1alphaCloudKmsConfig
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}

// GoogleCloudIntegrationsV1alphaCloudLoggingConfig: Config info for Cloud
// Logging
type GoogleCloudIntegrationsV1alphaCloudLoggingConfig struct {
	// Bucket: Cloud bucket name for the project.
	Bucket string `json:"bucket,omitempty"`
	// EnableCloudLogging: This field determines whether the logs should be sent to
	// cloud logging api
...
func (s GoogleCloudIntegrationsV1alphaCloudLoggingConfig) MarshalJSON() ([]byte, error) {
	type NoMethod GoogleCloudIntegrationsV1alphaCloudLoggingConfig
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}
...
// GoogleCloudIntegrationsV1alphaCreateBundleRequest: PROTECT WITH A VISIBILITY
// LABEL. THIS METHOD WILL BE MOVED TO A SEPARATE SERVICE. Request to create a
// new Bundle.
type GoogleCloudIntegrationsV1alphaCreateBundleRequest struct {
	...
	// SecondaryCustomerOrgId: Optional. The prefix for the SA, it should be in the
	// format "o". This is an optional field, and if empty service account will be
	// created per project, where we are creating bundle. This should only be used
	// as the org ID for which we want to run the integrations in the bundle.
...
// GoogleCloudIntegrationsV1alphaCreateBundleResponse: Response for create
// bundle.
...
// GoogleCloudIntegrationsV1alphaCreateCloudFunctionRequest: Request for
// Creating Cloud Function rpc call.
type GoogleCloudIntegrationsV1alphaCreateCloudFunctionRequest struct {
	...
	// ProjectId: Indicates the id of the GCP project that the function will be
	// created in.
	ProjectId string `json:"projectId,omitempty"`
	// ForceSendFields is a list of field names (e.g. "FunctionName") to
	// unconditionally include in API requests. By default, fields with empty or
...
func (s GoogleCloudIntegrationsV1alphaCreateCloudFunctionRequest) MarshalJSON() ([]byte, error) {
	type NoMethod GoogleCloudIntegrationsV1alphaCreateCloudFunctionRequest
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}

// GoogleCloudIntegrationsV1alphaCreateCloudFunctionResponse: Response for
// Creating Cloud Function rpc call.
type GoogleCloudIntegrationsV1alphaCreateCloudFunctionResponse struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "TriggerUrl") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
func (s GoogleCloudIntegrationsV1alphaCreateCloudFunctionResponse) MarshalJSON() ([]byte, error) {
	type NoMethod GoogleCloudIntegrationsV1alphaCreateCloudFunctionResponse
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}
...
// GoogleCloudIntegrationsV1alphaDeactivateIntegrationVersionRequest: Request
// for DeactivateIntegrationVersion.
type GoogleCloudIntegrationsV1alphaDeactivateIntegrationVersionRequest struct {
}

// GoogleCloudIntegrationsV1alphaDeactivateIntegrationVersionResponse: Response
// for DeactivateIntegrationVersion.
...
// GoogleCloudIntegrationsV1alphaDeprovisionClientRequest: Request for the
// Deprovision rpc
...
// GoogleCloudIntegrationsV1alphaDownloadExecutionResponse: Response for
// downloading an execution.
...
func (s GoogleCloudIntegrationsV1alphaDownloadExecutionResponse) MarshalJSON() ([]byte, error) {
	type NoMethod GoogleCloudIntegrationsV1alphaDownloadExecutionResponse
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}
...
// GoogleCloudIntegrationsV1alphaGetClientMetadataResponse: Response for the
// GetClientMetadata rpc
type GoogleCloudIntegrationsV1alphaGetClientMetadataResponse struct {
	// Properties: Required. Required: The client configuration that was requested
...
func (s GoogleCloudIntegrationsV1alphaGetClientMetadataResponse) MarshalJSON() ([]byte, error) {
	type NoMethod GoogleCloudIntegrationsV1alphaGetClientMetadataResponse
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}

// GoogleCloudIntegrationsV1alphaGetClientResponse: Response for the GetClient
// rpc
type GoogleCloudIntegrationsV1alphaGetClientResponse struct {
	// Client: Required. Required: The client configuration that was requested
...
func (s GoogleCloudIntegrationsV1alphaGetClientResponse) MarshalJSON() ([]byte, error) {
	type NoMethod GoogleCloudIntegrationsV1alphaGetClientResponse
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}
...
// GoogleCloudIntegrationsV1alphaIntegrationBundleConfig: This proto holds the
// core runner data in the bundle task. It is not expected to be directly
// edited by the user. Instead, a default value will be provided at the task
// creation time.
type GoogleCloudIntegrationsV1alphaIntegrationBundleConfig struct {
	// Integrations: A bundle of integrations that can be executed by the task at
	// runtime.
	Integrations []string `json:"integrations,omitempty"`
	// ServiceAccount: Output only. The service account created and owned by IP and
	// added to the customers GCP project.
	ServiceAccount string `json:"serviceAccount,omitempty"`
...
// GoogleCloudIntegrationsV1alphaListExecutionSnapshotsResponse: Response for
// listing the integration execution snapshot.
type GoogleCloudIntegrationsV1alphaListExecutionSnapshotsResponse struct {
	// ExecutionSnapshots: Required. The detailed information for the execution
	// snapshot.
	...
	// ServerResponse contains the HTTP response code and headers from the server.
	googleapi.ServerResponse `json:"-"`
	// ForceSendFields is a list of field names (e.g. "ExecutionSnapshots") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ExecutionSnapshots") to include
	// in API requests with the JSON null value. By default, fields with empty
	// values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// GoogleCloudIntegrationsV1alphaListTaskEntitiesResponse: This is a UI only
// method and will be moved away. Response for ListTaskEntities.
type GoogleCloudIntegrationsV1alphaListTaskEntitiesResponse struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "TaskEntities") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// GoogleCloudIntegrationsV1alphaProjectProperties: Metadata information for
// the given project
type GoogleCloudIntegrationsV1alphaProjectProperties struct {
	// IpEnablementState: An enum value of what the enablement state is for the
	// given project
	//
	// Possible values:
	...
	//   "IP_ENABLEMENT_STATE_APIGEE_ENTITLED" - The client is entitled for Apigee
	// but not enabled
	...
	// ForceSendFields is a list of field names (e.g. "IpEnablementState") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "IpEnablementState") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
func (s GoogleCloudIntegrationsV1alphaProjectProperties) MarshalJSON() ([]byte, error) {
	type NoMethod GoogleCloudIntegrationsV1alphaProjectProperties
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}

// GoogleCloudIntegrationsV1alphaProvisionClientRequest: Request for the
// Provision rpc
type GoogleCloudIntegrationsV1alphaProvisionClientRequest struct {
	// CloudKmsConfig: Required. Required: Cloud KMS config for AuthModule to
	// encrypt/decrypt credentials.
	CloudKmsConfig *GoogleCloudIntegrationsV1alphaCloudKmsConfig `json:"cloudKmsConfig,omitempty"`
	// CreateSampleWorkflows: Optional. Indicates if sample workflow should be
	// created along with provisioning
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "CloudKmsConfig") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
func (s GoogleCloudIntegrationsV1alphaProvisionClientRequest) MarshalJSON() ([]byte, error) {
	type NoMethod GoogleCloudIntegrationsV1alphaProvisionClientRequest
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}
...
// GoogleCloudIntegrationsV1alphaTestIntegrationsRequest: The request for
// testing an integration.
type GoogleCloudIntegrationsV1alphaTestIntegrationsRequest struct {
	// ClientId: Required. This is used to identify the client on whose behalf the
	...
	// execution.
	InputParameters map[string]GoogleCloudIntegrationsV1alphaValueType `json:"inputParameters,omitempty"`
	// IntegrationVersion: Required. integration config to execute the workflow
	IntegrationVersion *GoogleCloudIntegrationsV1alphaIntegrationVersion `json:"integrationVersion,omitempty"`
	// Parameters: Optional. Passed in as parameters to each integration execution.
	Parameters *EnterpriseCrmFrontendsEventbusProtoEventParameters `json:"parameters,omitempty"`
	// TestMode: Optional. Can be specified in the event request, otherwise false
	// (default). If true, enables tasks with condition "test_mode = true". If
	// false, disables tasks with condition "test_mode = true" if global test mode
	// (set by platform) is also false {@link EventBusConfig}.
	TestMode bool `json:"testMode,omitempty"`
	// TriggerId: Required. The trigger id of the integration trigger config. If
	// both trigger_id and client_id is present, the integration is executed from
...
func (s GoogleCloudIntegrationsV1alphaTestIntegrationsRequest) MarshalJSON() ([]byte, error) {
	type NoMethod GoogleCloudIntegrationsV1alphaTestIntegrationsRequest
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}

// GoogleCloudIntegrationsV1alphaTestIntegrationsResponse: The response for
// testing an integration.
type GoogleCloudIntegrationsV1alphaTestIntegrationsResponse struct {
	...
	// execution.
	ParameterEntries []*EnterpriseCrmFrontendsEventbusProtoParameterEntry `json:"parameterEntries,omitempty"`
	// Parameters: Optional. Parameters are a part of Event and can be used to
	// communicate between different tasks that are part of the same integration
	// execution.
...
func (s GoogleCloudIntegrationsV1alphaTestIntegrationsResponse) MarshalJSON() ([]byte, error) {
	type NoMethod GoogleCloudIntegrationsV1alphaTestIntegrationsResponse
	return gensupport.MarshalJSON(NoMethod(s), s.ForceSendFields, s.NullFields)
}
...
// GoogleCloudIntegrationsV1alphaUpdateBundleRequest: THIS METHOD WILL BE MOVED
// TO A SEPARATE SERVICE. Request message for Bundle update
...
// GoogleCloudIntegrationsV1alphaUpdateBundleResponse: Response message for
// Bundle update
...
// GoogleCloudIntegrationsV1alphaValidateIntegrationVersionRequest: Request for
// ValidateIntegrationVersion.
type GoogleCloudIntegrationsV1alphaValidateIntegrationVersionRequest struct {
}

// GoogleCloudIntegrationsV1alphaValidateIntegrationVersionResponse: Response
// for ValidateIntegrationVersion.
...
func (c *CallbackGenerateTokenCall) doRequest(alt string) (*http.Response, error) {
	...
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/callback:generateToken")
...
func (c *ConnectorPlatformRegionsEnumerateCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/connectorPlatformRegions:enumerate")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("GET", urls, body)
	if err != nil {
		return nil, err
...
func (r *ProjectsService) GetClientmetadata(parent string) *ProjectsGetClientmetadataCall {
	c := &ProjectsGetClientmetadataCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.parent = parent
	return c
}
...
func (c *ProjectsGetClientmetadataCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "", c.header_)
	if c.ifNoneMatch_ != "" {
		reqHeaders.Set("If-None-Match", c.ifNoneMatch_)
	}
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/{+parent}/clientmetadata")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("GET", urls, body)
	if err != nil {
		return nil, err
...
// Do executes the "integrations.projects.getClientmetadata" call.
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaGetClientMetadataResponse.ServerResponse.Heade
...
func (c *ProjectsGetClientmetadataCall) Do(opts ...googleapi.CallOption) (*GoogleCloudIntegrationsV1alphaGetClientMetadataResponse, error) {
	...
	ret := &GoogleCloudIntegrationsV1alphaGetClientMetadataResponse{
		ServerResponse: googleapi.ServerResponse{
			Header:         res.Header,
			HTTPStatusCode: res.StatusCode,
		},
...
// GetClients: Gets the client configuration for the given project and location
// resource name
//
// - parent: Required: The ID of the GCP Project to be provisioned.
func (r *ProjectsLocationsService) GetClients(parent string) *ProjectsLocationsGetClientsCall {
	c := &ProjectsLocationsGetClientsCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.parent = parent
	return c
}
...
func (c *ProjectsLocationsGetClientsCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "", c.header_)
	if c.ifNoneMatch_ != "" {
		reqHeaders.Set("If-None-Match", c.ifNoneMatch_)
	}
...
// Do executes the "integrations.projects.locations.getClients" call.
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaGetClientResponse.ServerResponse.Header or
...
func (c *ProjectsLocationsGetClientsCall) Do(opts ...googleapi.CallOption) (*GoogleCloudIntegrationsV1alphaGetClientResponse, error) {
	...
	ret := &GoogleCloudIntegrationsV1alphaGetClientResponse{
		ServerResponse: googleapi.ServerResponse{
			Header:         res.Header,
			HTTPStatusCode: res.StatusCode,
		},
...
// ListTaskEntities: This is a UI only method and will be moved away. Returns a
// list of common tasks.
//
//   - parent: The location resource of the request. This is not going to be used
...
func (c *ProjectsLocationsListTaskEntitiesCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/{+parent}:listTaskEntities")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("GET", urls, body)
	if err != nil {
		return nil, err
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaListTaskEntitiesResponse.ServerResponse.Header
//
//	or (if a response was returned at all) in error.(*googleapi.Error).Header.
//
// Use googleapi.IsNotModified to check whether the returned error was because
...
func (c *ProjectsLocationsAppsScriptProjectsCreateCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/{+parent}/appsScriptProjects")
	urls += "?" + c.urlParams_.Encode()
...
func (c *ProjectsLocationsAppsScriptProjectsLinkCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/{+parent}/appsScriptProjects:link")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
func (c *ProjectsLocationsAuthConfigsCreateCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/{+parent}/authConfigs")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
// Do executes the "integrations.projects.locations.certificates.create" call.
// Any non-2xx status code is an error. Response headers are in either
...
// Do executes the "integrations.projects.locations.certificates.delete" call.
// Any non-2xx status code is an error. Response headers are in either
// *GoogleProtobufEmpty.ServerResponse.Header or (if a response was returned at
// all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified was
...
// Do executes the "integrations.projects.locations.certificates.list" call.
// Any non-2xx status code is an error. Response headers are in either
...
// Do executes the "integrations.projects.locations.certificates.patch" call.
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaCertificate.ServerResponse.Header or (if a
// response was returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was because
...
type ProjectsLocationsClientsDeprovisionCall struct {
	s                                                      *Service
	parent                                                 string
	googlecloudintegrationsv1alphadeprovisionclientrequest *GoogleCloudIntegrationsV1alphaDeprovisionClientRequest
	urlParams_                                             gensupport.URLParams
	ctx_                                                   context.Context
	header_                                                http.Header
}

// Deprovision: Perform the deprovisioning steps to disable a user GCP project
// to use IP and purge all related data in a wipeout-compliant way.
//
...
func (r *ProjectsLocationsClientsService) Deprovision(parent string, googlecloudintegrationsv1alphadeprovisionclientrequest *GoogleCloudIntegrationsV1alphaDeprovisionClientRequest) *ProjectsLocationsClientsDeprovisionCall {
	c := &ProjectsLocationsClientsDeprovisionCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.parent = parent
	c.googlecloudintegrationsv1alphadeprovisionclientrequest = googlecloudintegrationsv1alphadeprovisionclientrequest
	return c
}
...
func (c *ProjectsLocationsClientsDeprovisionCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.googlecloudintegrationsv1alphadeprovisionclientrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/{+parent}/clients:deprovision")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
// Do executes the "integrations.projects.locations.clients.deprovision" call.
// Any non-2xx status code is an error. Response headers are in either
// *GoogleProtobufEmpty.ServerResponse.Header or (if a response was returned at
// all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified was
...
type ProjectsLocationsClientsProvisionCall struct {
	s                                                    *Service
	parent                                               string
	googlecloudintegrationsv1alphaprovisionclientrequest *GoogleCloudIntegrationsV1alphaProvisionClientRequest
	urlParams_                                           gensupport.URLParams
	ctx_                                                 context.Context
	header_                                              http.Header
}

// Provision: Perform the provisioning steps to enable a user GCP project to
// use IP. If GCP project already registered on IP end via Apigee Integration,
...
func (r *ProjectsLocationsClientsService) Provision(parent string, googlecloudintegrationsv1alphaprovisionclientrequest *GoogleCloudIntegrationsV1alphaProvisionClientRequest) *ProjectsLocationsClientsProvisionCall {
	c := &ProjectsLocationsClientsProvisionCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.parent = parent
	c.googlecloudintegrationsv1alphaprovisionclientrequest = googlecloudintegrationsv1alphaprovisionclientrequest
	return c
}
...
func (c *ProjectsLocationsClientsProvisionCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.googlecloudintegrationsv1alphaprovisionclientrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/{+parent}/clients:provision")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
// Do executes the "integrations.projects.locations.clients.provision" call.
// Any non-2xx status code is an error. Response headers are in either
// *GoogleProtobufEmpty.ServerResponse.Header or (if a response was returned at
// all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified was
...
type ProjectsLocationsCloudFunctionsCreateCall struct {
	s                                                        *Service
	parent                                                   string
	googlecloudintegrationsv1alphacreatecloudfunctionrequest *GoogleCloudIntegrationsV1alphaCreateCloudFunctionRequest
	urlParams_                                               gensupport.URLParams
	ctx_                                                     context.Context
	header_                                                  http.Header
}
...
func (r *ProjectsLocationsCloudFunctionsService) Create(parent string, googlecloudintegrationsv1alphacreatecloudfunctionrequest *GoogleCloudIntegrationsV1alphaCreateCloudFunctionRequest) *ProjectsLocationsCloudFunctionsCreateCall {
	c := &ProjectsLocationsCloudFunctionsCreateCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.parent = parent
	c.googlecloudintegrationsv1alphacreatecloudfunctionrequest = googlecloudintegrationsv1alphacreatecloudfunctionrequest
	return c
}
...
func (c *ProjectsLocationsCloudFunctionsCreateCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.googlecloudintegrationsv1alphacreatecloudfunctionrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/{+parent}/cloudFunctions")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
// Do executes the "integrations.projects.locations.cloudFunctions.create" call.
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaCreateCloudFunctionResponse.ServerResponse.Hea
...
func (c *ProjectsLocationsCloudFunctionsCreateCall) Do(opts ...googleapi.CallOption) (*GoogleCloudIntegrationsV1alphaCreateCloudFunctionResponse, error) {
	...
	ret := &GoogleCloudIntegrationsV1alphaCreateCloudFunctionResponse{
		ServerResponse: googleapi.ServerResponse{
			Header:         res.Header,
			HTTPStatusCode: res.StatusCode,
		},
...
func (c *ProjectsLocationsIntegrationsListCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/{+parent}/integrations")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("GET", urls, body)
	if err != nil {
		return nil, err
...
func (c *ProjectsLocationsIntegrationsScheduleCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/{+name}:schedule")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
type ProjectsLocationsIntegrationsTestCall struct {
	s                                                     *Service
	name                                                  string
	googlecloudintegrationsv1alphatestintegrationsrequest *GoogleCloudIntegrationsV1alphaTestIntegrationsRequest
	urlParams_                                            gensupport.URLParams
	ctx_                                                  context.Context
	header_                                               http.Header
}
...
func (r *ProjectsLocationsIntegrationsService) Test(name string, googlecloudintegrationsv1alphatestintegrationsrequest *GoogleCloudIntegrationsV1alphaTestIntegrationsRequest) *ProjectsLocationsIntegrationsTestCall {
	c := &ProjectsLocationsIntegrationsTestCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.name = name
	c.googlecloudintegrationsv1alphatestintegrationsrequest = googlecloudintegrationsv1alphatestintegrationsrequest
	return c
}
...
func (c *ProjectsLocationsIntegrationsTestCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.googlecloudintegrationsv1alphatestintegrationsrequest)
	if err != nil {
		return nil, err
	}
	c.urlParams_.Set("alt", alt)
...
// Do executes the "integrations.projects.locations.integrations.test" call.
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaTestIntegrationsResponse.ServerResponse.Header
//
//	or (if a response was returned at all) in error.(*googleapi.Error).Header.
//
// Use googleapi.IsNotModified to check whether the returned error was because
...
func (c *ProjectsLocationsIntegrationsTestCall) Do(opts ...googleapi.CallOption) (*GoogleCloudIntegrationsV1alphaTestIntegrationsResponse, error) {
	...
	ret := &GoogleCloudIntegrationsV1alphaTestIntegrationsResponse{
		ServerResponse: googleapi.ServerResponse{
			Header:         res.Header,
			HTTPStatusCode: res.StatusCode,
		},
...
func (r *ProjectsLocationsIntegrationsExecutionsService) Download(name string) *ProjectsLocationsIntegrationsExecutionsDownloadCall {
	c := &ProjectsLocationsIntegrationsExecutionsDownloadCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.name = name
	return c
}
...
func (c *ProjectsLocationsIntegrationsExecutionsDownloadCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "", c.header_)
	if c.ifNoneMatch_ != "" {
		reqHeaders.Set("If-None-Match", c.ifNoneMatch_)
	}
...
// Do executes the "integrations.projects.locations.integrations.executions.download" call.
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaDownloadExecutionResponse.ServerResponse.Heade
// r or (if a response was returned at all) in error.(*googleapi.Error).Header.
// Use googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
func (c *ProjectsLocationsIntegrationsExecutionsDownloadCall) Do(opts ...googleapi.CallOption) (*GoogleCloudIntegrationsV1alphaDownloadExecutionResponse, error) {
	...
	ret := &GoogleCloudIntegrationsV1alphaDownloadExecutionResponse{
		ServerResponse: googleapi.ServerResponse{
			Header:         res.Header,
			HTTPStatusCode: res.StatusCode,
		},
...
func (r *ProjectsLocationsIntegrationsExecutionsService) Get(name string) *ProjectsLocationsIntegrationsExecutionsGetCall {
	c := &ProjectsLocationsIntegrationsExecutionsGetCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.name = name
	return c
}
...
func (c *ProjectsLocationsIntegrationsExecutionsGetCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "", c.header_)
	if c.ifNoneMatch_ != "" {
		reqHeaders.Set("If-None-Match", c.ifNoneMatch_)
	}
...
// Do executes the "integrations.projects.locations.integrations.executions.get" call.
// Any non-2xx status code is an error. Response headers are in either
...
// support filtering on all fields in EventExecutionParamIndexes table. All
// fields support for EQUALS, in additional: CreateTimestamp support for
// LESS_THAN, GREATER_THAN ParameterKey, ParameterValue, ParameterType support
// for HAS For example: "parameter_value" HAS \"parameter1\" Also supports
// operators like AND, OR, NOT For example, trigger_id=\"id1\" AND
...
func (c *ProjectsLocationsIntegrationsExecutionsSuspensionsLiftCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/{+name}:lift")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
func (c *ProjectsLocationsIntegrationsExecutionsSuspensionsListCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/{+parent}/suspensions")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("GET", urls, body)
	if err != nil {
		return nil, err
...
// List: Lists the snapshots of a given integration executions. This RPC is not
// being used.
//
// - parent: The parent resource name of the integration execution.
func (r *ProjectsLocationsIntegrationsExecutionsnapshotsService) List(parent string) *ProjectsLocationsIntegrationsExecutionsnapshotsListCall {
	c := &ProjectsLocationsIntegrationsExecutionsnapshotsListCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.parent = parent
	return c
}

// Filter sets the optional parameter "filter": Currently supports filter by
// `execution_info_id` or `execution_snapshot_id`.
...
// PageSize sets the optional parameter "pageSize": Number of entries to be
// returned in a page.
...
// ReadMask sets the optional parameter "readMask": View mask for the response
// data. If set, only the field specified will be returned as part of the
// result. If not set, all fields in event execution snapshot will be filled
// and returned.
...
func (c *ProjectsLocationsIntegrationsExecutionsnapshotsListCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "", c.header_)
	if c.ifNoneMatch_ != "" {
		reqHeaders.Set("If-None-Match", c.ifNoneMatch_)
	}
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/{+parent}/executionsnapshots")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("GET", urls, body)
	if err != nil {
		return nil, err
...
// Do executes the "integrations.projects.locations.integrations.executionsnapshots.list" call.
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaListExecutionSnapshotsResponse.ServerResponse.
// Header or (if a response was returned at all) in
// error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
...
// Archive: Soft-deletes the integration. Changes the status of the integration
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaArchiveIntegrationVersionResponse.ServerRespon
...
// Deactivate: Sets the status of the ACTIVE integration to SNAPSHOT with a new
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaDeactivateIntegrationVersionResponse.ServerRes
...
func (c *ProjectsLocationsIntegrationsVersionsUnpublishCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/{+name}:unpublish")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
func (c *ProjectsLocationsIntegrationsVersionsUploadCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/{+parent}/versions:upload")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaValidateIntegrationVersionResponse.ServerRespo
// nse.Header or (if a response was returned at all) in
// error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
...
// CreateBundle: PROTECT WITH A VISIBILITY LABEL. THIS METHOD WILL BE MOVED TO
// A SEPARATE SERVICE. Create a bundle.
//
...
func (c *ProjectsLocationsProductsCreateBundleCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/{+parent}:createBundle")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaCreateBundleResponse.ServerResponse.Header or
// (if a response was returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
...
func (r *ProjectsLocationsProductsCloudFunctionsService) Create(parent string, googlecloudintegrationsv1alphacreatecloudfunctionrequest *GoogleCloudIntegrationsV1alphaCreateCloudFunctionRequest) *ProjectsLocationsProductsCloudFunctionsCreateCall {
	c := &ProjectsLocationsProductsCloudFunctionsCreateCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.parent = parent
	c.googlecloudintegrationsv1alphacreatecloudfunctionrequest = googlecloudintegrationsv1alphacreatecloudfunctionrequest
	return c
}
...
func (c *ProjectsLocationsProductsCloudFunctionsCreateCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.googlecloudintegrationsv1alphacreatecloudfunctionrequest)
	if err != nil {
...
// Do executes the "integrations.projects.locations.products.cloudFunctions.create" call.
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaCreateCloudFunctionResponse.ServerResponse.Hea
// der or (if a response was returned at all) in
// error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
...
// ArchiveBundle: PROTECT WITH A VISIBILITY LABEL. THIS METHOD WILL BE MOVED TO
// A SEPARATE SERVICE. Soft-deletes the bundle.
//
...
func (c *ProjectsLocationsProductsIntegrationsArchiveBundleCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/{+name}:archiveBundle")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaArchiveBundleResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// Use googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
...
func (r *ProjectsLocationsProductsIntegrationsService) Test(name string, googlecloudintegrationsv1alphatestintegrationsrequest *GoogleCloudIntegrationsV1alphaTestIntegrationsRequest) *ProjectsLocationsProductsIntegrationsTestCall {
	c := &ProjectsLocationsProductsIntegrationsTestCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.name = name
	c.googlecloudintegrationsv1alphatestintegrationsrequest = googlecloudintegrationsv1alphatestintegrationsrequest
	return c
}
...
func (c *ProjectsLocationsProductsIntegrationsTestCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "application/json", c.header_)
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.googlecloudintegrationsv1alphatestintegrationsrequest)
	if err != nil {
...
// Do executes the "integrations.projects.locations.products.integrations.test" call.
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaTestIntegrationsResponse.ServerResponse.Header
//
//	or (if a response was returned at all) in error.(*googleapi.Error).Header.
...
func (r *ProjectsLocationsProductsIntegrationsExecutionsService) Download(name string) *ProjectsLocationsProductsIntegrationsExecutionsDownloadCall {
	c := &ProjectsLocationsProductsIntegrationsExecutionsDownloadCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.name = name
	return c
}
...
func (c *ProjectsLocationsProductsIntegrationsExecutionsDownloadCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := gensupport.SetHeaders(c.s.userAgent(), "", c.header_)
	if c.ifNoneMatch_ != "" {
		reqHeaders.Set("If-None-Match", c.ifNoneMatch_)
	}
...
// Do executes the "integrations.projects.locations.products.integrations.executions.download" call.
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaDownloadExecutionResponse.ServerResponse.Heade
// r or (if a response was returned at all) in error.(*googleapi.Error).Header.
// Use googleapi.IsNotModified to check whether the returned error was because
...
// GetBundle: PROTECT WITH A VISIBILITY LABEL. THIS METHOD WILL BE MOVED TO A
// SEPARATE SERVICE. RPC to get details of the Bundle
//
...
func (c *ProjectsLocationsProductsIntegrationsVersionsGetBundleCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/{+name}:getBundle")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("GET", urls, body)
	if err != nil {
		return nil, err
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaGetBundleResponse.ServerResponse.Header or
// (if a response was returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
...
func (c *ProjectsLocationsProductsIntegrationsVersionsTakeoverEditLockCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/{+integrationVersion}:takeoverEditLock")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
// UpdateBundle: THIS METHOD WILL BE MOVED TO A SEPARATE SERVICE. RPC to update
// the Bundle
//
// - name: Bundle name.
...
func (c *ProjectsLocationsProductsIntegrationsVersionsUpdateBundleCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/{+name}:updateBundle")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("PATCH", urls, body)
	if err != nil {
		return nil, err
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaUpdateBundleResponse.ServerResponse.Header or
// (if a response was returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
...
func (c *ProjectsLocationsProductsSfdcInstancesCreateCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/{+parent}/sfdcInstances")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
func (c *ProjectsLocationsProductsSfdcInstancesSfdcChannelsCreateCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/{+parent}/sfdcChannels")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
