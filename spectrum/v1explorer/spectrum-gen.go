...
// is cancelled.
func (c *PawsGetSpectrumCall) Ctx(ctx context.Context) *PawsGetSpectrumCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *PawsGetSpectrumBatchCall) Ctx(ctx context.Context) *PawsGetSpectrumBatchCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *PawsInitCall) Ctx(ctx context.Context) *PawsInitCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *PawsNotifySpectrumUseCall) Ctx(ctx context.Context) *PawsNotifySpectrumUseCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *PawsRegisterCall) Ctx(ctx context.Context) *PawsRegisterCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *PawsVerifyDeviceCall) Ctx(ctx context.Context) *PawsVerifyDeviceCall {
	c.ctx_ = ctx
	return c
}
