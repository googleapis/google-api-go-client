...
type HostedmodelsServicer interface {
	Predict(project string, hostedModelName string, input *Input) *HostedmodelsPredictCall
}
...
type TrainedmodelsServicer interface {
	...
	Delete(project string, id string) *TrainedmodelsDeleteCall
	Get(project string, id string) *TrainedmodelsGetCall
	Insert(project string, insert *Insert) *TrainedmodelsInsertCall
	List(project string) *TrainedmodelsListCall
	Predict(project string, id string, input *Input) *TrainedmodelsPredictCall
	Update(project string, id string, update *Update) *TrainedmodelsUpdateCall
}
