...
type TasksServicer interface {
	...
	Insert(project string, taskqueue string, task *Task) *TasksInsertCall
	...
	Patch(project string, taskqueue string, task string, newLeaseSeconds int64, task2 *Task) *TasksPatchCall
	Update(project string, taskqueue string, task string, newLeaseSeconds int64, task2 *Task) *TasksUpdateCall
}
