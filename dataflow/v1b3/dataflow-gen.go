...
func (c *ProjectsJobsCreateCall) DoHeader() (*Job, http.Header, error) {
...
func (c *ProjectsJobsGetCall) DoHeader() (*Job, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["view"]; ok {
...
func (c *ProjectsJobsGetMetricsCall) DoHeader() (*JobMetrics, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *ProjectsJobsListCall) DoHeader() (*ListJobsResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *ProjectsJobsPatchCall) DoHeader() (*Job, http.Header, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.job)
	if err != nil {
		return nil, nil, err
...
func (c *ProjectsJobsUpdateCall) DoHeader() (*Job, http.Header, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.job)
	if err != nil {
		return nil, nil, err
...
func (c *ProjectsJobsMessagesListCall) DoHeader() (*ListJobMessagesResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *ProjectsJobsWorkItemsLeaseCall) DoHeader() (*LeaseWorkItemResponse, http.Header, error) {
	var body io.Reader = nil
...
func (c *ProjectsJobsWorkItemsReportStatusCall) DoHeader() (*ReportWorkItemStatusResponse, http.Header, error) {
	var body io.Reader = nil
