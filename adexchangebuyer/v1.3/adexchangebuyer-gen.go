...
func (c *BillingInfoGetCall) DoHeader() (http.Header, *BillingInfo, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *BillingInfoListCall) DoHeader() (http.Header, *BillingInfoList, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *BudgetGetCall) DoHeader() (http.Header, *Budget, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *BudgetPatchCall) DoHeader() (http.Header, *Budget, error) {
	var body io.Reader = nil
...
func (c *BudgetUpdateCall) DoHeader() (http.Header, *Budget, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.budget)
	if err != nil {
		return nil, nil, err
...
func (c *DirectDealsGetCall) DoHeader() (http.Header, *DirectDeal, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *DirectDealsListCall) DoHeader() (http.Header, *DirectDealsList, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *PerformanceReportListCall) DoHeader() (http.Header, *PerformanceReportList, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *PretargetingConfigGetCall) DoHeader() (http.Header, *PretargetingConfig, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *PretargetingConfigInsertCall) DoHeader() (http.Header, *PretargetingConfig, error) {
	var body io.Reader = nil
...
func (c *PretargetingConfigListCall) DoHeader() (http.Header, *PretargetingConfigList, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *PretargetingConfigPatchCall) DoHeader() (http.Header, *PretargetingConfig, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.pretargetingconfig)
	if err != nil {
		return nil, nil, err
...
func (c *PretargetingConfigUpdateCall) DoHeader() (http.Header, *PretargetingConfig, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.pretargetingconfig)
	if err != nil {
		return nil, nil, err
