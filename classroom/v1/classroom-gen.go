...
// is cancelled.
func (c *CoursesCreateCall) Ctx(ctx context.Context) *CoursesCreateCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *CoursesDeleteCall) Ctx(ctx context.Context) *CoursesDeleteCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *CoursesGetCall) Ctx(ctx context.Context) *CoursesGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *CoursesListCall) Ctx(ctx context.Context) *CoursesListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *CoursesPatchCall) Ctx(ctx context.Context) *CoursesPatchCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *CoursesUpdateCall) Ctx(ctx context.Context) *CoursesUpdateCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *CoursesAliasesCreateCall) Ctx(ctx context.Context) *CoursesAliasesCreateCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *CoursesAliasesDeleteCall) Ctx(ctx context.Context) *CoursesAliasesDeleteCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *CoursesAliasesListCall) Ctx(ctx context.Context) *CoursesAliasesListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *CoursesStudentsCreateCall) Ctx(ctx context.Context) *CoursesStudentsCreateCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *CoursesStudentsDeleteCall) Ctx(ctx context.Context) *CoursesStudentsDeleteCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *CoursesStudentsGetCall) Ctx(ctx context.Context) *CoursesStudentsGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *CoursesStudentsListCall) Ctx(ctx context.Context) *CoursesStudentsListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *CoursesTeachersCreateCall) Ctx(ctx context.Context) *CoursesTeachersCreateCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *CoursesTeachersDeleteCall) Ctx(ctx context.Context) *CoursesTeachersDeleteCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *CoursesTeachersGetCall) Ctx(ctx context.Context) *CoursesTeachersGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *CoursesTeachersListCall) Ctx(ctx context.Context) *CoursesTeachersListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *InvitationsAcceptCall) Ctx(ctx context.Context) *InvitationsAcceptCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *InvitationsCreateCall) Ctx(ctx context.Context) *InvitationsCreateCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *InvitationsDeleteCall) Ctx(ctx context.Context) *InvitationsDeleteCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *InvitationsGetCall) Ctx(ctx context.Context) *InvitationsGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *InvitationsListCall) Ctx(ctx context.Context) *InvitationsListCall {
	c.ctx_ = ctx
	return c
}
