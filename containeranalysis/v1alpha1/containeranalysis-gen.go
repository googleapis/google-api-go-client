...
// CISAKnownExploitedVulnerabilities: CISAKnownExploitedVulnerabilities
// provides information about whether the vulnerability is known to have been
// leveraged as part of a ransomware campaign.
type CISAKnownExploitedVulnerabilities struct {
	// KnownRansomwareCampaignUse: Optional. Whether the vulnerability is known to
	// have been leveraged as part of a ransomware campaign.
...
type CVSS struct {
	// AttackComplexity: Optional. Attack Complexity (AC). Defined in CVSS v2, v3,
	// v4.
	//
	// Possible values:
	...
	// AttackRequirements: Optional. Attack Requirements (AT). Defined in CVSS v4.
	//
	// Possible values:
	...
	// BaseScore: Optional. The base score is a function of the base metric scores.
	BaseScore float64 `json:"baseScore,omitempty"`
	// ConfidentialityImpact: Optional. Confidentiality Impact (C). Defined in CVSS
	// v2, v3.
	//
	// Possible values:
	//   "IMPACT_UNSPECIFIED" - Unspecified.
	...
	// PrivilegesRequired: Optional. Privileges Required (PR). Defined in CVSS v3,
	// v4.
	//
	// Possible values:
	...
	// SubsequentSystemAvailabilityImpact: Optional. Subsequent System Availability
	// Impact (SA). Defined in CVSS v4.
	//
	// Possible values:
	//   "IMPACT_UNSPECIFIED" - Unspecified.
	//   "IMPACT_HIGH" - High impact (H). Defined in CVSS v3, v4.
	...
	// CVSS v4.
	//   "USER_INTERACTION_ACTIVE" - Active user interaction (UI:A). Defined in
	// CVSS v4.
	UserInteraction string `json:"userInteraction,omitempty"`
	// VulnerableSystemAvailabilityImpact: Optional. Vulnerable System Availability
	// Impact (VA). Defined in CVSS v4.
	//
	// Possible values:
	//   "IMPACT_UNSPECIFIED" - Unspecified.
	//   "IMPACT_HIGH" - High impact (H). Defined in CVSS v3, v4.
...
// ExploitPredictionScoringSystem: ExploitPredictionScoringSystem provides
// information about the Exploit Prediction Scoring System (EPSS) score and
// percentile.
type ExploitPredictionScoringSystem struct {
	// Percentile: Optional. The percentile of the current score, the proportion of
...
type MalwareScanResult struct {
	...
	// ForceSendFields is a list of field names (e.g. "ScanState") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ScanState") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// Risk: The Risk message provides information about the risk of a
// vulnerability.
type Risk struct {
	...
	// likelihood (probability) that a software vulnerability will be exploited in
	// the wild.
...
type SecretOccurrence struct {
	...
	//   "SECRET_KIND_ANTHROPIC_ADMIN_API_KEY" - An Anthropic Admin API key. This
	// is called Workspace API key in Scalibr.
