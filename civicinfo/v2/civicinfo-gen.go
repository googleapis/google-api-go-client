...
type ElectionsServicer interface {
	ElectionQuery() *ElectionsElectionQueryCall
	VoterInfoQuery(address string) *ElectionsVoterInfoQueryCall
}
...
type RepresentativesServicer interface {
	RepresentativeInfoByAddress() *RepresentativesRepresentativeInfoByAddressCall
	RepresentativeInfoByDivision(ocdId string) *RepresentativesRepresentativeInfoByDivisionCall
}
