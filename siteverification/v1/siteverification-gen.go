...
func (c *WebResourceDeleteCall) Do() (err error) {
	_, err = c.DoHeader()
	return err
}
...
// Do performs a round-trip call to the server.
func (c *WebResourceGetCall) Do() (ret *SiteVerificationWebResourceResource, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *WebResourceGetTokenCall) Do() (ret *SiteVerificationWebResourceGettokenResponse, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *WebResourceInsertCall) Do() (ret *SiteVerificationWebResourceResource, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *WebResourceListCall) Do() (ret *SiteVerificationWebResourceListResponse, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *WebResourcePatchCall) Do() (ret *SiteVerificationWebResourceResource, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *WebResourceUpdateCall) Do() (ret *SiteVerificationWebResourceResource, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
