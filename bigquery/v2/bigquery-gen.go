...
type JobConfigurationLoad struct {
	...
	// NullMarker: [Optional] This string will be interpreted as a null
	// value when it appears in a CSV file. The default value is the empty
	// string. Please refer to the documentation for further information.
