...
// At most one of Media and ResumableMedia may be set.
func (c *TableImportRowsCall) ResumableMedia(ctx context.Context, r googleapi.Reader) *TableImportRowsCall {
	c.ctx_ = ctx
	c.media_ = r
...
// ResumableMedia specifies the media to upload in chunks and can be cancelled with ctx.
// At most one of Media and ResumableMedia may be set.
func (c *TableImportTableCall) ResumableMedia(ctx context.Context, r googleapi.Reader) *TableImportTableCall {
	c.ctx_ = ctx
	c.media_ = r
	c.protocol_ = "resumable"
	return c
...
// ResumableMedia specifies the media to upload in chunks and can be cancelled with ctx.
// At most one of Media and ResumableMedia may be set.
func (c *TableReplaceRowsCall) ResumableMedia(ctx context.Context, r googleapi.Reader) *TableReplaceRowsCall {
	c.ctx_ = ctx
	c.media_ = r
	c.protocol_ = "resumable"
	return c
