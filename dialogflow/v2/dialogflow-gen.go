...
type GoogleCloudDialogflowV2Agent struct {
	...
	// language tag. See Language Support for a list of the currently
	// supported language codes. This field cannot be set by the `Update`
	// method.
...
type GoogleCloudDialogflowV2ExportAgentRequest struct {
	// AgentUri: Required. The Google Cloud Storage URI to export the agent
...
type GoogleCloudDialogflowV2InputAudioConfig struct {
	...
	// Dialogflow does not do translations. See Language Support for a list
	// of the currently supported language codes. Note that queries in the
	...
	// Cloud Speech documentation for more details. This field is
...
type GoogleCloudDialogflowV2QueryParameters struct {
	...
	// the time zone specified in agent settings is used.
	TimeZone string `json:"timeZone,omitempty"`
...
type GoogleCloudDialogflowV2TextInput struct {
	...
	// See Language Support for a list of the currently supported language
	// codes. Note that queries in the same session do not necessarily need
