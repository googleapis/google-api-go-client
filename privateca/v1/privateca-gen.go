...
type RsaKeyType struct {
	// MaxModulusSize: Optional. The maximum allowed RSA modulus size, in
	// bits. If this is not set, or if set to zero, the service will not
	// enforce an explicit upper bound on RSA modulus sizes.
	MaxModulusSize int64 `json:"maxModulusSize,omitempty,string"`

	// MinModulusSize: Optional. The minimum allowed RSA modulus size, in
	// bits. If this is not set, or if set to zero, the service-level min
	// RSA modulus size will continue to apply.
