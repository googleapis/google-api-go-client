...
// "ifNoneMatch": Makes the operation conditional on whether
// the object's Etag does not match the given value.
func (c *TrainedmodelsAnalyzeCall) IfNoneMatch(ifNoneMatch string) *TrainedmodelsAnalyzeCall {
	c.opt_["ifNoneMatch"] = ifNoneMatch
	return c
}
...
func (c *TrainedmodelsAnalyzeCall) DoHeader() (http.Header, *Analyze, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *TrainedmodelsGetCall) DoHeader() (http.Header, *Insert2, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *TrainedmodelsInsertCall) DoHeader() (http.Header, *Insert2, error) {
	var body io.Reader = nil
...
// "ifNoneMatch": Makes the operation conditional on whether
// the object's Etag does not match the given value.
func (c *TrainedmodelsListCall) IfNoneMatch(ifNoneMatch string) *TrainedmodelsListCall {
	c.opt_["ifNoneMatch"] = ifNoneMatch
	return c
}
...
func (c *TrainedmodelsListCall) DoHeader() (http.Header, *List, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *TrainedmodelsUpdateCall) DoHeader() (http.Header, *Insert2, error) {
	var body io.Reader = nil
