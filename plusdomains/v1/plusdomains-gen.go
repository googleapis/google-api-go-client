...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *AudiencesListCall) Ctx(ctx context.Context) *AudiencesListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *CirclesAddPeopleCall) Ctx(ctx context.Context) *CirclesAddPeopleCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *CirclesGetCall) Ctx(ctx context.Context) *CirclesGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *CirclesInsertCall) Ctx(ctx context.Context) *CirclesInsertCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *CirclesListCall) Ctx(ctx context.Context) *CirclesListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *CirclesPatchCall) Ctx(ctx context.Context) *CirclesPatchCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *CirclesRemoveCall) Ctx(ctx context.Context) *CirclesRemoveCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *CirclesRemovePeopleCall) Ctx(ctx context.Context) *CirclesRemovePeopleCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *CirclesUpdateCall) Ctx(ctx context.Context) *CirclesUpdateCall {
	c.ctx_ = ctx
	return c
}
...
func (c *MediaInsertCall) Ctx(ctx context.Context) *MediaInsertCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *PeopleListByCircleCall) Ctx(ctx context.Context) *PeopleListByCircleCall {
	c.ctx_ = ctx
	return c
}
