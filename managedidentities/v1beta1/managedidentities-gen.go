...
type Domain struct {
	...
	// Engine networks the domain instance is connected to. Networks can be
	// added using UpdateDomain. The domain is only available on networks
	// listed in `authorized_networks`. If CIDR subnets overlap between
...
// of results. See Sorting order for more information.
