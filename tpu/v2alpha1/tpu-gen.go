...
type NetworkConfig struct {
	...
	// ForceSendFields is a list of field names (e.g. "EnableExternalIps")
	...
	// NullFields is a list of field names (e.g. "EnableExternalIps") to
	// include in API requests with the JSON null value. By default, fields
	// with empty values are omitted from API requests. However, any field
	// with an empty value appearing in NullFields will be sent to the
	// server as null. It is an error if a field in this list has a
...
// of fields from Node to update. Supported fields: None.
...
func (c *ProjectsLocationsNodesPatchCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	//     },
	//     "updateMask": {
	//       "description": "Required. Mask of fields from Node to update. Supported fields: None.",
