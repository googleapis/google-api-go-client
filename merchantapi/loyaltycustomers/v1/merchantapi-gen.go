...
// and the `loyalty_tier` value provided in the request. For more information
// on how to use this method, see Overview of the loyalty customer match
// service (/merchant/api/guides/loyalty/customer-match-service). **Operation
// Logic:** * **Upsert (Insert/Update):** Providing any valid tier other than
