...
type GoogleMapsPlacesV1Place struct {
	...
	Reviews []*GoogleMapsPlacesV1PlaceReview `json:"reviews,omitempty"`
...
// GoogleMapsPlacesV1PlaceReview: Information about a review of the
// place.
type GoogleMapsPlacesV1PlaceReview struct {
	...
	// OriginalLanguageCode: Output only. A BCP-47 language code indicating
	// the original language of the review. If the review has been
	// translated, then original_language != language. This field contains
	// the main language tag only, and not the secondary tag indicating
	// country or region. For example, all the English reviews are tagged as
	// 'en', and not 'en-AU' or 'en-UK' and so on.This field is empty if
	// there is only a rating with no review text.
	OriginalLanguageCode string `json:"originalLanguageCode,omitempty"`
	...
	// PublishTime: Output only. Timestamp for the review, expressed in
	// seconds since epoch.
	PublishTime string `json:"publishTime,omitempty"`

	// Rating: Output only. A whole number between 1.0 and 5.0, a.k.a. the
	// number of stars.
	Rating float64 `json:"rating,omitempty"`
	...
	// Translated: Output only. A boolean value indicating if the review was
	// translated from the original language it was written in. If a review
	// has been translated, corresponding to a value of true, Google
	// recommends that you indicate this to your users. For example, you can
	// add the following string, “Translated by Google”, to the review.
...
func (s *GoogleMapsPlacesV1PlaceReview) MarshalJSON() ([]byte, error) {
	type NoMethod GoogleMapsPlacesV1PlaceReview
	raw := NoMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}

func (s *GoogleMapsPlacesV1PlaceReview) UnmarshalJSON(data []byte) error {
	type NoMethod GoogleMapsPlacesV1PlaceReview
	var s1 struct {
		Rating gensupport.JSONFloat64 `json:"rating"`
		*NoMethod
