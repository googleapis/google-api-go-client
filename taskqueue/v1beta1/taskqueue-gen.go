...
// Usage example:
//
//   import "google-api-go-client.googlecode.com/hg/taskqueue/v1beta1"
//   ...
...
func (c *TasksListCall) Do() (*Tasks2, os.Error) {
...
func (c *TasksLeaseCall) Do() (*Tasks, os.Error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *TaskqueuesGetCall) Do() (*Taskqueue, os.Error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
