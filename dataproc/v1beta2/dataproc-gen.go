...
type ClusterConfig struct {
	...
	// you do not specify a temp bucket, Cloud Dataproc will determine a
	// Cloud Storage location (US, ASIA, or EU) for your cluster's temp
	// bucket according to the Compute Engine zone where your cluster is
	// deployed, and then create and manage this project-level, per-location
	// bucket. The default bucket has a TTL of 90 days, but you can use any
...
// WorkflowTemplate: A Dataproc workflow template resource. Next ID: 11
