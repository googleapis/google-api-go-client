...
func (c *FilesInsertCall) ResumableMedia(ctx context.Context, r io.Reader) *FilesInsertCall {
	c.ctx_ = ctx
	c.media_ = r
...
// or, as a special case for extra configuration, a googleapi.UploadParameters struct
// can be used. Refer to this struct's documentation for additional details.
func (c *FilesUpdateCall) ResumableMedia(ctx context.Context, r io.Reader) *FilesUpdateCall {
	c.ctx_ = ctx
	c.media_ = r
	c.protocol_ = "resumable"
	return c
...
// or, as a special case for extra configuration, a googleapi.UploadParameters struct
// can be used. Refer to this struct's documentation for additional details.
func (c *RealtimeUpdateCall) ResumableMedia(ctx context.Context, r io.Reader) *RealtimeUpdateCall {
	c.ctx_ = ctx
	c.media_ = r
	c.protocol_ = "resumable"
	return c
