...
// Do performs a round-trip call to the server.
func (c *TrainingDeleteCall) Do() (err error) {
	_, err = c.DoHeader()
	return err
}
...
// Do performs a round-trip call to the server.
func (c *TrainingGetCall) Do() (ret *Training, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *TrainingInsertCall) Do() (ret *Training, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *TrainingPredictCall) Do() (ret *Output, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// Do performs a round-trip call to the server.
func (c *TrainingUpdateCall) Do() (ret *Training, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
