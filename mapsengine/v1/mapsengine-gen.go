...
// At most one of Media and ResumableMedia may be set.
func (c *ProjectsIconsCreateCall) ResumableMedia(ctx context.Context, r googleapi.Reader) *ProjectsIconsCreateCall {
	c.ctx_ = ctx
	c.media_ = r
...
// ResumableMedia specifies the media to upload in chunks and can be cancelled with ctx.
// At most one of Media and ResumableMedia may be set.
func (c *RastersFilesInsertCall) ResumableMedia(ctx context.Context, r googleapi.Reader) *RastersFilesInsertCall {
	c.ctx_ = ctx
	c.media_ = r
	c.protocol_ = "resumable"
	return c
...
// ResumableMedia specifies the media to upload in chunks and can be cancelled with ctx.
// At most one of Media and ResumableMedia may be set.
func (c *TablesFilesInsertCall) ResumableMedia(ctx context.Context, r googleapi.Reader) *TablesFilesInsertCall {
	c.ctx_ = ctx
	c.media_ = r
	c.protocol_ = "resumable"
	return c
