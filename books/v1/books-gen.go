...
type BookshelvesGetCallDoer interface {
	Do() (*Bookshelf, error)
	Source(source string) BookshelvesGetCallDoer
	Fields(s ...googleapi.Field) BookshelvesGetCallDoer
}
...
type BookshelvesListCallDoer interface {
	...
	Source(source string) BookshelvesListCallDoer
	Fields(s ...googleapi.Field) BookshelvesListCallDoer
}
...
type BookshelvesVolumesListCallDoer interface {
	Do() (*Volumes, error)
	MaxResults(maxResults int64) BookshelvesVolumesListCallDoer
	ShowPreorders(showPreorders bool) BookshelvesVolumesListCallDoer
	Source(source string) BookshelvesVolumesListCallDoer
	StartIndex(startIndex int64) BookshelvesVolumesListCallDoer
	Fields(s ...googleapi.Field) BookshelvesVolumesListCallDoer
}
...
// BookshelvesServicer makes it easy to provide your own testable versions of BookshelvesService.
type BookshelvesServicer interface {
	Get(userId string, shelf string) BookshelvesGetCallDoer
	List(userId string) BookshelvesListCallDoer
}
...
type CloudloadingAddBookCallDoer interface {
	...
	DriveDocumentId(driveDocumentId string) CloudloadingAddBookCallDoer
	MimeType(mimeType string) CloudloadingAddBookCallDoer
	Name(name string) CloudloadingAddBookCallDoer
	UploadClientToken(uploadClientToken string) CloudloadingAddBookCallDoer
	Fields(s ...googleapi.Field) CloudloadingAddBookCallDoer
}
...
type CloudloadingDeleteBookCallDoer interface {
	Do() error
	Fields(s ...googleapi.Field) CloudloadingDeleteBookCallDoer
}
...
type CloudloadingUpdateBookCallDoer interface {
	Do() (*BooksCloudloadingResource, error)
	Fields(s ...googleapi.Field) CloudloadingUpdateBookCallDoer
}
...
// CloudloadingServicer makes it easy to provide your own testable versions of CloudloadingService.
type CloudloadingServicer interface {
	AddBook() CloudloadingAddBookCallDoer
	DeleteBook(volumeId string) CloudloadingDeleteBookCallDoer
	UpdateBook(bookscloudloadingresource *BooksCloudloadingResource) CloudloadingUpdateBookCallDoer
}
...
type DictionaryListOfflineMetadataCallDoer interface {
	Do() (*Metadata, error)
	Fields(s ...googleapi.Field) DictionaryListOfflineMetadataCallDoer
}
...
// DictionaryServicer makes it easy to provide your own testable versions of DictionaryService.
type DictionaryServicer interface {
	ListOfflineMetadata(cpksver string) DictionaryListOfflineMetadataCallDoer
}
...
type LayersGetCallDoer interface {
	...
	ContentVersion(contentVersion string) LayersGetCallDoer
	Source(source string) LayersGetCallDoer
...
type LayersListCallDoer interface {
	...
	ContentVersion(contentVersion string) LayersListCallDoer
	MaxResults(maxResults int64) LayersListCallDoer
	PageToken(pageToken string) LayersListCallDoer
	Source(source string) LayersListCallDoer
...
type LayersAnnotationDataGetCallDoer interface {
	...
	AllowWebDefinitions(allowWebDefinitions bool) LayersAnnotationDataGetCallDoer
	H(h int64) LayersAnnotationDataGetCallDoer
	Locale(locale string) LayersAnnotationDataGetCallDoer
	Scale(scale int64) LayersAnnotationDataGetCallDoer
	Source(source string) LayersAnnotationDataGetCallDoer
	W(w int64) LayersAnnotationDataGetCallDoer
	Fields(s ...googleapi.Field) LayersAnnotationDataGetCallDoer
}
...
type LayersAnnotationDataListCallDoer interface {
	...
	AnnotationDataId(annotationDataId string) LayersAnnotationDataListCallDoer
	H(h int64) LayersAnnotationDataListCallDoer
	Locale(locale string) LayersAnnotationDataListCallDoer
	MaxResults(maxResults int64) LayersAnnotationDataListCallDoer
	PageToken(pageToken string) LayersAnnotationDataListCallDoer
	Scale(scale int64) LayersAnnotationDataListCallDoer
	Source(source string) LayersAnnotationDataListCallDoer
	UpdatedMax(updatedMax string) LayersAnnotationDataListCallDoer
	UpdatedMin(updatedMin string) LayersAnnotationDataListCallDoer
	W(w int64) LayersAnnotationDataListCallDoer
	Fields(s ...googleapi.Field) LayersAnnotationDataListCallDoer
}
...
type LayersVolumeAnnotationsGetCallDoer interface {
	...
	Locale(locale string) LayersVolumeAnnotationsGetCallDoer
	Source(source string) LayersVolumeAnnotationsGetCallDoer
	Fields(s ...googleapi.Field) LayersVolumeAnnotationsGetCallDoer
}
...
type LayersVolumeAnnotationsListCallDoer interface {
	...
	EndOffset(endOffset string) LayersVolumeAnnotationsListCallDoer
	EndPosition(endPosition string) LayersVolumeAnnotationsListCallDoer
	Locale(locale string) LayersVolumeAnnotationsListCallDoer
	MaxResults(maxResults int64) LayersVolumeAnnotationsListCallDoer
	PageToken(pageToken string) LayersVolumeAnnotationsListCallDoer
	ShowDeleted(showDeleted bool) LayersVolumeAnnotationsListCallDoer
	Source(source string) LayersVolumeAnnotationsListCallDoer
	StartOffset(startOffset string) LayersVolumeAnnotationsListCallDoer
	StartPosition(startPosition string) LayersVolumeAnnotationsListCallDoer
	UpdatedMax(updatedMax string) LayersVolumeAnnotationsListCallDoer
	UpdatedMin(updatedMin string) LayersVolumeAnnotationsListCallDoer
	VolumeAnnotationsVersion(volumeAnnotationsVersion string) LayersVolumeAnnotationsListCallDoer
	Fields(s ...googleapi.Field) LayersVolumeAnnotationsListCallDoer
}
...
type LayersServicer interface {
	Get(volumeId string, summaryId string) LayersGetCallDoer
	List(volumeId string) LayersListCallDoer
}
...
type MyconfigGetUserSettingsCallDoer interface {
	...
	Fields(s ...googleapi.Field) MyconfigGetUserSettingsCallDoer
}
...
type MyconfigReleaseDownloadAccessCallDoer interface {
	...
	Locale(locale string) MyconfigReleaseDownloadAccessCallDoer
	Source(source string) MyconfigReleaseDownloadAccessCallDoer
	Fields(s ...googleapi.Field) MyconfigReleaseDownloadAccessCallDoer
}
...
type MyconfigRequestAccessCallDoer interface {
	...
	LicenseTypes(licenseTypes string) MyconfigRequestAccessCallDoer
	Locale(locale string) MyconfigRequestAccessCallDoer
	Fields(s ...googleapi.Field) MyconfigRequestAccessCallDoer
}
...
type MyconfigSyncVolumeLicensesCallDoer interface {
	Do() (*Volumes, error)
	Features(features string) MyconfigSyncVolumeLicensesCallDoer
	Locale(locale string) MyconfigSyncVolumeLicensesCallDoer
	ShowPreorders(showPreorders bool) MyconfigSyncVolumeLicensesCallDoer
	VolumeIds(volumeIds string) MyconfigSyncVolumeLicensesCallDoer
	Fields(s ...googleapi.Field) MyconfigSyncVolumeLicensesCallDoer
}
...
type MyconfigUpdateUserSettingsCallDoer interface {
	Do() (*Usersettings, error)
	Fields(s ...googleapi.Field) MyconfigUpdateUserSettingsCallDoer
}
...
// MyconfigServicer makes it easy to provide your own testable versions of MyconfigService.
type MyconfigServicer interface {
	GetUserSettings() MyconfigGetUserSettingsCallDoer
	ReleaseDownloadAccess(volumeIds []string, cpksver string) MyconfigReleaseDownloadAccessCallDoer
	RequestAccess(source string, volumeId string, nonce string, cpksver string) MyconfigRequestAccessCallDoer
	SyncVolumeLicenses(source string, nonce string, cpksver string) MyconfigSyncVolumeLicensesCallDoer
	UpdateUserSettings(usersettings *Usersettings) MyconfigUpdateUserSettingsCallDoer
}
...
type MylibraryAnnotationsDeleteCallDoer interface {
	Do() error
	Source(source string) MylibraryAnnotationsDeleteCallDoer
	Fields(s ...googleapi.Field) MylibraryAnnotationsDeleteCallDoer
}
...
type MylibraryAnnotationsInsertCallDoer interface {
	Do() (*Annotation, error)
	Country(country string) MylibraryAnnotationsInsertCallDoer
	ShowOnlySummaryInResponse(showOnlySummaryInResponse bool) MylibraryAnnotationsInsertCallDoer
	Source(source string) MylibraryAnnotationsInsertCallDoer
	Fields(s ...googleapi.Field) MylibraryAnnotationsInsertCallDoer
}
...
type MylibraryAnnotationsListCallDoer interface {
	...
	ContentVersion(contentVersion string) MylibraryAnnotationsListCallDoer
	LayerId(layerId string) MylibraryAnnotationsListCallDoer
	LayerIds(layerIds string) MylibraryAnnotationsListCallDoer
	MaxResults(maxResults int64) MylibraryAnnotationsListCallDoer
	PageToken(pageToken string) MylibraryAnnotationsListCallDoer
	ShowDeleted(showDeleted bool) MylibraryAnnotationsListCallDoer
	Source(source string) MylibraryAnnotationsListCallDoer
	UpdatedMax(updatedMax string) MylibraryAnnotationsListCallDoer
	UpdatedMin(updatedMin string) MylibraryAnnotationsListCallDoer
	VolumeId(volumeId string) MylibraryAnnotationsListCallDoer
	Fields(s ...googleapi.Field) MylibraryAnnotationsListCallDoer
}
...
type MylibraryAnnotationsSummaryCallDoer interface {
	...
	Fields(s ...googleapi.Field) MylibraryAnnotationsSummaryCallDoer
}
...
type MylibraryAnnotationsUpdateCallDoer interface {
	Do() (*Annotation, error)
	Source(source string) MylibraryAnnotationsUpdateCallDoer
	Fields(s ...googleapi.Field) MylibraryAnnotationsUpdateCallDoer
}
...
type MylibraryBookshelvesAddVolumeCallDoer interface {
	Do() error
	Reason(reason string) MylibraryBookshelvesAddVolumeCallDoer
	Source(source string) MylibraryBookshelvesAddVolumeCallDoer
	Fields(s ...googleapi.Field) MylibraryBookshelvesAddVolumeCallDoer
}
...
type MylibraryBookshelvesClearVolumesCallDoer interface {
	Do() error
	Source(source string) MylibraryBookshelvesClearVolumesCallDoer
	Fields(s ...googleapi.Field) MylibraryBookshelvesClearVolumesCallDoer
}
...
type MylibraryBookshelvesGetCallDoer interface {
	Do() (*Bookshelf, error)
	Source(source string) MylibraryBookshelvesGetCallDoer
	Fields(s ...googleapi.Field) MylibraryBookshelvesGetCallDoer
}
...
type MylibraryBookshelvesListCallDoer interface {
	Do() (*Bookshelves, error)
	Source(source string) MylibraryBookshelvesListCallDoer
	Fields(s ...googleapi.Field) MylibraryBookshelvesListCallDoer
}
...
type MylibraryBookshelvesMoveVolumeCallDoer interface {
	Do() error
	Source(source string) MylibraryBookshelvesMoveVolumeCallDoer
	Fields(s ...googleapi.Field) MylibraryBookshelvesMoveVolumeCallDoer
}
...
type MylibraryBookshelvesRemoveVolumeCallDoer interface {
	Do() error
	Reason(reason string) MylibraryBookshelvesRemoveVolumeCallDoer
	Source(source string) MylibraryBookshelvesRemoveVolumeCallDoer
	Fields(s ...googleapi.Field) MylibraryBookshelvesRemoveVolumeCallDoer
}
...
type MylibraryBookshelvesVolumesListCallDoer interface {
	Do() (*Volumes, error)
	Country(country string) MylibraryBookshelvesVolumesListCallDoer
	MaxResults(maxResults int64) MylibraryBookshelvesVolumesListCallDoer
	Projection(projection string) MylibraryBookshelvesVolumesListCallDoer
	Q(q string) MylibraryBookshelvesVolumesListCallDoer
	ShowPreorders(showPreorders bool) MylibraryBookshelvesVolumesListCallDoer
	Source(source string) MylibraryBookshelvesVolumesListCallDoer
	StartIndex(startIndex int64) MylibraryBookshelvesVolumesListCallDoer
	Fields(s ...googleapi.Field) MylibraryBookshelvesVolumesListCallDoer
}
...
type MylibraryReadingpositionsGetCallDoer interface {
	...
	ContentVersion(contentVersion string) MylibraryReadingpositionsGetCallDoer
	Source(source string) MylibraryReadingpositionsGetCallDoer
	Fields(s ...googleapi.Field) MylibraryReadingpositionsGetCallDoer
}
...
type MylibraryReadingpositionsSetPositionCallDoer interface {
	Do() error
	Action(action string) MylibraryReadingpositionsSetPositionCallDoer
	ContentVersion(contentVersion string) MylibraryReadingpositionsSetPositionCallDoer
	DeviceCookie(deviceCookie string) MylibraryReadingpositionsSetPositionCallDoer
	Source(source string) MylibraryReadingpositionsSetPositionCallDoer
	Fields(s ...googleapi.Field) MylibraryReadingpositionsSetPositionCallDoer
}
...
// MylibraryServicer makes it easy to provide your own testable versions of MylibraryService.
type MylibraryServicer interface {
}
...
type OnboardingListCategoriesCallDoer interface {
	Do() (*Category, error)
	Locale(locale string) OnboardingListCategoriesCallDoer
	Fields(s ...googleapi.Field) OnboardingListCategoriesCallDoer
}
...
type OnboardingListCategoryVolumesCallDoer interface {
	Do() (*Volume2, error)
	CategoryId(categoryId string) OnboardingListCategoryVolumesCallDoer
	Locale(locale string) OnboardingListCategoryVolumesCallDoer
	MaxAllowedMaturityRating(maxAllowedMaturityRating string) OnboardingListCategoryVolumesCallDoer
	PageSize(pageSize int64) OnboardingListCategoryVolumesCallDoer
	PageToken(pageToken string) OnboardingListCategoryVolumesCallDoer
	Fields(s ...googleapi.Field) OnboardingListCategoryVolumesCallDoer
}
...
// OnboardingServicer makes it easy to provide your own testable versions of OnboardingService.
type OnboardingServicer interface {
	ListCategories() OnboardingListCategoriesCallDoer
	ListCategoryVolumes() OnboardingListCategoryVolumesCallDoer
}
...
type PromoofferAcceptCallDoer interface {
	Do() error
	AndroidId(androidId string) PromoofferAcceptCallDoer
	Device(device string) PromoofferAcceptCallDoer
	Manufacturer(manufacturer string) PromoofferAcceptCallDoer
	Model(model string) PromoofferAcceptCallDoer
	OfferId(offerId string) PromoofferAcceptCallDoer
	Product(product string) PromoofferAcceptCallDoer
	Serial(serial string) PromoofferAcceptCallDoer
	VolumeId(volumeId string) PromoofferAcceptCallDoer
	Fields(s ...googleapi.Field) PromoofferAcceptCallDoer
}
...
type PromoofferDismissCallDoer interface {
	Do() error
	AndroidId(androidId string) PromoofferDismissCallDoer
	Device(device string) PromoofferDismissCallDoer
	Manufacturer(manufacturer string) PromoofferDismissCallDoer
	Model(model string) PromoofferDismissCallDoer
	OfferId(offerId string) PromoofferDismissCallDoer
	Product(product string) PromoofferDismissCallDoer
	Serial(serial string) PromoofferDismissCallDoer
	Fields(s ...googleapi.Field) PromoofferDismissCallDoer
}
...
type PromoofferGetCallDoer interface {
	Do() (*Offers, error)
	AndroidId(androidId string) PromoofferGetCallDoer
	Device(device string) PromoofferGetCallDoer
	Manufacturer(manufacturer string) PromoofferGetCallDoer
	Model(model string) PromoofferGetCallDoer
	Product(product string) PromoofferGetCallDoer
	Serial(serial string) PromoofferGetCallDoer
	Fields(s ...googleapi.Field) PromoofferGetCallDoer
}
...
// PromoofferServicer makes it easy to provide your own testable versions of PromoofferService.
type PromoofferServicer interface {
	Accept() PromoofferAcceptCallDoer
	Dismiss() PromoofferDismissCallDoer
	Get() PromoofferGetCallDoer
}
...
type VolumesGetCallDoer interface {
	Do() (*Volume, error)
	Country(country string) VolumesGetCallDoer
	Partner(partner string) VolumesGetCallDoer
	Projection(projection string) VolumesGetCallDoer
	Source(source string) VolumesGetCallDoer
	UserLibraryConsistentRead(userLibraryConsistentRead bool) VolumesGetCallDoer
	Fields(s ...googleapi.Field) VolumesGetCallDoer
}
...
type VolumesListCallDoer interface {
	Do() (*Volumes, error)
	Download(download string) VolumesListCallDoer
	Filter(filter string) VolumesListCallDoer
	LangRestrict(langRestrict string) VolumesListCallDoer
	LibraryRestrict(libraryRestrict string) VolumesListCallDoer
	MaxResults(maxResults int64) VolumesListCallDoer
	OrderBy(orderBy string) VolumesListCallDoer
	Partner(partner string) VolumesListCallDoer
	PrintType(printType string) VolumesListCallDoer
	Projection(projection string) VolumesListCallDoer
	ShowPreorders(showPreorders bool) VolumesListCallDoer
	Source(source string) VolumesListCallDoer
	StartIndex(startIndex int64) VolumesListCallDoer
	Fields(s ...googleapi.Field) VolumesListCallDoer
}
...
type VolumesAssociatedListCallDoer interface {
	Do() (*Volumes, error)
	Association(association string) VolumesAssociatedListCallDoer
	Locale(locale string) VolumesAssociatedListCallDoer
	MaxAllowedMaturityRating(maxAllowedMaturityRating string) VolumesAssociatedListCallDoer
	Source(source string) VolumesAssociatedListCallDoer
	Fields(s ...googleapi.Field) VolumesAssociatedListCallDoer
}
...
type VolumesMybooksListCallDoer interface {
	Do() (*Volumes, error)
	AcquireMethod(acquireMethod string) VolumesMybooksListCallDoer
	Locale(locale string) VolumesMybooksListCallDoer
	MaxResults(maxResults int64) VolumesMybooksListCallDoer
	ProcessingState(processingState string) VolumesMybooksListCallDoer
	Source(source string) VolumesMybooksListCallDoer
	StartIndex(startIndex int64) VolumesMybooksListCallDoer
	Fields(s ...googleapi.Field) VolumesMybooksListCallDoer
}
...
type VolumesRecommendedListCallDoer interface {
	Do() (*Volumes, error)
	Locale(locale string) VolumesRecommendedListCallDoer
	MaxAllowedMaturityRating(maxAllowedMaturityRating string) VolumesRecommendedListCallDoer
	Source(source string) VolumesRecommendedListCallDoer
	Fields(s ...googleapi.Field) VolumesRecommendedListCallDoer
}
...
type VolumesRecommendedRateCallDoer interface {
	...
	Locale(locale string) VolumesRecommendedRateCallDoer
	Source(source string) VolumesRecommendedRateCallDoer
	Fields(s ...googleapi.Field) VolumesRecommendedRateCallDoer
}
...
type VolumesUseruploadedListCallDoer interface {
	Do() (*Volumes, error)
	Locale(locale string) VolumesUseruploadedListCallDoer
	MaxResults(maxResults int64) VolumesUseruploadedListCallDoer
	ProcessingState(processingState string) VolumesUseruploadedListCallDoer
	Source(source string) VolumesUseruploadedListCallDoer
	StartIndex(startIndex int64) VolumesUseruploadedListCallDoer
	VolumeId(volumeId string) VolumesUseruploadedListCallDoer
	Fields(s ...googleapi.Field) VolumesUseruploadedListCallDoer
}
...
// VolumesServicer makes it easy to provide your own testable versions of VolumesService.
type VolumesServicer interface {
	Get(volumeId string) VolumesGetCallDoer
	List(q string) VolumesListCallDoer
}
