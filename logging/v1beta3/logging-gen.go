...
func (c *ProjectsLogServicesListCall) DoHeader() (*ListLogServicesResponse, http.Header, error) {
...
func (c *ProjectsLogServicesIndexesListCall) DoHeader() (*ListLogServiceIndexesResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *ProjectsLogServicesSinksCreateCall) DoHeader() (*LogSink, http.Header, error) {
	var body io.Reader = nil
...
func (c *ProjectsLogServicesSinksDeleteCall) DoHeader() (*Empty, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *ProjectsLogServicesSinksGetCall) DoHeader() (*LogSink, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *ProjectsLogServicesSinksListCall) DoHeader() (*ListLogServiceSinksResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *ProjectsLogServicesSinksUpdateCall) DoHeader() (*LogSink, http.Header, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.logsink)
	if err != nil {
		return nil, nil, err
...
func (c *ProjectsLogsDeleteCall) DoHeader() (*Empty, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *ProjectsLogsListCall) DoHeader() (*ListLogsResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["pageSize"]; ok {
...
func (c *ProjectsLogsEntriesWriteCall) DoHeader() (*WriteLogEntriesResponse, http.Header, error) {
	var body io.Reader = nil
...
func (c *ProjectsLogsSinksCreateCall) DoHeader() (*LogSink, http.Header, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.logsink)
	if err != nil {
		return nil, nil, err
...
func (c *ProjectsLogsSinksDeleteCall) DoHeader() (*Empty, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *ProjectsLogsSinksGetCall) DoHeader() (*LogSink, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *ProjectsLogsSinksListCall) DoHeader() (*ListLogSinksResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *ProjectsLogsSinksUpdateCall) DoHeader() (*LogSink, http.Header, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.logsink)
	if err != nil {
		return nil, nil, err
