...
// is cancelled.
func (c *SubscriptionsAcknowledgeCall) Ctx(ctx context.Context) *SubscriptionsAcknowledgeCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *SubscriptionsCreateCall) Ctx(ctx context.Context) *SubscriptionsCreateCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *SubscriptionsGetCall) Ctx(ctx context.Context) *SubscriptionsGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *SubscriptionsModifyAckDeadlineCall) Ctx(ctx context.Context) *SubscriptionsModifyAckDeadlineCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *SubscriptionsModifyPushConfigCall) Ctx(ctx context.Context) *SubscriptionsModifyPushConfigCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *SubscriptionsPullCall) Ctx(ctx context.Context) *SubscriptionsPullCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *SubscriptionsPullBatchCall) Ctx(ctx context.Context) *SubscriptionsPullBatchCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *TopicsCreateCall) Ctx(ctx context.Context) *TopicsCreateCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *TopicsDeleteCall) Ctx(ctx context.Context) *TopicsDeleteCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *TopicsGetCall) Ctx(ctx context.Context) *TopicsGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *TopicsListCall) Ctx(ctx context.Context) *TopicsListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *TopicsPublishCall) Ctx(ctx context.Context) *TopicsPublishCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *TopicsPublishBatchCall) Ctx(ctx context.Context) *TopicsPublishBatchCall {
	c.ctx_ = ctx
	return c
}
