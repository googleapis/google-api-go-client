...
func (r *AboutService) Get() *AboutGetCall {
	c := &AboutGetCall{s: r.s, urlParams_: make(urlParams)}
	return c
}
...
func (r *AppsService) Get(appId string) *AppsGetCall {
	c := &AppsGetCall{s: r.s, urlParams_: make(urlParams)}
	c.appId = appId
	return c
}
...
func (r *AppsService) List() *AppsListCall {
	c := &AppsListCall{s: r.s, urlParams_: make(urlParams)}
	return c
}
...
func (r *ChangesService) Get(changeId string) *ChangesGetCall {
	c := &ChangesGetCall{s: r.s, urlParams_: make(urlParams)}
	c.changeId = changeId
	return c
}
...
func (r *ChangesService) List() *ChangesListCall {
	c := &ChangesListCall{s: r.s, urlParams_: make(urlParams)}
	return c
}
...
func (r *ChangesService) Watch(channel *Channel) *ChangesWatchCall {
	c := &ChangesWatchCall{s: r.s, urlParams_: make(urlParams)}
	c.channel = channel
	return c
}
...
func (r *ChildrenService) Delete(folderId string, childId string) *ChildrenDeleteCall {
	c := &ChildrenDeleteCall{s: r.s, urlParams_: make(urlParams)}
	c.folderId = folderId
	c.childId = childId
	return c
}
...
func (r *ChildrenService) Get(folderId string, childId string) *ChildrenGetCall {
	c := &ChildrenGetCall{s: r.s, urlParams_: make(urlParams)}
	c.folderId = folderId
	c.childId = childId
	return c
}
...
func (r *ChildrenService) Insert(folderId string, childreference *ChildReference) *ChildrenInsertCall {
	c := &ChildrenInsertCall{s: r.s, urlParams_: make(urlParams)}
	c.folderId = folderId
...
func (r *ChildrenService) List(folderId string) *ChildrenListCall {
	c := &ChildrenListCall{s: r.s, urlParams_: make(urlParams)}
	c.folderId = folderId
	return c
}
...
func (r *CommentsService) Delete(fileId string, commentId string) *CommentsDeleteCall {
	c := &CommentsDeleteCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
...
func (r *CommentsService) Get(fileId string, commentId string) *CommentsGetCall {
	c := &CommentsGetCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	c.commentId = commentId
	return c
}
...
func (r *CommentsService) Insert(fileId string, comment *Comment) *CommentsInsertCall {
	c := &CommentsInsertCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	c.comment = comment
	return c
}
...
func (r *CommentsService) List(fileId string) *CommentsListCall {
	c := &CommentsListCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	return c
}
...
func (r *CommentsService) Patch(fileId string, commentId string, comment *Comment) *CommentsPatchCall {
	c := &CommentsPatchCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	c.commentId = commentId
	c.comment = comment
	return c
...
func (r *CommentsService) Update(fileId string, commentId string, comment *Comment) *CommentsUpdateCall {
	c := &CommentsUpdateCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	c.commentId = commentId
	c.comment = comment
	return c
...
func (r *FilesService) Copy(fileId string, file *File) *FilesCopyCall {
	c := &FilesCopyCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	c.file = file
	return c
}
...
func (r *FilesService) Delete(fileId string) *FilesDeleteCall {
	c := &FilesDeleteCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	return c
}
...
func (r *FilesService) EmptyTrash() *FilesEmptyTrashCall {
	c := &FilesEmptyTrashCall{s: r.s, urlParams_: make(urlParams)}
	return c
}
...
func (r *FilesService) GenerateIds() *FilesGenerateIdsCall {
	c := &FilesGenerateIdsCall{s: r.s, urlParams_: make(urlParams)}
	return c
}
...
func (r *FilesService) Get(fileId string) *FilesGetCall {
	c := &FilesGetCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	return c
}
...
func (r *FilesService) Insert(file *File) *FilesInsertCall {
	c := &FilesInsertCall{s: r.s, urlParams_: make(urlParams)}
	c.file = file
	return c
}
...
func (r *FilesService) List() *FilesListCall {
	c := &FilesListCall{s: r.s, urlParams_: make(urlParams)}
	return c
}
...
func (r *FilesService) Patch(fileId string, file *File) *FilesPatchCall {
	c := &FilesPatchCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	c.file = file
	return c
}
...
func (r *FilesService) Touch(fileId string) *FilesTouchCall {
	c := &FilesTouchCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	return c
}
...
func (r *FilesService) Trash(fileId string) *FilesTrashCall {
	c := &FilesTrashCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	return c
}
...
func (r *FilesService) Untrash(fileId string) *FilesUntrashCall {
	c := &FilesUntrashCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	return c
}
...
func (r *FilesService) Update(fileId string, file *File) *FilesUpdateCall {
	c := &FilesUpdateCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	c.file = file
	return c
}
...
func (r *FilesService) Watch(fileId string, channel *Channel) *FilesWatchCall {
	c := &FilesWatchCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	c.channel = channel
	return c
}
...
func (r *ParentsService) Delete(fileId string, parentId string) *ParentsDeleteCall {
	c := &ParentsDeleteCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	c.parentId = parentId
	return c
}
...
func (r *ParentsService) Get(fileId string, parentId string) *ParentsGetCall {
	c := &ParentsGetCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	c.parentId = parentId
	return c
}
...
func (r *ParentsService) Insert(fileId string, parentreference *ParentReference) *ParentsInsertCall {
	c := &ParentsInsertCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
...
func (r *ParentsService) List(fileId string) *ParentsListCall {
	c := &ParentsListCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	return c
}
...
func (r *PermissionsService) Delete(fileId string, permissionId string) *PermissionsDeleteCall {
	c := &PermissionsDeleteCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
...
func (r *PermissionsService) Get(fileId string, permissionId string) *PermissionsGetCall {
	c := &PermissionsGetCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	c.permissionId = permissionId
	return c
}
...
func (r *PermissionsService) GetIdForEmail(email string) *PermissionsGetIdForEmailCall {
	c := &PermissionsGetIdForEmailCall{s: r.s, urlParams_: make(urlParams)}
	c.email = email
	return c
}
...
func (r *PermissionsService) Insert(fileId string, permission *Permission) *PermissionsInsertCall {
	c := &PermissionsInsertCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
...
func (r *PermissionsService) List(fileId string) *PermissionsListCall {
	c := &PermissionsListCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	return c
}
...
func (r *PermissionsService) Patch(fileId string, permissionId string, permission *Permission) *PermissionsPatchCall {
	c := &PermissionsPatchCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	c.permissionId = permissionId
	c.permission = permission
	return c
...
func (r *PermissionsService) Update(fileId string, permissionId string, permission *Permission) *PermissionsUpdateCall {
	c := &PermissionsUpdateCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	c.permissionId = permissionId
	c.permission = permission
	return c
...
func (r *PropertiesService) Delete(fileId string, propertyKey string) *PropertiesDeleteCall {
	c := &PropertiesDeleteCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
...
func (r *PropertiesService) Get(fileId string, propertyKey string) *PropertiesGetCall {
	c := &PropertiesGetCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	c.propertyKey = propertyKey
	return c
}
...
func (r *PropertiesService) Insert(fileId string, property *Property) *PropertiesInsertCall {
	c := &PropertiesInsertCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	c.property = property
	return c
}
...
func (r *PropertiesService) List(fileId string) *PropertiesListCall {
	c := &PropertiesListCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	return c
}
...
func (r *PropertiesService) Patch(fileId string, propertyKey string, property *Property) *PropertiesPatchCall {
	c := &PropertiesPatchCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	c.propertyKey = propertyKey
	c.property = property
	return c
...
func (r *PropertiesService) Update(fileId string, propertyKey string, property *Property) *PropertiesUpdateCall {
	c := &PropertiesUpdateCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	c.propertyKey = propertyKey
	c.property = property
	return c
...
func (r *RealtimeService) Get(fileId string) *RealtimeGetCall {
	c := &RealtimeGetCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	return c
}
...
func (r *RealtimeService) Update(fileId string) *RealtimeUpdateCall {
	c := &RealtimeUpdateCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	return c
}
...
func (r *RepliesService) Delete(fileId string, commentId string, replyId string) *RepliesDeleteCall {
	c := &RepliesDeleteCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	c.commentId = commentId
	c.replyId = replyId
	return c
...
func (r *RepliesService) Get(fileId string, commentId string, replyId string) *RepliesGetCall {
	c := &RepliesGetCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	c.commentId = commentId
	c.replyId = replyId
	return c
...
func (r *RepliesService) Insert(fileId string, commentId string, commentreply *CommentReply) *RepliesInsertCall {
	c := &RepliesInsertCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	c.commentId = commentId
...
func (r *RepliesService) List(fileId string, commentId string) *RepliesListCall {
	c := &RepliesListCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	c.commentId = commentId
	return c
}
...
func (r *RepliesService) Patch(fileId string, commentId string, replyId string, commentreply *CommentReply) *RepliesPatchCall {
	c := &RepliesPatchCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	c.commentId = commentId
	c.replyId = replyId
	c.commentreply = commentreply
...
func (r *RepliesService) Update(fileId string, commentId string, replyId string, commentreply *CommentReply) *RepliesUpdateCall {
	c := &RepliesUpdateCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	c.commentId = commentId
	c.replyId = replyId
	c.commentreply = commentreply
...
func (r *RevisionsService) Delete(fileId string, revisionId string) *RevisionsDeleteCall {
	c := &RevisionsDeleteCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
...
func (r *RevisionsService) Get(fileId string, revisionId string) *RevisionsGetCall {
	c := &RevisionsGetCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	c.revisionId = revisionId
	return c
}
...
func (r *RevisionsService) List(fileId string) *RevisionsListCall {
	c := &RevisionsListCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	return c
}
...
func (r *RevisionsService) Patch(fileId string, revisionId string, revision *Revision) *RevisionsPatchCall {
	c := &RevisionsPatchCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	c.revisionId = revisionId
	c.revision = revision
	return c
...
func (r *RevisionsService) Update(fileId string, revisionId string, revision *Revision) *RevisionsUpdateCall {
	c := &RevisionsUpdateCall{s: r.s, urlParams_: make(urlParams)}
	c.fileId = fileId
	c.revisionId = revisionId
	c.revision = revision
	return c
