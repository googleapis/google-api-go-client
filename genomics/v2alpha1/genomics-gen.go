...
type CheckInRequest struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "DeadlineExpired") to include in
...
type CheckInResponse struct {
	...
	// backend will allow for network transmission time and other delays, but the
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "Deadline") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// Cloud Genomics service account or the request will fail.
...
// TimestampedEvent: An event that occured in the operation assigned to the
...
type WorkerStatus struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AttachedDisks") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// Once the pipeline finishes, the value is true. Examples: * `projectId =
...
// CheckIn: The worker uses this method to retrieve the assigned operation and
...
// Any non-2xx status code is an error. Response headers are in either
// *CheckInResponse.ServerResponse.Header or (if a response was returned at
