...
// Usage example:
//
//   import "google-api-go-client.googlecode.com/hg/moderator/v1"
//   ...
...
func (c *TopicsListCall) Do() (*TopicList, os.Error) {
...
func (c *TopicsUpdateCall) Do() (*Topic, os.Error) {
	var body io.Reader = nil
	...
	urls = strings.Replace(urls, "{seriesId}", strconv.Itoa64(c.seriesId), 1)
	urls = strings.Replace(urls, "{topicId}", strconv.Itoa64(c.topicId), 1)
	urls += "?" + params.Encode()
...
func (c *TopicsInsertCall) Do() (*Topic, os.Error) {
	var body io.Reader = nil
	body, err := googleapi.WithDataWrapper.JSONReader(c.topic)
	if err != nil {
		return nil, err
...
func (c *TopicsGetCall) Do() (*Topic, os.Error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	urls := googleapi.ResolveRelative("https://www.googleapis.com/moderator/v1/", "series/{seriesId}/topics/{topicId}")
...
func (c *ProfilesUpdateCall) Do() (*Profile, os.Error) {
	var body io.Reader = nil
...
func (c *ProfilesGetCall) Do() (*Profile, os.Error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	urls := googleapi.ResolveRelative("https://www.googleapis.com/moderator/v1/", "profiles/@me")
...
func (c *ProfilesPatchCall) Do() (*Profile, os.Error) {
	var body io.Reader = nil
	body, err := googleapi.WithDataWrapper.JSONReader(c.profile)
	if err != nil {
		return nil, err
...
func (c *VotesListCall) Do() (*VoteList, os.Error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["start-index"]; ok {
...
func (c *VotesUpdateCall) Do() (*Vote, os.Error) {
	var body io.Reader = nil
...
func (c *VotesGetCall) Do() (*Vote, os.Error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["unauthToken"]; ok {
...
func (c *VotesPatchCall) Do() (*Vote, os.Error) {
	var body io.Reader = nil
	body, err := googleapi.WithDataWrapper.JSONReader(c.vote)
	if err != nil {
		return nil, err
...
func (c *TagsListCall) Do() (*TagList, os.Error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *TagsInsertCall) Do() (*Tag, os.Error) {
	var body io.Reader = nil
...
func (c *TagsDeleteCall) Do() os.Error {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *SubmissionsGetCall) Do() (*Submission, os.Error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *SeriesListCall) Do() (*SeriesList, os.Error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["q"]; ok {
...
func (c *SeriesUpdateCall) Do() (*Series, os.Error) {
	var body io.Reader = nil
...
func (c *SeriesInsertCall) Do() (*Series, os.Error) {
	var body io.Reader = nil
	body, err := googleapi.WithDataWrapper.JSONReader(c.series)
	if err != nil {
		return nil, err
...
func (c *SeriesGetCall) Do() (*Series, os.Error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	urls := googleapi.ResolveRelative("https://www.googleapis.com/moderator/v1/", "series/{seriesId}")
...
func (c *SeriesPatchCall) Do() (*Series, os.Error) {
	var body io.Reader = nil
	body, err := googleapi.WithDataWrapper.JSONReader(c.series)
	if err != nil {
		return nil, err
...
func (c *ResponsesListCall) Do() (*SubmissionList, os.Error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *ResponsesInsertCall) Do() (*Submission, os.Error) {
	...
	urls = strings.Replace(urls, "{seriesId}", strconv.Itoa64(c.seriesId), 1)
	urls = strings.Replace(urls, "{topicId}", strconv.Itoa64(c.topicId), 1)
	urls = strings.Replace(urls, "{parentSubmissionId}", strconv.Itoa64(c.parentSubmissionId), 1)
	urls += "?" + params.Encode()
	req, _ := http.NewRequest("POST", urls, body)
	req.Header.Set("Content-Type", ctype)
	req.Header.Set("User-Agent", "google-api-go-client/0.5")
