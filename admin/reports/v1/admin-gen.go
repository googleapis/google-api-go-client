...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ActivitiesWatchCall) Ctx(ctx context.Context) {
	c.ctx_ = ctx
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *CustomerUsageReportsGetCall) Ctx(ctx context.Context) {
	c.ctx_ = ctx
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *UserUsageReportGetCall) Ctx(ctx context.Context) {
	c.ctx_ = ctx
}
