...
func (c *UsersDataSourcesCreateCall) DoHeader() (*DataSource, http.Header, error) {
...
func (c *UsersDataSourcesDeleteCall) DoHeader() (*DataSource, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *UsersDataSourcesGetCall) DoHeader() (*DataSource, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *UsersDataSourcesListCall) DoHeader() (*ListDataSourcesResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *UsersDataSourcesPatchCall) DoHeader() (*DataSource, http.Header, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.datasource)
	if err != nil {
		return nil, nil, err
...
func (c *UsersDataSourcesUpdateCall) DoHeader() (*DataSource, http.Header, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.datasource)
	if err != nil {
		return nil, nil, err
...
func (c *UsersDataSourcesDatasetsGetCall) DoHeader() (*Dataset, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *UsersDataSourcesDatasetsPatchCall) DoHeader() (*Dataset, http.Header, error) {
	var body io.Reader = nil
...
func (c *UsersDatasetAggregateCall) DoHeader() (*AggregateResponse, http.Header, error) {
	var body io.Reader = nil
...
func (c *UsersSessionsListCall) DoHeader() (*ListSessionsResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *UsersSessionsUpdateCall) DoHeader() (*Session, http.Header, error) {
	var body io.Reader = nil
