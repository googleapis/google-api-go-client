...
// AsyncRecognizeRequest: The top-level message sent by the client for the
...
type RecognitionConfig struct {
	...
	// Hz.
	//   "AMR_WB" - Adaptive Multi-Rate Wideband codec. `sample_rate` must be 16000
	// Hz.
	Encoding string `json:"encoding,omitempty"`
	// LanguageCode: *Optional* The language of the supplied audio as a BCP-47
	// language tag.
	...
	// audio
	// source to 16000 Hz. If that's not possible, use the native sample rate
	// of
	// the audio source (instead of re-sampling).
	SampleRate int64 `json:"sampleRate,omitempty"`
	// SpeechContext: *Optional* A means to provide context to assist the speech
	// recognition.
...
type SpeechRecognitionAlternative struct {
	...
	// the
	// `confidence` field as it is not guaranteed to be accurate, or even set,
	// in
	// any of the results.
...
// SyncRecognizeRequest: The top-level message sent by the client for the
...
// Asyncrecognize: Performs asynchronous speech recognition: receive results
// via
// the
...
// Syncrecognize: Performs synchronous speech recognition: receive results
// after all audio
...
// Any non-2xx status code is an error. Response headers are in either
// *SyncRecognizeResponse.ServerResponse.Header or (if a response was returned
// at all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified was
// returned.
