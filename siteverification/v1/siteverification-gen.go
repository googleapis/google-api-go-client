...
func (c *WebResourceGetCall) DoHeader() (*SiteVerificationWebResourceResource, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *WebResourceGetTokenCall) DoHeader() (*SiteVerificationWebResourceGettokenResponse, http.Header, error) {
	var body io.Reader = nil
...
func (c *WebResourceInsertCall) DoHeader() (*SiteVerificationWebResourceResource, http.Header, error) {
	var body io.Reader = nil
...
func (c *WebResourceListCall) DoHeader() (*SiteVerificationWebResourceListResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *WebResourcePatchCall) DoHeader() (*SiteVerificationWebResourceResource, http.Header, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.siteverificationwebresourceresource)
	if err != nil {
		return nil, nil, err
...
func (c *WebResourceUpdateCall) DoHeader() (*SiteVerificationWebResourceResource, http.Header, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.siteverificationwebresourceresource)
	if err != nil {
		return nil, nil, err
