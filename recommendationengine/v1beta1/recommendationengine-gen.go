...
//
// For product documentation, see: https://cloud.google.com/recommendations/docs/
//
// Creating a client
//
// Usage example:
...
type GoogleCloudRecommendationengineV1alphaTuningMetadata struct {
	...
	// that this tune applies
	// to.
	// Format:
	// projects/{project_number}/locations/{location_id}/catalogs
	// /{catalog_id}/eventStores/{event_store_id}/recommendationModels/{recom
	// mendation_model_id}
...
type GoogleCloudRecommendationengineV1beta1BigQuerySource struct {
	...
	//
	// Su
	// pported values for user event imports:
	//
...
type GoogleCloudRecommendationengineV1beta1CatalogItem struct {
	...
	// repeated for supporting
	// one catalog item belonging to several parallel category
	// hierarchies.
	//
	// For example, if a shoes product belongs to both
	// ["Shoes & Accessories" -> "Shoes"] and
	// ["Sports & Fitness" -> "Athletic Clothing" -> "Shoes"], it could
	// be
	// represented as:
	//
	//      "categoryHierarchies": [
	//        { "categories": ["Shoes & Accessories", "Shoes"]},
	//        { "categories": ["Sports & Fitness", "Athletic Clothing",
	// "Shoes"] }
	//      ]
	...
	// of 128 bytes.
	//
	// This id must be unique among all catalog items within the same
	// catalog. It
	// should also be used when logging user events in order for the user
	// events
	...
	// products,
	// this could include the store name, vendor, style, color, etc. These
	// are
	// very strong signals for recommendation model, thus we highly
	// recommend
	...
	//
	// This field must be enabled before it can be used.
	// [Learn
	// more](/recommendations-ai/docs/catalog#item-group-id).
	ItemGroupId string `json:"itemGroupId,omitempty"`

	// LanguageCode: Optional. Deprecated. The model automatically detects
	// the text language. Your
	// catalog can include text in different languages, but
	// duplicating
	// catalog items to provide text in multiple languages can result
	// in
...
type GoogleCloudRecommendationengineV1beta1CatalogItemCategoryHierarchy struct {
	...
	//
	// Note that the order in the list denotes the specificity (from least
	// to
	// most specific).
...
// Configures what level the catalog should be uploaded with regards
// to
// how users will be send events and how predictions will be made.
type GoogleCloudRecommendationengineV1beta1CatalogItemLevelConfig struct {
	// EventItemLevel: Optional. What level of the catalog are events
	// uploaded at.
	// See
	...
	// PredictItemLevel: Optional. What level of the catalog are predictions
	// made at.
	// See
	// https://cloud.google.com/recommendations-ai/docs/catalog#catalog-levels
	// for more details.
...
type GoogleCloudRecommendationengineV1beta1EventDetail struct {
	...
	// model.
	//
	// For product recommendation, an example of extra user information
	// is
	// traffic_channel, i.e. how user arrives at the site. Users can
	// arrive
	// at the site by coming to the site directly, or coming through
	// Google
	// search, and etc.
	...
	// events
	// associated with different experiment setups (e.g. using
	// Recommendation
	// Engine system, using different recommendation models).
	ExperimentIds []string `json:"experimentIds,omitempty"`

	// PageViewId: Optional. A unique id of a web page view.
	// This should be kept the same for all user events triggered from the
	// same
	// pageview. For example, an item detail page view could trigger
	// multiple
	// events as the user is browsing the page.
	// The `pageViewId` property should be kept the same for all these
	// events so
	// that they can be grouped together properly. This `pageViewId` will
	// be
	...
	// performance.
	//
	// This token enables us to accurately attribute page view or purchase
	// back to
	// the event and the particular predict response containing
	// this
	// clicked/purchased item. If user clicks on product K in the
	// recommendation
	// results, pass the `PredictResponse.recommendationToken` property as a
	// url
	// parameter to product K's page. When recording events on product K's
	// page,
	// log the PredictResponse.recommendation_token to this
	// field.
	//
	// Optional, but highly encouraged for user events that are the result
	// of a
	...
	// current page.
	// When using the JavaScript pixel, this value is filled in
	// automatically.
	// Maximum length 5KB.
...
// represents extra features that customers want to include in
// the
...
type GoogleCloudRecommendationengineV1beta1FeatureMap struct {
	...
	// values. Some examples would be the brand/maker of a product, or
	// country of
	// a customer.
	//
...
type GoogleCloudRecommendationengineV1beta1GcsSource struct {
	...
	// example,
	// gs://bucket/directory/object.json) or a pattern matching one or
	// more
	// files, such as gs://bucket/directory/*.json. A request can
	// contain at most 100 files, and each file can be up to 2 GB.
	// See
	// [Importing catalog
	// information](/recommendations-ai/docs/upload-catalog)
	...
	//
	// Su
	// pported values for user events imports:
	//
	//  1: "user_events_recommendations_ai" using
	//
	// https://cloud.google.com/recommendations-ai/docs/manage-user-events#import
...
// GoogleCloudRecommendationengineV1beta1GetCatalogItemsWithItemGroupIdRe
// sponse: Response message for GetCatalogItemsWithItemGroupId method.
type GoogleCloudRecommendationengineV1beta1GetCatalogItemsWithItemGroupIdResponse struct {
	// CanonicalCatalogItem: The canonical catalog item representing all
	// items associated with the item
	// group id.
	CanonicalCatalogItem *GoogleCloudRecommendationengineV1beta1CatalogItem `json:"canonicalCatalogItem,omitempty"`

	// CatalogItems: The list of catalog items associated with the item
	// group id.
	CatalogItems []*GoogleCloudRecommendationengineV1beta1CatalogItem `json:"catalogItems,omitempty"`
	...
	// ForceSendFields is a list of field names (e.g.
	// "CanonicalCatalogItem") to unconditionally include in API requests.
	// By default, fields with empty values are omitted from API requests.
	// However, any non-pointer, non-interface field appearing in
	// ForceSendFields will be sent to the server regardless of whether the
	// field is empty or not. This may be used to include empty fields in
	...
	// NullFields is a list of field names (e.g. "CanonicalCatalogItem") to
	// include in API requests with the JSON null value. By default, fields
	// with empty values are omitted from API requests. However, any field
	// with an empty value appearing in NullFields will be sent to the
	// server as null. It is an error if a field in this list has a
...
func (s *GoogleCloudRecommendationengineV1beta1GetCatalogItemsWithItemGroupIdResponse) MarshalJSON() ([]byte, error) {
	type NoMethod GoogleCloudRecommendationengineV1beta1GetCatalogItemsWithItemGroupIdResponse
	raw := NoMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}
...
type GoogleCloudRecommendationengineV1beta1ImportCatalogItemsRequest struct {
	...
	// deduplication.
	// Server-generated if unspecified. Up to 128 characters long. This
	// is
...
// related to the progress of the Import operation. This will
// be
...
type GoogleCloudRecommendationengineV1beta1ImportUserEventsRequest struct {
	...
	// Server-generated if unspecified. Up to 128 characters long. This
	// is
	// returned as google.longrunning.Operation.name in the response. Note
	// that
	// this field must not be set if the desired input config
	// is
...
// Response of the ImportUserEventsRequest. If the long
// running
// operation was successful, then this message is returned by
// the
// google.longrunning.Operations.response field if the operation was
// successful.
...
type GoogleCloudRecommendationengineV1beta1PredictRequest struct {
	...
	// Note that the dryRun mode should only be used for testing the API, or
	// if
	...
	//
	//  * Tag expressions. Restricts predictions to items that match all of
	// the
	//    specified tags. Boolean operators `OR` and `NOT` are supported if
	// the
	//    expression is enclosed in parentheses, and must be separated from
	// the
	//    tag values by a space. `-"tagA" is also supported and is
	// equivalent to
	//    `NOT "tagA". Tag values must be double quoted UTF-8 encoded
	// strings
	//    with a size limit of 1 KiB.
	//
	//  * filterOutOfStockItems. Restricts predictions to items that do not
	// have a
	...
	//
	// If your filter blocks all prediction results, generic (unfiltered)
	// popular
	// items are returned. This behavior can be overridden by
	// setting
	...
	//
	//  * Label keys can contain lowercase letters, digits and hyphens, must
	// start
	//    with a letter, and must end with a letter or digit.
	//  * Non-zero label values can contain lowercase letters, digits and
	// hyphens,
	...
	// this property
	// to the number of prediction results required. If zero, the service
	// will
	...
	// Allowed values:
	//
	// * `returnCatalogItem`: Boolean. If set to true, the associated
	// catalogItem
	//    object will be returned in the
	//   `PredictResponse.PredictionResult.itemMetadata` object in the
	// method
	//    response.
	...
	//    probability of an item being clicked/purchased given the user's
	// context
	//    and history.
	// * `strictFiltering`: Boolean. If set to true, the service will return
	// empty
	//    instead of generic (unfiltered) popular items if your filter
	// blocks all
	//    prediction results.
	...
	// and what action
	// they took to trigger the predict request. Note that this user event
	// detail
	// won't be ingested to userEvent logs. Thus, a separate userEvent
	// write
...
type GoogleCloudRecommendationengineV1beta1ProductCatalogItem struct {
	...
	// item detail page with a
	// length limit of 5 KiB..
	CanonicalProductUri string `json:"canonicalProductUri,omitempty"`

	// Costs: Optional. A map to pass the costs associated with the
	// product.
	//
	// For example:
	// {"manufacturing": 45.5} The profit of selling this item is computed
	// like
	// so:
	//
...
// Product price range when there are a range of prices for
// different
...
type GoogleCloudRecommendationengineV1beta1ProductDetail struct {
	...
	// user event happens.
	// Optional. If provided, this overrides the available quantity in
	// Catalog for
	// this event. and can only be set if `stock_status` is set to
	// `IN_STOCK`.
	//
	// Note that if an item is out of stock, you must set the `stock_state`
	// field
	// to be `OUT_OF_STOCK`. Leaving this field unspecified / as zero is
	// not
	...
	// shopping
	// cart for `add-to-cart` event. Required for `add-to-cart`,
	// `add-to-list`,
	// `remove-from-cart`, `checkout-start`, `purchase-complete`, `refund`
	// event
	// types.
...
// ProductEventDetail captures user event information specific to
// retail
// products.
type GoogleCloudRecommendationengineV1beta1ProductEventDetail struct {
	...
	// This id is used
	// to associate multiple items added or present in the cart before
	// purchase.
	//
	// This can only be set for `add-to-cart`,
	// `remove-from-cart`,
	// `checkout-start`, `purchase-complete`, or `shopping-cart-page-view`
	// events.
	CartId string `json:"cartId,omitempty"`

	// ListId: Required for `add-to-list` and `remove-from-list` events. The
	// id or name of
	// the list that the item is being added to or removed from. Other event
	// types
	// should not set this field.
	ListId string `json:"listId,omitempty"`

	// PageCategories: Required for `category-page-view` events. Other event
	// types should not set
	// this field.
	// The categories associated with a category page.
	// Category pages include special pages such as sales or promotions.
	// For
	...
	//
	// * `page-visit`
	// * `shopping-cart-page-view` - note that 'product_details' should be
	// set for
	//   this unless the shopping cart is empty.
	// * `search` (highly encouraged)
	//
	// In a `search` event, this field represents the products returned to
	// the end
	// user on the current page (the end user may have not finished broswing
	// the
	// whole page yet). When a new page is returned to the end user,
	// after
	...
	// not set this field.
	// The user's search query as UTF-8 encoded text with a length limit of
	// 5 KiB.
...
type GoogleCloudRecommendationengineV1beta1PurchaseTransaction struct {
	...
	// transaction.
	// This value include shipping, tax, or other adjustments to total
	// revenue
	// that you want to include as part of your revenue calculations. This
	// field
	// is not required if the event type is `refund`.
...
// Metadata related to the progress of the PurgeUserEvents
// operation.
...
type GoogleCloudRecommendationengineV1beta1PurgeUserEventsRequest struct {
	...
	// * `userId`: field of type string. Specifying this will delete all
	// events
	...
	//   `eventTime > "2012-04-23T18:25:43.511Z" eventType =
	// "detail-page-view"
...
// all metadata information recommendation engine needs to
...
type GoogleCloudRecommendationengineV1beta1UserEvent struct {
	...
	// * `add-to-list` Items being added to a list (shopping list,
	// favorites
	//   etc).
...
// summary of import result. The UserEventImportSummary summarizes
...
type GoogleCloudRecommendationengineV1beta1UserInfo struct {
	...
	// in which case the user_agent and ip_address fields can be
	// populated
	// from the HTTP request. This should *not* be set when using the
	// javascript
	// pixel. This flag should be set only if the API request is made
	// directly
	// from the end user such as a mobile app (and not if a gateway or a
	// server is
	...
	// IPv4 (e.g. 104.133.9.80) or
	// IPv6 (e.g. 2001:0db8:85a3:0000:0000:8a2e:0370:7334). This should
	// *not* be
	// set when using the javascript pixel or if `direct_user_request` is
	// set.
...
// results to return. If unspecified, defaults
...
// received from a previous `ListCatalogs`
...
func (c *ProjectsLocationsCatalogsListCall) Do(opts ...googleapi.CallOption) (*GoogleCloudRecommendationengineV1beta1ListCatalogsResponse, error) {
	...
	//   "parameters": {
	//     "pageSize": {
	//       "description": "Optional. Maximum number of results to return. If unspecified, defaults\nto 50. Max allowed value is 1000.",
	//       "format": "int32",
	//       "location": "query",
	//       "type": "integer"
	//     },
	//     "pageToken": {
	//       "description": "Optional. A page token, received from a previous `ListCatalogs`\ncall. Provide this to retrieve the subsequent page.",
	//       "location": "query",
	//       "type": "string"
	//     },
	//     "parent": {
...
// fields in the provided 'recommendation_model' to
// update. If not set, will only update the catalog_item_level_config
// field.
...
func (c *ProjectsLocationsCatalogsPatchCall) Do(opts ...googleapi.CallOption) (*GoogleCloudRecommendationengineV1beta1Catalog, error) {
	...
	//     },
	//     "updateMask": {
	//       "description": "Optional. Indicates which fields in the provided 'recommendation_model' to\nupdate. If not set, will only update the catalog_item_level_config field.",
...
func (c *ProjectsLocationsCatalogsCatalogItemsCreateCall) Do(opts ...googleapi.CallOption) (*GoogleCloudRecommendationengineV1beta1CatalogItem, error) {
	...
	//   "parameters": {
	//     "parent": {
	//       "description": "Required. The parent catalog resource name, such as\n\"projects/*/locations/global/catalogs/default_catalog\".",
	//       "location": "path",
	//       "pattern": "^projects/[^/]+/locations/[^/]+/catalogs/[^/]+$",
	//       "required": true,
	//       "type": "string"
...
func (c *ProjectsLocationsCatalogsCatalogItemsDeleteCall) Do(opts ...googleapi.CallOption) (*GoogleProtobufEmpty, error) {
	...
	//   "parameters": {
	//     "name": {
	//       "description": "Required. Full resource name of catalog item, such as\n\"projects/*/locations/global/catalogs/default_catalog/catalogItems/some_catalog_item_id\".",
	//       "location": "path",
...
// method id "recommendationengine.projects.locations.catalogs.catalogItems.getGroupIdItems":

type ProjectsLocationsCatalogsCatalogItemsGetGroupIdItemsCall struct {
	s            *Service
	parent       string
	urlParams_   gensupport.URLParams
	ifNoneMatch_ string
...
// GetGroupIdItems: Method for getting the catalog items associated with
// item group id.
func (r *ProjectsLocationsCatalogsCatalogItemsService) GetGroupIdItems(parent string) *ProjectsLocationsCatalogsCatalogItemsGetGroupIdItemsCall {
	c := &ProjectsLocationsCatalogsCatalogItemsGetGroupIdItemsCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.parent = parent
	return c
}

// ItemGroupId sets the optional parameter "itemGroupId": Required.
// Catalog item identifier for prediction results.
func (c *ProjectsLocationsCatalogsCatalogItemsGetGroupIdItemsCall) ItemGroupId(itemGroupId string) *ProjectsLocationsCatalogsCatalogItemsGetGroupIdItemsCall {
	c.urlParams_.Set("itemGroupId", itemGroupId)
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *ProjectsLocationsCatalogsCatalogItemsGetGroupIdItemsCall) Fields(s ...googleapi.Field) *ProjectsLocationsCatalogsCatalogItemsGetGroupIdItemsCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// request. Use googleapi.IsNotModified to check whether the response
// error from Do is the result of In-None-Match.
func (c *ProjectsLocationsCatalogsCatalogItemsGetGroupIdItemsCall) IfNoneMatch(entityTag string) *ProjectsLocationsCatalogsCatalogItemsGetGroupIdItemsCall {
	c.ifNoneMatch_ = entityTag
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *ProjectsLocationsCatalogsCatalogItemsGetGroupIdItemsCall) Context(ctx context.Context) *ProjectsLocationsCatalogsCatalogItemsGetGroupIdItemsCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns an http.Header that can be modified by the caller to
// add HTTP headers to the request.
func (c *ProjectsLocationsCatalogsCatalogItemsGetGroupIdItemsCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *ProjectsLocationsCatalogsCatalogItemsGetGroupIdItemsCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1beta1/{+parent}/catalogItems:groupIdItems")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("GET", urls, body)
	if err != nil {
		return nil, err
...
// Do executes the "recommendationengine.projects.locations.catalogs.catalogItems.getGroupIdItems" call.
// Exactly one of
// *GoogleCloudRecommendationengineV1beta1GetCatalogItemsWithItemGroupIdR
...
// was returned.
func (c *ProjectsLocationsCatalogsCatalogItemsGetGroupIdItemsCall) Do(opts ...googleapi.CallOption) (*GoogleCloudRecommendationengineV1beta1GetCatalogItemsWithItemGroupIdResponse, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
	...
	ret := &GoogleCloudRecommendationengineV1beta1GetCatalogItemsWithItemGroupIdResponse{
		ServerResponse: googleapi.ServerResponse{
			Header:         res.Header,
			HTTPStatusCode: res.StatusCode,
		},
	...
	return ret, nil
	// {
	//   "description": "Method for getting the catalog items associated with item group id.",
	//   "flatPath": "v1beta1/projects/{projectsId}/locations/{locationsId}/catalogs/{catalogsId}/catalogItems:groupIdItems",
	//   "httpMethod": "GET",
	//   "id": "recommendationengine.projects.locations.catalogs.catalogItems.getGroupIdItems",
	//   "parameterOrder": [
	//     "parent"
	//   ],
	//   "parameters": {
	//     "itemGroupId": {
	//       "description": "Required. Catalog item identifier for prediction results.",
	//       "location": "query",
	//       "type": "string"
	//     },
	//     "parent": {
	//       "description": "Required. Parent resource name of group id item, such as\n\"projects/*/locations/global/catalogs/default_catalog\".",
	//       "location": "path",
	//       "pattern": "^projects/[^/]+/locations/[^/]+/catalogs/[^/]+$",
	//       "required": true,
	//       "type": "string"
...
// be
// synchronous. No partial updating supported. Non-existing items will
// be
// created.
//
// Operation.response is of type ImportResponse. Note that it
// is
...
// PageSize sets the optional parameter "pageSize": Maximum number of
// results to return per page. If zero, the
...
func (c *ProjectsLocationsCatalogsCatalogItemsListCall) Do(opts ...googleapi.CallOption) (*GoogleCloudRecommendationengineV1beta1ListCatalogItemsResponse, error) {
	...
	//     },
	//     "pageSize": {
	//       "description": "Optional. Maximum number of results to return per page. If zero, the\nservice will choose a reasonable default.",
	//       "format": "int32",
	//       "location": "query",
	//       "type": "integer"
	//     },
...
// UpdateMask sets the optional parameter "updateMask": Indicates which
// fields in the provided 'item' to update. If not
// set, will by default update all fields.
...
func (c *ProjectsLocationsCatalogsCatalogItemsPatchCall) Do(opts ...googleapi.CallOption) (*GoogleCloudRecommendationengineV1beta1CatalogItem, error) {
	...
	return ret, nil
	// {
	//   "description": "Updates a catalog item. Partial updating is supported. Non-existing\nitems will be created.",
	//   "flatPath": "v1beta1/projects/{projectsId}/locations/{locationsId}/catalogs/{catalogsId}/catalogItems/{catalogItemsId}",
	//   "httpMethod": "PATCH",
	...
	//     },
	//     "updateMask": {
	//       "description": "Optional. Indicates which fields in the provided 'item' to update. If not\nset, will by default update all fields.",
	//       "format": "google-fieldmask",
	//       "location": "query",
	//       "type": "string"
	//     }
...
// authentication,
// the API Key must be registered using
// the
...
func (c *ProjectsLocationsCatalogsEventStoresPlacementsPredictCall) Do(opts ...googleapi.CallOption) (*GoogleCloudRecommendationengineV1beta1PredictResponse, error) {
	...
	return ret, nil
	// {
	//   "description": "Makes a recommendation prediction. If using API Key based authentication,\nthe API Key must be registered using the\nPredictionApiKeyRegistry\nservice. [Learn more](/recommendations-ai/docs/setting-up#register-key).",
...
func (c *ProjectsLocationsCatalogsEventStoresPredictionApiKeyRegistrationsCreateCall) Do(opts ...googleapi.CallOption) (*GoogleCloudRecommendationengineV1beta1PredictionApiKeyRegistration, error) {
	...
	//   "parameters": {
	//     "parent": {
	//       "description": "Required. The parent resource path.\n\"projects/*/locations/global/catalogs/default_catalog/eventStores/default_event_store\".",
	//       "location": "path",
	//       "pattern": "^projects/[^/]+/locations/[^/]+/catalogs/[^/]+/eventStores/[^/]+$",
	//       "required": true,
	//       "type": "string"
...
func (c *ProjectsLocationsCatalogsEventStoresPredictionApiKeyRegistrationsDeleteCall) Do(opts ...googleapi.CallOption) (*GoogleProtobufEmpty, error) {
	...
	//   "parameters": {
	//     "name": {
	//       "description": "Required. The API key to unregister including full resource path.\n\"projects/*/locations/global/catalogs/default_catalog/eventStores/default_event_store/predictionApiKeyRegistrations/\u003cYOUR_API_KEY\u003e\"",
	//       "location": "path",
...
// PageSize sets the optional parameter "pageSize": Maximum number of
// results to return per page. If unset, the
// service will choose a reasonable default.
...
func (c *ProjectsLocationsCatalogsEventStoresPredictionApiKeyRegistrationsListCall) Do(opts ...googleapi.CallOption) (*GoogleCloudRecommendationengineV1beta1ListPredictionApiKeyRegistrationsResponse, error) {
	...
	//   "parameters": {
	//     "pageSize": {
	//       "description": "Optional. Maximum number of results to return per page. If unset, the\nservice will choose a reasonable default.",
	//       "format": "int32",
	//       "location": "query",
	//       "type": "integer"
	//     },
	...
	//     },
	//     "parent": {
	//       "description": "Required. The parent placement resource name such as\n\"projects/1234/locations/global/catalogs/default_catalog/eventStores/default_event_store\"",
	//       "location": "path",
	//       "pattern": "^projects/[^/]+/locations/[^/]+/catalogs/[^/]+/eventStores/[^/]+$",
	//       "required": true,
	//       "type": "string"
...
//
// This method is used only by the Recommendations AI JavaScript
// pixel.
...
// otherwise identical get requests. The name is abbreviated to reduce
// the
// payload bytes.
...
// cgi-parameters but excluding the hash fragment. The URL
// must be truncated to 1.5K bytes to conservatively be under the 2K
// bytes.
// This is often more useful than the referer url, because many browsers
// only
...
func (c *ProjectsLocationsCatalogsEventStoresUserEventsCollectCall) Do(opts ...googleapi.CallOption) (*GoogleApiHttpBody, error) {
	...
	return ret, nil
	// {
	//   "description": "Writes a single user event from the browser. This uses a GET request to\ndue to browser restriction of POST-ing to a 3rd party domain.\n\nThis method is used only by the Recommendations AI JavaScript pixel.\nUsers should not call this method directly.",
	...
	//   "parameters": {
	//     "ets": {
	//       "description": "Optional. The event timestamp in milliseconds. This prevents browser caching of\notherwise identical get requests. The name is abbreviated to reduce the\npayload bytes.",
	//       "format": "int64",
	//       "location": "query",
	//       "type": "string"
	//     },
	//     "parent": {
	//       "description": "Required. The parent eventStore name, such as\n\"projects/1234/locations/global/catalogs/default_catalog/eventStores/default_event_store\".",
	//       "location": "path",
	//       "pattern": "^projects/[^/]+/locations/[^/]+/catalogs/[^/]+/eventStores/[^/]+$",
	//       "required": true,
	//       "type": "string"
...
// Import: Bulk import of User events. Request processing might
// be
// synchronous. Events that already exist are skipped.
// Use this method for backfilling historical user
// events.
//
// Operation.response is of type ImportResponse. Note that it
// is
// possible for a subset of the items to be successfully
// inserted.
...
//
// Unjoined user event definition: when a user event is ingested
// from
// Recommendations AI User Event APIs, the catalog item included in the
// user
// event is connected with the current catalog. If a catalog item of
// the
// ingested event is not in the current catalog, it could lead to
// degraded
...
// specify restrictions over
// returned events. This is a sequence of terms, where each term applies
// some
// kind of a restriction to the returned user events. Use this
// expression to
// restrict results to a specific time range, or filter events by
// eventType.
//    eg: eventTime > "2012-04-23T18:25:43.511Z"
// eventsMissingCatalogItems
//    eventTime<"2012-04-23T18:25:43.511Z" eventType=search
//
//   We expect only 3 types of fields:
//
//    * eventTime: this can be specified a maximum of 2 times, once with
// a
//      less than operator and once with a greater than operator. The
//      eventTime restrict should result in one contiguous valid
// eventTime
//      range.
//
//    * eventType: only 1 eventType restriction can be specified.
//
//    * eventsMissingCatalogItems: specififying this will restrict
// results
//      to events for which catalog items were not found in the catalog.
// The
//      default behavior is to return only those events for which
// catalog
//      items were found.
//
...
func (c *ProjectsLocationsCatalogsEventStoresUserEventsListCall) Do(opts ...googleapi.CallOption) (*GoogleCloudRecommendationengineV1beta1ListUserEventsResponse, error) {
	...
	//     },
	//     "parent": {
	//       "description": "Required. The parent eventStore resource name, such as\n\"projects/*/locations/*/catalogs/default_catalog/eventStores/default_event_store\".",
	//       "location": "path",
	//       "pattern": "^projects/[^/]+/locations/[^/]+/catalogs/[^/]+/eventStores/[^/]+$",
	//       "required": true,
	//       "type": "string"
...
// operation
// could take hours or days to complete. To test a filter, use the
// list
// command first.
...
func (c *ProjectsLocationsCatalogsEventStoresUserEventsPurgeCall) Do(opts ...googleapi.CallOption) (*GoogleLongrunningOperation, error) {
	...
	return ret, nil
	// {
	//   "description": "Deletes permanently all user events specified by the filter provided.\nDepending on the number of events specified by the filter, this operation\ncould take hours or days to complete. To test a filter, use the list\ncommand first.",
	...
	//   "parameters": {
	//     "parent": {
	//       "description": "Required. The resource name of the event_store under which the events are\ncreated. The format is\n\"projects/${projectId}/locations/global/catalogs/${catalogId}/eventStores/${eventStoreId}\"",
	//       "location": "path",
	//       "pattern": "^projects/[^/]+/locations/[^/]+/catalogs/[^/]+/eventStores/[^/]+$",
	//       "required": true,
	//       "type": "string"
...
// data. Events
// will not be annotated with detailed catalog information if catalog
// item is
// missing at the time the user event is ingested, and these events are
// stored
// as unjoined events with a limited usage on training and serving. This
// API
// can be used to trigger a 'join' operation on specified events with
// latest
// version of catalog items. It can also be used to correct events
// joined with
// wrong catalog items.
...
func (c *ProjectsLocationsCatalogsEventStoresUserEventsRejoinCall) Do(opts ...googleapi.CallOption) (*GoogleLongrunningOperation, error) {
	...
	//   "parameters": {
	//     "parent": {
	//       "description": "Required. Full resource name of user event, such as\n\"projects/*/locations/*/catalogs/default_catalog/eventStores/default_event_store\".",
	//       "location": "path",
	//       "pattern": "^projects/[^/]+/locations/[^/]+/catalogs/[^/]+/eventStores/[^/]+$",
	//       "required": true,
	//       "type": "string"
