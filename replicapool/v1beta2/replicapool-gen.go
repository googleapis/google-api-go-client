...
type InstanceGroupManagersAbandonInstancesCallDoer interface {
	Do() (*Operation, error)
	Fields(s ...googleapi.Field) InstanceGroupManagersAbandonInstancesCallDoer
}
...
type InstanceGroupManagersDeleteCallDoer interface {
	Do() (*Operation, error)
	Fields(s ...googleapi.Field) InstanceGroupManagersDeleteCallDoer
}
...
type InstanceGroupManagersDeleteInstancesCallDoer interface {
	Do() (*Operation, error)
	Fields(s ...googleapi.Field) InstanceGroupManagersDeleteInstancesCallDoer
}
...
type InstanceGroupManagersGetCallDoer interface {
	...
	Fields(s ...googleapi.Field) InstanceGroupManagersGetCallDoer
}
...
type InstanceGroupManagersInsertCallDoer interface {
	Do() (*Operation, error)
	Fields(s ...googleapi.Field) InstanceGroupManagersInsertCallDoer
}
...
type InstanceGroupManagersListCallDoer interface {
	...
	Filter(filter string) InstanceGroupManagersListCallDoer
	MaxResults(maxResults int64) InstanceGroupManagersListCallDoer
	PageToken(pageToken string) InstanceGroupManagersListCallDoer
	Fields(s ...googleapi.Field) InstanceGroupManagersListCallDoer
}
...
type InstanceGroupManagersRecreateInstancesCallDoer interface {
	Do() (*Operation, error)
	Fields(s ...googleapi.Field) InstanceGroupManagersRecreateInstancesCallDoer
}
...
type InstanceGroupManagersResizeCallDoer interface {
	Do() (*Operation, error)
	Fields(s ...googleapi.Field) InstanceGroupManagersResizeCallDoer
}
...
type InstanceGroupManagersSetInstanceTemplateCallDoer interface {
	Do() (*Operation, error)
	Fields(s ...googleapi.Field) InstanceGroupManagersSetInstanceTemplateCallDoer
}
...
type InstanceGroupManagersSetTargetPoolsCallDoer interface {
	Do() (*Operation, error)
	Fields(s ...googleapi.Field) InstanceGroupManagersSetTargetPoolsCallDoer
}
...
// InstanceGroupManagersServicer makes it easy to provide your own testable versions of InstanceGroupManagersService.
type InstanceGroupManagersServicer interface {
	AbandonInstances(project string, zone string, instanceGroupManager string, instancegroupmanagersabandoninstancesrequest *InstanceGroupManagersAbandonInstancesRequest) InstanceGroupManagersAbandonInstancesCallDoer
	Delete(project string, zone string, instanceGroupManager string) InstanceGroupManagersDeleteCallDoer
	DeleteInstances(project string, zone string, instanceGroupManager string, instancegroupmanagersdeleteinstancesrequest *InstanceGroupManagersDeleteInstancesRequest) InstanceGroupManagersDeleteInstancesCallDoer
	Get(project string, zone string, instanceGroupManager string) InstanceGroupManagersGetCallDoer
	Insert(project string, zone string, size int64, instancegroupmanager *InstanceGroupManager) InstanceGroupManagersInsertCallDoer
	List(project string, zone string) InstanceGroupManagersListCallDoer
	RecreateInstances(project string, zone string, instanceGroupManager string, instancegroupmanagersrecreateinstancesrequest *InstanceGroupManagersRecreateInstancesRequest) InstanceGroupManagersRecreateInstancesCallDoer
	Resize(project string, zone string, instanceGroupManager string, size int64) InstanceGroupManagersResizeCallDoer
	SetInstanceTemplate(project string, zone string, instanceGroupManager string, instancegroupmanagerssetinstancetemplaterequest *InstanceGroupManagersSetInstanceTemplateRequest) InstanceGroupManagersSetInstanceTemplateCallDoer
	SetTargetPools(project string, zone string, instanceGroupManager string, instancegroupmanagerssettargetpoolsrequest *InstanceGroupManagersSetTargetPoolsRequest) InstanceGroupManagersSetTargetPoolsCallDoer
}
...
type ZoneOperationsGetCallDoer interface {
	Do() (*Operation, error)
	Fields(s ...googleapi.Field) ZoneOperationsGetCallDoer
}
...
type ZoneOperationsListCallDoer interface {
	...
	Filter(filter string) ZoneOperationsListCallDoer
	MaxResults(maxResults int64) ZoneOperationsListCallDoer
	PageToken(pageToken string) ZoneOperationsListCallDoer
	Fields(s ...googleapi.Field) ZoneOperationsListCallDoer
}
