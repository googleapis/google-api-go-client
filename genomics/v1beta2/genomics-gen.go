...
type AnnotationSetsServicer interface {
	Create(annotationset *AnnotationSet) *AnnotationSetsCreateCall
	Delete(annotationSetId string) *AnnotationSetsDeleteCall
	Get(annotationSetId string) *AnnotationSetsGetCall
	Patch(annotationSetId string, annotationset *AnnotationSet) *AnnotationSetsPatchCall
	Search(searchannotationsetsrequest *SearchAnnotationSetsRequest) *AnnotationSetsSearchCall
	Update(annotationSetId string, annotationset *AnnotationSet) *AnnotationSetsUpdateCall
}
...
type AnnotationsServicer interface {
	BatchCreate(batchcreateannotationsrequest *BatchCreateAnnotationsRequest) *AnnotationsBatchCreateCall
	Create(annotation *Annotation) *AnnotationsCreateCall
	Delete(annotationId string) *AnnotationsDeleteCall
	Get(annotationId string) *AnnotationsGetCall
	Patch(annotationId string, annotation *Annotation) *AnnotationsPatchCall
	Search(searchannotationsrequest *SearchAnnotationsRequest) *AnnotationsSearchCall
	Update(annotationId string, annotation *Annotation) *AnnotationsUpdateCall
}
...
type CallsetsServicer interface {
	Create(callset *CallSet) *CallsetsCreateCall
	Delete(callSetId string) *CallsetsDeleteCall
	Get(callSetId string) *CallsetsGetCall
	Patch(callSetId string, callset *CallSet) *CallsetsPatchCall
	Search(searchcallsetsrequest *SearchCallSetsRequest) *CallsetsSearchCall
	Update(callSetId string, callset *CallSet) *CallsetsUpdateCall
}
...
type DatasetsServicer interface {
	Create(dataset *Dataset) *DatasetsCreateCall
	Delete(datasetId string) *DatasetsDeleteCall
	Get(datasetId string) *DatasetsGetCall
	List() *DatasetsListCall
	Patch(datasetId string, dataset *Dataset) *DatasetsPatchCall
	Undelete(datasetId string) *DatasetsUndeleteCall
	Update(datasetId string, dataset *Dataset) *DatasetsUpdateCall
}
...
type JobsServicer interface {
	Cancel(jobId string) *JobsCancelCall
	Get(jobId string) *JobsGetCall
	Search(searchjobsrequest *SearchJobsRequest) *JobsSearchCall
}
...
type ReadgroupsetsServicer interface {
	Align(alignreadgroupsetsrequest *AlignReadGroupSetsRequest) *ReadgroupsetsAlignCall
	Call(callreadgroupsetsrequest *CallReadGroupSetsRequest) *ReadgroupsetsCallCall
	Delete(readGroupSetId string) *ReadgroupsetsDeleteCall
	Export(exportreadgroupsetsrequest *ExportReadGroupSetsRequest) *ReadgroupsetsExportCall
	Get(readGroupSetId string) *ReadgroupsetsGetCall
	Import(importreadgroupsetsrequest *ImportReadGroupSetsRequest) *ReadgroupsetsImportCall
	Patch(readGroupSetId string, readgroupset *ReadGroupSet) *ReadgroupsetsPatchCall
	Search(searchreadgroupsetsrequest *SearchReadGroupSetsRequest) *ReadgroupsetsSearchCall
	Update(readGroupSetId string, readgroupset *ReadGroupSet) *ReadgroupsetsUpdateCall
}
...
type ReadsServicer interface {
	Search(searchreadsrequest *SearchReadsRequest) *ReadsSearchCall
}
...
type ReferencesServicer interface {
	Get(referenceId string) *ReferencesGetCall
	Search(searchreferencesrequest *SearchReferencesRequest) *ReferencesSearchCall
}
...
type ReferencesetsServicer interface {
	Get(referenceSetId string) *ReferencesetsGetCall
	Search(searchreferencesetsrequest *SearchReferenceSetsRequest) *ReferencesetsSearchCall
}
...
type VariantsServicer interface {
	Create(variant *Variant) *VariantsCreateCall
	Delete(variantId string) *VariantsDeleteCall
	Get(variantId string) *VariantsGetCall
	Search(searchvariantsrequest *SearchVariantsRequest) *VariantsSearchCall
	Update(variantId string, variant *Variant) *VariantsUpdateCall
}
...
type VariantsetsServicer interface {
	Delete(variantSetId string) *VariantsetsDeleteCall
	Export(variantSetId string, exportvariantsetrequest *ExportVariantSetRequest) *VariantsetsExportCall
	Get(variantSetId string) *VariantsetsGetCall
	ImportVariants(variantSetId string, importvariantsrequest *ImportVariantsRequest) *VariantsetsImportVariantsCall
	MergeVariants(variantSetId string, mergevariantsrequest *MergeVariantsRequest) *VariantsetsMergeVariantsCall
	Patch(variantSetId string, variantset *VariantSet) *VariantsetsPatchCall
	Search(searchvariantsetsrequest *SearchVariantSetsRequest) *VariantsetsSearchCall
	Update(variantSetId string, variantset *VariantSet) *VariantsetsUpdateCall
}
