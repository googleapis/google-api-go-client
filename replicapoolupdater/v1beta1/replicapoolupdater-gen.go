...
func (c *RollingUpdatesCancelCall) DoHeader() (http.Header, *Operation, error) {
...
func (c *RollingUpdatesGetCall) DoHeader() (http.Header, *RollingUpdate, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *RollingUpdatesInsertCall) DoHeader() (http.Header, *Operation, error) {
	var body io.Reader = nil
...
func (c *RollingUpdatesListCall) DoHeader() (http.Header, *RollingUpdateList, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *RollingUpdatesListInstanceUpdatesCall) DoHeader() (http.Header, *InstanceUpdateList, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["filter"]; ok {
...
func (c *RollingUpdatesPauseCall) DoHeader() (http.Header, *Operation, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *RollingUpdatesResumeCall) DoHeader() (http.Header, *Operation, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *RollingUpdatesRollbackCall) DoHeader() (http.Header, *Operation, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
