...
func (c *AboutGetCall) doRequest(alt string) (*http.Response, error) {
	...
	urls := googleapi.ResolveRelative(c.s.BasePath, "drive/v3/about")
...
func (c *ChangesGetStartPageTokenCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "drive/v3/changes/startPageToken")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("GET", urls, body)
	if err != nil {
		return nil, err
...
func (c *ChangesGetStartPageTokenCall) Do(opts ...googleapi.CallOption) (*StartPageToken, error) {
	...
	//   "flatPath": "drive/v3/changes/startPageToken",
	//   "httpMethod": "GET",
...
func (c *ChangesListCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "drive/v3/changes")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("GET", urls, body)
	if err != nil {
		return nil, err
...
func (c *ChangesWatchCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "drive/v3/changes/watch")
	urls += "?" + c.urlParams_.Encode()
...
func (c *ChangesWatchCall) Do(opts ...googleapi.CallOption) (*Channel, error) {
	...
	//   "flatPath": "drive/v3/changes/watch",
	//   "httpMethod": "POST",
...
func (c *ChannelsStopCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "drive/v3/channels/stop")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
func (c *ChannelsStopCall) Do(opts ...googleapi.CallOption) error {
	...
	//   "flatPath": "drive/v3/channels/stop",
	//   "httpMethod": "POST",
...
func (c *CommentsCreateCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "drive/v3/files/{fileId}/comments")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
func (c *CommentsCreateCall) Do(opts ...googleapi.CallOption) (*Comment, error) {
	...
	//   "flatPath": "drive/v3/files/{fileId}/comments",
	//   "httpMethod": "POST",
...
func (c *CommentsDeleteCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "drive/v3/files/{fileId}/comments/{commentId}")
	urls += "?" + c.urlParams_.Encode()
...
func (c *CommentsDeleteCall) Do(opts ...googleapi.CallOption) error {
	...
	//   "flatPath": "drive/v3/files/{fileId}/comments/{commentId}",
	//   "httpMethod": "DELETE",
...
func (c *DrivesCreateCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "drive/v3/drives")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
func (c *DrivesDeleteCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "drive/v3/drives/{driveId}")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("DELETE", urls, body)
	if err != nil {
		return nil, err
...
func (c *DrivesDeleteCall) Do(opts ...googleapi.CallOption) error {
	...
	//   "flatPath": "drive/v3/drives/{driveId}",
	//   "httpMethod": "DELETE",
...
func (c *DrivesHideCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "drive/v3/drives/{driveId}/hide")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
func (c *DrivesHideCall) Do(opts ...googleapi.CallOption) (*Drive, error) {
	...
	//   "flatPath": "drive/v3/drives/{driveId}/hide",
	//   "httpMethod": "POST",
	...
	//     }
	//   },
	//   "path": "drive/v3/drives/{driveId}/hide",
	//   "response": {
	//     "$ref": "Drive"
	//   },
	//   "scopes": [
...
func (c *DrivesUnhideCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "drive/v3/drives/{driveId}/unhide")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
func (c *DrivesUnhideCall) Do(opts ...googleapi.CallOption) (*Drive, error) {
	...
	//   "flatPath": "drive/v3/drives/{driveId}/unhide",
	//   "httpMethod": "POST",
	...
	//     }
	//   },
	//   "path": "drive/v3/drives/{driveId}/unhide",
	//   "response": {
	//     "$ref": "Drive"
	//   },
	//   "scopes": [
...
func (c *FilesCopyCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "drive/v3/files/{fileId}/copy")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
func (c *FilesCopyCall) Do(opts ...googleapi.CallOption) (*File, error) {
	...
	//   "flatPath": "drive/v3/files/{fileId}/copy",
	//   "httpMethod": "POST",
	//   "id": "drive.files.copy",
	//   "parameterOrder": [
	//     "fileId"
...
// *Maximum file size:* 5120GB - *Accepted Media MIME types:*`*/*` Note:
// Specify a valid MIME type, rather than the literal `*/*` value. The
// literal `*/*` is only used to indicate that any valid MIME type can
// be uploaded. For further information on uploading files, refer to
// Upload files (/drive/api/guides/manage-uploads). Apps creating
...
// missing, Google Drive attempts to determine the extension based on
...
func (c *FilesCreateCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "drive/v3/files")
	if c.mediaInfo_ != nil {
...
func (c *FilesDeleteCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "drive/v3/files/{fileId}")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("DELETE", urls, body)
	if err != nil {
		return nil, err
...
func (c *FilesDeleteCall) Do(opts ...googleapi.CallOption) error {
	...
	//   "flatPath": "drive/v3/files/{fileId}",
	//   "httpMethod": "DELETE",
...
func (c *FilesEmptyTrashCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "drive/v3/files/trash")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("DELETE", urls, body)
	if err != nil {
		return nil, err
...
func (c *FilesExportCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "drive/v3/files/{fileId}/export")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("GET", urls, body)
	if err != nil {
		return nil, err
...
func (c *FilesExportCall) Do(opts ...googleapi.CallOption) error {
	...
	//   "flatPath": "drive/v3/files/{fileId}/export",
	//   "httpMethod": "GET",
...
func (c *FilesGenerateIdsCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "drive/v3/files/generateIds")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("GET", urls, body)
	if err != nil {
		return nil, err
...
func (c *FilesGenerateIdsCall) Do(opts ...googleapi.CallOption) (*GeneratedIds, error) {
	...
	//   "flatPath": "drive/v3/files/generateIds",
	//   "httpMethod": "GET",
...
// instead. For further information on downloading files, refer to
// Download files (/drive/api/guides/manage-downloads).
//
// - fileId: The ID of the file.
...
// information, see the Search for files
...
// parameter to filter trashed files from the results.
...
func (c *FilesListLabelsCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "drive/v3/files/{fileId}/listLabels")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("GET", urls, body)
	if err != nil {
		return nil, err
...
func (c *FilesListLabelsCall) Do(opts ...googleapi.CallOption) (*LabelList, error) {
	...
	//   "flatPath": "drive/v3/files/{fileId}/listLabels",
	//   "httpMethod": "GET",
	...
	//     }
	//   },
	//   "path": "drive/v3/files/{fileId}/listLabels",
	//   "response": {
	//     "$ref": "LabelList"
	//   },
	//   "scopes": [
...
func (c *FilesModifyLabelsCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "drive/v3/files/{fileId}/modifyLabels")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
func (c *FilesModifyLabelsCall) Do(opts ...googleapi.CallOption) (*ModifyLabelsResponse, error) {
	...
	//   "flatPath": "drive/v3/files/{fileId}/modifyLabels",
	//   "httpMethod": "POST",
	...
	//     }
	//   },
	//   "path": "drive/v3/files/{fileId}/modifyLabels",
	//   "request": {
...
// following characteristics: - *Maximum file size:* 5120GB - *Accepted
// Media MIME types:*`*/*` Note: Specify a valid MIME type, rather than
// the literal `*/*` value. The literal `*/*` is only used to indicate
// that any valid MIME type can be uploaded. For further information on
// uploading files, refer to Upload files
...
func (c *FilesWatchCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "drive/v3/files/{fileId}/watch")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
func (c *FilesWatchCall) Do(opts ...googleapi.CallOption) (*Channel, error) {
	...
	//   "flatPath": "drive/v3/files/{fileId}/watch",
	//   "httpMethod": "POST",
...
func (c *PermissionsCreateCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "drive/v3/files/{fileId}/permissions")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
func (c *PermissionsCreateCall) Do(opts ...googleapi.CallOption) (*Permission, error) {
	...
	//   "flatPath": "drive/v3/files/{fileId}/permissions",
	//   "httpMethod": "POST",
...
func (c *PermissionsDeleteCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "drive/v3/files/{fileId}/permissions/{permissionId}")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("DELETE", urls, body)
	if err != nil {
		return nil, err
...
func (c *PermissionsDeleteCall) Do(opts ...googleapi.CallOption) error {
	...
	//   "flatPath": "drive/v3/files/{fileId}/permissions/{permissionId}",
	//   "httpMethod": "DELETE",
...
func (c *RepliesCreateCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "drive/v3/files/{fileId}/comments/{commentId}/replies")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
func (c *RepliesCreateCall) Do(opts ...googleapi.CallOption) (*Reply, error) {
	...
	//   "flatPath": "drive/v3/files/{fileId}/comments/{commentId}/replies",
	//   "httpMethod": "POST",
...
func (c *RepliesDeleteCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "drive/v3/files/{fileId}/comments/{commentId}/replies/{replyId}")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("DELETE", urls, body)
	if err != nil {
		return nil, err
...
func (c *RepliesDeleteCall) Do(opts ...googleapi.CallOption) error {
	...
	//   "flatPath": "drive/v3/files/{fileId}/comments/{commentId}/replies/{replyId}",
	//   "httpMethod": "DELETE",
...
func (c *RevisionsDeleteCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "drive/v3/files/{fileId}/revisions/{revisionId}")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("DELETE", urls, body)
	if err != nil {
		return nil, err
...
func (c *RevisionsDeleteCall) Do(opts ...googleapi.CallOption) error {
	...
	//   "flatPath": "drive/v3/files/{fileId}/revisions/{revisionId}",
	//   "httpMethod": "DELETE",
...
func (c *RevisionsListCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "drive/v3/files/{fileId}/revisions")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("GET", urls, body)
	if err != nil {
		return nil, err
...
func (c *RevisionsListCall) Do(opts ...googleapi.CallOption) (*RevisionList, error) {
	...
	//   "flatPath": "drive/v3/files/{fileId}/revisions",
	//   "httpMethod": "GET",
...
func (c *TeamdrivesCreateCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "drive/v3/teamdrives")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("POST", urls, body)
	if err != nil {
		return nil, err
...
func (c *TeamdrivesDeleteCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "drive/v3/teamdrives/{teamDriveId}")
	urls += "?" + c.urlParams_.Encode()
	req, err := http.NewRequest("DELETE", urls, body)
	if err != nil {
		return nil, err
...
func (c *TeamdrivesDeleteCall) Do(opts ...googleapi.CallOption) error {
	...
	//   "flatPath": "drive/v3/teamdrives/{teamDriveId}",
	//   "httpMethod": "DELETE",
