...
type MenuItem struct {
	...
	// timeline item.
	// - VIEW_WEBSITE - Open the payload of the menu item in
	// the browser.
	...
	// MenuItem's action. When the action is VIEW_WEBSITE, the payload is
...
type TimelineItem struct {
	...
	// HtmlPages: This field is deprecated, use the html property with
	// pagination instead.
