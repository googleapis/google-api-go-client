...
func (c *PagespeedapiRunpagespeedCall) IfNoneMatch(ifNoneMatch string) *PagespeedapiRunpagespeedCall {
...
func (c *PagespeedapiRunpagespeedCall) DoHeader() (*Result, http.Header, error) {
