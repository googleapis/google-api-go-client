...
func checkMarshalJSON(t *testing.T, tc testCase) {
	doCheckMarshalJSON(t, tc.s, tc.forceSendFields, tc.want)
	if len(tc.forceSendFields) == 0 {
...
func doCheckMarshalJSON(t *testing.T, s interface{}, forceSendFields []string, wantJSON string) {
