...
// ComputeFlightEmissions: Retrieves emission estimates. Details on how
// emission estimates are computed are in GitHub
// (https://github.com/google/travel-impact-model). The response will contain
// all entries that match the input flight legs, in the same order. If there
// are no estimates available for a certain flight leg, the response will
// return the flight leg object with empty emission fields. The request will
...
// ComputeScope3FlightEmissions: Retrieves GHG emissions estimates for a set of
// flight segments for Scope 3 reporting. The response will contain all entries
// that match the input Scope3FlightSegment flight segments, in the same order
