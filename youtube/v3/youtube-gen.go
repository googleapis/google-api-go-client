...
type ActivitiesServicer interface {
	Insert(part string, activity *Activity) *ActivitiesInsertCall
	List(part string) *ActivitiesListCall
}
...
type CaptionsServicer interface {
	Delete(id string) *CaptionsDeleteCall
	Download(id string) *CaptionsDownloadCall
	Insert(part string, caption *Caption) *CaptionsInsertCall
	List(part string, videoId string) *CaptionsListCall
	Update(part string, caption *Caption) *CaptionsUpdateCall
}
...
type ChannelBannersServicer interface {
	Insert(channelbannerresource *ChannelBannerResource) *ChannelBannersInsertCall
}
...
type ChannelSectionsServicer interface {
	Delete(id string) *ChannelSectionsDeleteCall
	Insert(part string, channelsection *ChannelSection) *ChannelSectionsInsertCall
	List(part string) *ChannelSectionsListCall
	Update(part string, channelsection *ChannelSection) *ChannelSectionsUpdateCall
}
...
type ChannelsServicer interface {
	List(part string) *ChannelsListCall
	Update(part string, channel *Channel) *ChannelsUpdateCall
}
...
type CommentThreadsServicer interface {
	Insert(part string, commentthread *CommentThread) *CommentThreadsInsertCall
	List(part string) *CommentThreadsListCall
	Update(part string, commentthread *CommentThread) *CommentThreadsUpdateCall
}
...
type CommentsServicer interface {
	Delete(id string) *CommentsDeleteCall
	Insert(part string, comment *Comment) *CommentsInsertCall
	List(part string) *CommentsListCall
	MarkAsSpam(id string) *CommentsMarkAsSpamCall
	SetModerationStatus(id string, moderationStatus string) *CommentsSetModerationStatusCall
	Update(part string, comment *Comment) *CommentsUpdateCall
}
...
type GuideCategoriesServicer interface {
	List(part string) *GuideCategoriesListCall
}
...
type I18nLanguagesServicer interface {
	List(part string) *I18nLanguagesListCall
}
...
type I18nRegionsServicer interface {
	List(part string) *I18nRegionsListCall
}
...
type LiveBroadcastsServicer interface {
	Bind(id string, part string) *LiveBroadcastsBindCall
	Control(id string, part string) *LiveBroadcastsControlCall
	Delete(id string) *LiveBroadcastsDeleteCall
	Insert(part string, livebroadcast *LiveBroadcast) *LiveBroadcastsInsertCall
	List(part string) *LiveBroadcastsListCall
	Transition(broadcastStatus string, id string, part string) *LiveBroadcastsTransitionCall
	Update(part string, livebroadcast *LiveBroadcast) *LiveBroadcastsUpdateCall
}
...
type LiveStreamsServicer interface {
	Delete(id string) *LiveStreamsDeleteCall
	Insert(part string, livestream *LiveStream) *LiveStreamsInsertCall
	List(part string) *LiveStreamsListCall
	Update(part string, livestream *LiveStream) *LiveStreamsUpdateCall
}
...
type PlaylistItemsServicer interface {
	Delete(id string) *PlaylistItemsDeleteCall
	Insert(part string, playlistitem *PlaylistItem) *PlaylistItemsInsertCall
	List(part string) *PlaylistItemsListCall
	Update(part string, playlistitem *PlaylistItem) *PlaylistItemsUpdateCall
}
...
type PlaylistsServicer interface {
	Delete(id string) *PlaylistsDeleteCall
	Insert(part string, playlist *Playlist) *PlaylistsInsertCall
	List(part string) *PlaylistsListCall
	Update(part string, playlist *Playlist) *PlaylistsUpdateCall
}
...
type SearchServicer interface {
	List(part string) *SearchListCall
}
...
type SubscriptionsServicer interface {
	...
	Insert(part string, subscription *Subscription) *SubscriptionsInsertCall
...
type ThumbnailsServicer interface {
	Set(videoId string) *ThumbnailsSetCall
}
...
type VideoAbuseReportReasonsServicer interface {
	List(part string) *VideoAbuseReportReasonsListCall
}
...
type VideoCategoriesServicer interface {
	List(part string) *VideoCategoriesListCall
}
...
type VideosServicer interface {
	Delete(id string) *VideosDeleteCall
	GetRating(id string) *VideosGetRatingCall
	Insert(part string, video *Video) *VideosInsertCall
	List(part string) *VideosListCall
	Rate(id string, rating string) *VideosRateCall
	ReportAbuse(videoabusereport *VideoAbuseReport) *VideosReportAbuseCall
	Update(part string, video *Video) *VideosUpdateCall
}
...
type WatermarksServicer interface {
	Set(channelId string, invideobranding *InvideoBranding) *WatermarksSetCall
	Unset(channelId string) *WatermarksUnsetCall
}
