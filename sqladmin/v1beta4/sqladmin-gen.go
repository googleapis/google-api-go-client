...
// is cancelled.
func (c *BackupRunsDeleteCall) Ctx(ctx context.Context) *BackupRunsDeleteCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *DatabasesDeleteCall) Ctx(ctx context.Context) *DatabasesDeleteCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *DatabasesGetCall) Ctx(ctx context.Context) *DatabasesGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *DatabasesInsertCall) Ctx(ctx context.Context) *DatabasesInsertCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *DatabasesListCall) Ctx(ctx context.Context) *DatabasesListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *DatabasesPatchCall) Ctx(ctx context.Context) *DatabasesPatchCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *DatabasesUpdateCall) Ctx(ctx context.Context) *DatabasesUpdateCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *InstancesStartReplicaCall) Ctx(ctx context.Context) *InstancesStartReplicaCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *InstancesStopReplicaCall) Ctx(ctx context.Context) *InstancesStopReplicaCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *SslCertsCreateEphemeralCall) Ctx(ctx context.Context) *SslCertsCreateEphemeralCall {
	c.ctx_ = ctx
	return c
}
