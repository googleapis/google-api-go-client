...
// Choose to use either Media or ResumableMedia, but not both.
// mediaType identifies the MIME media type of the upload (e.g. "image/png").
func (c *ObjectsInsertCall) ResumableMedia(ctx context.Context, r googleapi.SizeReaderAt, mediaType string) *ObjectsInsertCall {
	c.ctx_ = ctx
	c.resumable_ = r
