...
const basePathTemplate = "https://www.UNIVERSE_DOMAIN/pagespeedonline/v4/"
...
type PagespeedApiFormatStringV4 struct {
	...
	// Format: A localized format string with {{FOO}} placeholders, where 'FOO' is
...
type PagespeedApiFormatStringV4Args struct {
	...
	// Rects: The screen rectangles being referred to, with dimensions measured in
	// CSS pixels. This is only ever used for SNAPSHOT_RECT arguments. If this is
	...
	// dimensions measured in CSS pixels. This is only ever used for SNAPSHOT_RECT
	// arguments.
	SecondaryRects []*PagespeedApiFormatStringV4ArgsSecondaryRects `json:"secondary_rects,omitempty"`
	// Type: Type of argument. One of URL, STRING_LITERAL, INT_LITERAL, BYTES,
...
type PagespeedApiPagespeedResponseV4 struct {
	...
	// Snapshots: Additional base64-encoded screenshots of the page, in various
...
// results. Contains a ruleResults entry for each PageSpeed rule instantiated
...
// PagespeedApiPagespeedResponseV4FormattedResultsRuleResults: The enum-like
// identifier for this rule. For instance "EnableKeepAlive" or
// "AvoidCssImport". Not localized.
type PagespeedApiPagespeedResponseV4FormattedResultsRuleResults struct {
	// Beta: Whether this rule is in 'beta'. Rules in beta are new rules that are
	// being tested, which do not impact the overall score.
	Beta bool `json:"beta,omitempty"`
	// Groups: List of rule groups that this rule belongs to. Each entry in the
	// list is one of "SPEED", "USABILITY", or "SECURITY".
	...
	// Summary: A brief summary description for the rule, indicating at a high
	// level what should be done to follow the rule and what benefit can be gained
	// by doing so.
	...
	// ForceSendFields is a list of field names (e.g. "Beta") to unconditionally
	// include in API requests. By default, fields with empty or default values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "Beta") to include in API requests
	// with the JSON null value. By default, fields with empty values are omitted
	// from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// PagespeedApiPagespeedResponseV4LoadingExperience: Metrics of end users' page
// loading experience.
...
// PagespeedApiPagespeedResponseV4LoadingExperienceMetrics: The type of the
// metric.
...
// PagespeedApiPagespeedResponseV4PageStats: Summary statistics for the page,
// such as number of JavaScript bytes, number of HTML bytes, etc.
type PagespeedApiPagespeedResponseV4PageStats struct {
	...
	// NumRenderBlockingRoundTrips: The needed round trips to load render blocking
	// resources
	...
	// NumberTransientFetchFailureResources: Number of transient-failed resources.
	...
	// OverTheWireResponseBytes: Number of over-the-wire bytes, uses the default
	// gzip compression strategy as an estimation.
	...
	// ForceSendFields is a list of field names (e.g. "Cms") to unconditionally
	// include in API requests. By default, fields with empty or default values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "Cms") to include in API requests
	// with the JSON null value. By default, fields with empty values are omitted
	// from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// PagespeedApiPagespeedResponseV4RuleGroups: The name of this rule group: one
// of "SPEED", "USABILITY", or "SECURITY".
type PagespeedApiPagespeedResponseV4RuleGroups struct {
	Pass bool `json:"pass,omitempty"`
	// Score: The score (0-100) for this rule group, which indicates how much
	// better a page could be in that category (e.g. how much faster, or how much
	// more usable, or how much more secure). A high score indicates little room
	// for improvement, while a lower score indicates more room for improvement.
	Score int64 `json:"score,omitempty"`
	// ForceSendFields is a list of field names (e.g. "Pass") to unconditionally
	// include in API requests. By default, fields with empty or default values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "Pass") to include in API requests
	// with the JSON null value. By default, fields with empty values are omitted
	// from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// PagespeedApiPagespeedResponseV4Version: The version of PageSpeed used to
...
// Snapshots sets the optional parameter "snapshots": Indicates if binary data
// containing snapshot images should be included
...
// *PagespeedApiPagespeedResponseV4.ServerResponse.Header or (if a response was
