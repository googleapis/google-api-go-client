...
// GoogleAppsDriveLabelsV2betaField: Defines a field which has a display
...
// GoogleAppsDriveLabelsV2betaLabel: A Label defines a taxonomy which
// may be applied to a Drive items in order to organize and search
// across Items. Labels may be simple strings, or may contain Fields
// that describe additional metadata which can be further used to
...
// object, e.g. Label, Field, or Choice. The Lifecycle enforces the
