...
func (r *ColumnService) Delete(tableId string, columnId string) *ColumnDeleteCall {
	c := &ColumnDeleteCall{s: r.s, urlParams_: make(urlParams)}
	c.tableId = tableId
	c.columnId = columnId
	return c
}
...
func (r *ColumnService) Get(tableId string, columnId string) *ColumnGetCall {
	c := &ColumnGetCall{s: r.s, urlParams_: make(urlParams)}
	c.tableId = tableId
	c.columnId = columnId
	return c
}
...
func (r *ColumnService) Insert(tableId string, column *Column) *ColumnInsertCall {
	c := &ColumnInsertCall{s: r.s, urlParams_: make(urlParams)}
	c.tableId = tableId
	c.column = column
	return c
}
...
func (r *ColumnService) List(tableId string) *ColumnListCall {
	c := &ColumnListCall{s: r.s, urlParams_: make(urlParams)}
	c.tableId = tableId
	return c
}
...
func (r *ColumnService) Patch(tableId string, columnId string, column *Column) *ColumnPatchCall {
	c := &ColumnPatchCall{s: r.s, urlParams_: make(urlParams)}
	c.tableId = tableId
	c.columnId = columnId
	c.column = column
	return c
...
func (r *ColumnService) Update(tableId string, columnId string, column *Column) *ColumnUpdateCall {
	c := &ColumnUpdateCall{s: r.s, urlParams_: make(urlParams)}
	c.tableId = tableId
	c.columnId = columnId
	c.column = column
	return c
...
func (r *QueryService) Sql(sql string) *QuerySqlCall {
	c := &QuerySqlCall{s: r.s, urlParams_: make(urlParams)}
	c.sql = sql
	return c
}
...
func (c *QuerySqlCall) doRequest(alt string) (*http.Response, error) {
	var body io.Reader = nil
	c.urlParams_.set("alt", alt)
	c.urlParams_.set("sql", fmt.Sprintf("%v", c.sql))
...
func (r *QueryService) SqlGet(sql string) *QuerySqlGetCall {
	c := &QuerySqlGetCall{s: r.s, urlParams_: make(urlParams)}
	c.sql = sql
	return c
}
...
func (r *StyleService) Delete(tableId string, styleId int64) *StyleDeleteCall {
	c := &StyleDeleteCall{s: r.s, urlParams_: make(urlParams)}
	c.tableId = tableId
	c.styleId = styleId
	return c
}
...
func (r *StyleService) Get(tableId string, styleId int64) *StyleGetCall {
	c := &StyleGetCall{s: r.s, urlParams_: make(urlParams)}
	c.tableId = tableId
	c.styleId = styleId
	return c
}
...
func (r *StyleService) Insert(tableId string, stylesetting *StyleSetting) *StyleInsertCall {
	c := &StyleInsertCall{s: r.s, urlParams_: make(urlParams)}
	c.tableId = tableId
...
func (r *StyleService) List(tableId string) *StyleListCall {
	c := &StyleListCall{s: r.s, urlParams_: make(urlParams)}
	c.tableId = tableId
	return c
}
...
func (r *StyleService) Patch(tableId string, styleId int64, stylesetting *StyleSetting) *StylePatchCall {
	c := &StylePatchCall{s: r.s, urlParams_: make(urlParams)}
	c.tableId = tableId
	c.styleId = styleId
	c.stylesetting = stylesetting
	return c
...
func (r *StyleService) Update(tableId string, styleId int64, stylesetting *StyleSetting) *StyleUpdateCall {
	c := &StyleUpdateCall{s: r.s, urlParams_: make(urlParams)}
	c.tableId = tableId
	c.styleId = styleId
	c.stylesetting = stylesetting
	return c
...
func (r *TableService) Copy(tableId string) *TableCopyCall {
	c := &TableCopyCall{s: r.s, urlParams_: make(urlParams)}
	c.tableId = tableId
	return c
}
...
func (r *TableService) Delete(tableId string) *TableDeleteCall {
	c := &TableDeleteCall{s: r.s, urlParams_: make(urlParams)}
	c.tableId = tableId
	return c
}
...
func (r *TableService) Get(tableId string) *TableGetCall {
	c := &TableGetCall{s: r.s, urlParams_: make(urlParams)}
	c.tableId = tableId
	return c
}
...
func (r *TableService) ImportRows(tableId string) *TableImportRowsCall {
	c := &TableImportRowsCall{s: r.s, urlParams_: make(urlParams)}
	c.tableId = tableId
	return c
}
...
func (r *TableService) ImportTable(name string) *TableImportTableCall {
	c := &TableImportTableCall{s: r.s, urlParams_: make(urlParams)}
	c.name = name
	return c
}
...
func (c *TableImportTableCall) doRequest(alt string) (*http.Response, error) {
	var body io.Reader = nil
	c.urlParams_.set("alt", alt)
	c.urlParams_.set("name", fmt.Sprintf("%v", c.name))
...
func (r *TableService) Insert(table *Table) *TableInsertCall {
	c := &TableInsertCall{s: r.s, urlParams_: make(urlParams)}
	c.table = table
	return c
}
...
func (r *TableService) List() *TableListCall {
	c := &TableListCall{s: r.s, urlParams_: make(urlParams)}
	return c
}
...
func (r *TableService) Patch(tableId string, table *Table) *TablePatchCall {
	c := &TablePatchCall{s: r.s, urlParams_: make(urlParams)}
	c.tableId = tableId
	c.table = table
	return c
}
...
func (r *TableService) ReplaceRows(tableId string) *TableReplaceRowsCall {
	c := &TableReplaceRowsCall{s: r.s, urlParams_: make(urlParams)}
	c.tableId = tableId
	return c
}
...
func (r *TableService) Update(tableId string, table *Table) *TableUpdateCall {
	c := &TableUpdateCall{s: r.s, urlParams_: make(urlParams)}
	c.tableId = tableId
	c.table = table
	return c
}
...
func (r *TaskService) Delete(tableId string, taskId string) *TaskDeleteCall {
	c := &TaskDeleteCall{s: r.s, urlParams_: make(urlParams)}
	c.tableId = tableId
	c.taskId = taskId
	return c
}
...
func (r *TaskService) Get(tableId string, taskId string) *TaskGetCall {
	c := &TaskGetCall{s: r.s, urlParams_: make(urlParams)}
	c.tableId = tableId
	c.taskId = taskId
	return c
}
...
func (r *TaskService) List(tableId string) *TaskListCall {
	c := &TaskListCall{s: r.s, urlParams_: make(urlParams)}
	c.tableId = tableId
	return c
}
...
func (r *TemplateService) Delete(tableId string, templateId int64) *TemplateDeleteCall {
	c := &TemplateDeleteCall{s: r.s, urlParams_: make(urlParams)}
	c.tableId = tableId
...
func (r *TemplateService) Get(tableId string, templateId int64) *TemplateGetCall {
	c := &TemplateGetCall{s: r.s, urlParams_: make(urlParams)}
	c.tableId = tableId
	c.templateId = templateId
	return c
}
...
func (r *TemplateService) Insert(tableId string, template *Template) *TemplateInsertCall {
	c := &TemplateInsertCall{s: r.s, urlParams_: make(urlParams)}
	c.tableId = tableId
	c.template = template
	return c
}
...
func (r *TemplateService) List(tableId string) *TemplateListCall {
	c := &TemplateListCall{s: r.s, urlParams_: make(urlParams)}
	c.tableId = tableId
	return c
}
...
func (r *TemplateService) Patch(tableId string, templateId int64, template *Template) *TemplatePatchCall {
	c := &TemplatePatchCall{s: r.s, urlParams_: make(urlParams)}
	c.tableId = tableId
	c.templateId = templateId
	c.template = template
	return c
...
func (r *TemplateService) Update(tableId string, templateId int64, template *Template) *TemplateUpdateCall {
	c := &TemplateUpdateCall{s: r.s, urlParams_: make(urlParams)}
	c.tableId = tableId
	c.templateId = templateId
	c.template = template
	return c
