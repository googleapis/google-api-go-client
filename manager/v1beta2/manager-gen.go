...
type Deployment struct {
	...
	// deployment.
	Modules *DeploymentModules `json:"modules,omitempty"`
...
type ReplicaPoolModule struct {
	...
	EnvVariables *ReplicaPoolModuleEnvVariables `json:"envVariables,omitempty"`
...
type ReplicaPoolModuleEnvVariables struct {
}
