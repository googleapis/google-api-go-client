...
// is cancelled.
func (c *StatesClearCall) Ctx(ctx context.Context) {
	c.ctx_ = ctx
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *StatesDeleteCall) Ctx(ctx context.Context) {
	c.ctx_ = ctx
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *StatesGetCall) Ctx(ctx context.Context) {
	c.ctx_ = ctx
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *StatesListCall) Ctx(ctx context.Context) {
	c.ctx_ = ctx
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *StatesUpdateCall) Ctx(ctx context.Context) {
	c.ctx_ = ctx
}
