...
// is cancelled.
func (c *StatscollectionUpdateaggregatedstatsCall) Ctx(ctx context.Context) *StatscollectionUpdateaggregatedstatsCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *StatscollectionUpdatestatsCall) Ctx(ctx context.Context) *StatscollectionUpdatestatsCall {
	c.ctx_ = ctx
	return c
}
