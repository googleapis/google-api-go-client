...
type TransferConfig struct {
	...
	// The individual data source id can also be found in the bq tab in the
	// 'Setting up a data transfer' section for each data source. For
	// example, the data source id for Cloud Storage transfers is listed
	// here:
