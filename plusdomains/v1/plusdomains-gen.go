...
type ActivitiesServicer interface {
	...
	Insert(userId string, activity *Activity) *ActivitiesInsertCall
...
type AudiencesServicer interface {
	List(userId string) *AudiencesListCall
}
...
type CirclesServicer interface {
	AddPeople(circleId string) *CirclesAddPeopleCall
	Get(circleId string) *CirclesGetCall
	Insert(userId string, circle *Circle) *CirclesInsertCall
	List(userId string) *CirclesListCall
	Patch(circleId string, circle *Circle) *CirclesPatchCall
	Remove(circleId string) *CirclesRemoveCall
	RemovePeople(circleId string) *CirclesRemovePeopleCall
	Update(circleId string, circle *Circle) *CirclesUpdateCall
}
...
type CommentsServicer interface {
	...
	Insert(activityId string, comment *Comment) *CommentsInsertCall
...
type MediaServicer interface {
	Insert(userId string, collection string, media *Media) *MediaInsertCall
}
...
type PeopleServicer interface {
	...
	ListByCircle(circleId string) *PeopleListByCircleCall
}
