...
// "ifNoneMatch": Makes the operation conditional on whether
// the object's Etag does not match the given value.
func (c *AccountsMetadataDimensionsListCall) IfNoneMatch(ifNoneMatch string) *AccountsMetadataDimensionsListCall {
	c.opt_["ifNoneMatch"] = ifNoneMatch
	return c
}
...
func (c *AccountsMetadataDimensionsListCall) DoHeader() (http.Header, *Metadata, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
// "ifNoneMatch": Makes the operation conditional on whether
// the object's Etag does not match the given value.
func (c *AccountsMetadataMetricsListCall) IfNoneMatch(ifNoneMatch string) *AccountsMetadataMetricsListCall {
	c.opt_["ifNoneMatch"] = ifNoneMatch
	return c
}
...
func (c *AccountsMetadataMetricsListCall) DoHeader() (http.Header, *Metadata, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
// "ifNoneMatch": Makes the operation conditional on whether
// the object's Etag does not match the given value.
func (c *AccountsPreferreddealsGetCall) IfNoneMatch(ifNoneMatch string) *AccountsPreferreddealsGetCall {
	c.opt_["ifNoneMatch"] = ifNoneMatch
	return c
}
...
func (c *AccountsPreferreddealsGetCall) DoHeader() (http.Header, *PreferredDeal, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
// "ifNoneMatch": Makes the operation conditional on whether
// the object's Etag does not match the given value.
func (c *AccountsPreferreddealsListCall) IfNoneMatch(ifNoneMatch string) *AccountsPreferreddealsListCall {
	c.opt_["ifNoneMatch"] = ifNoneMatch
	return c
}
...
func (c *AccountsPreferreddealsListCall) DoHeader() (http.Header, *PreferredDeals, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *AccountsReportsGenerateCall) DoHeader() (http.Header, *Report, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *AccountsReportsSavedGenerateCall) DoHeader() (http.Header, *Report, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["locale"]; ok {
