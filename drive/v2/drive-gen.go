...
// Exactly one of *About,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *About, .ServerResponse.Header
...
// Exactly one of *App,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *App, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *AppList,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *AppList, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Change,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Change, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *ChangeList,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *ChangeList, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *ChildReference,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *ChildReference, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *ChildList,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *ChildList, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *CommentList,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *CommentList, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *File,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *File, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *GeneratedIds,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *GeneratedIds, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *FileList,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *FileList, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *ParentReference,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *ParentReference, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *ParentList,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *ParentList, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Permission,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Permission, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *PermissionId,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *PermissionId, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *PermissionList,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *PermissionList, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Property,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Property, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *PropertyList,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *PropertyList, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *CommentReply,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *CommentReply, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *CommentReplyList,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *CommentReplyList, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *Revision,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *Revision, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
...
// Exactly one of *RevisionList,  or error will be non-nil.
// Any non-2xx status code is an error.
// Response headers are in either *RevisionList, .ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// googleapi.IsNotModified can be called to check if http.StatusNotModified is returned.
