...
// DeleteOrganizationMetadata: LINT.IfChange A status object which is
// used as the `metadata` field for the operation returned by
// DeleteOrganization.
...
// UndeleteOrganizationMetadata: LINT.IfChange A status object which is
// used as the `metadata` field for the Operation returned by
