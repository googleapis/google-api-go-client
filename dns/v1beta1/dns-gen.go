...
// is cancelled.
func (c *ChangesCreateCall) Ctx(ctx context.Context) {
	c.ctx_ = ctx
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ManagedZonesCreateCall) Ctx(ctx context.Context) {
	c.ctx_ = ctx
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ManagedZonesDeleteCall) Ctx(ctx context.Context) {
	c.ctx_ = ctx
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ManagedZonesGetCall) Ctx(ctx context.Context) {
	c.ctx_ = ctx
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ManagedZonesListCall) Ctx(ctx context.Context) {
	c.ctx_ = ctx
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ResourceRecordSetsListCall) Ctx(ctx context.Context) {
	c.ctx_ = ctx
}
