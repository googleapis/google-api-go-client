...
type GoogleCloudContactcenterinsightsV1ConversationParticipant struct {
	// DialogflowParticipant: The name of the Dialogflow participant.
	// Format:
...
type GoogleCloudContactcenterinsightsV1IssueModelInputDataConfig struct {
	// Medium: Required. Medium of conversations used in training data.
	//
	// Possible values:
	//   "MEDIUM_UNSPECIFIED" - Default value.
	//   "PHONE_CALL" - The format for conversations that took place over
...
// of conversations to return in the response. If this value is zero,
