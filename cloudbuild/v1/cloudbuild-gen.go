...
type BuildTrigger struct {
	...
	// ServiceAccount: Optional. The service account used for all
	// user-controlled operations including UpdateBuildTrigger,
	// RunBuildTrigger, CreateBuild, and CancelBuild. If no service account
...
// Enterprise server. This API is experimental.
//
...
// List: List all GitHubEnterpriseConfigs for a given project. This API
// is experimental.
//
// - parent: Name of the parent project. For example:
//   projects/{$project_number} or projects/{$project_id}.
