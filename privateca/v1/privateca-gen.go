...
func NewProjectsLocationsService(s *Service) *ProjectsLocationsService {
	...
	rs.ManagedPkis = NewProjectsLocationsManagedPkisService(s)
...
type ProjectsLocationsService struct {
	...
	ManagedPkis *ProjectsLocationsManagedPkisService
...
func NewProjectsLocationsManagedPkisService(s *Service) *ProjectsLocationsManagedPkisService {
	rs := &ProjectsLocationsManagedPkisService{s: s}
	return rs
}

type ProjectsLocationsManagedPkisService struct {
	s *Service
}
...
// method id "privateca.projects.locations.managedPkis.getIamPolicy":

type ProjectsLocationsManagedPkisGetIamPolicyCall struct {
	s            *Service
	resource     string
	urlParams_   gensupport.URLParams
	ifNoneMatch_ string
...
//   requested. See the operation documentation for the appropriate
//   value for this field.
func (r *ProjectsLocationsManagedPkisService) GetIamPolicy(resource string) *ProjectsLocationsManagedPkisGetIamPolicyCall {
	c := &ProjectsLocationsManagedPkisGetIamPolicyCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.resource = resource
	return c
}
...
// documentation
// (https://cloud.google.com/iam/help/conditions/resource-policies).
func (c *ProjectsLocationsManagedPkisGetIamPolicyCall) OptionsRequestedPolicyVersion(optionsRequestedPolicyVersion int64) *ProjectsLocationsManagedPkisGetIamPolicyCall {
	c.urlParams_.Set("options.requestedPolicyVersion", fmt.Sprint(optionsRequestedPolicyVersion))
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *ProjectsLocationsManagedPkisGetIamPolicyCall) Fields(s ...googleapi.Field) *ProjectsLocationsManagedPkisGetIamPolicyCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// request. Use googleapi.IsNotModified to check whether the response
// error from Do is the result of In-None-Match.
func (c *ProjectsLocationsManagedPkisGetIamPolicyCall) IfNoneMatch(entityTag string) *ProjectsLocationsManagedPkisGetIamPolicyCall {
	c.ifNoneMatch_ = entityTag
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *ProjectsLocationsManagedPkisGetIamPolicyCall) Context(ctx context.Context) *ProjectsLocationsManagedPkisGetIamPolicyCall {
	c.ctx_ = ctx
	return c
}
...
// Header returns an http.Header that can be modified by the caller to
// add HTTP headers to the request.
func (c *ProjectsLocationsManagedPkisGetIamPolicyCall) Header() http.Header {
	if c.header_ == nil {
		c.header_ = make(http.Header)
	}
	return c.header_
...
func (c *ProjectsLocationsManagedPkisGetIamPolicyCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("x-goog-api-client", "gl-go/"+gensupport.GoVersion()+" gdcl/20220129")
	for k, v := range c.header_ {
		reqHeaders[k] = v
...
// Do executes the "privateca.projects.locations.managedPkis.getIamPolicy" call.
// Exactly one of *Policy or error will be non-nil. Any non-2xx status
// code is an error. Response headers are in either
// *Policy.ServerResponse.Header or (if a response was returned at all)
// in error.(*googleapi.Error).Header. Use googleapi.IsNotModified to
// check whether the returned error was because http.StatusNotModified
// was returned.
func (c *ProjectsLocationsManagedPkisGetIamPolicyCall) Do(opts ...googleapi.CallOption) (*Policy, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
