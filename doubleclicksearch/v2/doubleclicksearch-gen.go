...
func (c *ConversionGetCall) DoHeader() (http.Header, *ConversionList, error) {
...
func (c *ConversionInsertCall) DoHeader() (http.Header, *ConversionList, error) {
	var body io.Reader = nil
...
func (c *ConversionPatchCall) DoHeader() (http.Header, *ConversionList, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.conversionlist)
	if err != nil {
		return nil, nil, err
...
func (c *ConversionUpdateCall) DoHeader() (http.Header, *ConversionList, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.conversionlist)
	if err != nil {
		return nil, nil, err
...
func (c *ConversionUpdateAvailabilityCall) DoHeader() (http.Header, *UpdateAvailabilityResponse, error) {
	var body io.Reader = nil
...
func (c *ReportsRequestCall) DoHeader() (http.Header, *Report, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.reportrequest)
	if err != nil {
		return nil, nil, err
...
func (c *SavedColumnsListCall) DoHeader() (http.Header, *SavedColumnList, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
