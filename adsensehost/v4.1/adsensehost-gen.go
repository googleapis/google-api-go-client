...
func (c *AccountsAdclientsGetCall) DoHeader() (http.Header, *AdClient, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *AccountsAdunitsDeleteCall) DoHeader() (http.Header, *AdUnit, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *AccountsAdunitsInsertCall) DoHeader() (http.Header, *AdUnit, error) {
	var body io.Reader = nil
...
func (c *AccountsAdunitsPatchCall) DoHeader() (http.Header, *AdUnit, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.adunit)
	if err != nil {
		return nil, nil, err
...
func (c *AccountsAdunitsUpdateCall) DoHeader() (http.Header, *AdUnit, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.adunit)
	if err != nil {
		return nil, nil, err
...
func (c *AdclientsGetCall) DoHeader() (http.Header, *AdClient, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *AssociationsessionsStartCall) DoHeader() (http.Header, *AssociationSession, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *AssociationsessionsVerifyCall) DoHeader() (http.Header, *AssociationSession, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *CustomchannelsDeleteCall) DoHeader() (http.Header, *CustomChannel, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *CustomchannelsInsertCall) DoHeader() (http.Header, *CustomChannel, error) {
	var body io.Reader = nil
...
func (c *CustomchannelsPatchCall) DoHeader() (http.Header, *CustomChannel, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.customchannel)
	if err != nil {
		return nil, nil, err
...
func (c *CustomchannelsUpdateCall) DoHeader() (http.Header, *CustomChannel, error) {
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.customchannel)
	if err != nil {
		return nil, nil, err
...
func (c *UrlchannelsDeleteCall) DoHeader() (http.Header, *UrlChannel, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
func (c *UrlchannelsInsertCall) DoHeader() (http.Header, *UrlChannel, error) {
	var body io.Reader = nil
