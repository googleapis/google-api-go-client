...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *GetCertForOpenIdConnectRawCall) Ctx(ctx context.Context) *GetCertForOpenIdConnectRawCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *GetRobotJwkCall) Ctx(ctx context.Context) *GetRobotJwkCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *GetRobotMetadataRawCall) Ctx(ctx context.Context) *GetRobotMetadataRawCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *GetRobotMetadataX509Call) Ctx(ctx context.Context) *GetRobotMetadataX509Call {
	c.ctx_ = ctx
	return c
}
