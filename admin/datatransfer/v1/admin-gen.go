...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *ApplicationsListCall) Ctx(ctx context.Context) *ApplicationsListCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *TransfersGetCall) Ctx(ctx context.Context) *TransfersGetCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *TransfersInsertCall) Ctx(ctx context.Context) *TransfersInsertCall {
	c.ctx_ = ctx
	return c
}
...
// Any pending HTTP request will be aborted if the provided context
// is cancelled.
func (c *TransfersListCall) Ctx(ctx context.Context) *TransfersListCall {
	c.ctx_ = ctx
	return c
}
