...
func (c *StatesClearCall) Do() (ret *WriteResult, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
func (c *StatesClearCall) DoHeader() (ret *WriteResult, resHeader http.Header, err error) {
...
// Do performs a round-trip call to the server.
func (c *StatesDeleteCall) Do() (err error) {
	_, err = c.DoHeader()
	return err
}
...
// regardless of the status code returned. This can be useful for checking for
// header values such as "Etag" even when http.StatusNotModified is returned.
func (c *StatesDeleteCall) DoHeader() (resHeader http.Header, err error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
// Do performs a round-trip call to the server.
func (c *StatesGetCall) Do() (ret *GetResponse, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// regardless of the status code returned. This can be useful for checking for
// header values such as "Etag" even when http.StatusNotModified is returned.
func (c *StatesGetCall) DoHeader() (ret *GetResponse, resHeader http.Header, err error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
	if v, ok := c.opt_["fields"]; ok {
...
// Do performs a round-trip call to the server.
func (c *StatesListCall) Do() (ret *ListResponse, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// regardless of the status code returned. This can be useful for checking for
// header values such as "Etag" even when http.StatusNotModified is returned.
func (c *StatesListCall) DoHeader() (ret *ListResponse, resHeader http.Header, err error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
// Do performs a round-trip call to the server.
func (c *StatesUpdateCall) Do() (ret *WriteResult, err error) {
	v, _, err := c.DoHeader()
	return v, err
}
...
// regardless of the status code returned. This can be useful for checking for
// header values such as "Etag" even when http.StatusNotModified is returned.
func (c *StatesUpdateCall) DoHeader() (ret *WriteResult, resHeader http.Header, err error) {
	var body io.Reader = nil
