...
type CustomFieldDefListCallDoer interface {
	...
	Fields(s ...googleapi.Field) CustomFieldDefListCallDoer
}
...
type JobsGetCallDoer interface {
	Do() (*Job, error)
	Fields(s ...googleapi.Field) JobsGetCallDoer
}
...
type JobsInsertCallDoer interface {
	Do() (*Job, error)
	Assignee(assignee string) JobsInsertCallDoer
	CustomField(customField string) JobsInsertCallDoer
	CustomerName(customerName string) JobsInsertCallDoer
	CustomerPhoneNumber(customerPhoneNumber string) JobsInsertCallDoer
	Note(note string) JobsInsertCallDoer
	Fields(s ...googleapi.Field) JobsInsertCallDoer
}
...
type JobsListCallDoer interface {
	...
	MaxResults(maxResults int64) JobsListCallDoer
	MinModifiedTimestampMs(minModifiedTimestampMs uint64) JobsListCallDoer
	PageToken(pageToken string) JobsListCallDoer
	Fields(s ...googleapi.Field) JobsListCallDoer
}
...
type JobsPatchCallDoer interface {
	Do() (*Job, error)
	Address(address string) JobsPatchCallDoer
	Assignee(assignee string) JobsPatchCallDoer
	CustomField(customField string) JobsPatchCallDoer
	CustomerName(customerName string) JobsPatchCallDoer
	CustomerPhoneNumber(customerPhoneNumber string) JobsPatchCallDoer
	Lat(lat float64) JobsPatchCallDoer
	Lng(lng float64) JobsPatchCallDoer
	Note(note string) JobsPatchCallDoer
	Progress(progress string) JobsPatchCallDoer
	Title(title string) JobsPatchCallDoer
	Fields(s ...googleapi.Field) JobsPatchCallDoer
}
...
type JobsUpdateCallDoer interface {
	Do() (*Job, error)
	Address(address string) JobsUpdateCallDoer
	Assignee(assignee string) JobsUpdateCallDoer
	CustomField(customField string) JobsUpdateCallDoer
	CustomerName(customerName string) JobsUpdateCallDoer
	CustomerPhoneNumber(customerPhoneNumber string) JobsUpdateCallDoer
	Lat(lat float64) JobsUpdateCallDoer
	Lng(lng float64) JobsUpdateCallDoer
	Note(note string) JobsUpdateCallDoer
	Progress(progress string) JobsUpdateCallDoer
	Title(title string) JobsUpdateCallDoer
	Fields(s ...googleapi.Field) JobsUpdateCallDoer
}
...
type LocationListCallDoer interface {
	...
	MaxResults(maxResults int64) LocationListCallDoer
	PageToken(pageToken string) LocationListCallDoer
	Fields(s ...googleapi.Field) LocationListCallDoer
}
...
type ScheduleGetCallDoer interface {
	Do() (*Schedule, error)
	Fields(s ...googleapi.Field) ScheduleGetCallDoer
}
...
type SchedulePatchCallDoer interface {
	Do() (*Schedule, error)
	AllDay(allDay bool) SchedulePatchCallDoer
	Duration(duration uint64) SchedulePatchCallDoer
	EndTime(endTime uint64) SchedulePatchCallDoer
	StartTime(startTime uint64) SchedulePatchCallDoer
	Fields(s ...googleapi.Field) SchedulePatchCallDoer
}
...
type ScheduleUpdateCallDoer interface {
	Do() (*Schedule, error)
	AllDay(allDay bool) ScheduleUpdateCallDoer
	Duration(duration uint64) ScheduleUpdateCallDoer
	EndTime(endTime uint64) ScheduleUpdateCallDoer
	StartTime(startTime uint64) ScheduleUpdateCallDoer
	Fields(s ...googleapi.Field) ScheduleUpdateCallDoer
}
...
type TeamListCallDoer interface {
	...
	Admin(admin bool) TeamListCallDoer
	Dispatcher(dispatcher bool) TeamListCallDoer
	Worker(worker bool) TeamListCallDoer
	Fields(s ...googleapi.Field) TeamListCallDoer
}
...
type WorkerListCallDoer interface {
	...
	Fields(s ...googleapi.Field) WorkerListCallDoer
}
