...
type VirtualMachine struct {
	...
	// cache. The disks will be
	// mounted into the Docker folder in a way that the images present in
	// the
	// cache will not need to be pulled. The digests of the cached images
	// must
