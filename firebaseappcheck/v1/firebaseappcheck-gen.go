...
type GoogleFirebaseAppcheckV1ResourcePolicy struct {
	...
	// This will override the App Check overall EnforcementMode setting on the
	// service.
	//
	// Possible values:
...
// against the current DebugToken, to ensure the client has an up-to-date value
// before proceeding. This checksum is computed by the server based on the
// values of fields in the DebugToken object, and can be obtained from the
// DebugToken object received from the last CreateDebugToken, GetDebugToken,
// ListDebugTokens, or UpdateDebugToken call. This etag is strongly validated
// as defined by RFC 7232.
func (c *ProjectsAppsDebugTokensDeleteCall) Etag(etag string) *ProjectsAppsDebugTokensDeleteCall {
