...
type CustomersServicer interface {
	Get(customerId string) *CustomersGetCall
	Insert(customer *Customer) *CustomersInsertCall
	Patch(customerId string, customer *Customer) *CustomersPatchCall
	Update(customerId string, customer *Customer) *CustomersUpdateCall
}
...
type SubscriptionsServicer interface {
	Activate(customerId string, subscriptionId string) *SubscriptionsActivateCall
	ChangePlan(customerId string, subscriptionId string, changeplanrequest *ChangePlanRequest) *SubscriptionsChangePlanCall
	ChangeRenewalSettings(customerId string, subscriptionId string, renewalsettings *RenewalSettings) *SubscriptionsChangeRenewalSettingsCall
	ChangeSeats(customerId string, subscriptionId string, seats *Seats) *SubscriptionsChangeSeatsCall
	Delete(customerId string, subscriptionId string, deletionType string) *SubscriptionsDeleteCall
	Get(customerId string, subscriptionId string) *SubscriptionsGetCall
	Insert(customerId string, subscription *Subscription) *SubscriptionsInsertCall
	List() *SubscriptionsListCall
	StartPaidService(customerId string, subscriptionId string) *SubscriptionsStartPaidServiceCall
	Suspend(customerId string, subscriptionId string) *SubscriptionsSuspendCall
}
