...
type AccountsServicer interface {
	Insert(userToken string, accountType string, accountName string, account *Account) *AccountsInsertCall
}
...
type ContactsServicer interface {
	Delete(id string) *ContactsDeleteCall
	Get(id string) *ContactsGetCall
	Insert(contact *Contact) *ContactsInsertCall
	List() *ContactsListCall
	Patch(id string, contact *Contact) *ContactsPatchCall
	Update(id string, contact *Contact) *ContactsUpdateCall
}
...
type LocationsServicer interface {
	Get(id string) *LocationsGetCall
	List() *LocationsListCall
}
...
type SubscriptionsServicer interface {
	Delete(id string) *SubscriptionsDeleteCall
	Insert(subscription *Subscription) *SubscriptionsInsertCall
	List() *SubscriptionsListCall
	Update(id string, subscription *Subscription) *SubscriptionsUpdateCall
}
...
type TimelineServicer interface {
	Delete(id string) *TimelineDeleteCall
	Get(id string) *TimelineGetCall
	Insert(timelineitem *TimelineItem) *TimelineInsertCall
	List() *TimelineListCall
	Patch(id string, timelineitem *TimelineItem) *TimelinePatchCall
	Update(id string, timelineitem *TimelineItem) *TimelineUpdateCall
}
