...
type ApprovalResult struct {
	...
	// API was called (the user's actual email that is tied to their GAIA ID
	// may have changed). This field is not stored, rather, it is calculated
	// on the fly using approver_id.
