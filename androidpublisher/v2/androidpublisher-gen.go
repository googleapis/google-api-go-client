...
// Media specifies the media to upload. The upload may be performed as a
// series of chunks, the size of which can be controlled by supplying a
// MediaOption generated by googleapi.ChunkSize. At most one of Media
