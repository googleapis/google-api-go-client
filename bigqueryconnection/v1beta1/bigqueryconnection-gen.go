...
// ConnectionId sets the optional parameter "connectionId": Optional
// connection id that should be assigned to the created connection.
...
// the connection fields to be updated.
