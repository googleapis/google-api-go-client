...
// RuntimeEnvironment: Environment values to set at runtime.
type RuntimeEnvironment struct {
	// BypassTempDirValidation: Bypass the safety checks for the job's temp
	...
	// TempLocation: The temp location to use for the job.
