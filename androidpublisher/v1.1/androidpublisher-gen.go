...
type InapppurchasesServicer interface {
	Get(packageName string, productId string, token string) *InapppurchasesGetCall
}
...
type PurchasesServicer interface {
	Cancel(packageName string, subscriptionId string, token string) *PurchasesCancelCall
	Get(packageName string, subscriptionId string, token string) *PurchasesGetCall
}
