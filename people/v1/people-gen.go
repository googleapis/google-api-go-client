...
// BatchCreateContactsErrorDetails.contacts which contains a list of
// errors for each invalid contact. The response to a request to create
// a batch of contacts.
...
// BatchUpdateContactsErrorDetails.contacts, a list of errors
// corresponding to each contact. The response to a request to update a
// batch of contacts.
