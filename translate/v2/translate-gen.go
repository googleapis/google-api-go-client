...
func (c *DetectionsListCall) DoHeader() (*DetectionsListResponse, http.Header, error) {
...
func (c *LanguagesListCall) DoHeader() (*LanguagesListResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
...
func (c *TranslationsListCall) DoHeader() (*TranslationsListResponse, http.Header, error) {
	var body io.Reader = nil
	params := make(url.Values)
	params.Set("alt", "json")
