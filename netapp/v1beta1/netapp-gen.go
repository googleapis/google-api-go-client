...
type BlockDevice struct {
	...
	// Volume. In case no user input is provided, name will be autogenerated in the
	...
	// in this field during Volume creation is IGNORED. The block device's size is
...
type StoragePool struct {
	...
	// whether the pool supports FILE based volumes only or UNIFIED (both FILE and
