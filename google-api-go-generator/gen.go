...
const googleAPIsDiscoveryURL = "https://www.googleapis.com/discovery/v1/apis"
...
var (
	...
	apisURL       = flag.String("discoveryurl", googleAPIsDiscoveryURL, "URL to root discovery document")
...
func getAPIs() []*API {
	...
	if *apiToGenerate == "*" && *apisURL == googleAPIsDiscoveryURL {
