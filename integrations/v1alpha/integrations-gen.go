...
const basePathTemplate = "https://integrations.UNIVERSE_DOMAIN/"
...
// CrmlogErrorCode: Registered ids for errors, as "oneof" enums. Each task or
// logical grouping of tasks may share the same enum.
type CrmlogErrorCode struct {
	...
	//   "SYNC_EVENTBUS_EXECUTION_TIMEOUT" - SYNC_EVENTBUS_EXECUTION_TIMEOUT is for
	// eventbus internal use only.
	...
	// NullFields is a list of field names (e.g. "CommonErrorCode") to include in
...
type EnterpriseCrmEventbusAuthconfigAuthConfigTaskParam struct {
	// AllowedCredentialTypes: Defines the credential types to be supported as Task
	// may restrict specific types to use, e.g. Cloud SQL Task will use
	// username/password type only.
	//
	// Possible values:
	...
	// ForceSendFields is a list of field names (e.g. "AllowedCredentialTypes") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AllowedCredentialTypes") to
...
// EnterpriseCrmEventbusProtoAddress: Email address along with optional name
// and tokens. These tokens will be substituted for the variables in the form
// of [{var_name}], where var_name could be any string of no more than 32
// bytes.
...
// EnterpriseCrmEventbusProtoAttributes: Attributes are additional options that
// can be associated with each event property. For more information, see
type EnterpriseCrmEventbusProtoAttributes struct {
	// DataType: Things like URL, Email, Currency, Timestamp (rather than string,
	// int64...)
	//
	// Possible values:
	...
	// IsRequired: Required for event execution. The validation will be done by the
	// event bus when the event is triggered.
	IsRequired bool `json:"isRequired,omitempty"`
	// IsSearchable: Used to indicate if a ParameterEntry should be converted to
	// ParamIndexes for ST-Spanner full-text search. DEPRECATED: use searchable.
	IsSearchable bool `json:"isSearchable,omitempty"`
	// LogSettings: See
	LogSettings *EnterpriseCrmEventbusProtoLogSettings `json:"logSettings,omitempty"`
	// Possible values:
	//   "UNSPECIFIED"
	//   "YES" - If yes, the parameter key and value will be full-text indexed. In
	// a proto, this value will propagate to all children whose searchable is
	// unspecified.
	...
	// TaskVisibility: List of tasks that can view this property, if empty then
	// all.
...
// EnterpriseCrmEventbusProtoBaseAlertConfigErrorEnumList: List of error enums
// for alerts.
type EnterpriseCrmEventbusProtoBaseAlertConfigErrorEnumList struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "EnumStrings") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// EnterpriseCrmEventbusProtoBaseAlertConfigThresholdValue: The threshold value
// of the metric, above or below which the alert should be triggered. See
// EventAlertConfig or TaskAlertConfig for the different alert metric types in
// each case. For the *RATE metrics, one or both of these fields may be set.
...
type EnterpriseCrmEventbusProtoBaseAlertConfigThresholdValue struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "Absolute") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type EnterpriseCrmEventbusProtoBaseValue struct {
	// BaseFunction: Start with a function that does not build on existing values.
	// Eg. CurrentTime, Min, Max, Exists, etc.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "BaseFunction") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type EnterpriseCrmEventbusProtoBooleanParameterArray struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "BooleanValues") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type EnterpriseCrmEventbusProtoBuganizerNotification struct {
	...
	// ComponentId: ID of the buganizer component within which to create a new
	// issue. Required.
...
type EnterpriseCrmEventbusProtoCloudKmsConfig struct {
	// GcpProjectId: Optional. The id of GCP project where the KMS key is stored.
	// If not provided, assume the key is stored in the same GCP project defined in
	// Client (tag 14).
	...
	// KeyRingName: A key ring organizes keys in a specific Google Cloud location
	// and allows you to manage access control on groups of keys. A key ring's name
	// does not need to be unique across a Google Cloud project, but must be unique
	// within a given location.
	KeyRingName string `json:"keyRingName,omitempty"`
	// KeyVersionName: Optional. Each version of a key contains key material used
	// for encryption or signing. A key's version is represented by an integer,
	// starting at 1. To decrypt data or verify a signature, you must use the same
	// key version that was used to encrypt or sign the data.
	KeyVersionName string `json:"keyVersionName,omitempty"`
	// LocationName: Location name of the key ring, e.g. "us-west1".
	LocationName string `json:"locationName,omitempty"`
	// ServiceAccount: Optional. The service account used for authentication of
	// this KMS key. If this is not provided, the service account in
...
// EnterpriseCrmEventbusProtoCloudSchedulerConfig: Cloud Scheduler Trigger
// configuration
...
// EnterpriseCrmEventbusProtoCondition: Condition that uses `operator` to
// evaluate the key against the value.
type EnterpriseCrmEventbusProtoCondition struct {
	// EventPropertyKey: Key that's evaluated against the `value`. Please note the
	// data type of the runtime value associated with the key should match the data
	// type of `value`, else an IllegalArgumentException is thrown.
	EventPropertyKey string `json:"eventPropertyKey,omitempty"`
	// Operator: Operator used to evaluate the condition. Please note that an
	// operator with an inappropriate key/value operand will result in
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "EventPropertyKey") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// EnterpriseCrmEventbusProtoConditionResult: Contains the combined condition
// calculation results.
type EnterpriseCrmEventbusProtoConditionResult struct {
	...
	// Result: the result comes out after evaluate the combined condition. True if
	// there's no combined condition specified.
	Result bool `json:"result,omitempty"`
	// ForceSendFields is a list of field names (e.g. "CurrentTaskNumber") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "CurrentTaskNumber") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type EnterpriseCrmEventbusProtoConnectorsConnection struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ConnectionName") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type EnterpriseCrmEventbusProtoCustomSuspensionRequest struct {
	// PostToQueueWithTriggerIdRequest: Request to fire an event containing the
	...
	// SuspensionInfoEventParameterKey: In the fired event, set the SuspensionInfo
	// message as the value for this key.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "PostToQueueWithTriggerIdRequest")
...
type EnterpriseCrmEventbusProtoDoubleParameterArray struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "DoubleValues") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// EnterpriseCrmEventbusProtoErrorDetail: An error, warning, or information
// message associated with a workflow.
type EnterpriseCrmEventbusProtoErrorDetail struct {
	// ErrorCode: The associated error-code, which can be a common or internal
	// code.
	ErrorCode *CrmlogErrorCode `json:"errorCode,omitempty"`
	// ErrorMessage: The full text of the error message, including any parameters
	// that were thrown along with the exception.
	ErrorMessage string `json:"errorMessage,omitempty"`
	...
	// TaskNumber: The task try-number, in which, the error occurred. If zero, the
	// error happened at the event level.
...
// EnterpriseCrmEventbusProtoEventBusProperties: LINT.IfChange This message is
// used for storing key value pair properties for each Event / Task in the
// EventBus.
...
// EnterpriseCrmEventbusProtoEventExecutionDetails: Contains the details of the
// execution info of this event: this includes the tasks execution details plus
// the event execution statistics. Next available id: 10
type EnterpriseCrmEventbusProtoEventExecutionDetails struct {
	...
	// Possible values:
	//   "UNSPECIFIED"
	//   "ON_HOLD" - Event is received and waiting for the execution. This happens
	// when firing the event via "postToQueue" or "schedule".
	...
	// EventRetriesFromBeginningCount: Indicates the number of times the execution
	// has restarted from the beginning.
	...
	// NetworkAddress: The network address (aka. bns address) that indicates where
	// the event executor is running.
	NetworkAddress string `json:"networkAddress,omitempty"`
	// NextExecutionTime: Next scheduled execution time in case the execution
	// status was RETRY_ON_HOLD.
	NextExecutionTime int64 `json:"nextExecutionTime,omitempty,string"`
	// RyeLockUnheldCount: Used internally and shouldn't be exposed to users. A
	// counter for the cron job to record how many times this event is in
	// in_process state but don't have a lock consecutively/
	RyeLockUnheldCount int64 `json:"ryeLockUnheldCount,omitempty"`
	// ForceSendFields is a list of field names (e.g. "EventAttemptStats") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "EventAttemptStats") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type EnterpriseCrmEventbusProtoEventExecutionDetailsEventAttemptStats struct {
	...
	// StartTime: The start time of the event execution for current attempt. This
...
// EnterpriseCrmEventbusProtoEventExecutionSnapshot: Contains the snapshot of
// the event execution for a given checkpoint. Next available id: 13
type EnterpriseCrmEventbusProtoEventExecutionSnapshot struct {
	...
	// DiffParams: The parameters in Event object that differs from last snapshot.
	DiffParams *EnterpriseCrmEventbusProtoEventParameters `json:"diffParams,omitempty"`
	// EventExecutionInfoId: Points to the event execution info this snapshot
	// belongs to.
	...
	// ExceedMaxSize: indicate whether snapshot exceeded maximum size before clean
	// up
	...
	// TaskExecutionDetails: All of the task execution details at the given point
	// of time.
	TaskExecutionDetails []*EnterpriseCrmEventbusProtoTaskExecutionDetails `json:"taskExecutionDetails,omitempty"`
	// TaskName: The task name associated with this snapshot. Could be empty.
	TaskName string `json:"taskName,omitempty"`
	// ForceSendFields is a list of field names (e.g. "CheckpointTaskNumber") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "CheckpointTaskNumber") to include
	// in API requests with the JSON null value. By default, fields with empty
	// values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type EnterpriseCrmEventbusProtoEventExecutionSnapshotEventExecutionSnapshotMetadata struct {
	...
	// TaskAttemptNum: the task attempt number this snapshot belongs to. Could be
	// empty.
	TaskAttemptNum int64 `json:"taskAttemptNum,omitempty"`
	// TaskLabel: the task label associated with this snapshot. Could be empty.
	TaskLabel string `json:"taskLabel,omitempty"`
	// TaskName: the task name associated with this snapshot. Could be empty.
	TaskName string `json:"taskName,omitempty"`
	// TaskNumber: The task number associated with this snapshot. Could be empty.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "EventAttemptNum") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// EnterpriseCrmEventbusProtoEventParameters: LINT.IfChange This message is
// used for processing and persisting (when applicable) key value pair
// parameters for each event in the event bus. Please see
type EnterpriseCrmEventbusProtoEventParameters struct {
	// Parameters: Parameters are a part of Event and can be used to communicate
...
// EnterpriseCrmEventbusProtoExecutionTraceInfo: Message that helps aggregate
// all sub-executions triggered by one execution and keeps track of
// child-parent relationships.
type EnterpriseCrmEventbusProtoExecutionTraceInfo struct {
	// ParentEventExecutionInfoId: Parent event execution info id that triggers the
	// current execution through SubWorkflowExecutorTask.
	...
	// ForceSendFields is a list of field names (e.g. "ParentEventExecutionInfoId")
	// to unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ParentEventExecutionInfoId") to
	// include in API requests with the JSON null value. By default, fields with
	// empty values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// EnterpriseCrmEventbusProtoExternalTraffic: Represents external traffic type
// and id.
type EnterpriseCrmEventbusProtoExternalTraffic struct {
	// GcpProjectId: User’s GCP project id the traffic is referring to.
	GcpProjectId string `json:"gcpProjectId,omitempty"`
	// GcpProjectNumber: User’s GCP project number the traffic is referring to.
	GcpProjectNumber string `json:"gcpProjectNumber,omitempty"`
	// Location: Location for the user's request.
	Location string `json:"location,omitempty"`
	// Source:
	// LINT.ThenChange(//depot/google3/enterprise/crm/eventbus/proto/product.proto:p
	// roduct,
	// //depot/google3/java/com/google/enterprise/crm/integrationplatform/api/utils/
	// ConverterUtils.java:source_to_product)
	//
	// Possible values:
	//   "SOURCE_UNSPECIFIED"
	//   "APIGEE"
...
// EnterpriseCrmEventbusProtoFailurePolicy: Policy that defines the task retry
// logic and failure type. If no FailurePolicy is defined for a task, all its
// dependent tasks will not be executed (i.e, a `retry_strategy` of NONE will
// be applied).
type EnterpriseCrmEventbusProtoFailurePolicy struct {
	...
	// Possible values:
	//   "UNSPECIFIED"
	//   "IGNORE" - Ignores the failure of this task. The rest of the workflow will
	// be executed Assuming this task succeeded.
	...
	// after a fixed delay. A max-retry count is required to be specified with this
	...
	// exact same exponential interval. Max_num_retries and interval_in_seconds
	// must be specified.
	...
	// ForceSendFields is a list of field names (e.g. "IntervalInSeconds") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "IntervalInSeconds") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// EnterpriseCrmEventbusProtoField: Information about the value and type of the
// field.
type EnterpriseCrmEventbusProtoField struct {
	// Cardinality: By default, if the cardinality is unspecified the field is
	// considered required while mapping.
	//
	// Possible values:
	//   "UNSPECIFIED" - For fields with unspecified cardinality.
	//   "OPTIONAL" - If field cardinality is set to optional, ignore errors if
	// input field value is null or the reference_key is not found.
	Cardinality string `json:"cardinality,omitempty"`
	// DefaultValue: This holds the default values for the fields. This value is
	// supplied by user so may or may not contain PII or SPII data.
	...
	// parameter. 1. Any workflow parameter, for e.g. $workflowParam1$. 2. Any task
	// input or output parameter, for e.g. $task1_param1$. 3. Any workflow or task
	// parameters with subfield references, for e.g., $task1_param1.employee.id$
	ReferenceKey string `json:"referenceKey,omitempty"`
	// TransformExpression: This is the transform expression to fetch the input
	// field value. for e.g. $param1$.CONCAT('test'). Keep points - 1. Only input
	// field can have a transform expression. 2. If a transform expression is
	// provided, reference_key will be ignored. 3. If no value is returned after
	// evaluation of transform expression, default_value can be mapped if provided.
	// 4. The field_type should be the type of the final object returned after the
...
// EnterpriseCrmEventbusProtoFieldMappingConfig: Field Mapping Config to map
// multiple output fields values from input fields values.
type EnterpriseCrmEventbusProtoFieldMappingConfig struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "MappedFields") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type EnterpriseCrmEventbusProtoFunction struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "FunctionType") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type EnterpriseCrmEventbusProtoFunctionType struct {
	...
	// JsonFunction:
	// LINT.ThenChange(//depot/google3/alkali/apps/integrationplatform/client/workfl
	// ow_editor/utils/transform_function.ts)
...
type EnterpriseCrmEventbusProtoIntParameterArray struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "IntValues") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// attributes for an event property. These attributes are used to map the
// property to the parameter in the log proto. Also used to define
// scrubbing/truncation behavior and PII information.
type EnterpriseCrmEventbusProtoLogSettings struct {
	// LogFieldName: The name of corresponding logging field of the event property.
	// If omitted, assumes the same name as the event property key.
	LogFieldName string `json:"logFieldName,omitempty"`
	// SanitizeOptions: Contains the scrubbing options, such as whether to scrub,
	// obfuscate, etc.
	...
	// ShorteningLimits: Contains the field limits for shortening, such as max
	// string length and max array length.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "LogFieldName") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type EnterpriseCrmEventbusProtoLoopMetadata struct {
	...
	// CurrentIterationDetail: Needs to be set by the loop impl class before each
	// iteration. The abstract loop class will append the request and response to
	// it. Eg. The foreach Loop will clean up and set it as the current iteration
	// element at the start of each loop. The post request and response will be
	...
	// ForceSendFields is a list of field names (e.g. "CurrentIterationCount") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
...
// EnterpriseCrmEventbusProtoMappedField: Mapped field is a pair of input field
// and output field.
type EnterpriseCrmEventbusProtoMappedField struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "InputField") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// EnterpriseCrmEventbusProtoNextTask: The task that is next in line to be
// executed, if the condition specified evaluated to true.
type EnterpriseCrmEventbusProtoNextTask struct {
	// CombinedConditions: Combined condition for this task to become an eligible
	// next task. Each of these combined_conditions are joined with logical OR.
	...
	TaskNumber string `json:"taskNumber,omitempty"`
	// ForceSendFields is a list of field names (e.g. "CombinedConditions") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "CombinedConditions") to include
	// in API requests with the JSON null value. By default, fields with empty
	// values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// EnterpriseCrmEventbusProtoNextTeardownTask: The teardown task that is next
// in line to be executed. We support only sequential execution of teardown
// tasks (i.e. no branching).
...
// EnterpriseCrmEventbusProtoNodeIdentifier: Represents a node identifier (type
// + id). Next highest id: 3
type EnterpriseCrmEventbusProtoNodeIdentifier struct {
	...
	// ElementType: Destination node where the edge ends. It can only be a task
	// config.
	//
	// Possible values:
	//   "UNKNOWN_TYPE"
	...
	// ForceSendFields is a list of field names (e.g. "ElementIdentifier") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ElementIdentifier") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type EnterpriseCrmEventbusProtoNotification struct {
	...
	// Request: If the out-of-the-box email/pubsub notifications are not suitable
	// and custom logic is required, fire a workflow containing all info needed to
	// notify users to resume execution.
	Request *EnterpriseCrmEventbusProtoCustomSuspensionRequest `json:"request,omitempty"`
	// ForceSendFields is a list of field names (e.g. "BuganizerNotification") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
...
type EnterpriseCrmEventbusProtoParamSpecEntryConfig struct {
	...
	// HelpText: Detailed help text for this parameter containing information not
	// provided elsewhere. For example, instructions on how to migrate from a
	...
	// templates.
	//   "NUMBER_SLIDER" - A slider to select a numerical value. The default range
	// is [0, 100].
	...
	//   "KEY_IS_PARAMETER_NAME" - If this field is a ParameterMap and this option
	// is selected, the map's keys will be interpreted as parameter names. Ignored
	// if this field is not a ParameterMap.
	//   "VALUE_IS_PARAMETER_NAME" - If this field is a ParameterMap and this
	// option is selected, the map's values will be interpreted as parameter names.
	...
	// UiPlaceholderText: Placeholder text which will appear in the UI input form
	// for this parameter.
	UiPlaceholderText string `json:"uiPlaceholderText,omitempty"`
	// ForceSendFields is a list of field names (e.g. "DescriptivePhrase") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "DescriptivePhrase") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type EnterpriseCrmEventbusProtoParamSpecEntryProtoDefinition struct {
	// FullName: The fully-qualified proto name. This message, for example, would
	// be "enterprise.crm.eventbus.proto.ParamSpecEntry.ProtoDefinition".
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "FullName") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type EnterpriseCrmEventbusProtoParamSpecEntryValidationRule struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "DoubleRange") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// EnterpriseCrmEventbusProtoParamSpecEntryValidationRuleDoubleRange: Range
// used to validate doubles and floats.
...
// EnterpriseCrmEventbusProtoParamSpecEntryValidationRuleIntRange: Range used
// to validate longs and ints.
...
// EnterpriseCrmEventbusProtoParamSpecEntryValidationRuleStringRegex: Rule used
// to validate strings.
type EnterpriseCrmEventbusProtoParamSpecEntryValidationRuleStringRegex struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "Exclusive") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type EnterpriseCrmEventbusProtoParameterEntry struct {
	// Key: Key is used to retrieve the corresponding parameter value. This should
	// be unique for a given fired event. These parameters must be predefined in
...
// EnterpriseCrmEventbusProtoParameterMap: A generic multi-map that holds key
// value pairs. They keys and values can be of any type, unless specified.
type EnterpriseCrmEventbusProtoParameterMap struct {
	...
	// KeyType: Option to specify key value type for all entries of the map. If
...
// EnterpriseCrmEventbusProtoParameterMapEntry: Entry is a pair of key and
// value.
...
// EnterpriseCrmEventbusProtoParameterMapField: Field represents either the key
// or value in an entry.
type EnterpriseCrmEventbusProtoParameterMapField struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "LiteralValue") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// EnterpriseCrmEventbusProtoParameterValueType: LINT.IfChange To support
...
type EnterpriseCrmEventbusProtoParameterValueType struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "BooleanArray") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type EnterpriseCrmEventbusProtoPropertyEntry struct {
	// Key: Key is used to retrieve the corresponding property value. This should
	// be unique for a given fired event. The Tasks should be aware of the keys
	// used while firing the events for them to be able to retrieve the values.
	Key string `json:"key,omitempty"`
	// Value: Values for the defined keys. Each value can either be string, int,
	// double or any proto message.
	Value *EnterpriseCrmEventbusProtoValueType `json:"value,omitempty"`
...
type EnterpriseCrmEventbusProtoProtoParameterArray struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ProtoValues") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type EnterpriseCrmEventbusProtoScatterResponse struct {
	...
	ErrorMsg string `json:"errorMsg,omitempty"`
	// ExecutionIds: The execution ids of each Subworkflow fired by this scatter.
	ExecutionIds []string `json:"executionIds,omitempty"`
	// IsSuccessful: If execution is sync, this is true if the execution passed and
	// false if it failed. If the execution is async, this is true if the WF was
	// fired off successfully, and false if it failed to execute. The success or
	// failure of the subworkflows executed are not captured.
	IsSuccessful bool `json:"isSuccessful,omitempty"`
	// ResponseParams: A list of all the response parameters in the aggregtorMap
	// stored with the remapped key.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ErrorMsg") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type EnterpriseCrmEventbusProtoSerializedObjectParameter struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ObjectValue") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type EnterpriseCrmEventbusProtoStringParameterArray struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "StringValues") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// EnterpriseCrmEventbusProtoSuccessPolicy: Policy that dictates the behavior
// for the task after it completes successfully.
type EnterpriseCrmEventbusProtoSuccessPolicy struct {
	// FinalState: State to which the execution snapshot status will be set if the
	// task succeeds.
	//
	// Possible values:
	//   "UNSPECIFIED"
	//   "SUCCEEDED" - The default behavior, where successful tasks will be marked
	// as SUCCEEDED.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "FinalState") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type EnterpriseCrmEventbusProtoSuspensionAuthPermissions struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "GaiaIdentity") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type EnterpriseCrmEventbusProtoSuspensionConfig struct {
	// CustomMessage: Optional information to provide recipients of the suspension
	// in addition to the resolution URL, typically containing relevant parameter
	// values from the originating workflow.
	CustomMessage string                                    `json:"customMessage,omitempty"`
	Notifications []*EnterpriseCrmEventbusProtoNotification `json:"notifications,omitempty"`
	// SuspensionExpiration: Indicates the next steps when no external actions
	// happen on the suspension.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "CustomMessage") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type EnterpriseCrmEventbusProtoSuspensionExpiration struct {
	// ExpireAfterMs: Milliseconds after which the suspension expires, if no action
	// taken.
	ExpireAfterMs int64 `json:"expireAfterMs,omitempty"`
	// LiftWhenExpired: Whether the suspension will be REJECTED or LIFTED upon
	// expiration. REJECTED is the default behavior.
	LiftWhenExpired bool `json:"liftWhenExpired,omitempty"`
	// RemindAfterMs: Milliseconds after which the previous suspension action
	// reminder, if any, is sent using the selected notification option, for a
	// suspension which is still PENDING_UNSPECIFIED.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ExpireAfterMs") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type EnterpriseCrmEventbusProtoSuspensionResolutionInfo struct {
	...
	// Product: Which Google product the suspension belongs to. If not set, the
	// suspension belongs to Integration Platform by default.
	//
	// Possible values:
	//   "UNSPECIFIED_PRODUCT"
	//   "IP"
...
type EnterpriseCrmEventbusProtoSuspensionResolutionInfoAudit struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ResolvedBy") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// EnterpriseCrmEventbusProtoTaskAlertConfig: Message to be used to configure
// alerting in the {@code TaskConfig} protos for tasks in an event.
type EnterpriseCrmEventbusProtoTaskAlertConfig struct {
	// AggregationPeriod: The period over which the metric value should be
	// aggregated and evaluated. Format is , where integer should be a positive
	// integer and unit should be one of (s,m,h,d,w) meaning (second, minute, hour,
	// day, week).
	AggregationPeriod string `json:"aggregationPeriod,omitempty"`
	// AlertDisabled: Set to false by default. When set to true, the metrics are
	// not aggregated or pushed to Monarch for this workflow alert.
	AlertDisabled bool `json:"alertDisabled,omitempty"`
	// AlertName: A name to identify this alert. This will be displayed in the
	// alert subject. If set, this name should be unique in within the scope of the
	// containing workflow.
	AlertName string `json:"alertName,omitempty"`
	// ClientId: Client associated with this alert configuration. Must be a client
	// enabled in one of the containing workflow's triggers.
	ClientId string `json:"clientId,omitempty"`
	// DurationThresholdMs: Should be specified only for TASK_AVERAGE_DURATION and
	...
	//   "TASK_ERROR_RATE" - Specifies alerting on the rate of errors (potentially
	// for a specific set of enum values) for the enclosing TaskConfig.
	...
	// NumAggregationPeriods: For how many contiguous aggregation periods should
	...
	// PlaybookUrl: Link to a playbook for resolving the issue that triggered this
	// alert.
	PlaybookUrl string `json:"playbookUrl,omitempty"`
	// ThresholdType: The threshold type for which this alert is being configured.
	// If value falls below expected_min or exceeds expected_max, an alert will be
	// fired.
	//
	// Possible values:
	...
	// ThresholdValue: The metric value, above or below which the alert should be
	// triggered.
...
// EnterpriseCrmEventbusProtoTaskExecutionDetails: Contains the details of the
// execution of this task. Next available id: 11
type EnterpriseCrmEventbusProtoTaskExecutionDetails struct {
	...
	// Possible values:
	//   "UNSPECIFIED"
	//   "PENDING_EXECUTION" - Task is waiting for its precondition tasks to finish
	...
	//   "PENDING_ROLLBACK" - Task is waiting for its dependency tasks' rollback to
	// finish to start its rollback.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "TaskAttemptStats") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type EnterpriseCrmEventbusProtoTaskExecutionDetailsTaskAttemptStats struct {
	...
	EndTime int64 `json:"endTime,omitempty,string"`
	// StartTime: The start time of the task execution for current attempt. This
	// could be in the future if it's been scheduled.
	StartTime int64 `json:"startTime,omitempty,string"`
	// ForceSendFields is a list of field names (e.g. "EndTime") to unconditionally
	// include in API requests. By default, fields with empty or default values are
...
// EnterpriseCrmEventbusProtoTaskMetadata: TaskMetadata are attributes that are
// associated to every common Task we have.
type EnterpriseCrmEventbusProtoTaskMetadata struct {
	// ActiveTaskName: The new task name to replace the current task if it is
	// deprecated. Otherwise, it is the same as the current task name.
	...
	// typically
	//   "CUSTOM_TASK_TEMPLATE" - include connecting to Vector salesforce, CRM Hub
	// Spanner etc. Task entities that derive from a custom task template.
	...
	// DefaultJsonValidationOption: Controls whether JSON workflow parameters are
	// validated against provided schemas before and/or after this task's
	// execution.
	//
	// Possible values:
	...
	// DefaultSpec: Contains the initial configuration of the task with default
	// values set. For now, The string should be compatible to an ASCII-proto
	// format.
	DefaultSpec string `json:"defaultSpec,omitempty"`
	// Description: In a few sentences, describe the purpose and usage of the task.
	Description string `json:"description,omitempty"`
	// DescriptiveName: The string name to show on the task list on the Workflow
	// editor screen. This should be a very short, one to two words name for the
	// task. (e.g. "Send Mail")
	DescriptiveName string `json:"descriptiveName,omitempty"`
	// DocMarkdown: Snippet of markdown documentation to embed in the RHP for this
	// task.
	...
	//   "EXTERNAL_DATABASES" - Database operation tasks, e.g. read firestore info
	// tasks
	...
	//   "EXTERNAL_DATA_MANIPULATION" - Data manipulation related tasks, e.g. data
	// mapping task
	ExternalCategory string `json:"externalCategory,omitempty"`
	// ExternalCategorySequence: Sequence with which the task in specific category
	// to be displayed in task discovery panel for external users.
	ExternalCategorySequence int64 `json:"externalCategorySequence,omitempty"`
	// ExternalDocHtml: External-facing documention embedded in the RHP for this
	// task.
	ExternalDocHtml string `json:"externalDocHtml,omitempty"`
	// ExternalDocLink: Doc link for external-facing documentation (separate from
	// g3doc).
	...
	// IconLink: URL to gstatic image icon for this task. This icon shows up on the
	// task list panel along with the task name in the Workflow Editor screen. Use
	// the 24p, 2x, gray color icon image format.
	IconLink string `json:"iconLink,omitempty"`
	// IsDeprecated: The deprecation status of the current task. Default value is
	// false;
	IsDeprecated bool `json:"isDeprecated,omitempty"`
	// Name: The actual class name or the annotated name of the task. Task Author
	// should initialize this field with value from the getName() method of the
	// Task class.
	Name string `json:"name,omitempty"`
	// StandaloneExternalDocHtml: External-facing documention for standalone IP in
	// pantheon embedded in the RHP for this task. Non null only if different from
	// external_doc_html
	StandaloneExternalDocHtml string `json:"standaloneExternalDocHtml,omitempty"`
	// Status: Allows author to indicate if the task is ready to use or not. If not
	// set, then it will default to INACTIVE.
	//
	// Possible values:
	//   "UNSPECIFIED_STATUS" - Default value. Actual Task Status should always be
	// set to either INACTIVE or ACTIVE. If none is specified at runtime, it will
	// be set to INACTIVE.
	//   "DEFAULT_INACTIVE" - Still in-progress or incomplete, and not intended for
	// use.
	...
	// Tags: A set of tags that pertain to a particular task. This can be used to
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ActiveTaskName") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// EnterpriseCrmEventbusProtoTaskMetadataAdmin: Admins are owners of a Task,
// and have all permissions on a particular task identified by the task name.
...
type EnterpriseCrmEventbusProtoTaskMetadataAdmin struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "GoogleGroupEmail") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// EnterpriseCrmEventbusProtoTaskUiConfig: Task authors would use this type to
// configure the UI for a particular task by specifying what UI config modules
// should be included to compose the UI. Learn more about config module
// framework:
type EnterpriseCrmEventbusProtoTaskUiConfig struct {
	...
	// ForceSendFields is a list of field names (e.g. "TaskUiModuleConfigs") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "TaskUiModuleConfigs") to include
	// in API requests with the JSON null value. By default, fields with empty
	// values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// EnterpriseCrmEventbusProtoTaskUiModuleConfig: Task author would use this
// type to configure a config module.
type EnterpriseCrmEventbusProtoTaskUiModuleConfig struct {
	...
	//   "ERROR_HANDLING" - Supports editing error handling settings such as retry
	// strategy.
	//   "TASK_PARAM_TABLE" - Supports adding, removing and editing task parameter
	// values in a table with little assistance or restriction.
...
type EnterpriseCrmEventbusProtoTeardown struct {
	...
	// ForceSendFields is a list of field names (e.g. "TeardownTaskConfigs") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "TeardownTaskConfigs") to include
	// in API requests with the JSON null value. By default, fields with empty
	// values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type EnterpriseCrmEventbusProtoTeardownTaskConfig struct {
	...
	// Name: Required. Unique identifier of the teardown task within this Config.
	...
	// TeardownTaskImplementationClassName: Required. Implementation class name.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "CreatorEmail") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type EnterpriseCrmEventbusProtoTransformExpression struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "InitialValue") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type EnterpriseCrmEventbusProtoTriggerCriteria struct {
	// Condition: Required. Standard filter expression, when true the workflow will
	// be executed. If there's no trigger_criteria_task_implementation_class_name
	...
	Parameters *EnterpriseCrmEventbusProtoEventParameters `json:"parameters,omitempty"`
	// TriggerCriteriaTaskImplementationClassName: Optional. Implementation class
	// name. The class should implement the “TypedTask” interface.
...
// configure custom alerting in the {@code EventConfig} protos for an event.
type EnterpriseCrmEventbusProtoWorkflowAlertConfig struct {
	// AggregationPeriod: For an EXPECTED_MIN threshold, this aggregation_period
	...
	AlertDisabled bool `json:"alertDisabled,omitempty"`
	// AlertName: A name to identify this alert. This will be displayed in the
	// alert subject. If set, this name should be unique within the scope of the
	// workflow.
	AlertName string `json:"alertName,omitempty"`
	// ClientId: Client associated with this alert configuration.
	ClientId string `json:"clientId,omitempty"`
	// DurationThresholdMs: Should be specified only for *AVERAGE_DURATION and
	...
	// enclosing workflow.
	//   "EVENT_WARNING_RATE" - Specifies alerting on the rate of warnings for the
	// enclosing workflow. Warnings use the same enum values as errors.
	//   "TASK_ERROR_RATE" - Specifies alerting on the rate of errors for any task
	// in the enclosing workflow.
	//   "TASK_WARNING_RATE" - Specifies alerting on the rate of warnings for any
	// task in the enclosing workflow.
	//   "TASK_RATE" - Specifies alerting on the rate of executions over all tasks
	// in the enclosing workflow.
	//   "EVENT_RATE" - Specifies alerting on the number of events executed in the
	// given aggregation_period.
	//   "EVENT_AVERAGE_DURATION" - Specifies alerting on the average duration of
	// executions for this workflow.
	//   "EVENT_PERCENTILE_DURATION" - Specifies alerting on the duration value of
	// a particular percentile of workflow executions. E.g. If 10% or more of the
	// workflow executions have durations above 5 seconds, alert.
	//   "TASK_AVERAGE_DURATION" - Specifies alerting on the average duration of
	// any task in the enclosing workflow,
	//   "TASK_PERCENTILE_DURATION" - Specifies alerting on the duration value of a
	// particular percentile of any task executions within the enclosing workflow.
	// E.g. If 10% or more of the task executions in the workflow have durations
	// above 5 seconds, alert.
	MetricType string `json:"metricType,omitempty"`
	// NumAggregationPeriods: For how many contiguous aggregation periods should
	// the expected min or max be violated for the alert to be fired.
	NumAggregationPeriods int64 `json:"numAggregationPeriods,omitempty"`
	// OnlyFinalAttempt: For either events or tasks, depending on the type of
	// alert, count only final attempts, not retries.
	OnlyFinalAttempt bool `json:"onlyFinalAttempt,omitempty"`
	// PlaybookUrl: Link to a playbook for resolving the issue that triggered this
	// alert.
	PlaybookUrl string `json:"playbookUrl,omitempty"`
	// ThresholdType: The threshold type, whether lower(expected_min) or
	// upper(expected_max), for which this alert is being configured. If value
...
type EnterpriseCrmEventbusStatsDimensions struct {
	...
	TaskName     string `json:"taskName,omitempty"`
	TaskNumber   string `json:"taskNumber,omitempty"`
	// TriggerId: Stats have been or will be aggregated on set fields for any
...
// EnterpriseCrmFrontendsEventbusProtoEventExecutionDetails: Contains the
// details of the execution info of this event: this includes the tasks
// execution details plus the event execution statistics. Next available id: 10
type EnterpriseCrmFrontendsEventbusProtoEventExecutionDetails struct {
	EventAttemptStats []*EnterpriseCrmEventbusProtoEventExecutionDetailsEventAttemptStats `json:"eventAttemptStats,omitempty"`
	// EventExecutionSnapshot: After snapshot migration, this field will no longer
	// be populated, but old execution snapshots will still be accessible.
...
// EnterpriseCrmFrontendsEventbusProtoEventExecutionInfo: Contains all the
// execution details for a workflow instance. Next available id: 24
type EnterpriseCrmFrontendsEventbusProtoEventExecutionInfo struct {
	...
	// workflow/task. The order in which the errors were added by the workflow/task
	// is maintained.
	...
	// Product: Which Google product the execution_info belongs to. If not set, the
	...
	// TriggerId: The trigger id of the workflow trigger config. If both trigger_id
	// and client_id is present, the workflow is executed from the start tasks
	...
	WorkflowName string `json:"workflowName,omitempty"`
	// WorkflowRetryBackoffIntervalSeconds: Time interval in seconds to schedule
	// retry of workflow in manifold when workflow is already running
...
// EnterpriseCrmFrontendsEventbusProtoEventParameters: LINT.IfChange This
// message is used for processing and persisting (when applicable) key value
// pair parameters for each event in the event bus. Please see
type EnterpriseCrmFrontendsEventbusProtoEventParameters struct {
	// Parameters: Parameters are a part of Event and can be used to communicate
	// between different tasks that are part of the same workflow execution.
...
type EnterpriseCrmFrontendsEventbusProtoParamSpecEntry struct {
	...
	// example, would be "java.lang.String". If this is "java.lang.Object", the
	// parameter can be of any type.
	ClassName string `json:"className,omitempty"`
	// CollectionElementClassName: If it is a collection of objects, this would be
	// the FCQN of every individual element in the collection. If this is
	// "java.lang.Object", the parameter is a collection of any type.
	...
	//   "JSON_VALUE"
	DataType string `json:"dataType,omitempty"`
	// DefaultValue: Default values for the defined keys. Each value can either be
	// string, int, double or any proto message or a serialized object.
	DefaultValue *EnterpriseCrmFrontendsEventbusProtoParameterValueType `json:"defaultValue,omitempty"`
	// IsDeprecated: If set, this entry is deprecated, so further use of this
	// parameter should be prohibited.
	IsDeprecated bool `json:"isDeprecated,omitempty"`
	...
	// Key: Key is used to retrieve the corresponding parameter value. This should
	// be unique for a given task. These parameters must be predefined in the
	// workflow definition.
	Key string `json:"key,omitempty"`
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ClassName") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// EnterpriseCrmFrontendsEventbusProtoParameterMap: A generic multi-map that
// holds key value pairs. They keys and values can be of any type, unless
// specified.
...
// EnterpriseCrmFrontendsEventbusProtoParameterMapEntry: Entry is a pair of key
// and value.
...
// EnterpriseCrmFrontendsEventbusProtoParameterMapField: Field represents
...
// EnterpriseCrmFrontendsEventbusProtoParameterValueType: To support various
// types of parameter values. Next available id: 14
...
type EnterpriseCrmFrontendsEventbusProtoRollbackStrategy struct {
	...
	// RollbackTaskImplementationClassName: Required. This is the name of the task
	// that needs to be executed upon rollback of this task.
	RollbackTaskImplementationClassName string `json:"rollbackTaskImplementationClassName,omitempty"`
	// TaskNumbersToRollback: Required. These are the tasks numbers of the tasks
	// whose `rollback_strategy.rollback_task_implementation_class_name` needs to
...
// details. This is not the implementation of Task. There might be multiple
// TaskConfigs for the same Task.
type EnterpriseCrmFrontendsEventbusProtoTaskConfig struct {
	// AlertConfigs: Alert configurations on error rate, warning rate, number of
	// runs, durations, etc.
	AlertConfigs []*EnterpriseCrmEventbusProtoTaskAlertConfig `json:"alertConfigs,omitempty"`
	// CreateTime: Auto-generated.
	CreateTime string `json:"createTime,omitempty"`
	// CreatorEmail: The creator's email address. Auto-generated from the user's
	// email.
	CreatorEmail string `json:"creatorEmail,omitempty"`
	// Description: User-provided description intended to give more business
	// context about the task.
	Description string `json:"description,omitempty"`
	// DisableStrictTypeValidation: If this config contains a TypedTask, allow
	// validation to succeed if an input is read from the output of another
	// TypedTask whose output type is declared as a superclass of the requested
	// input type. For instance, if the previous task declares an output of type
	// Message, any task with this flag enabled will pass validation when
	// attempting to read any proto Message type from the resultant Event
	// parameter.
	DisableStrictTypeValidation bool `json:"disableStrictTypeValidation,omitempty"`
	// ErrorCatcherId: Optional Error catcher id of the error catch flow which will
	...
	// FailurePolicy: Optional. Determines the number of times the task will be
	// retried on failure and with what retry strategy. This is applicable for
	...
	// JsonValidationOption: If set, overrides the option configured in the Task
	...
	// NextTasks: The set of tasks that are next in line to be executed as per the
	...
	// NextTasksExecutionPolicy: The policy dictating the execution of the next set
	// of tasks for the current task.
	//
	// Possible values:
	//   "UNSPECIFIED" - Default
	...
	// Position: Optional. Informs the front-end application where to draw this
	// task config on the UI.
	...
	// execution. Independent of other conditions and tasks. Can be used to enable
	// rollout. e.g. "rollout(5)" will only allow 5% of incoming traffic to task.
	...
	// RollbackStrategy: Optional. Contains information about what needs to be done
	// upon failure (either a permanent error or after it has been retried too many
	// times).
	...
	// SynchronousCallFailurePolicy: Optional. Determines the number of times the
	// task will be retried on failure and with what retry strategy. This is
	// applicable for synchronous calls to Eventbus alone (Post).
	...
	// TaskExecutionStrategy: The policy dictating the execution strategy of this
	// task.
	//
	// Possible values:
	...
	//   "WHEN_ANY_SUCCEED" - Start execution as long as any of its previous tasks
	// finished execution and the corresponding edge condition is met (since we
	// will execute if only that succeeding edge condition is met).
	...
	TaskName string `json:"taskName,omitempty"`
	// TaskNumber: REQUIRED: the identifier of this task within its parent event
	// config, specified by the client. This should be unique among all the tasks
	// belong to the same event config. We use this field as the identifier to find
	// next tasks (via field `next_tasks.task_number`).
	TaskNumber string `json:"taskNumber,omitempty"`
	// TaskSpec: A string template that allows user to configure task parameters
	// (with either literal default values or tokens which will be resolved at
	// execution time) for the task. It will eventually replace the old
	// "parameters" field.
	TaskSpec string `json:"taskSpec,omitempty"`
	// TaskTemplateName: Used to define task-template name if task is of type
	// task-template
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AlertConfigs") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// EnterpriseCrmFrontendsEventbusProtoTaskEntity: Contains a task's metadata
// and associated information. Next available id: 7
type EnterpriseCrmFrontendsEventbusProtoTaskEntity struct {
	...
	// ParamSpecs: Declarations for inputs/outputs for a TypedTask. This is also
	// associated with the METADATA mask.
	...
	// task
	TaskType string `json:"taskType,omitempty"`
	// UiConfig: UI configuration for this task Also associated with the METADATA
	// mask.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "DisabledForVpcSc") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// EnterpriseCrmFrontendsEventbusProtoTriggerConfig: Configuration detail of a
// trigger. Next available id: 19
type EnterpriseCrmFrontendsEventbusProtoTriggerConfig struct {
	// AlertConfig: An alert threshold configuration for the [trigger + client +
	// workflow] tuple. If these values are not specified in the trigger config,
	// default values will be populated by the system. Note that there must be
	// exactly one alert threshold configured per [client + trigger + workflow]
	// when published.
	...
	// execute the workflow using this trigger. In other words, these clients have
	// the workflow execution privledges for this trigger. For API trigger, the
	// client id in the incoming request is validated against the list of enabled
	// clients. For non-API triggers, one workflow execution is triggered on behalf
	// of each enabled client.
	...
	// condition.
	NextTasksExecutionPolicy string `json:"nextTasksExecutionPolicy,omitempty"`
	// PauseWorkflowExecutions: Optional. If set to true, any upcoming requests for
	// this trigger config will be paused and the executions will be resumed later
	// when the flag is reset. The workflow to which this trigger config belongs
	// has to be in ACTIVE status for the executions to be paused or resumed.
	PauseWorkflowExecutions bool `json:"pauseWorkflowExecutions,omitempty"`
	// Position: Optional. Informs the front-end application where to draw this
	// trigger config on the UI.
	Position *EnterpriseCrmEventbusProtoCoordinate `json:"position,omitempty"`
	// Properties: Configurable properties of the trigger, not to be confused with
	// workflow parameters. E.g. "name" is a property for API triggers and
	// "subscription" is a property for Cloud Pubsub triggers.
	Properties map[string]string `json:"properties,omitempty"`
	// StartTasks: Set of tasks numbers from where the workflow execution is
	// started by this trigger. If this is empty, then workflow is executed with
	// default start tasks. In the list of start tasks, none of two tasks can have
	// direct ancestor-descendant relationships (i.e. in a same workflow execution
	// graph).
	StartTasks []*EnterpriseCrmEventbusProtoNextTask `json:"startTasks,omitempty"`
	// TriggerCriteria: Optional. When set, Eventbus will run the task specified in
	// the trigger_criteria and validate the result using the
...
type EnterpriseCrmFrontendsEventbusProtoWorkflowParameterEntry struct {
	...
	// Children: Child parameters nested within this parameter. This field only
	// applies to protobuf parameters
	...
	//   "OUT" - Output Parameters for the workflow. EventBus will only return the
	// workflow parameters tagged with OUT in the response back.
	//   "IN_OUT" - Input or Output Parameters. These can be used as both input and
	// output. EventBus will validate for the existence of these parameters before
	...
	// "myName".
	Name string `json:"name,omitempty"`
	// ProducedBy: The identifier of the node (TaskConfig/TriggerConfig) this
	// parameter was produced by, if it is a transient param or a copy of an input
	// param.
	ProducedBy *EnterpriseCrmEventbusProtoNodeIdentifier `json:"producedBy,omitempty"`
	Producer   string                                    `json:"producer,omitempty"`
	// ProtoDefName: The name of the protobuf type if the parameter has a protobuf
	// data type.
	ProtoDefName string `json:"protoDefName,omitempty"`
	// ProtoDefPath: If the data type is of type proto or proto array, this field
	// needs to be populated with the fully qualified proto name. This message, for
	// example, would be
...
// EnterpriseCrmFrontendsEventbusProtoWorkflowParameters: LINT.IfChange This is
// the frontend version of WorkflowParameters. It's exactly like the backend
// version except that instead of flattening protobuf parameters and treating
// every field and subfield of a protobuf parameter as a separate parameter,
// the fields/subfields of a protobuf parameter will be nested as "children"
// (see 'children' field below) parameters of the parent parameter. Please
// refer to enterprise/crm/eventbus/proto/workflow_parameters.proto for more
// information about WorkflowParameters.
type EnterpriseCrmFrontendsEventbusProtoWorkflowParameters struct {
	// Parameters: Parameters are a part of Event and can be used to communiticate
	// between different tasks that are part of the same workflow execution.
...
// EnterpriseCrmLoggingGwsFieldLimits: Describes string and array limits when
// writing to logs. When a limit is exceeded the *shortener_type* describes how
// to shorten the field. next_id: 6
type EnterpriseCrmLoggingGwsFieldLimits struct {
	...
	//   "GTS" - Limits apply when log detail records are written to GTS (e.g.,
	// RecordIO files).
	//   "ALL" - Limits apply to *all* output log types.
	LogType []string `json:"logType,omitempty"`
	// MaxArraySize: maximum array size. If the array exceds this size, the field
	// (list) is truncated.
	MaxArraySize int64 `json:"maxArraySize,omitempty"`
	// MaxStringLength: maximum string length. If the field exceeds this amount the
	// field is shortened.
	...
	//   "SHORTEN_EMAIL" - String shortening for email addresses. Shortening may be
	// done on the user and/or domain portion of the email address.
	//   "SHORTEN_EMAIL_WITH_HASH" - String is replaced by a combination of string
	// shortening and a hex-string hash for an email address.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "LogAction") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// EnterpriseCrmLoggingGwsSanitizeOptions: Identifies whether a field contains,
// or may contain, PII or sensitive data, and how to sanitize the field if it
// does. If a field's privacy type cannot be determined then it is sanitized
// (e.g., scrubbed). The specific sanitizer implementation is determined by
// run-time configuration and environment options (e.g., prod vs. qa). next_id:
// 5
type EnterpriseCrmLoggingGwsSanitizeOptions struct {
	// IsAlreadySanitized: If true, the value has already been sanitized and needs
	// no further sanitization. For instance, a D3 customer id is already an
	// obfuscated entity and *might not* need further sanitization.
	...
	// events. However, a given value, is transformed to the same value *within* an
	// event. E.g., "foo.com" is transformed to "0xabcdef" for event 1001, and to
	// "0xfedcba" for event 1002.
	//   "ANONYMIZE_LIMITED_REPEATABLE" - Transform values as with ANONYMIZER, but
	// the same transformation is repeated for a limited time (e.g., 1 day).
	...
	// ForceSendFields is a list of field names (e.g. "IsAlreadySanitized") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "IsAlreadySanitized") to include
	// in API requests with the JSON null value. By default, fields with empty
	// values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// GoogleCloudConnectorsV1AuthConfigOauth2AuthCodeFlow: Parameters to support
// Oauth 2.0 Auth Code Grant Authentication. See
...
// GoogleCloudConnectorsV1AuthConfigOauth2ClientCredentials: Parameters to
// support Oauth 2.0 Client Credentials Grant Authentication. See
...
// GoogleCloudConnectorsV1AuthConfigOauth2JwtBearer: Parameters to support JSON
...
// GoogleCloudConnectorsV1AuthConfigOauth2JwtBearerJwtClaims: JWT claims used
// for the jwt-bearer authorization grant.
...
// GoogleCloudConnectorsV1AuthConfigSshPublicKey: Parameters to support Ssh
...
// GoogleCloudConnectorsV1Connection: Connection represents an instance of
// connector.
type GoogleCloudConnectorsV1Connection struct {
	...
	Description string `json:"description,omitempty"`
	// DestinationConfigs: Optional. Configuration of the Connector's destination.
	...
	// Labels: Optional. Resource labels to represent user-provided metadata. Refer
	...
	// ServiceAccount: Optional. Service account needed for runtime plane to access
	// GCP resources.
	ServiceAccount string `json:"serviceAccount,omitempty"`
	...
	// "projects/cloud-connectors-e2e-testing/locations/us-central1/namespaces/istio
...
// GoogleCloudConnectorsV1ConnectionStatus: ConnectionStatus indicates the
...
// GoogleCloudConnectorsV1DestinationConfig: Define the Connectors target
// endpoint.
...
// GoogleCloudConnectorsV1LockConfig: Determines whether or no a connection is
// locked. If locked, a reason must be specified.
...
// GoogleCloudConnectorsV1Secret: Secret provides a reference to entries in
// Secret Manager.
...
// GoogleCloudIntegrationsV1alphaAccessToken: The access token represents the
// authorization of a specific application to access specific parts of a
// user’s data.
type GoogleCloudIntegrationsV1alphaAccessToken struct {
	// AccessToken: The access token encapsulating the security identity of a
	// process or thread.
	AccessToken string `json:"accessToken,omitempty"`
	// AccessTokenExpireTime: Required. The approximate time until the access token
	// retrieved is valid.
	AccessTokenExpireTime string `json:"accessTokenExpireTime,omitempty"`
	// RefreshToken: If the access token will expire, use the refresh token to
...
// GoogleCloudIntegrationsV1alphaAuthConfig: The AuthConfig resource use to
// hold channels and connection config data.
type GoogleCloudIntegrationsV1alphaAuthConfig struct {
	...
	CreateTime string `json:"createTime,omitempty"`
	// CreatorEmail: The creator's email address. Generated based on the End User
	...
	// ExpiryNotificationDuration: User can define the time to receive notification
	// after which the auth config becomes invalid. Support up to 30 days. Support
	// granularity in hours.
	ExpiryNotificationDuration []string `json:"expiryNotificationDuration,omitempty"`
	// LastModifierEmail: The last modifier's email address. Generated based on the
	// End User Credentials/LOAS role of the user making the call.
	...
	Name string `json:"name,omitempty"`
	// OverrideValidTime: User provided expiry time to override. For the example of
	...
	UpdateTime string `json:"updateTime,omitempty"`
	// ValidTime: The time until the auth config is valid. Empty or max value is
...
// GoogleCloudIntegrationsV1alphaAuthToken: The credentials to authenticate a
// user agent with a server that is put in HTTP Authorization request header.
...
// GoogleCloudIntegrationsV1alphaBooleanParameterArray: This message only
// contains a field of boolean array.
...
// GoogleCloudIntegrationsV1alphaCancelExecutionRequest: Request for cancelling
// an execution.
...
type GoogleCloudIntegrationsV1alphaCancelExecutionResponse struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "IsCanceled") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type GoogleCloudIntegrationsV1alphaCertificate struct {
	...
	// CredentialId: Immutable. Credential id that will be used to register with
	// trawler INTERNAL_ONLY
	...
	// RequestorId: Immutable. Requestor ID to be used to register certificate with
	// trawler
	...
	// ValidStartTime: Output only. The timestamp after which certificate will be
	// valid
	ValidStartTime string `json:"validStartTime,omitempty"`

	// ServerResponse contains the HTTP response code and headers from the server.
	googleapi.ServerResponse `json:"-"`
	// ForceSendFields is a list of field names (e.g. "CertificateStatus") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "CertificateStatus") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// GoogleCloudIntegrationsV1alphaClientCertificate: Contains client certificate
// information
type GoogleCloudIntegrationsV1alphaClientCertificate struct {
	// EncryptedPrivateKey: The ssl certificate encoded in PEM format. This string
	// must include the begin header and end footer lines. For example, -----BEGIN
	// CERTIFICATE-----
	...
	// encrypted. Note that 'passphrase' is not the password for web server, but an
	// extra layer of security to protected private key.
	Passphrase string `json:"passphrase,omitempty"`
	// SslCertificate: The ssl certificate encoded in PEM format. This string must
	// include the begin header and end footer lines. For example, -----BEGIN
	// CERTIFICATE-----
	// MIICTTCCAbagAwIBAgIJAPT0tSKNxan/MA0GCSqGSIb3DQEBCwUAMCoxFzAVBgNV
	// BAoTDkdvb2dsZSBURVNUSU5HMQ8wDQYDVQQDEwZ0ZXN0Q0EwHhcNMTUwMTAxMDAw
	// MDAwWhcNMjUwMTAxMDAwMDAwWjAuMRcwFQYDVQQKEw5Hb29nbGUgVEVTVElORzET
	...
	// ForceSendFields is a list of field names (e.g. "EncryptedPrivateKey") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "EncryptedPrivateKey") to include
	// in API requests with the JSON null value. By default, fields with empty
	// values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// GoogleCloudIntegrationsV1alphaCloudSchedulerConfig: Cloud Scheduler Trigger
// configuration
...
// GoogleCloudIntegrationsV1alphaConnectionSchemaMetadata: Metadata of runtime
// connection schema.
...
// GoogleCloudIntegrationsV1alphaCreateAppsScriptProjectRequest: Request for
// CreateAppsScriptProject rpc call.
type GoogleCloudIntegrationsV1alphaCreateAppsScriptProjectRequest struct {
	...
	AuthConfigId string `json:"authConfigId,omitempty"`
	// ForceSendFields is a list of field names (e.g. "AppsScriptProject") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AppsScriptProject") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// GoogleCloudIntegrationsV1alphaCreateAppsScriptProjectResponse: Response for
// CreateAppsScriptProject rpc call.
...
// GoogleCloudIntegrationsV1alphaCredential: Defines parameters for a single,
...
type GoogleCloudIntegrationsV1alphaCredential struct {
	...
	// Oauth2AuthorizationCode: The api_key and oauth2_implicit are not covered in
	// v1 and will be picked up once v1 is implemented. ApiKey api_key = 3; OAuth2
	...
	// Oauth2ClientCredentials: OAuth2Implicit oauth2_implicit = 5; OAuth2 client
	// credentials
...
// GoogleCloudIntegrationsV1alphaDownloadIntegrationVersionResponse: Response
// for DownloadIntegrationVersion.
...
// GoogleCloudIntegrationsV1alphaErrorCatcherConfig: Configuration detail of a
// error catch task
type GoogleCloudIntegrationsV1alphaErrorCatcherConfig struct {
	...
	Label string `json:"label,omitempty"`
	// Position: Optional. Informs the front-end application where to draw this
	// error catcher config on the UI.
...
// GoogleCloudIntegrationsV1alphaEventParameter: This message is used for
// processing and persisting (when applicable) key value pair parameters for
// each event in the event bus.
...
// GoogleCloudIntegrationsV1alphaExecuteEventRequest: Request for triggering an
// integration using event triggers.
type GoogleCloudIntegrationsV1alphaExecuteEventRequest struct {
	// CloudEvent: Required. Details about the trigger which is to be executed and
	// values for input variable to the integration.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "CloudEvent") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// GoogleCloudIntegrationsV1alphaExecuteIntegrationsRequest: The request for
// executing an integration.
type GoogleCloudIntegrationsV1alphaExecuteIntegrationsRequest struct {
	// DoNotPropagateError: Optional. Flag to determine how to should propagate
	// errors. If this flag is set to be true, it will not throw an exception.
	// Instead, it will return a {@link ExecuteIntegrationsResponse} with an
	// execution id and error messages as PostWithTriggerIdExecutionException in
	// {@link EventParameters}. The flag is set to be false by default.
	...
	// ParameterEntries: Optional. Parameters are a part of Event and can be used
	// to communicate between different tasks that are part of the same integration
	// execution.
	ParameterEntries []*EnterpriseCrmFrontendsEventbusProtoParameterEntry `json:"parameterEntries,omitempty"`
	// Parameters: Optional. Passed in as parameters to each integration execution.
	// Redacted
	Parameters *EnterpriseCrmFrontendsEventbusProtoEventParameters `json:"parameters,omitempty"`
	// RequestId: Optional. This is used to de-dup incoming request: if the
	// duplicate request was detected, the response from the previous execution is
	// returned.
	RequestId string `json:"requestId,omitempty"`
	// TriggerId: Required. Matched against all {@link TriggerConfig}s across all
	// integrations. i.e. TriggerConfig.trigger_id.equals(trigger_id). The
	// trigger_id is in the format of `api_trigger/TRIGGER_NAME`.
	TriggerId string `json:"triggerId,omitempty"`
	// ForceSendFields is a list of field names (e.g. "DoNotPropagateError") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "DoNotPropagateError") to include
	// in API requests with the JSON null value. By default, fields with empty
	// values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// GoogleCloudIntegrationsV1alphaExecuteIntegrationsResponse: The response for
// executing an integration.
type GoogleCloudIntegrationsV1alphaExecuteIntegrationsResponse struct {
	...
	// ExecutionFailed: Is true if any execution in the integration failed. False
	// otherwise.
	ExecutionFailed bool `json:"executionFailed,omitempty"`
	// ExecutionId: The id of the execution corresponding to this run of
	// integration.
	ExecutionId string `json:"executionId,omitempty"`
	// OutputParameters: OUTPUT parameters in format of Map. Where Key is the name
	// of the parameter. Note: Name of the system generated parameters are wrapped
	// by backtick(`) to distinguish them from the user defined parameters.
	...
	// communicate between different tasks that are part of the same integration
	// execution.
	ParameterEntries []*EnterpriseCrmFrontendsEventbusProtoParameterEntry `json:"parameterEntries,omitempty"`
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "EventParameters") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// GoogleCloudIntegrationsV1alphaExecution: The Execution resource contains
// detailed information of an individual integration execution.
type GoogleCloudIntegrationsV1alphaExecution struct {
	...
	// start tasks provided by the matching trigger config otherwise it is executed
	// from the default start tasks.
	TriggerId string `json:"triggerId,omitempty"`
...
// GoogleCloudIntegrationsV1alphaExecutionDetails: Contains the details of the
// execution info: this includes the tasks execution details plus the event
...
type GoogleCloudIntegrationsV1alphaExecutionDetails struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AttemptStats") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// GoogleCloudIntegrationsV1alphaExecutionSnapshot: Contains the snapshot of
// the execution for a given checkpoint.
type GoogleCloudIntegrationsV1alphaExecutionSnapshot struct {
	// CheckpointTaskNumber: Indicates "after which checkpoint task's execution"
...
type GoogleCloudIntegrationsV1alphaExecutionSnapshotExecutionSnapshotMetadata struct {
	// ExecutionAttempt: the execution attempt number this snapshot belongs to.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ExecutionAttempt") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// GoogleCloudIntegrationsV1alphaFailurePolicy: Policy that defines the task
// retry logic and failure type. If no FailurePolicy is defined for a task, all
// its dependent tasks will not be executed (i.e, a `retry_strategy` of NONE
// will be applied).
type GoogleCloudIntegrationsV1alphaFailurePolicy struct {
	...
	// strategy. A jitter is added to each exponential interval so that
	// concurrently failing tasks of the same type do not end up retrying after the
	// exact same exponential interval. max_retries and interval_in_seconds must be
	// specified.
	//   "LINEAR_BACKOFF" - The task will be retried from the failed task onwards
	// after a fixed delay that linearly increases with each retry attempt. A
	// jitter is added to each exponential interval so that concurrently failing
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "IntervalTime") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// GoogleCloudIntegrationsV1alphaGenerateTokenResponse: Returns success or
// error message
type GoogleCloudIntegrationsV1alphaGenerateTokenResponse struct {
	// Message: The message that notifies the user if the request succeeded or not.
...
// GoogleCloudIntegrationsV1alphaIntParameterArray: This message only contains
// a field of integer array.
...
// GoogleCloudIntegrationsV1alphaIntegrationAlertConfig: Message to be used to
// configure custom alerting in the {@code EventConfig} protos for an event.
type GoogleCloudIntegrationsV1alphaIntegrationAlertConfig struct {
	// AggregationPeriod: The period over which the metric value should be
	// aggregated and evaluated. Format is , where integer should be a positive
	// integer and unit should be one of (s,m,h,d,w) meaning (second, minute, hour,
	// day, week). For an EXPECTED_MIN threshold, this aggregation_period must be
	// lesser than 24 hours.
	AggregationPeriod string `json:"aggregationPeriod,omitempty"`
	// AlertThreshold: For how many contiguous aggregation periods should the
	// expected min or max be violated for the alert to be fired.
	AlertThreshold int64 `json:"alertThreshold,omitempty"`
	// DisableAlert: Set to false by default. When set to true, the metrics are not
	// aggregated or pushed to Monarch for this integration alert.
	DisableAlert bool `json:"disableAlert,omitempty"`
	// DisplayName: Name of the alert. This will be displayed in the alert subject.
	// If set, this name should be unique within the scope of the integration.
	DisplayName string `json:"displayName,omitempty"`
	...
	//   "EVENT_WARNING_RATE" - Specifies alerting on the rate of warnings for the
	// enclosing integration. Warnings use the same enum values as errors.
	//   "TASK_ERROR_RATE" - Specifies alerting on the rate of errors for any task
	// in the enclosing integration.
	//   "TASK_WARNING_RATE" - Specifies alerting on the rate of warnings for any
	...
	//   "EVENT_PERCENTILE_DURATION" - Specifies alerting on the duration value of
	// a particular percentile of integration executions. E.g. If 10% or more of
	// the integration executions have durations above 5 seconds, alert.
	//   "TASK_AVERAGE_DURATION" - Specifies alerting on the average duration of
	// any task in the enclosing integration,
	//   "TASK_PERCENTILE_DURATION" - Specifies alerting on the duration value of a
	// particular percentile of any task executions within the enclosing
...
// GoogleCloudIntegrationsV1alphaIntegrationAlertConfigThresholdValue: The
// threshold value of the metric, above or below which the alert should be
...
// GoogleCloudIntegrationsV1alphaIntegrationParameter: Integration Parameter is
// defined in the integration config and are used to provide information about
// data types of the expected parameters and provide any default values if
// needed. They can also be used to add custom attributes. These are static in
// nature and should not be used for dynamic event definition.
...
type GoogleCloudIntegrationsV1alphaIntegrationTemplateVersion struct {
	...
	CreateTime string `json:"createTime,omitempty"`
	// DatabasePersistencePolicy: Optional. Flag to disable database persistence
	// for execution data, including event execution info, execution export info,
	// execution metadata index and execution param index.
	//
	// Possible values:
	...
	// Description: Optional. The templateversion description. Permitted format is
	...
	// LastModifierEmail: Optional. The last modifier's email address. Generated
	// based on the End User Credentials/LOAS role of the user making the call.
	LastModifierEmail string `json:"lastModifierEmail,omitempty"`
	// Name: Output only. Auto-generated primary key. Format:
	// projects/{project}/locations/{location}/products/{product}/integrationtemplat
	// es/{integrationtemplate}/versions/{version}
	Name string `json:"name,omitempty"`
	// ParentIntegrationVersionId: Optional. ID of the IntegrationVersion that was
	// used to create this IntegrationTemplateVersion
	ParentIntegrationVersionId string `json:"parentIntegrationVersionId,omitempty"`
	// SnapshotNumber: Output only. An increasing sequence that is set when a new
	// snapshot is created.
	SnapshotNumber int64 `json:"snapshotNumber,omitempty,string"`
	...
	// Teardown: Optional. Contains a graph of tasks that will be executed before
	// putting the event in a terminal state (SUCCEEDED/FAILED/FATAL), regardless
	// of success or failure, similar to "finally" in code.
	Teardown *EnterpriseCrmEventbusProtoTeardown `json:"teardown,omitempty"`
	// TemplateParameters: Optional. Parameters that are expected to be passed to
	// the IntegrationTemplateVersion when an event is triggered. This consists of
	// all the parameters that are expected in the IntegrationTemplateVersion
...
// GoogleCloudIntegrationsV1alphaIntegrationVersion: The integration version
// definition.
type GoogleCloudIntegrationsV1alphaIntegrationVersion struct {
	...
	// parameters that are expected in the integration execution. This gives the
	// user the ability to provide default values, add information like PII and
	// also provide data types of each parameter.
	IntegrationParameters []*GoogleCloudIntegrationsV1alphaIntegrationParameter `json:"integrationParameters,omitempty"`
	// IntegrationParametersInternal: Optional. Parameters that are expected to be
	// passed to the integration when an event is triggered. This consists of all
	// the parameters that are expected in the integration execution. This gives
	// the user the ability to provide default values, add information like PII and
	// also provide data types of each parameter.
	...
	// based on the End User Credentials/LOAS role of the user making the call.
	LastModifierEmail string `json:"lastModifierEmail,omitempty"`
	// LockHolder: Optional. The edit lock holder's email address. Generated based
	// on the End User Credentials/LOAS role of the user making the call.
	LockHolder string `json:"lockHolder,omitempty"`
	// Name: Output only. Auto-generated primary key.
	Name string `json:"name,omitempty"`
	// Origin: Optional. The origin that indicates where this integration is coming
	// from.
	//
	// Possible values:
	//   "UNSPECIFIED"
	//   "UI" - Workflow is being created via event bus UI.
	//   "PIPER_V2" - User checked in this workflow in Piper as v2 textproto format
	// and we synced it into spanner.
	//   "PIPER_V3" - User checked in this workflow in piper as v3 textproto format
	// and we synced it into spanner.
	//   "APPLICATION_IP_PROVISIONING" - Workflow is being created via Standalone
	// IP Provisioning
	Origin string `json:"origin,omitempty"`
	// ParentTemplateId: Optional. The id of the template which was used to create
	// this integration_version.
	ParentTemplateId string `json:"parentTemplateId,omitempty"`
	// RunAsServiceAccount: Optional. The run-as service account email, if set and
	// auth config is not configured, that will be used to generate auth token to
	// be used in Connector task, Rest caller task and Cloud function task.
	...
	// snapshot need not be same as the HEAD. So users should always use "HEAD" tag
	...
	//   "SNAPSHOT" - Snapshot.
	State string `json:"state,omitempty"`
	// Status: Output only. Generated by eventbus. User should not set it as an
	// input.
	//
	// Possible values:
	//   "UNKNOWN"
	...
	// TaskConfigsInternal: Optional. Task configuration for the integration. It's
	// optional, but the integration doesn't do anything without task_configs.
...
// GoogleCloudIntegrationsV1alphaJwt: Represents JSON web token(JWT), which is
// a compact, URL-safe means of representing claims to be transferred between
// two parties, enabling the claims to be digitally signed or integrity
// protected.
type GoogleCloudIntegrationsV1alphaJwt struct {
	...
	// JwtPayload: Contains a set of claims. The JWT specification defines seven
	// Registered Claim Names which are the standard fields commonly included in
	// tokens. Custom claims are usually also included, depending on the purpose of
	// the token.
...
type GoogleCloudIntegrationsV1alphaLiftSuspensionRequest struct {
	// SuspensionResult: User passed in suspension result and will be used to
	// control workflow execution branching behavior by setting up corresponnding
	// edge condition with suspension result. For example, if you want to lift the
	// suspension, you can pass "Approved", or if you want to reject the suspension
	// and terminate workfloe execution, you can pass "Rejected" and terminate the
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "SuspensionResult") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// GoogleCloudIntegrationsV1alphaLiftSuspensionResponse: Response of lift
// Suspense
type GoogleCloudIntegrationsV1alphaLiftSuspensionResponse struct {
	...
	// ServerResponse contains the HTTP response code and headers from the server.
	googleapi.ServerResponse `json:"-"`
	// ForceSendFields is a list of field names (e.g. "EventExecutionInfoId") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "EventExecutionInfoId") to include
	// in API requests with the JSON null value. By default, fields with empty
	// values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// GoogleCloudIntegrationsV1alphaLinkAppsScriptProjectRequest: Request for
// LinkAppsScriptProject rpc call.
type GoogleCloudIntegrationsV1alphaLinkAppsScriptProjectRequest struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ScriptId") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// GoogleCloudIntegrationsV1alphaLinkAppsScriptProjectResponse: Response for
// LinkAppsScriptProject rpc call.
...
// GoogleCloudIntegrationsV1alphaListAuthConfigsResponse: Response to list
// AuthConfigs.
type GoogleCloudIntegrationsV1alphaListAuthConfigsResponse struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AuthConfigs") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// GoogleCloudIntegrationsV1alphaListCertificatesResponse: Response to list
// Certificates.
...
// GoogleCloudIntegrationsV1alphaListConnectionsResponse: Response containing
// Connections listed by region.
...
// GoogleCloudIntegrationsV1alphaListExecutionsResponse: Response for listing
// the integration execution data.
type GoogleCloudIntegrationsV1alphaListExecutionsResponse struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ExecutionInfos") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type GoogleCloudIntegrationsV1alphaListIntegrationTemplateVersionsResponse struct {
	// IntegrationTemplateVersions: The IntegrationTemplateVersions which match the
	// request.
	...
	googleapi.ServerResponse `json:"-"`
	// ForceSendFields is a list of field names (e.g.
	// "IntegrationTemplateVersions") to unconditionally include in API requests.
	// By default, fields with empty or default values are omitted from API
	// requests. See https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields
	// for more details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "IntegrationTemplateVersions") to
	// include in API requests with the JSON null value. By default, fields with
	// empty values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// GoogleCloudIntegrationsV1alphaListIntegrationVersionsResponse: Response for
...
type GoogleCloudIntegrationsV1alphaListIntegrationVersionsResponse struct {
	...
	// next page. If this field is omitted, there are no subsequent pages.
	NextPageToken string `json:"nextPageToken,omitempty"`
	// NoPermission: Whether the user has no permission on the version or not.
	NoPermission bool `json:"noPermission,omitempty"`

	// ServerResponse contains the HTTP response code and headers from the server.
	googleapi.ServerResponse `json:"-"`
	// ForceSendFields is a list of field names (e.g. "IntegrationVersions") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "IntegrationVersions") to include
	// in API requests with the JSON null value. By default, fields with empty
	// values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type GoogleCloudIntegrationsV1alphaListIntegrationsResponse struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "Integrations") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// GoogleCloudIntegrationsV1alphaListRuntimeActionSchemasResponse: Response for
// listing RuntimeActionSchemas for a specific Connection.
...
// GoogleCloudIntegrationsV1alphaListRuntimeEntitySchemasResponse: Response for
// listing RuntimeEntitySchemas for a specific Connection.
...
// GoogleCloudIntegrationsV1alphaListSfdcChannelsResponse: Response to list
// SfdcChannels.
...
// GoogleCloudIntegrationsV1alphaListSfdcInstancesResponse: Response to list
// SfdcInstances.
...
type GoogleCloudIntegrationsV1alphaListSuspensionsResponse struct {
	...
	NextPageToken string `json:"nextPageToken,omitempty"`
	// Suspensions: The suspensions for the relevant execution which the caller has
...
// GoogleCloudIntegrationsV1alphaNextTask: The task that is next in line to be
// executed, if the condition specified evaluated to true.
type GoogleCloudIntegrationsV1alphaNextTask struct {
	// Condition: Standard filter expression for this task to become an eligible
	// next task.
	Condition string `json:"condition,omitempty"`
	// Description: User-provided description intended to give additional business
	// context about the task.
	Description string `json:"description,omitempty"`
...
// GoogleCloudIntegrationsV1alphaOAuth2AuthorizationCode: The OAuth Type where
// the client sends request with the client id and requested scopes to auth
// endpoint. User sees a consent screen and auth code is received at specified
// redirect url afterwards. The auth code is then combined with the client id
// and secret and sent to the token endpoint in exchange for the access and
// refresh token. The refresh token can be used to fetch new access tokens.
type GoogleCloudIntegrationsV1alphaOAuth2AuthorizationCode struct {
	...
	// ApplyReauthPolicy: Indicates if the user has opted in Google Reauth Policy.
	// If opted in, the refresh token will be valid for 20 hours, after which time
	// users must re-authenticate in order to obtain a new one.
	...
	// parameter.
	//   "ENCODED_HEADER" - To pass client id and client secret as base 64 encoding
	// of client_id:client_password and rest parameters in post body.
...
// 'client_credentials' to the authorization server. The authorization server
...
type GoogleCloudIntegrationsV1alphaOAuth2ClientCredentials struct {
	...
	// Scope: A space-delimited list of requested scope permissions.
	Scope string `json:"scope,omitempty"`
	// TokenEndpoint: The token endpoint is used by the client to obtain an access
...
// GoogleCloudIntegrationsV1alphaOAuth2ResourceOwnerCredentials: For resource
// owner credentials grant, the client will ask the user for their
...
type GoogleCloudIntegrationsV1alphaOidcToken struct {
	...
	Audience string `json:"audience,omitempty"`
	// ServiceAccountEmail: The service account email to be used as the identity
	// for the token.
	ServiceAccountEmail string `json:"serviceAccountEmail,omitempty"`
...
// GoogleCloudIntegrationsV1alphaParameterMap: A generic multi-map that holds
// key value pairs. They keys and values can be of any type, unless specified.
type GoogleCloudIntegrationsV1alphaParameterMap struct {
	...
	// KeyType: Option to specify key type for all entries of the map. If provided
	...
	//   "PROTO_ARRAY" - Proto Array (Internal use only).
	KeyType string `json:"keyType,omitempty"`
	// ValueType: Option to specify value type for all entries of the map. If
	// provided then field types for all entries must conform to this.
	//
	// Possible values:
	//   "INTEGRATION_PARAMETER_DATA_TYPE_UNSPECIFIED" - Unspecified.
...
// GoogleCloudIntegrationsV1alphaParameterMapEntry: Entry is a pair of key and
// value.
...
// GoogleCloudIntegrationsV1alphaParameterMapField: Field represents either the
// key or value in an entry.
...
// GoogleCloudIntegrationsV1alphaPublishIntegrationVersionRequest: Request for
// PublishIntegrationVersion.
type GoogleCloudIntegrationsV1alphaPublishIntegrationVersionRequest struct {
}

// GoogleCloudIntegrationsV1alphaPublishIntegrationVersionResponse: Response
// for PublishIntegrationVersion.
...
type GoogleCloudIntegrationsV1alphaResolveSuspensionRequest struct {
	// Suspension: Suspension, containing the event_execution_info_id, task_id, and
	// state to set on the corresponding suspension record.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "Suspension") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// GoogleCloudIntegrationsV1alphaRuntimeActionSchema: Metadata of an action,
// including schemas for its inputs and outputs.
...
// GoogleCloudIntegrationsV1alphaRuntimeEntitySchema: Metadata of an entity,
// including a schema for its properties.
type GoogleCloudIntegrationsV1alphaRuntimeEntitySchema struct {
	// ArrayFieldSchema: The above schema, but for an array of the associated
	// entity.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ArrayFieldSchema") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// GoogleCloudIntegrationsV1alphaScheduleIntegrationsRequest: The request for
...
type GoogleCloudIntegrationsV1alphaScheduleIntegrationsRequest struct {
	...
	Parameters *EnterpriseCrmEventbusProtoEventParameters `json:"parameters,omitempty"`
	// RequestId: This is used to de-dup incoming request: if the duplicate request
	// was detected, the response from the previous execution is returned.
	RequestId string `json:"requestId,omitempty"`
	// ScheduleTime: The time that the integration should be executed. If the time
	// is less or equal to the current time, the integration is executed
	// immediately.
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "InputParameters") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// GoogleCloudIntegrationsV1alphaScheduleIntegrationsResponse: The response for
// executing an integration.
type GoogleCloudIntegrationsV1alphaScheduleIntegrationsResponse struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ExecutionInfoIds") to include in
	// API requests with the JSON null value. By default, fields with empty values
	// are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// GoogleCloudIntegrationsV1alphaServiceAccountCredentials: Represents the
// service account which can be used to generate access token for
// authenticating the service call.
type GoogleCloudIntegrationsV1alphaServiceAccountCredentials struct {
	// Scope: A space-delimited list of requested scope permissions.
	Scope string `json:"scope,omitempty"`
	// ServiceAccount: Name of the service account that has the permission to make
	// the request.
	ServiceAccount string `json:"serviceAccount,omitempty"`
...
// GoogleCloudIntegrationsV1alphaSfdcChannel: The SfdcChannel that points to a
// CDC or Platform Event Channel.
type GoogleCloudIntegrationsV1alphaSfdcChannel struct {
	// ChannelTopic: The Channel topic defined by salesforce once an channel is
	// opened
	ChannelTopic string `json:"channelTopic,omitempty"`
	// CreateTime: Output only. Time when the channel is created
	CreateTime string `json:"createTime,omitempty"`
	// DeleteTime: Output only. Time when the channel was deleted. Empty if not
	// deleted.
	...
	DisplayName string `json:"displayName,omitempty"`
	// IsActive: Indicated if a channel has any active integrations referencing it.
	...
	// projects/{project}/locations/{location}/sfdcInstances/{sfdc_instance}/sfdcCha
	// nnels/{sfdc_channel}.
	Name string `json:"name,omitempty"`
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ChannelTopic") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// GoogleCloudIntegrationsV1alphaSfdcInstance: The SfdcInstance resource use to
// hold channels and connection config data.
type GoogleCloudIntegrationsV1alphaSfdcInstance struct {
	// AuthConfigId: A list of AuthConfigs that can be tried to open the channel to
	// SFDC
	AuthConfigId []string `json:"authConfigId,omitempty"`
	// CreateTime: Output only. Time when the instance is created
	CreateTime string `json:"createTime,omitempty"`
	// DeleteTime: Output only. Time when the instance was deleted. Empty if not
	// deleted.
	DeleteTime string `json:"deleteTime,omitempty"`
	...
	Name string `json:"name,omitempty"`
	// ServiceAuthority: URL used for API calls after authentication (the login
	// authority is configured within the referenced AuthConfig).
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "AuthConfigId") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type GoogleCloudIntegrationsV1alphaSuspension struct {
	// ApprovalConfig: Controls the notifications and approval permissions for this
	// suspension.
	...
	Name string `json:"name,omitempty"`
	// State: Required. State of this suspension, indicating what action a resolver
	// has taken.
	//
	// Possible values:
	...
	State string `json:"state,omitempty"`
	// SuspensionConfig: Controls the notifications and resolver permissions for
	// this suspension.
	SuspensionConfig *EnterpriseCrmEventbusProtoSuspensionConfig `json:"suspensionConfig,omitempty"`
...
// GoogleCloudIntegrationsV1alphaSuspensionApprovalConfig: Configurations for
...
type GoogleCloudIntegrationsV1alphaSuspensionApprovalConfig struct {
	...
	// Expiration: Indicates the next steps when no external actions happen on the
	// suspension.
...
// configs for the approval request.
type GoogleCloudIntegrationsV1alphaSuspensionApprovalExpiration struct {
	// ExpireTime: Output only. Time after which the suspension expires, if no
	// action taken.
	ExpireTime string `json:"expireTime,omitempty"`
	// LiftWhenExpired: Whether the suspension will be REJECTED or LIFTED upon
	// expiration. REJECTED is the default behavior.
	LiftWhenExpired bool `json:"liftWhenExpired,omitempty"`
	// RemindTime: Time after the previous suspension action reminder, if any, is
...
// GoogleCloudIntegrationsV1alphaSuspensionAudit: Contains when and by whom the
...
type GoogleCloudIntegrationsV1alphaSuspensionAudit struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "ResolveTime") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type GoogleCloudIntegrationsV1alphaTakeoverEditLockResponse struct {
	// IntegrationVersion: Version after the lock is acquired by the new user.
	IntegrationVersion *GoogleCloudIntegrationsV1alphaIntegrationVersion `json:"integrationVersion,omitempty"`

	// ServerResponse contains the HTTP response code and headers from the server.
	googleapi.ServerResponse `json:"-"`
	// ForceSendFields is a list of field names (e.g. "IntegrationVersion") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-ForceSendFields for more
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "IntegrationVersion") to include
	// in API requests with the JSON null value. By default, fields with empty
	// values are omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
type GoogleCloudIntegrationsV1alphaTaskConfig struct {
	// Description: Optional. User-provided description intended to give additional
	// business context about the task.
	Description string `json:"description,omitempty"`
	// DisplayName: Optional. User-provided label that is attached to this
	// TaskConfig in the UI.
	DisplayName string `json:"displayName,omitempty"`
	// ErrorCatcherId: Optional. Optional Error catcher id of the error catch flow
	...
	// JsonValidationOption: Optional. If set, overrides the option configured in
	// the Task implementation class.
	//
	// Possible values:
	...
	// NextTasksExecutionPolicy: Optional. The policy dictating the execution of
	// the next set of tasks for the current task.
	//
	// Possible values:
	...
	// error catcher config on the UI.
	Position *GoogleCloudIntegrationsV1alphaCoordinate `json:"position,omitempty"`
	// SuccessPolicy: Optional. Determines what action to take upon successful task
	// completion.
	...
	Task string `json:"task,omitempty"`
	// TaskExecutionStrategy: Optional. The policy dictating the execution strategy
	// of this task.
	//
	// Possible values:
	...
	TaskId string `json:"taskId,omitempty"`
	// TaskTemplate: Optional. Used to define task-template name if task is of type
	// task-template
...
// GoogleCloudIntegrationsV1alphaTaskExecutionDetails: Contains the details of
...
type GoogleCloudIntegrationsV1alphaTaskExecutionDetails struct {
	...
	// wasn't met, or the event execution been canceled before reach to the task.
	// There's no more changes after this state.
	//   "CANCELLED" - Task execution canceled when in progress. This happens when
	// event execution been canceled or any other task fall in fatal state.
	//   "PENDING_ROLLBACK" - Task is waiting for its dependency tasks' rollback to
	// finish to start its rollback.
	//   "ROLLBACK_IN_PROCESS" - Task is rolling back.
...
// GoogleCloudIntegrationsV1alphaTriggerConfig: Configuration detail of a
// trigger.
type GoogleCloudIntegrationsV1alphaTriggerConfig struct {
	// AlertConfig: Optional. An alert threshold configuration for the [trigger +
	// client + integration] tuple. If these values are not specified in the
	// trigger config, default values will be populated by the system. Note that
	// there must be exactly one alert threshold configured per [client + trigger +
	...
	// execution is started by this trigger. If this is empty, then integration is
	// executed with default start tasks. In the list of start tasks, none of two
	// tasks can have direct ancestor-descendant relationships (i.e. in a same
...
// for UnpublishIntegrationVersion.
type GoogleCloudIntegrationsV1alphaUnpublishIntegrationVersionRequest struct {
}

// GoogleCloudIntegrationsV1alphaUploadIntegrationVersionRequest: Request for
...
// GoogleCloudIntegrationsV1alphaUploadIntegrationVersionResponse: Response for
// UploadIntegrationVersion.
...
// GoogleCloudIntegrationsV1alphaUsernameAndPassword: Username and password
// pair.
...
// GoogleInternalCloudCrmEventbusV3PostToQueueWithTriggerIdRequest: Use this
// request to post all workflows associated with a given trigger id. Next
// available id: 11
type GoogleInternalCloudCrmEventbusV3PostToQueueWithTriggerIdRequest struct {
	// ClientId: Optional. If the client id is provided, then the combination of
	// trigger id and client id is matched across all the workflows. If the client
	// id is not provided, then workflows with matching trigger id are executed for
	// each client id in the {@link TriggerConfig}. For Api Trigger, the client id
	// is required and will be validated against the allowed clients.
	ClientId string `json:"clientId,omitempty"`
	// IgnoreErrorIfNoActiveWorkflow: Optional. Flag to determine whether clients
	// would suppress a warning when no ACTIVE workflows are not found. If this
	// flag is set to be true, an error will not be thrown if the requested
	// trigger_id or client_id is not found in any ACTIVE workflow. Otherwise, the
	// error is always thrown. The flag is set to be false by default.
	IgnoreErrorIfNoActiveWorkflow bool `json:"ignoreErrorIfNoActiveWorkflow,omitempty"`
	// Parameters: Passed in as parameters to each workflow execution. Optional.
	Parameters *EnterpriseCrmEventbusProtoEventParameters `json:"parameters,omitempty"`
	// Priority: The request priority this request should be processed at. For
	// internal users:
	//
	// Possible values:
	...
	// other requests. * This is the default for async calls sent from batch jobs.
	...
	// critical traffic. * This is the default for async calls sent from production
	// jobs.
	//   "CRITICAL" - Any outage is a pageable event. * During a production outage
	// requests in this band will only be shed before CRITICAL_PLUS. * This is the
	// default for sync calls sent from production jobs.
	...
	// outage requests in this band will be prioritized above all others. * Opt-in
	// to CRITICAL_PLUS when your workflow triggers by human.
	Priority string `json:"priority,omitempty"`
	// RequestId: Optional. This is used to de-dup incoming request: if the
	// duplicate request was detected, the response from the previous execution is
	// returned. Must have no more than 36 characters and contain only alphanumeric
	// characters and hyphens.
	RequestId string `json:"requestId,omitempty"`
	// ResourceName: This field is only required when using Admin Access. The
	// resource name of target, or the parent resource name. For example:
	// "projects/*/locations/*/integrations/*"
	ResourceName string `json:"resourceName,omitempty"`
	// ScheduledTime: Optional. Time in milliseconds since epoch when the given
	...
	// TriggerId: Matched against all {@link TriggerConfig}s across all workflows.
	// i.e. TriggerConfig.trigger_id.equals(trigger_id) Required.
	TriggerId string `json:"triggerId,omitempty"`
	// WorkflowName: Optional. If provided, the workflow_name is used to filter all
	// the matched workflows having same trigger_id+client_id. A combination of
	// trigger_id, client_id and workflow_name identifies a unique workflow.
	WorkflowName string `json:"workflowName,omitempty"`
	// ForceSendFields is a list of field names (e.g. "ClientId") to
	// unconditionally include in API requests. By default, fields with empty or
	// default values are omitted from API requests. See
...
type IoCloudeventsV1CloudEventCloudEventAttributeValue struct {
	...
	// details.
	ForceSendFields []string `json:"-"`
	// NullFields is a list of field names (e.g. "CeBoolean") to include in API
	// requests with the JSON null value. By default, fields with empty values are
	// omitted from API requests. See
	// https://pkg.go.dev/google.golang.org/api#hdr-NullFields for more details.
	NullFields []string `json:"-"`
...
// GenerateToken: Receives the auth code and auth config id to combine that
// with the client id and secret to retrieve access tokens from the token
// endpoint. Returns either a success or error message when it's done.
...
// GcpProjectId sets the optional parameter "gcpProjectId": The gcp project id
// of the request
...
// Product sets the optional parameter "product": Which product sends the
// request
//
// Possible values:
//
...
// RedirectUri sets the optional parameter "redirectUri": Redirect uri of the
// auth code request
...
// State sets the optional parameter "state": The auth config id for the given
// request
...
// *GoogleCloudIntegrationsV1alphaGenerateTokenResponse.ServerResponse.Header
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaEnumerateConnectorPlatformRegionsResponse.Serv
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaCreateAppsScriptProjectResponse.ServerResponse
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaLinkAppsScriptProjectResponse.ServerResponse.H
...
// Create: Creates an auth config record. Fetch corresponding credentials for
...
// "clientCertificate.encryptedPrivateKey": The ssl certificate encoded in PEM
// format. This string must include the begin header and end footer lines. For
...
// "clientCertificate.passphrase": 'passphrase' should be left unset if private
// key is not encrypted. Note that 'passphrase' is not the password for web
// server, but an extra layer of security to protected private key.
...
// "clientCertificate.sslCertificate": The ssl certificate encoded in PEM
// format. This string must include the begin header and end footer lines. For
// example, -----BEGIN CERTIFICATE-----
// MIICTTCCAbagAwIBAgIJAPT0tSKNxan/MA0GCSqGSIb3DQEBCwUAMCoxFzAVBgNV
// BAoTDkdvb2dsZSBURVNUSU5HMQ8wDQYDVQQDEwZ0ZXN0Q0EwHhcNMTUwMTAxMDAw
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaAuthConfig.ServerResponse.Header or (if a
...
// List: Lists all auth configs that match the filter. Restrict to auth configs
...
// Filter sets the optional parameter "filter": Filtering as supported in
...
// PageSize sets the optional parameter "pageSize": The size of entries in the
// response. If unspecified, defaults to 100.
func (c *ProjectsLocationsAuthConfigsListCall) PageSize(pageSize int64) *ProjectsLocationsAuthConfigsListCall {
	c.urlParams_.Set("pageSize", fmt.Sprint(pageSize))
	return c
}

// PageToken sets the optional parameter "pageToken": The token returned in the
// previous response.
...
// ReadMask sets the optional parameter "readMask": The mask which specifies
// fields that need to be returned in the AuthConfig's response.
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaListAuthConfigsResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// Use googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
...
// Patch: Updates an auth config. If credential is updated, fetch the encrypted
// auth config from Spanner, decrypt with Cloud KMS key, update the credential
...
// UpdateMask sets the optional parameter "updateMask": Field mask specifying
// the fields in the above AuthConfig that have been modified and need to be
// updated.
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaCertificate.ServerResponse.Header or (if a
// response was returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
...
//     projects/{project}/locations/{location}/connections/{connection}/connection
//     SchemaMetadata.
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaConnectionSchemaMetadata.ServerResponse.Header
//
//	or (if a response was returned at all) in error.(*googleapi.Error).Header.
//
// Use googleapi.IsNotModified to check whether the returned error was because
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaListConnectionsResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// Use googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
...
// List: Lists the JSON schemas for the inputs and outputs of actions, filtered
// by action name.
//
...
// Filter sets the optional parameter "filter": Filter. Only the action field
// with literal equality operator is supported.
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaListRuntimeActionSchemasResponse.ServerRespons
...
// Filter sets the optional parameter "filter": Filter. Only the entity field
// with literal equality operator is supported.
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaListRuntimeEntitySchemasResponse.ServerRespons
// e.Header or (if a response was returned at all) in
// error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
...
// Execute: Executes integrations synchronously by passing the trigger id in
// the request body. The request is not returned until the requested executions
// are either fulfilled or experienced an error. If the integration name is not
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaExecuteIntegrationsResponse.ServerResponse.Hea
...
// ExecuteEvent: Executes an integration on receiving events from Integration
// Connector triggers, Eventarc or CPS Trigger. The details about integration
// are derived from CloudEvent request body.
//
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaExecuteEventResponse.ServerResponse.Header or
...
//
//   - parent: Project and location from which the integrations should be listed.
...
// IntegrationVersion. Fields can be compared with literal values by use of ":"
// (containment), "=" (equality), ">" (greater), "<" (less than), >=" (greater
// than or equal to), "<=" (less than or equal to), and "!=" (inequality)
// operators. Negation, conjunction, and disjunction are written using NOT,
// AND, and OR keywords. For example, organization_id=\"1\" AND state=ACTIVE
// AND description:"test". Filtering cannot be performed on repeated fields
// like `task_config`.
...
// OrderBy sets the optional parameter "orderBy": The results would be returned
// in order you specified here. Supported sort keys are: Descending sort order
// by "last_modified_time", "created_time", "snapshot_number". Ascending sort
// order by the integration name.
func (c *ProjectsLocationsIntegrationsListCall) OrderBy(orderBy string) *ProjectsLocationsIntegrationsListCall {
	c.urlParams_.Set("orderBy", orderBy)
	return c
}

// PageSize sets the optional parameter "pageSize": The page size for the
// resquest.
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaListIntegrationsResponse.ServerResponse.Header
//
//	or (if a response was returned at all) in error.(*googleapi.Error).Header.
//
// Use googleapi.IsNotModified to check whether the returned error was because
...
// Schedule: Schedules an integration for execution by passing the trigger id
// and the scheduled time in the request body.
//
// - name: The integration resource name.
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaScheduleIntegrationsResponse.ServerResponse.He
...
// List: Lists the results of all the integration executions. The response
// includes the same information as the execution log
// (https://cloud.google.com/application-integration/docs/viewing-logs) in the
// Integration UI.
//
...
// Filter sets the optional parameter "filter": Standard filter field, we
// support filtering on following fields: workflow_name: the name of the
// integration. CreateTimestamp: the execution created time.
// event_execution_state: the state of the executions. execution_id: the id of
// the execution. trigger_id: the id of the trigger. parameter_type: the type
// of the parameters involved in the execution. All fields support for EQUALS,
// in additional: CreateTimestamp support for LESS_THAN, GREATER_THAN
...
// FilterParamsEndTime sets the optional parameter "filterParams.endTime": End
// timestamp.
...
// "filterParams.parameterKey": Param key. DEPRECATED. User parameter_pair_key
// instead.
...
// "filterParams.parameterPairKey": Param key in the key value pair filter.
...
// "filterParams.parameterPairValue": Param value in the key value pair filter.
...
// FilterParamsStartTime sets the optional parameter "filterParams.startTime":
// Start timestamp.
...
// OrderBy sets the optional parameter "orderBy": The results would be returned
// in order you specified here. Currently supporting "last_modified_time" and
// "create_time".
...
// ReadMask sets the optional parameter "readMask": View mask for the response
// data. If set, only the field specified will be returned as part of the
// result. If not set, all fields in event execution info will be filled and
// returned.
...
// RefreshAcl sets the optional parameter "refreshAcl": If true, the service
// will use the most recent acl information to list event execution infos and
// renew the acl cache. Note that fetching the most recent acl is synchronous,
// so it will increase RPC call latency.
...
// TruncateParams sets the optional parameter "truncateParams": If true, the
// service will truncate the params to only keep the first 1000 characters of
// string params and empty the executions in order to make response smaller.
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaListExecutionsResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// Use googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
...
// Lift: * Lifts suspension for advanced suspension task. Fetch corresponding
...
//     "projects/{project}/locations/{location}/products/{product}/integrations/{i
//     ntegration}/executions/{execution}/suspensions/{suspenion}" format.
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaLiftSuspensionResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// Use googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
...
// List: * Lists suspensions associated with a specific execution. Only those
// with permissions to resolve the relevant suspensions will be able to view
// them.
//
//   - parent:
//     projects/{gcp_project_id}/locations/{location}/products/{product}/integrati
//     ons/{integration_name}/executions/{execution_name}.
...
// PageToken sets the optional parameter "pageToken": Token to retrieve a
// specific page.
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaListSuspensionsResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// Use googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
...
//   - name:
//     projects/{gcp_project_id}/locations/{location}/products/{product}/integrati
//     ons/{integration_name}/executions/{execution_name}/suspensions/{suspension_
//     id}.
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaResolveSuspensionResponse.ServerResponse.Heade
...
//
//   - parent: The parent resource where this version will be created. Format:
...
// NewIntegration sets the optional parameter "newIntegration": Set this flag
// to true, if draft version is to be created for a brand new integration.
// False, if the request is for an existing integration. For backward
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaIntegrationVersion.ServerResponse.Header or
// (if a response was returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
...
// Delete: Soft-deletes the integration. Changes the status of the integration
// to ARCHIVED. If the integration being ARCHIVED is tagged as "HEAD", the tag
// is removed from this snapshot and set to the previous non-ARCHIVED snapshot.
...
// Download: Downloads an integration. Retrieves the `IntegrationVersion` for a
// given `integration_id` and returns the response as a string.
//
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaDownloadIntegrationVersionResponse.ServerRespo
...
// FieldMask sets the optional parameter "fieldMask": The field mask which
// specifies the particular data to be returned.
...
// OrderBy sets the optional parameter "orderBy": The results would be returned
// in order you specified here. Currently supported sort keys are: Descending
// sort order for "last_modified_time", "created_time", "snapshot_number"
...
// from a previous `ListIntegrationVersions` call. Provide this to retrieve the
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaListIntegrationVersionsResponse.ServerResponse
// .Header or (if a response was returned at all) in
// error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
...
// UpdateMask sets the optional parameter "updateMask": Field mask specifying
// the fields in the above integration that have been modified and need to be
// updated.
...
// Publish: This RPC throws an exception if the integration is in ARCHIVED or
// ACTIVE state. This RPC throws an exception if the version being published is
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaPublishIntegrationVersionResponse.ServerRespon
...
// TakeoverEditLock: Clears the `locked_by` and `locked_at_timestamp`in the
// DRAFT version of this integration. It then performs the same action as the
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaTakeoverEditLockResponse.ServerResponse.Header
//
//	or (if a response was returned at all) in error.(*googleapi.Error).Header.
//
// Use googleapi.IsNotModified to check whether the returned error was because
...
// Unpublish: Sets the status of the ACTIVE integration to SNAPSHOT with a new
// tag "PREVIOUSLY_PUBLISHED" after validating it. The "HEAD" and
...
// Upload: Uploads an integration. The content can be a previously downloaded
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaUploadIntegrationVersionResponse.ServerRespons
// e.Header or (if a response was returned at all) in
// error.(*googleapi.Error).Header. Use googleapi.IsNotModified to check
// whether the returned error was because http.StatusNotModified was returned.
...
// Create: Creates a new certificate. The certificate will be registered to the
...
// ReadMask sets the optional parameter "readMask": The mask which specifies
// fields that need to be returned in the Certificate's response.
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaListCertificatesResponse.ServerResponse.Header
//
//	or (if a response was returned at all) in error.(*googleapi.Error).Header.
//
// Use googleapi.IsNotModified to check whether the returned error was because
...
// Patch: Updates the certificate by id. If new certificate file is updated, it
// will register with the trawler service, re-encrypt with cloud KMS and update
// the Spanner record. Other fields will directly update the Spanner record.
// Returns the Certificate.
//
// - name: Output only. Auto generated primary key.
...
// UpdateMask sets the optional parameter "updateMask": Field mask specifying
// the fields in the above Certificate that have been modified and need to be
// updated.
...
//     projects/{gcp_project_id}/locations/{location}/products/{product}/integrati
//     ons/{integration_id}/executions/{execution_id}.
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaCancelExecutionResponse.ServerResponse.Header
// or (if a response was returned at all) in error.(*googleapi.Error).Header.
// Use googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaExecution.ServerResponse.Header or (if a
// response was returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
...
//
//   - parent: The parent resource where this TemplateVersion will be created.
//     Format:
//     projects/{project}/location/{location}/product/{product}/integrationtemplat
//     es/{integrationtemplate}.
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaIntegrationTemplateVersion.ServerResponse.Head
...
//     projects/{project}/locations/{location}/products/{product}/integrationtempl
//     ates/{integrationtemplate}/versions/{version}.
...
// List: Returns the list of all IntegrationTemplateVersions in the specified
// project.
//
//   - parent: Format:
//     projects/{project}/location/{location}/product/{product}/integrationtemplat
...
// Filter sets the optional parameter "filter": Filter syntax: defined in the
// EBNF grammar.
...
// PageSize sets the optional parameter "pageSize": The maximum number of
// IntegrationTemplateVersions to return. The service may return fewer than
...
// PageToken sets the optional parameter "pageToken": A page token, received
// from a previous `ListIntegrationTemplateVersions` call. Provide this to
// retrieve the subsequent page. When paginating, all other parameters provided
// to `ListIntegrationTemplateVersions` must match the call that provided the
// page token.
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaListIntegrationTemplateVersionsResponse.Server
...
// Create: Creates an sfdc instance record. Store the sfdc instance in Spanner.
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaSfdcInstance.ServerResponse.Header or (if a
// response was returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
...
// Get: Gets an sfdc instance. If the instance doesn't exist, Code.NOT_FOUND
...
// List: Lists all sfdc instances that match the filter. Restrict to sfdc
// instances belonging to the current client only.
//
...
// ReadMask sets the optional parameter "readMask": The mask which specifies
// fields that need to be returned in the SfdcInstance's response.
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaListSfdcInstancesResponse.ServerResponse.Heade
// r or (if a response was returned at all) in error.(*googleapi.Error).Header.
// Use googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
...
// Patch: Updates an sfdc instance. Updates the sfdc instance in spanner.
// Returns the sfdc instance.
//
//   - name: Resource name of the SFDC instance
//     projects/{project}/locations/{location}/sfdcInstances/{sfdcInstance}.
...
// UpdateMask sets the optional parameter "updateMask": Field mask specifying
// the fields in the above SfdcInstance that have been modified and need to be
// updated.
...
// Create: Creates an sfdc channel record. Store the sfdc channel in Spanner.
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaSfdcChannel.ServerResponse.Header or (if a
// response was returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was because
// http.StatusNotModified was returned.
...
// Get: Gets an sfdc channel. If the channel doesn't exist, Code.NOT_FOUND
// exception will be thrown.
//
// - name: The name that is associated with the SfdcChannel.
...
// ReadMask sets the optional parameter "readMask": The mask which specifies
// fields that need to be returned in the SfdcChannel's response.
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleCloudIntegrationsV1alphaListSfdcChannelsResponse.ServerResponse.Header
//
//	or (if a response was returned at all) in error.(*googleapi.Error).Header.
//
// Use googleapi.IsNotModified to check whether the returned error was because
...
// Patch: Updates an sfdc channel. Updates the sfdc channel in spanner. Returns
// the sfdc channel.
//
//   - name: Resource name of the SFDC channel
//     projects/{project}/locations/{location}/sfdcInstances/{sfdc_instance}/sfdcC
//     hannels/{sfdc_channel}.
...
// UpdateMask sets the optional parameter "updateMask": Field mask specifying
// the fields in the above SfdcChannel that have been modified and need to be
// updated.
