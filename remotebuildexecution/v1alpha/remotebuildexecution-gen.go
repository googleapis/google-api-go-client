...
const basePathTemplate = "https://admin-remotebuildexecution.UNIVERSE_DOMAIN/"
...
// Create: Creates a new instance in the specified region. Returns a long
// running operation which contains an instance on completion. While the long
// running operation is in progress, any call to `GetInstance` returns an
// instance in state `CREATING`.
//
//   - parent: Resource name of the project containing the instance. Format:
//     `projects/[PROJECT_ID]`.
...
// Delete: Deletes the specified instance. Returns a long running operation
// which contains a `google.protobuf.Empty` response on completion. Deleting an
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleDevtoolsRemotebuildexecutionAdminV1alphaInstance.ServerResponse.Header
//
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleDevtoolsRemotebuildexecutionAdminV1alphaListInstancesResponse.ServerRe
...
// Patch: Updates the specified instance. Returns a long running operation
// which contains the updated instance in the response on completion.
//
//   - name: Output only. Instance resource name formatted as:
//     `projects/[PROJECT_ID]/instances/[INSTANCE_ID]`. Name should not be
//     populated when creating an instance since it is provided in the
...
// LoggingEnabled sets the optional parameter "loggingEnabled": Deprecated, use
// instance.logging_enabled instead. Whether to enable Stackdriver logging for
// this instance.
...
// Name1 sets the optional parameter "name1": Deprecated, use instance.Name
// instead. Name of the instance to update. Format:
// `projects/[PROJECT_ID]/instances/[INSTANCE_ID]`.
...
// to instance. For the `FieldMask` definition, see
// https://developers.google.com/protocol-buffers/docs/reference/google.protobuf#fieldmask
// If an empty update_mask is provided, only the non-default valued field in
// the worker pool field will be updated. Note that in order to update a field
// to the default value (zero, false, empty string) an explicit update_mask
...
// Create: Creates a new worker pool with a specified size and configuration.
...
// Delete: Deletes the specified worker pool. Returns a long running operation,
// which contains a `google.protobuf.Empty` response on completion. While the
// long running operation is in progress, any call to `GetWorkerPool` returns a
// worker pool in state `DELETING`.
//
//   - name: Name of the worker pool to delete. Format:
//     `projects/[PROJECT_ID]/instances/[INSTANCE_ID]/workerpools/[POOL_ID]`.
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerPool.ServerResponse.Head
...
// filtering. The value must be a string, a number, or a boolean. String values
// are case-insensitive. The comparison operator must be either `:`, `=`, `!=`,
...
// using parentheses to specify precedence. If neither operator is specified,
// `AND` is assumed. Examples: Include only pools with more than 100 reserved
// workers: `(worker_count > 100) (worker_config.reserved = true)` Include only
...
// Any non-2xx status code is an error. Response headers are in either
// *GoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsResponse.Server
