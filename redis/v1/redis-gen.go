...
type Instance struct {
	...
	//
	// Possible values:
	//   "READ_REPLICAS_MODE_UNSPECIFIED" - If not set, redis backend would
	// pick the mode based on other fields in the request.
	...
	// standard tier is [1-5] and defaults to 1. Valid value for basic tier
